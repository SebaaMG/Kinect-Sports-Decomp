...
void fn_82CD5DD0(undefined4 *param_1,int param_2,int param_3,int param_4,undefined8 param_5,
          ...
          if ((int)lVar10 < (int)lVar9) {
            do {
              ...
              *param_1 = CONCAT31(CONCAT21(CONCAT11(*(undefined1 *)
                                                     ((iVar11 >> (in_stack_00000064 & 0x3f)) *
                                                      param_3 + param_2 + iVar1),
                                                    *(undefined1 *)
                                                     ((iVar5 >> (in_stack_00000064 & 0x3f)) *
                                                      param_3 + param_2 + iVar1)),
                                           *(undefined1 *)
                                            (((int)(iVar4 + in_stack_0000005c) >>
                                             (in_stack_00000064 & 0x3f)) * param_3 + param_2 + iVar1
                                            )),
                                  *(undefined1 *)
                                   ((iVar4 >> (in_stack_00000064 & 0x3f)) * param_3 + param_2 +
                                   iVar1));
