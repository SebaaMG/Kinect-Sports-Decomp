...
void fn_8250E0B0(undefined8 param_1)

{
  ...
  *(float *)(iVar4 + 0x10) = (float)(dVar7 + dVar6);
  if (((bVar5 & 0x10) == 0) && ((bVar1 & 0x10) == 0)) {
    bVar5 = *(byte *)(iVar4 + 0x1c) & 0xef;
  }
  else {
    bVar5 = *(byte *)(iVar4 + 0x1c) | 0x10;
  }
