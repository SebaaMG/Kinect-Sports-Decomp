...
void fn_83011A38(int param_1,undefined8 param_2)

{
  ...
  do {
    while( true ) {
      ...
      uVar1 = puVar3[2];
      cVar5 = fn_83010770(param_1,param_2,*(undefined4 *)(*(int *)(uVar1 + 8) + 0x10));
      if (cVar5 != '\0') break;
      uStack_a0 = CONCAT44((uint *)*puVar3,puVar3);
      puVar3 = (uint *)*puVar3;
    }
    auStack_90[0] = 0;
...
LAB_83011ab4:
    ...
    plVar4 = (longlong *)fn_83013400(auStack_98,param_1,uVar1,param_1 + 0x50,uStack_a0);
    uStack_a0 = ((((U64)(uStack_a0)) & (~(((U64)0xFFFFFFFF) << 0))) | ((((U64)((uint *)((ulonglong)*plVar4 >> 0x20))) & ((U64)0xFFFFFFFF)) << 0));
    puVar3 = (((U64)(uStack_a0) >> 0) & 0xFFFFFFFF);
    uStack_a0 = *plVar4;
  } while( true );
}
