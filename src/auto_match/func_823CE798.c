...
void fn_823CE798(int param_1,undefined8 param_2)

{
  ...
  if ((iVar1 != 0) && (cVar4 = fn_8288B760(iVar1), cVar4 == '\0')) {
    ...
    fn_823F0828((ulonglong)*(uint *)*puVar3 + 0x3d8,param_2);
    if (iStack_3c == 0) {
      return;
    }
    fn_822315A0();
  ...
  *(int *)(param_1 + 0x1594) = (int)param_2;
  uVar2 = lbl_821CC160;
  *(undefined1 *)(param_1 + 0x1590) = 1;
  *(undefined4 *)(param_1 + 0x15d0) = uVar2;
  puVar3 = (undefined4 *)(param_1 + 0x15a0U & 0xfffffff0);
