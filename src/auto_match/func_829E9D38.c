...
undefined8 fn_829E9D38(int *param_1,int param_2)

{
  ...
  iVar5 = ((param_1[3] - param_1[1] >> 2) + param_2) * 4;
  ...
  if (uVar3 == 0) {
    ...
    fn_82F63CA0(uVar6,param_1[1],(param_1[2] - param_1[1] >> 2) << 2);
    if (*param_1 != 0) {
    ...
    *param_1 = (int)uVar3;
    ...
    param_1[1] = iVar2;
    param_1[2] = (param_1[2] - iVar1 >> 2) * 4 + iVar2;
  }
  return uVar4;
}
