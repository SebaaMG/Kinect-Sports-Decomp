...
extern unsigned int lbl_821091E0;
extern unsigned int lbl_821091E1;


undefined8 fn_82C64FC0(int param_1,uint *param_2)

{
  ...
  iVar5 = (int)((*puVar3 >> 0x3d) << 1);
  fn_82C4E470(puVar3,(&lbl_821091E0)[iVar5]);
  lVar9 = 3;
  bVar1 = (&lbl_821091E1)[iVar5];
  if (bVar1 == 0xff) {
    *(undefined4 *)((int)puVar3 + 0x14) = 3;
  }
  puVar3 = *(ulonglong **)(param_1 + 0x54);
  if ((*(int *)((int)puVar3 + 0x14) == 0) && (bVar1 < 4)) {
    uVar7 = *puVar3;
    uVar4 = *(uint *)(puVar3 + 1);
    *puVar3 = uVar7 << 1;
