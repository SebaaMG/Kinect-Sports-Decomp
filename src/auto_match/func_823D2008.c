...
int fn_823D2008(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  puVar1 = (undefined4 *)fn_8265C9E0(0x60);
  if (puVar1 != (undefined4 *)0x0) {
    *puVar1 = &lbl_821B623C;
    fn_82F68CC0(puVar1 + 4,&stack0x00000020,0x50);
