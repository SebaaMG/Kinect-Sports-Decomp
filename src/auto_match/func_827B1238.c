...
extern int fn_827B1778();


void fn_827B1238(int *param_1,undefined8 param_2,undefined2 *param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    lVar4 = 8;
LAB_827b128c:
    fn_827B1778(param_1,param_2,lVar4);
  }
    ...
    *puVar11 = 0xffffffff;
    ...
    if (uVar8 != param_4) {
      ...
      if (puVar6 != (uint *)0x0) {
        ...
        *(undefined2 *)(iVar7 + 0x10) = *(undefined2 *)(iVar10 + 0x10);
      }
      *puVar9 = uVar5;
      uVar12 = *param_3;
      *puVar11 = 0xffffffff;
      *(undefined2 *)(iVar10 + 0x10) = uVar12;
      goto LAB_827b1384;
    }
    if (puVar6 != (uint *)0x0) {
      *puVar6 = uVar3;
