...
void fn_82262A90(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (*pcVar2 != '\0') {
    iVar3 = fn_8225FDE0(6,param_10);
    if ((iVar3 == 0) && (cVar4 = fn_82E1CAD0(6), cVar4 != '\0')) {
