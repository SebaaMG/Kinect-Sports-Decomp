...
void fn_8259B378(int param_1,undefined8 param_2)

{
  ...
  if (aiStack_2c[0] != *(int *)(param_1 + 0x38)) {
    if (*(int *)(aiStack_2c[0] + 0xc) != 0) {
      fn_8265CA20();
    }
    fn_8259BA48(aiStack_2c,param_1 + 0x34,aiStack_2c[0]);
  }
  fn_82A1BB18();
