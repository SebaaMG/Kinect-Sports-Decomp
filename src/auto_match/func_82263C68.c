...
void fn_82263C68(undefined8 param_1,undefined1 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (*pcVar1 != '\0') {
    iVar2 = fn_8225FDE0(0x52,param_2);
    if ((iVar2 == 0) && (cVar3 = fn_82E1CAD0(0x52), cVar3 != '\0')) {
