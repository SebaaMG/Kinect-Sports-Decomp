...
void fn_82A884C0(undefined8 param_1,int param_2,undefined8 param_3,longlong param_4,
                  longlong param_5)

{
  ...
  fn_82A87148(param_3,param_4 + 0x20,0x10,param_5 + 0x20);
  fn_82A87148(param_3,param_4 + 0x30,0x10,param_5 + 0x22);
  return;
}
