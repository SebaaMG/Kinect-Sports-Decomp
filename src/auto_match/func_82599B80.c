...
undefined8 fn_82599B80(undefined8 param_1,longlong param_2,ulonglong param_3)

{
  ...
  if ((param_3 & 0xffffffff) < 0x11) {
    uVar3 = fn_82522E60(param_2,param_3);
  }
  else {
    ...
    *(undefined4 *)(iVar4 + 0x28) = 0x10;
    uVar3 = fn_82522CF8(iVar4,param_2 + param_3 + -0x10);
    if (0x10 < uVar5) {
      uVar5 = 0x10;
    }
