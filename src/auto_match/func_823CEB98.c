...
void fn_823CEB98(int param_1,undefined8 param_2)

{
  ...
  if ((iVar1 != 0) && (cVar4 = fn_8288B760(iVar1), cVar4 == '\0')) {
    ...
    fn_823F0828((ulonglong)*(uint *)*puVar3 + 0x2e8,param_2);
    if (iStack_3c == 0) {
      return;
    }
    fn_822315A0();
  ...
  *(int *)(param_1 + 0x15e4) = (int)param_2;
  uVar2 = lbl_821CC160;
  *(undefined1 *)(param_1 + 0x15e0) = 1;
  *(undefined4 *)(param_1 + 0x1620) = uVar2;
  puVar3 = (undefined4 *)(param_1 + 0x15f0U & 0xfffffff0);
