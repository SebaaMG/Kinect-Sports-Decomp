...
void fn_827354B0(longlong param_1,uint *param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (((uVar1 & 0xff) == 0) &&
    ...
    fn_826C1620(param_1 + 100,param_1 + -0x10,param_2,param_3,param_4,uVar1);
  }
  return;
}
