...
extern int fn_82272E58();
extern int fn_82273298();
...
undefined4 * fn_82272CC8(undefined4 *param_1,int param_2,ulonglong param_3,uint *param_4)
  ...
  if (((param_3 & 0xffffffff) == (ulonglong)*puVar1) && (param_4 == puVar1)) {
    ...
    *param_1 = **(undefined4 **)(param_2 + 4);
    ...
    while ((param_3 & 0xffffffff) != ZEXT48(param_4)) {
      ...
      fn_82272E58(auStack_30,param_2,param_3);
