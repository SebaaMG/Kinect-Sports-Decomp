...
undefined4 * fn_828CEAD0(undefined4 *param_1,int param_2,int *param_3,int param_4)

{
  ...
  if (param_3 == (int *)*piVar2) {
    if (*(uint *)(param_4 + 0xc) < (uint)param_3[3]) {
      fn_828CE758(param_1,param_2,1,param_3,param_4);
      return param_1;
    }
  }
  else {
    if (param_3 != piVar2) {
      ...
      fn_828CE758(param_1,param_2,0,param_3,param_4);
      return param_1;
    }
    if (*(uint *)(piVar2[2] + 0xc) < *(uint *)(param_4 + 0xc)) {
      fn_828CE758(param_1,param_2,0,piVar2[2],param_4);
      return param_1;
    }
  }
LAB_828cec54:
