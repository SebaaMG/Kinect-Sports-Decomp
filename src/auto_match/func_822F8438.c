...
void fn_822F8438(uint *param_1,undefined4 *param_2)

{
  ...
  if (bVar4) {
    uVar2 = *param_1;
    if (puVar8 == puVar7) {
      uVar3 = (int)((int)puVar8 - uVar2) >> 3;
      if (0x1ffffffe < uVar3) {
                    /* WARNING: Subroutine does not return */
        fn_82F622A8(0xffffffff82196fd4);
      }
      uVar6 = (longlong)(int)uVar3 + 1;
      uVar3 = (int)((int)puVar7 - uVar2) >> 3;
      if ((ulonglong)uVar3 < (uVar6 & 0xffffffff)) {
        ...
        fn_822F7FA0(param_1,uVar5);
      }
    }
    puVar8 = (undefined4 *)param_1[1];
    puVar7 = (undefined4 *)(((int)((int)param_2 - uVar2) >> 3) * 8 + *param_1);
    if (puVar8 == (undefined4 *)0x0) goto LAB_822f85b8;
    *puVar8 = *puVar7;
    uVar1 = puVar7[1];
  }
  else {
    if (puVar8 == puVar7) {
      uVar2 = (int)((int)puVar8 - *param_1) >> 3;
      if (0x1ffffffe < uVar2) {
                    /* WARNING: Subroutine does not return */
        fn_82F622A8(0xffffffff82196fd4);
      }
      uVar6 = (longlong)(int)uVar2 + 1;
      uVar2 = (int)((int)puVar7 - *param_1) >> 3;
