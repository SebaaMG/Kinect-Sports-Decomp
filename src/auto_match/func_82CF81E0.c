...
undefined8 fn_82CF81E0(int param_1,int *param_2,int param_3)

{
  ...
  uVar1 = (**(code **)(**(int **)(param_1 + 0x34) + 4))(*(int **)(param_1 + 0x34),lVar4);
  iVar3 = (**(code **)(**(int **)(param_1 + 0x34) + 0x2c))(*(int **)(param_1 + 0x34),uVar1,lVar4);
  *(int *)(param_1 + 0x48) = iVar3 + *(int *)(param_1 + 0x48);
  uStack_b8 = CONCAT13(1,(((U64)(uStack_b8) >> 8) & 0xFFFFFF));
  if (*(int *)(param_1 + 4) == 0) {
    uStack_c0 = 0;
  }
  else {
  ...
  fn_82CF84B0(*(undefined4 *)(param_1 + 0x44),*(undefined4 *)(param_1 + 0x38),uVar1,
                  CONCAT44(uStack_c0,(int)lVar4),(ulonglong)uStack_b8 << 0x20);
