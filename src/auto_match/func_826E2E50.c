...
extern int fn_826E18F0();
extern int fn_826E7A08();
extern int fn_826F6710();
extern int fn_826F6798();
extern int fn_826FAA70();


void fn_826E2E50(int param_1)

{
  ...
  fn_826A9280(param_1 + 0x14,0xffffffff8200d0b8);
  iVar4 = *(int *)(param_1 + 0x314);
  if (iVar4 == 0) {
    iVar4 = param_1 + 0x28;
  }
  lVar1 = fn_826FAA70(iVar4);
  cVar3 = fn_826F6710(iVar4);
  if (cVar3 != '\0') {
    lVar1 = lVar1 + 4;
  }
  lVar2 = fn_826E18F0(param_1,lVar1);
  if (cVar3 == '\0') {
