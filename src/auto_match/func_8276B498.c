...
extern int fn_826E1FE8();
extern int fn_8276D470();
...
void fn_8276B498(int *param_1,undefined8 param_2,uint param_3)
    ...
    if (*param_1 != 0) {
      ...
      do {
        ...
        if (*(int *)(iVar3 + 8) != -2) {
          ...
          fn_8276D470(apuStack_60,param_2,iVar3 + 0x10);
          fn_826DF9C0(iVar3 + 0x10,0);
