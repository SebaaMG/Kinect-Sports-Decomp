...
longlong fn_823864B8(uint *param_1)

{
  ...
  if (*(char *)((int)puVar5[1] + 0x31) == '\0') {
    ...
    do {
      if ((uint)puVar2[4] < *param_1) {
        ...
        if ((*(char *)((int)puVar4 + 0x31) != '\0') && (*param_1 < (uint)puVar2[4])) {
          puVar4 = puVar2;
        }
  ...
  if (*(char *)((int)puVar4 + 0x31) == '\0') {
    ...
    puVar2 = *(undefined4 **)(*(int *)(lbl_83276560 + 4) + 4);
  }
  ...
  while (apuStack_30[0] != puVar4) {
    lVar6 = lVar6 + 1;
    fn_824A30C8(apuStack_30);
  }
  fn_82386848(apuStack_30,iVar3,puVar5,puVar4);
  return lVar6;
}
