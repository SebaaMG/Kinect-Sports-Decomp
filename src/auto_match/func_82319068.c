...
extern int fn_82319130();
extern int fn_823194E0();
...
undefined4 * fn_82319068(undefined4 *param_1,int param_2,ulonglong param_3,uint *param_4)
  ...
  if (((param_3 & 0xffffffff) == (ulonglong)*puVar1) && (param_4 == puVar1)) {
    ...
    *param_1 = **(undefined4 **)(param_2 + 4);
    ...
    while ((param_3 & 0xffffffff) != ZEXT48(param_4)) {
      ...
      fn_82319130(auStack_30,param_2,param_3);
