...
extern int fn_828EF288();


undefined4 * fn_828EF580(undefined4 *param_1,int param_2,int *param_3,longlong param_4)

{
  ...
  lVar4 = param_4 + 0xc;
  if (*(int *)(param_2 + 8) == 0) {
    fn_828EF040(param_1,param_2,1,*(undefined4 *)(param_2 + 4),param_4);
  }
  else {
    ...
    if (param_3 == (int *)*piVar1) {
      ...
      if (cVar3 != '\0') {
        fn_828EF040(param_1,param_2,1,param_3,param_4);
        return param_1;
      }
    }
    else if (param_3 == piVar1) {
      cVar3 = fn_828A0C20((ulonglong)(uint)piVar1[2] + 0xc,lVar4);
      if (cVar3 != '\0') {
        fn_828EF040(param_1,param_2,0,*(undefined4 *)(*(int *)(param_2 + 4) + 8),param_4);
        return param_1;
      }
    }
    else {
      ...
      if ((cVar3 != '\0') &&
        ...
        fn_828EF040(param_1,param_2,1,piVar1,param_4);
        return param_1;
      }
    }
