...
undefined4 *
fn_828E3F60(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)
  ...
  while (cVar1 == '\0') {
    ...
    if (piVar2 == (int *)*piVar3) {
      ...
      if (*(char *)(iVar4 + 0x24) == '\0') {
        ...
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x24) = 0;
        fn_828E28E0(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar4 = *piVar3;
      if (*(char *)(iVar4 + 0x24) == '\0') {
        ...
        *(undefined1 *)(piVar5[1] + 0x24) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x24) = 0;
        fn_828E2868(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
