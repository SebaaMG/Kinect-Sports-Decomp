...
void fn_82263A78(undefined8 param_1,undefined1 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (*pcVar1 != '\0') {
    iVar2 = fn_8225FDE0(0x4d,param_2);
    if ((iVar2 == 0) && (cVar3 = fn_82E1CAD0(0x4d), cVar3 != '\0')) {
