...
extern int fn_82AD0020();
extern int fn_82AE5188();


ulonglong fn_82AE5828(longlong param_1,longlong param_2,ulonglong param_3,longlong param_4)

{
  ...
  while( true ) {
    if ((int)param_4 < 1) {
      uVar1 = fn_82AE5188(param_1 + 8,param_2,auStack_30);
    }
    else {
      uVar1 = fn_82AD0020();
    }
    ...
    if (0x100 < (param_2 + param_3 & 0xffffffff)) {
      return 0xffffffffffffffff;
    }
  }
