...
void fn_826A9168(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  piVar1 = (int *)(**(code **)(**(int **)(param_1 + 0x74) + 0x94))();
  if (piVar1 != (int *)0x0) {
    (**(code **)(*piVar1 + 4))(piVar1,0x10,param_2,&stack0x00000020);
  }
  return;
}
