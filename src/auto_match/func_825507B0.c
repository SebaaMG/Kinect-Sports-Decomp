...
extern int fn_82550D00();
extern int fn_82550E48();
extern int fn_8260D428();


undefined4 * fn_825507B0(undefined4 *param_1,int param_2,int *param_3,int param_4)
  ...
  if (*(int *)(param_2 + 8) == 0) {
    ...
    if (param_3 != (int *)*piVar3) {
      ...
      if (iVar2 < 0) {
        ...
        piVar3 = (int *)fn_8251F2B0(apiStack_50);
        puVar6 = puVar4;
        if (0xf < *(uint *)(param_4 + 0x20)) {
...
LAB_8255094c:
        ...
        if (-1 < iVar2) {
LAB_82550a00:
          puVar4 = (undefined4 *)fn_82550D00(auStack_48,param_2,param_4);
          *param_1 = *puVar4;
          return param_1;
        }
        apiStack_50[0] = param_3;
        piVar3 = (int *)fn_825503E0(apiStack_50);
  ...
  uVar5 = 1;
LAB_825507f8:
  fn_82550E48(param_1,param_2,uVar5,param_3,param_4);
  return param_1;
}
