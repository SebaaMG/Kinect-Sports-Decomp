...
undefined8
fn_826B4AD8(char *param_1,undefined8 param_2,int *param_3,int param_4,undefined8 param_5,
             undefined8 param_6)

{
  ...
  *(int *)(iStack_90 + 8) = (int)lVar5;
  ...
  if (iStack_88 != 0) {
    ...
    uVar2 = fn_826AEC60(auStack_60,param_2,param_3,param_4,param_5,param_6,param_1);
