...
extern unsigned int lbl_8213721C;


undefined4 * fn_82D50C58(undefined4 *param_1,undefined8 param_2,int param_3)

{
  ...
  *param_1 = &lbl_8213721C;
  *(undefined2 *)((int)param_1 + 6) = 1;
  param_1[2] = 0;
  param_1[3] = 0xf;
  param_1[5] = (int)param_2;
  param_1[4] = &lbl_82134CF4;
  fn_82CE4040(param_2);
