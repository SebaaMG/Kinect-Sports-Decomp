...
void fn_8292CFC0(int param_1,int param_2,int param_3,longlong param_4)

{
  ...
  uVar10 = *(int *)(param_1 + 0x60) * param_2 + *(int *)(param_1 + 100) * param_3 +
           *(int *)(param_1 + 0x20);
  uVar8 = *(int *)(param_1 + 0x68) * 2 + uVar10;
  if (uVar10 < uVar8) {
    puVar7 = (undefined2 *)(uVar10 - 2);
    lVar9 = (ulonglong)((uVar8 - uVar10) - 1 >> 1) + 1;
    do {
      puVar7 = puVar7 + 1;
      uVar1 = *puVar7;
      ...
      *pfVar2 = (float)(longlong)(char)((cVar3 == -0x80) + cVar3) * fVar6;
      pfVar2[1] = (float)(longlong)(char)((cVar4 == -0x80) + cVar4) * fVar6;
