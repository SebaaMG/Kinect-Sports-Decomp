...
void fn_8265B200(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  *(undefined1 *)(param_1 + 0x2028) = 0;
  ...
  fn_8265B100(param_1,param_2,&stack0x00000020);
  return;
}
