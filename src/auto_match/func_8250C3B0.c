...
void fn_8250C3B0(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  do {
    auStack_a0[0] = uVar2;
    fn_8250C280(param_1,param_2,param_3,auStack_a0);
    uVar11 = 0;
...
LAB_8250c4f8:
            ...
            if (iVar4 == 0) goto LAB_8250c510;
          }
          fn_828114A8(iStack_b0,lVar13);
        }
        else {
          iVar4 = aiStack_a8[0];
          if ((uVar11 & 0xffffffff) < uVar6) goto LAB_8250c4f8;
        }
LAB_8250c510:
        uVar11 = uVar11 + 1;
        lVar13 = lVar13 + 1;
