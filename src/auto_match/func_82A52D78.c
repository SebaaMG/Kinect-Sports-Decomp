...
extern int fn_82A6D330();
extern int fn_82A6D378();
extern int fn_82A6E1C0();
extern int fn_82A6E738();
...
ulonglong fn_82A52D78(int *param_1,ushort *param_2,short *param_3)
...
switchD_82a52e10_caseD_1:
    ...
    case 2:
      ...
      *(undefined4 *)(iVar3 + 0x17c) = 0;
      ...
      goto switchD_82a52e10_caseD_1;
    case 3:
      if (*(short *)(param_1 + 4) == 0) goto LAB_82a535e0;
      uVar13 = fn_82A6E738(param_1);
      if ((int)uVar13 < 0) goto LAB_82a535f8;
      if (*(short *)(iVar3 + 0x22) != 0) {
        iVar10 = 0;
        do {
          iVar11 = iVar10 * 0x6f0;
    ...
    case 4:
      ...
      *(undefined2 *)(iVar3 + 0x2da) = 1;
      break;
    case 6:
      goto switchD_82a52e10_caseD_6;
    case 7:
      goto switchD_82a52e10_caseD_7;
    case 8:
      goto switchD_82a52e10_caseD_8;
    case 9:
      goto switchD_82a52e10_caseD_9;
    }
    if (*(int *)(*param_1 + 0xb0) != 1) {
      uVar13 = (*(code *)param_1[0x7e])(param_1);
      if ((uVar13 & 0xffffffff) != 0x80040004) {
        if (-1 < (int)uVar13) goto LAB_82a52f64;
        goto LAB_82a535f8;
      }
      iVar10 = fn_82C30098(param_1 + 0x38);
      if ((iVar10 == 0) || (param_1[0xb0] == 0)) goto LAB_82a535f8;
      param_1[8] = 8;
      uVar13 = 4;
      param_1[0x36] = 1;
...
switchD_82a52e10_caseD_6:
    if (2 < *(int *)(iVar3 + 0x3c)) {
      iStack_9c = 0;
      do {
        uVar13 = fn_82A6D090(param_1 + 0x38,1,&iStack_9c);
        if ((int)uVar13 < 0) goto LAB_82a535f8;
      } while (iStack_9c != 1);
    }
    param_1[8] = 7;
switchD_82a52e10_caseD_7:
    if (*(int *)(iVar3 + 0x3c) < 3) {
      *(short *)(param_1 + 4) = *(short *)(param_1 + 4) + -1;
    }
    else {
      uVar13 = fn_82A6D330(param_1);
    }
    if ((int)uVar13 < 0) goto LAB_82a535f8;
    if (param_1[0xb0] != 0) {
      *(undefined2 *)(param_1 + 4) = 0;
    ...
    *(short *)(param_1 + 0x37) = *(short *)(param_1 + 0x37) + 1;
    if (0 < *(short *)(iVar3 + 0x244)) {
      ...
      do {
        ...
        if (**(short **)(iVar10 + 0x1a8) <= *(short *)(iVar10 + 0x72)) goto LAB_82a5341c;
        sVar12 = (short)iVar11 + 1;
