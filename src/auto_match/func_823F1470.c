...
void fn_823F1470(int param_1,undefined4 param_2,undefined4 param_3,undefined8 param_4,
...

{
  ...
  (**(code **)(**(int **)(param_1 + 0x88) + 0x10))
            (*(int **)(param_1 + 0x88),uStack_20,&stack0x00000066);
  (**(code **)(**(int **)(param_1 + 0x90) + 0x10))
            (*(int **)(param_1 + 0x90),uStack_20,&stack0x0000006c);
  (**(code **)(**(int **)(param_1 + 0x98) + 0x10))
            (*(int **)(param_1 + 0x98),uStack_20,in_stack_00000074);
  if (*(int *)(param_1 + 0x48) != 0) {
    fn_828E9D90(uStack_20);
    fn_828E9D40(uStack_20);
    fn_82251F78(param_1,uStack_20,param_1 + 0x38);
  }
