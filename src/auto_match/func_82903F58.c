...
undefined4 fn_82903F58(int param_1,ulonglong param_2)

{
  ...
  if ((ulonglong)uVar1 < (param_2 & 0xffffffff)) {
    ...
    for (; uVar3 < (param_2 & 0xffffffff); uVar3 = (uVar3 & 0x7fffffff) << 1) {
    }
    ...
    *(int *)(param_1 + 0x98) = (int)lVar2;
    *(int *)(param_1 + 0x9c) = (int)uVar3;
  }
