...
void fn_82236678(int param_1,undefined8 param_2,int param_3)

{
  ...
  (**(code **)(**(int **)(param_1 + 0x80) + 0x14))(*(int **)(param_1 + 0x80),param_2,afStack_5c);
  ...
  (**(code **)(**(int **)(param_1 + 0xa0) + 0x14))(*(int **)(param_1 + 0xa0),param_2,&fStack_60);
  (**(code **)(**(int **)(param_1 + 0xa8) + 0x14))(*(int **)(param_1 + 0xa8),param_2,&fStack_64);
  if (*(int **)(param_3 + 0x10) != (int *)0x0) {
    (**(code **)(**(int **)(param_3 + 0x10) + 4))
              ((double)afStack_5c[0],(double)fStack_60,(double)fStack_64);
  }
  return;
}
