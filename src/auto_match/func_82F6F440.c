...
void fn_82F6F440(ulonglong param_1,uint param_2,ulonglong param_3,code *param_4,undefined8 param_5
                  )
...
LAB_82f6f4bc:
    while( true ) {
      ...
      iVar6 = (*param_4)(param_5,param_1,uVar7);
      uVar3 = (uint)param_1;
      ...
      iVar6 = (*param_4)(param_5,param_1,uVar14);
      uVar2 = (uint)uVar14;
      ...
      iVar6 = (*param_4)(param_5,uVar7,uVar14);
      uVar15 = uVar14;
      uVar16 = param_1;
...
LAB_82f6f660:
      if ((uVar16 & 0xffffffff) < (uVar7 & 0xffffffff)) {
        do {
          ...
          if ((uVar7 & 0xffffffff) <= (uVar16 & 0xffffffff)) goto LAB_82f6f698;
          iVar6 = (*param_4)(param_5,uVar16,uVar7);
        } while (iVar6 < 1);
        if ((uVar7 & 0xffffffff) <= (uVar16 & 0xffffffff)) goto LAB_82f6f698;
      }
      else {
LAB_82f6f698:
      ...
      do {
        ...
        iVar6 = (*param_4)(param_5,uVar15,uVar7);
      } while (0 < iVar6);
      uVar4 = (uint)uVar16;
      ...
      if ((uVar7 & 0xffffffff) < (uVar15 & 0xffffffff)) {
        do {
          uVar15 = uVar15 - param_3;
          if ((uVar15 & 0xffffffff) <= (uVar7 & 0xffffffff)) goto LAB_82f6f764;
          iVar6 = (*param_4)(param_5,uVar15,uVar7);
        } while (iVar6 == 0);
        if ((uVar15 & 0xffffffff) <= (uVar7 & 0xffffffff)) goto LAB_82f6f764;
      }
...
LAB_82f6f764:
      ...
      if ((int)((uint)uVar15 - uVar3) < (int)(uVar2 - uVar4)) goto LAB_82f6f7c8;
      ...
      param_1 = uVar16;
      puVar13 = puVar12;
      if ((uVar14 & 0xffffffff) <= (uVar16 & 0xffffffff)) goto LAB_82f6f558;
    }
    puVar13 = puVar12;
