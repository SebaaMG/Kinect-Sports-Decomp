...
extern int fn_82747C50();
extern int fn_82747CA0();
...
undefined4 * fn_82748020(undefined4 *param_1,int param_2)

{
  ...
  if ((uVar2 & 0xffffffff) == 0) {
    ...
    uVar5 = fn_82747C50(uVar2,&iStack_50);
  }
  *param_1 = uVar5;
  *(undefined1 *)(param_1 + 2) = 0;
  ...
  if (lVar3 == 0) {
    ...
    uVar6 = fn_82747CA0(lVar3,&iStack_50,uVar4,param_1);
  }
  if (uVar6 != 0) {
  ...
  (**(code **)(iVar1 + 0x28))
            ((ulonglong)*(uint *)(param_2 + 0x28c) + 0x10,&iStack_50,param_2 + 0x44,uVar4,auStack_60
            );
