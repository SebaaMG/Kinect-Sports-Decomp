...
void fn_827A61A0(undefined8 param_1,int *param_2,int *param_3)

{
  ...
  if ((*(int *)*param_3 != 2) || (iVar1 = 1, 1 < (uint)param_3[1])) {
    ...
    if ((iVar1 == 0) || ((iVar1 == 1 && (2 < (uint)piVar3[2])))) {
      ...
      iVar1 = fn_82790270(uVar4,0xffffffff82196f18,uVar2);
      if (iVar1 == 0) {
        uVar5 = 0;
        if (param_2[1] != 0) {
          iVar1 = 0;
          do {
            fn_8278B208(*(undefined4 *)(iVar1 + *param_2),1);
            uVar5 = uVar5 + 1;
            iVar1 = iVar1 + 4;
        ...
        iVar1 = fn_82790270(uVar4,0xffffffff82196f10,uVar6);
        if ((iVar1 == 0) && (uVar5 = 0, param_2[1] != 0)) {
          iVar1 = 0;
          do {
            fn_8278B208(*(undefined4 *)(iVar1 + *param_2),0);
            uVar5 = uVar5 + 1;
            iVar1 = iVar1 + 4;
          } while (uVar5 < (uint)param_2[1]);
        }
