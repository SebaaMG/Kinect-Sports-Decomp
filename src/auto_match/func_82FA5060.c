...
ulonglong fn_82FA5060(int param_1,ulonglong param_2)

{
  ...
  if ((param_2 & 0xffffffff) == 0) {
    ...
    if (*(int *)(iVar3 + 0x44) == 0) {
      uVar1 = fn_82FA64D8(*(undefined4 *)(iVar3 + 0x40),param_2);
    }
    else {
      uVar1 = fn_82FA6550(*(undefined4 *)(iVar3 + 0x40),*(int *)(iVar3 + 0x44),param_2);
    }
