...
void fn_823EB240(int param_1,undefined4 param_2)

{
  ...
  *puVar1 = in_register_00010010;
  ...
  puVar1[3] = in_vr1;
  uStack_40 = param_2;
  uVar2 = fn_823D1F70(auStack_50,0x823ced9000000000,CONCAT44(uStack_48,uStack_44),
                            CONCAT44(param_2,uStack_3c),uStack_38,uStack_30,uStack_28);
  fn_8227CB30(uVar3 + 0xb60,uVar2);
  fn_82359C18(uVar2);
  return;
}
