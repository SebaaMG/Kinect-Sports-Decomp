...
void fn_82CEC5E0(undefined4 *param_1,undefined4 *param_2)

{
  ...
  *param_1 = uVar2;
  param_1[5] = uVar2;
  param_1[10] = uVar2;
  param_1[param_2[2] * 5] = *param_2;
  param_1[param_2[3] * 4 + param_2[2]] = param_2[1];
  param_1[param_2[2] * 4 + param_2[3]] = -(float)param_2[1];
  param_1[param_2[3] * 5] = *param_2;
  return;
}
