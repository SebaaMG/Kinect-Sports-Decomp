...
void fn_8285A580(int param_1,undefined8 param_2,undefined8 param_3)

{
  lbl_83211330 = *(undefined4 *)(param_1 + 0x34);
  lbl_8321132C = 0;
  if (*(int *)(param_1 + 0x44) != 0) {
    lbl_8321132C = *(undefined4 *)(*(int *)(param_1 + 0x44) + 0x44);
  }
  fn_8285A498(lbl_83211330,param_2,param_3);
  if (*(int *)(param_1 + 0x44) != 0) {
    fn_828628F8(*(int *)(param_1 + 0x44),param_2,param_3);
  }
  return;
}
