...

{
  ...
  case 1:
    ...
    return;
  case 2:
    cVar1 = fn_828ACCE8(*(undefined4 *)(param_1 + 8));
    if ((cVar1 == '\0') || (cVar1 = fn_828AD740(*(undefined4 *)(param_1 + 8)), cVar1 != '\0'))
    {
      fn_828D2F28(param_1);
      return;
    }
  ...
  case 10:
    cVar1 = fn_828ACCE8(*(undefined4 *)(param_1 + 8));
    if (cVar1 != '\0') {
      fn_828AE818(*(undefined4 *)(param_1 + 8),0x10);
    }
  }
  return;
}
