...
ulonglong fn_826C9940(int *param_1)

{
  ...
  if (cVar4 == '\0') {
    ...
    if (iVar1 != 0) {
      acStack_30[0] = '\0';
      fn_82681728(aiStack_40,(ulonglong)(uint)param_1[0x52] + 0x254,0xffffffff8200670c);
      cVar4 = (**(code **)(*(int *)(iVar1 + 0x10) + 0x2c))
                        (iVar1 + 0x10,param_1 + 0x52,aiStack_40,acStack_30);
      ...
      *(int *)(aiStack_40[0] + 8) = (int)lVar5;
      ...
      if (cVar4 != '\0') {
        ...
        if (!bVar2) {
          uVar3 = fn_82695608(acStack_30,param_1 + 0x34);
    ...
    cVar4 = fn_826C98F8(param_1);
    if ((cVar4 != '\0') || (uVar3 = 0, 0 < *(short *)(param_1 + 0x24))) {
      uVar3 = 1;
    }
  }
  else {
