...
uint fn_82918A68(int param_1,undefined8 param_2,uint *param_3,uint param_4,longlong param_5)
            ...
            do {
              ...
              if (puVar4[5] != 0) {
                ...
                do {
                  ...
                  uVar8 = fn_82918A68(iVar6,param_2,param_3,*(undefined4 *)(iVar6 + 0x30),param_5)
                  ;
                  if ((int)uVar8 < 0) {
                    return uVar8;
                  }
              ...
              do {
                ...
                if (uVar8 != 0) {
                  do {
                    ...
                    uVar13 = uVar13 + 1;
                    puVar21 = puVar21 + 1;
                    *puVar21 = param_3[iVar18 * (uint)puVar4[3] + uVar15];
                    uVar8 = (uint)puVar4[2];
                  } while (uVar13 < uVar8);
                }
                uVar13 = (uint)puVar4[3];
...
LAB_82918c34:
  ...
  if (uVar2 != 1) {
    ...
    if (uVar2 == 2) {
      if ((uVar23 & 0xffffffff) != 0) {
        puVar19 = puVar5;
        do {
          *puVar19 = (uint)(*(int *)((int)puVar19 + ((int)puVar20 - (int)puVar5)) != 0);
          puVar19 = puVar19 + 1;
          uVar23 = uVar23 - 1;
        } while (uVar23 != 0);
      }
      ...
      do {
        uVar9 = uVar8;
        if (*(int *)(((int)puVar20 - (int)puVar5) + (int)puVar19) != 0) {
          uVar9 = uVar13;
        }
        *puVar19 = uVar9;
        puVar19 = puVar19 + 1;
      ...
      if (uVar12 != 0) {
        ...
        do {
          ...
          if ((uint)uVar2 < uVar22) {
            ...
            do {
              uVar16 = uVar16 - 1;
              *(undefined4 *)((int)((lVar14 + uVar16 & 0xffffffff) << 2) + (int)puVar5) =
          ...
          for (; uVar7 != 0; uVar7 = uVar7 - 1) {
            uVar17 = uVar17 - 1;
            *(undefined4 *)((int)((lVar14 + uVar17 & 0xffffffff) << 2) + (int)puVar5) =
                 *(undefined4 *)((int)((lVar11 + uVar17 & 0xffffffff) << 2) + (int)puVar21);
          }
  ...
  if (*(code **)(param_1 + 0x1c) == (code *)0x0) {
    ...
    uVar13 = (**(code **)(param_1 + 0x1c))
                       (param_2,(ulonglong)*(ushort *)(param_1 + 10) + param_5,puVar20,puVar5,uVar23
                       );
