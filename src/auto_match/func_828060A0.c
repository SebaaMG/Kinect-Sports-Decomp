...
void fn_828060A0(int param_1,int param_2,int *param_3,byte *param_4,int *param_5,uint param_6)
    ...
    if ((uVar5 & bVar1) != 0) {
      if ((uVar5 >> 3 & (ulonglong)bVar1) == 0) {
        ...
        *(float *)*param_3 =
             ...
             (float)(longlong)sVar2) * *(float *)(*(int *)(param_1 + 4) + iVar3);
        bVar4 = *param_4 + bVar4;
        *param_4 = bVar4 & 0x1f;
