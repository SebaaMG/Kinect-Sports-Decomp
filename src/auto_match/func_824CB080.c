...
extern int fn_824CB5D0();
extern int fn_824CB638();
extern int fn_8265CA20();
extern int fn_82F622E0();
extern unsigned int stack0x00000024;


undefined4 * fn_824CB080(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar7 + 0x51) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x51) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar1 = *(undefined1 *)(piStack00000024 + 0x14);
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x51) == '\0') {
      piVar5 = (int *)*piVar8;
      piVar6 = piVar8;
      while (piVar2 = piVar5, *(char *)((int)piVar2 + 0x51) == '\0') {
        piVar6 = piVar2;
        piVar5 = (int *)*piVar2;
      }
    }
        ...
        if (piVar8 == piVar7) {
          ...
          if (*(char *)(piVar7 + 0x14) == '\0') {
            ...
            *(undefined1 *)(piVar6 + 0x14) = 0;
            fn_824CB5D0(param_2,piVar6);
            piVar7 = (int *)piVar6[2];
          }
          if (*(char *)((int)piVar7 + 0x51) == '\0') {
            if ((*(char *)(*piVar7 + 0x50) != '\x01') || (*(char *)(piVar7[2] + 0x50) != '\x01')) {
              if (*(char *)(piVar7[2] + 0x50) == '\x01') {
                *(undefined1 *)(*piVar7 + 0x50) = 1;
                *(undefined1 *)(piVar7 + 0x14) = 0;
                fn_824CB638(param_2,piVar7);
                piVar7 = (int *)piVar6[2];
              }
              *(undefined1 *)(piVar7 + 0x14) = *(undefined1 *)(piVar6 + 0x14);
              *(undefined1 *)(piVar6 + 0x14) = 1;
              *(undefined1 *)(piVar7[2] + 0x50) = 1;
              fn_824CB5D0(param_2,piVar6);
              break;
            }
LAB_824cb394:
          ...
          if (*(char *)(piVar7 + 0x14) == '\0') {
            *(undefined1 *)(piVar7 + 0x14) = 1;
            *(undefined1 *)(piVar6 + 0x14) = 0;
            fn_824CB638(param_2,piVar6);
            piVar7 = (int *)*piVar6;
          }
          if (*(char *)((int)piVar7 + 0x51) == '\0') {
            if ((*(char *)(piVar7[2] + 0x50) == '\x01') && (*(char *)(*piVar7 + 0x50) == '\x01'))
            goto LAB_824cb394;
            if (*(char *)(*piVar7 + 0x50) == '\x01') {
              *(undefined1 *)(piVar7[2] + 0x50) = 1;
              *(undefined1 *)(piVar7 + 0x14) = 0;
              fn_824CB5D0(param_2,piVar7);
              piVar7 = (int *)*piVar6;
            }
            *(undefined1 *)(piVar7 + 0x14) = *(undefined1 *)(piVar6 + 0x14);
            *(undefined1 *)(piVar6 + 0x14) = 1;
