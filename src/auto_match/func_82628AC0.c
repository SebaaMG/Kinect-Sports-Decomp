...
extern int fn_827D9D48();
extern int fn_827DA480();
extern int fn_827DEA50();
extern int fn_82816F98();
extern int fn_828171A0();


longlong fn_82628AC0(int param_1,undefined8 param_2,undefined4 *param_3)

{
  ...
  iVar4 = fn_827D50F8(*param_3);
  if (iVar4 != 0) {
    fn_827D9D48(*(undefined4 *)(param_1 + 0xc));
  }
  iVar4 = fn_827DA480(*(undefined4 *)(param_1 + 0x14),*(undefined4 *)(param_1 + 0xc));
  if (iVar4 == 0) {
    if (*(int *)(param_1 + 0x1c) == 0) {
      lVar3 = 0x65b;
      if ((((*(int *)(param_1 + 0x24) != 0) && (lVar3 = fn_827D50B8(), lVar3 == 0)) &&
          (*(int *)(param_1 + 0x2c) != 0)) &&
         ((lVar3 = fn_827D50B8(), lVar3 == 0 && (*(int *)(param_1 + 0x34) != 0)))) {
        lVar3 = fn_827D50B8();
      }
