...
extern unsigned int lbl_821396E4;


undefined4 * fn_82D6B358(int *param_1,int *param_2,int *param_3,undefined8 param_4)

{
  ...
  *puVar3 = &lbl_8213969C;
  ...
  uVar4 = (**(code **)((uint)*(byte *)(*(int *)(iVar1 + 0xc) * 0x20 + iVar5 +
                                      *(int *)(*param_1 + 0xc)) * 0x14 + iVar2 + 0x9a0))
                    (aiStack_110,param_1,param_3,param_4);
  puVar3[3] = uVar4;
  *puVar3 = &lbl_821396E4;
  return puVar3;
}
