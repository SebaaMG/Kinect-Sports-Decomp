...
undefined4 * fn_8243DFF8(int param_1,undefined4 *param_2,undefined4 param_3)

{
  ...
  if (*(char *)((int)param_2 + 0x15) == '\0') {
    ...
    *(undefined1 *)((int)puVar1 + 0x15) = 0;
    ...
    puVar1[1] = param_3;
    *(undefined1 *)(puVar1 + 5) = *(undefined1 *)(param_2 + 5);
    if (*(char *)((int)puVar3 + 0x15) != '\0') {
      puVar3 = puVar1;
    }
    uVar2 = fn_8243DFF8(param_1,*param_2,puVar1);
    *puVar1 = uVar2;
    uVar2 = fn_8243DFF8(param_1,param_2[2],puVar1);
    puVar1[2] = uVar2;
  }
  return puVar3;
}
