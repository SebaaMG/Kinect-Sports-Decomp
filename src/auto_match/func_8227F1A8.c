...
undefined4 * fn_8227F1A8(undefined4 *param_1,undefined8 param_2,undefined4 param_3)

{
  ...
  *param_1 = fn_824FB6D8;
  ...
  param_1[0x22] = (float)param_1[0x22] + (float)param_1[10];
  param_1[0x24] = (float)param_1[10] + (float)param_1[0x24];
  param_1[0x23] = uVar2;
