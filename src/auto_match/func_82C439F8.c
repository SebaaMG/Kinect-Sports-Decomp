...
void fn_82C439F8(undefined8 param_1,uint *param_2,longlong param_3)

{
  ...
  iVar9 = fn_82F6A548();
  dVar27 = (double)fn_82C31720(*(undefined4 *)(iVar9 + 0x128));
  uVar24 = 0;
  ...
  if ((int)uVar26 < (int)*(uint *)(iVar9 + 0x10c)) {
    ...
    do {
      ...
      iVar15 = (int)uVar24;
      if (*(char *)lVar16 == '\x01') {
        dVar28 = (double)fn_82C31720(*(undefined4 *)(iVar11 + uVar5));
