...
undefined8 fn_82819728(int param_1,longlong param_2,ulonglong param_3,longlong param_4)

{
  ...
  if (-1 < lVar3) {
    ...
    if (-1 < (int)lVar3) {
      if ((lbl_8320A5F0 == 0) ||
         ((ulonglong)*(uint *)(param_1 + 0x20) < (ulonglong)*(uint *)(lbl_8320A5F0 + 0x20))) {
      ...
      fn_82819728(iStack_30,param_2,param_3,param_4);
      return 1;
    }
  }
  fn_82823080(param_1,&iStack_30);
