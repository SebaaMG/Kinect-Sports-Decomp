...
undefined8 fn_829E9EA0(int *param_1,longlong param_2)

{
  ...
  lVar5 = ((param_1[3] - param_1[1]) / 0xc + param_2) * 0xc;
  ...
  if (uVar3 == 0) {
    ...
    fn_82F63CA0(uVar6,param_1[1],(longlong)((param_1[2] - param_1[1]) / 0xc) * 0xc);
    if (*param_1 != 0) {
    ...
    *param_1 = (int)uVar3;
    ...
    param_1[1] = iVar2;
    param_1[2] = ((param_1[2] - iVar1) / 0xc) * 0xc + iVar2;
  }
  return uVar4;
}
