...
undefined4 * fn_827F3070(undefined4 *param_1,int param_2)

{
  ...
  fn_827F4248(param_1,param_1 + 0x18,*(undefined4 *)(param_2 + 4),0,0);
  ...
  *(undefined2 *)(param_1 + 0x17) = 0;
  ...
  if ((uVar1 & 0xffffffff) == 0) {
    ...
    uVar2 = fn_827FA5E8(uVar1,param_1,*(undefined4 *)(param_2 + 4));
  }
  param_1[8] = (int)uVar2;
