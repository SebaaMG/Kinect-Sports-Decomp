...
undefined4 *
fn_828C9DB8(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)

{
  ...
  if (0x4924922 < *(uint *)(param_2 + 8)) {
    fn_828B22F0(param_5 + 10);
    fn_8265CA20(param_5[10]);
    fn_8288E4B0(auStack_40,param_5 + 6,*(undefined4 *)param_5[7]);
  ...
  while (cVar1 == '\0') {
    ...
    if (piVar2 == (int *)*piVar3) {
      ...
      if (*(char *)(iVar4 + 0x48) == '\0') {
        ...
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x48) = 0;
        fn_828C8DC8(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar4 = *piVar3;
      if (*(char *)(iVar4 + 0x48) == '\0') {
        ...
        *(undefined1 *)(piVar5[1] + 0x48) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x48) = 0;
        fn_828C8F18(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
