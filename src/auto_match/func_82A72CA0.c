...
undefined8 fn_82A72CA0(int *param_1)
        ...
        if (*(int *)(iVar9 + 0x28) == 0) {
          ...
          *(int *)(iVar9 + 0x24) = *(int *)(iVar1 + 0x194) - *(int *)(iVar1 + 0x108);
          while( true ) {
            ...
            uVar6 = fn_82A6D090(param_1 + 0x38,1,&iStack_60);
            if ((int)uVar6 < 0) {
              return uVar6;
            }
      ...
      if (*(int *)(iVar9 + 0x28) != 0) {
        ...
        if (*pbVar4 != 0) {
          if (*(short *)(param_1 + 0x26) == 0) {
            uVar6 = fn_82A6D090(param_1 + 0x38,7,&iStack_60);
            if ((int)uVar6 < 0) {
              return uVar6;
            }
          ...
          if (*(short *)(param_1 + 0x26) < (short)(ushort)*pbVar4) {
            do {
              uVar6 = fn_82A75DF8(0xffffffff82091198,param_1 + 0x38,&uStack_5c,aiStack_58,0);
              if ((int)uVar6 < 0) {
                return uVar6;
              }
