...
void fn_82390DC0(double param_1,double param_2,int param_3,undefined8 param_4,undefined4 param_5,
...

{
  ...
  (**(code **)(**(int **)(param_3 + 0x68) + 0x10))
            (*(int **)(param_3 + 0x68),uStack_20,&stack0x00000020);
  (**(code **)(**(int **)(param_3 + 0x70) + 0x10))
            (*(int **)(param_3 + 0x70),uStack_20,&stack0x00000030);
  (**(code **)(**(int **)(param_3 + 0x78) + 0x10))
            (*(int **)(param_3 + 0x78),uStack_20,&stack0x00000040);
  (**(code **)(**(int **)(param_3 + 0x80) + 0x10))
            (*(int **)(param_3 + 0x80),uStack_20,&stack0x00000054);
  (**(code **)(**(int **)(param_3 + 0x88) + 0x10))
            (*(int **)(param_3 + 0x88),uStack_20,&stack0x0000005c);
  (**(code **)(**(int **)(param_3 + 0x90) + 0x10))
            (*(int **)(param_3 + 0x90),uStack_20,&stack0x00000064);
  (**(code **)(**(int **)(param_3 + 0x98) + 0x10))
            (*(int **)(param_3 + 0x98),uStack_20,&stack0x0000006c);
  (**(code **)(**(int **)(param_3 + 0xa0) + 0x10))
            (*(int **)(param_3 + 0xa0),uStack_20,&stack0x00000074);
  if (*(int *)(param_3 + 0x48) != 0) {
    fn_828E9D90(uStack_20);
    fn_828E9D40(uStack_20);
    fn_82236448(param_3,uStack_20,param_3 + 0x38);
  }
  fn_828E2B28(param_3,&uStack_20);
  if (iStack_1c != 0) {
    fn_822315A0();
  }
  return;
