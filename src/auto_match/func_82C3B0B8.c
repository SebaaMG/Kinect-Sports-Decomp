...
undefined8 fn_82C3B0B8(int *param_1)
  ...
  if (param_1[0x6d] != 4) {
    ...
    do {
      ...
      if (uVar3 < 4) {
        if (uVar3 == 1) {
          auStack_90[0] = 0;
          uVar7 = fn_82C30370(param_1 + 0x38,1,auStack_90);
          if ((int)uVar7 < 0) {
            return uVar7;
          }
          ...
          if (uVar3 == 2) {
            ...
            if (uVar3 == 0) {
              ...
              do {
                uVar7 = fn_82C30370(param_1 + 0x38,4,auStack_90);
                if ((int)uVar7 < 0) {
                  return uVar7;
                }
                if ((auStack_90[0] & 8) != 0) {
...
LAB_82c3b314:;} while (param_1[0x6d] != 4);
  }
  return uVar7;
}
