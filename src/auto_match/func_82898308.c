...
void fn_82898308(longlong param_1,longlong param_2,longlong param_3,longlong param_4)

{
  ...
  if ((*(int *)(iVar1 + 4) == 9) && (*(int *)(iVar2 + 4) == 7)) {
    *(undefined4 *)(iVar1 + 4) = 7;
    lVar7 = param_1 + 8;
    lVar6 = 4;
    *(undefined4 *)(iVar1 + 0x18) = *(undefined4 *)(iVar2 + 0xc);
    do {
      if (4 < *(uint *)(iVar1 + 0x18)) {
        uVar5 = fn_8265C9E0(*(undefined4 *)(iVar2 + 0xc));
                    /* WARNING: Subroutine does not return */
        fn_82F691F0(uVar5,0,*(undefined4 *)(iVar2 + 0xc));
      }
      *(undefined4 *)lVar7 = 0;
      lVar6 = lVar6 + -1;
      lVar7 = lVar7 + 4;
