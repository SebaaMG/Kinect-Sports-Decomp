...
ulonglong fn_82AD01A0(int *param_1,undefined8 param_2,char param_3)

{
  ...
  uVar2 = fn_82AD00E0(param_1,0,param_2,4);
  if ((int)uVar2 == -1) {
    if (param_3 != '\0') {
      iVar1 = *param_1;
      if (*(int *)(iVar1 + 0x318) != 0) {
                    /* WARNING: Subroutine does not return */
        fn_82AA66A8(iVar1,0xdbe);
      }
                    /* WARNING: Subroutine does not return */
      fn_82AA66A8(iVar1,0xded);
    }
    ...
    *(ulonglong *)(param_1 + iVar1 * 2) =
         (uVar4 & 0xffffffff) << ((uVar2 & 0xffffffff) >> 2 & 0x3c) |
         *(ulonglong *)(param_1 + iVar1 * 2);
  }
  return uVar3;
}
