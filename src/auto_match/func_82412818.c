...
int * fn_82412818(int *param_1,undefined8 param_2,undefined4 param_3)
  ...
  if (puVar1 == (undefined4 *)0x0) {
    ...
    *puVar1 = &lbl_821A8D8C;
    ...
    if (puVar1 + 4 != (undefined4 *)0x0) {
      puVar1[5] = param_3;
      puVar1[4] = &lbl_821B5EBC;
      puVar2 = (undefined4 *)((uint)(puVar1 + 8) & 0xfffffff0);
      *puVar2 = in_register_000104d0;
      ...
      uVar8 = puVar2[2];
      uVar9 = puVar2[3];
      puVar4 = (undefined4 *)((uint)(puVar1 + 0xc) & 0xfffffff0);
      *puVar4 = *puVar2;
      puVar4[1] = uVar7;
      puVar4[2] = uVar8;
      puVar4[3] = uVar9;
