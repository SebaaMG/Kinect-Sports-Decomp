...
extern int fn_828BA968();
extern int fn_828BBD90();
extern int fn_828BC5D0();


undefined4 * fn_828BC798(undefined4 *param_1,int param_2,int *param_3,int param_4)

{
  ...
  if (*(int *)(param_2 + 8) == 0) {
    fn_828BBD90(param_1,param_2,1,*(undefined4 *)(param_2 + 4),param_4);
    return param_1;
  }
  ...
  if (param_3 == (int *)*piVar3) {
    ...
    if (iVar1 < 0) {
      fn_828BBD90(param_1,param_2,1,param_3,param_4);
      return param_1;
    }
  }
    ...
    if (iVar1 < 0) {
      fn_828BBD90(param_1,param_2,0,*(undefined4 *)(*(int *)(param_2 + 4) + 8),param_4);
      return param_1;
    }
  }
  else {
    ...
    if (iVar1 < 0) {
      ...
      if (iVar1 < 0) {
        if (*(char *)(piVar3[2] + 0x31) != '\0') {
          fn_828BBD90(param_1,param_2,0,piVar3,param_4);
          return param_1;
        }
        fn_828BBD90(param_1,param_2,1,param_3,param_4);
        return param_1;
    ...
    if (iVar1 < 0) {
      ...
      if (*(char *)(param_3[2] + 0x31) != '\0') {
        fn_828BBD90(param_1,param_2,0,param_3,param_4);
        return param_1;
      }
      fn_828BBD90(param_1,param_2,1,piVar3,param_4);
      return param_1;
    }
  }
LAB_828bca48:
