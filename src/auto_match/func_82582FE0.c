...
extern unsigned int lbl_821C6058;


void fn_82582FE0(undefined4 *param_1)

{
  int iVar1;
  uint uVar2;
  
  *param_1 = &lbl_821C6058;
  if (param_1[0x3b] != 0) {
    fn_8262FEC8();
    param_1[0x3b] = 0;
  }
  ...
  if (param_1[0x29] != 0) {
    fn_82545950(param_1 + 0x29);
  }
  if (param_1[0x2a] != 0) {
    fn_82545A90(param_1 + 0x2a);
  }
  if (param_1[0x25] != 0) {
    fn_8251FA58();
    param_1[0x25] = 0;
