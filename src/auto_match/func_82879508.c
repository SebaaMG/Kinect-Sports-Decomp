...
extern int fn_82FE69B0();


undefined8 fn_82879508(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((int)uVar1 == 1) {
    ...
    uVar2 = fn_8286A3D8(uVar2,0,0xffffffff820228b4,0x1f);
    uVar2 = fn_8223DFF0(uVar2,0xffffffff820228ac,4);
