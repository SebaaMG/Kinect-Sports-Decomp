...
void fn_828531A8(int param_1,int param_2,int param_3,undefined8 param_4)

{
  ...
  iVar5 = fn_828116B8(param_4,*(undefined4 *)(param_2 + 0x20));
  if (iVar5 != 0) {
    ...
    if ((*(uint *)(param_2 + 0x10) & uVar3) == 0) {
      if ((*(uint *)(param_2 + 0x14) & uVar3) == 0) {
        ...
        uVar6 = 1;
        uVar8 = (ulonglong)*(uint *)(param_2 + 8) / 3;
        uVar7 = (ulonglong)*(uint *)(param_2 + 0xc) / 3;
      }
      fn_82640680(*(undefined4 *)(param_1 + 4),uVar6,uVar7,uVar8);
    }
    else {
      iVar5 = *(int *)(param_2 + 0x18) * 0x3c + *(int *)(*(int *)(param_3 + 0x48) + 0x40);
      fn_8263A120(*(undefined4 *)(param_1 + 4),
                        *(undefined4 *)(*(int *)(iVar5 + 0x38) * 8 + *(int *)(iVar5 + 0x30)));
