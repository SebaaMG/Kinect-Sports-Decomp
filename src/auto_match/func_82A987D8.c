...
void fn_82A987D8(ulonglong param_1,int param_2,int *param_3,ulonglong param_4,int param_5,
...

{
  ...
  uVar12 = 0;
  if (param_7 == (uint *)0x0) {
    param_7 = (uint *)(aiStack_b8 + 2);
    aiStack_b8[2] = 0;
    aiStack_b8[3] = 0;
    aiStack_b8[4] = param_5;
    iStack_a4 = param_6;
  }
  uVar1 = param_7[3];
  uVar2 = param_7[1];
  ...
  if ((param_4 & 0xffffffff) == (param_1 & 0xffffffff)) {
    uVar13 = (longlong)(int)((param_6 + 0x1fU & 0xffffffe0) * (param_5 + 0x1fU & 0xffffffe0)) *
             (longlong)(int)param_8 + 0xfffU & 0xfffff000;
    uVar6 = fn_8265C940(uVar13,0x24870000);
    fn_82A981D8(uVar6,param_4,uVar13);
  }
  uVar21 = param_8 >> 2;
  uVar22 = *param_7;
  ...
  if (uVar1 - uVar2 != 0) {
    ...
    do {
      uVar3 = *param_7;
      uVar8 = uVar12 + param_7[1];
      iVar5 = (int)((uVar8 & 6) << 2);
      iVar20 = ((uint)uVar8 >> 5) * (param_5 + 0x1fU >> 5);
