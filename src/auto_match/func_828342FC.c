...
void fn_828342FC(int param_1,int param_2,int param_3,undefined4 *param_4)

{
  ...
  while ((param_3 < param_2 &&
         (puVar3 = (undefined4 *)(in_r11 * 0xc + param_1), (uint)puVar3[1] < (uint)param_4[1]))) {
    *(undefined4 *)(param_2 * 0xc + param_1) = *puVar3;
    iVar2 = param_2 * 0xc + param_1;
    uVar1 = in_r11 - 1;
