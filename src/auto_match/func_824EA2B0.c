...
void fn_824EA2B0(undefined8 param_1,double param_2,double param_3,double param_4,double param_5)

{
  ...
  if ((iVar11 != 0) && (iVar11 = *(int *)(iVar11 + 0xd54), iVar11 != 0)) {
    ...
    *puVar7 = in_register_00010080;
    ...
    puVar7 = (undefined4 *)((uint)(auStack_b0 + in_r0) & 0xfffffff0);
    *puVar7 = uVar23;
    puVar7[1] = uVar24;
    puVar7[2] = uVar25;
    puVar7[3] = uVar26;
    ...
    puVar7 = (undefined4 *)((int)&uStack_110 + in_r0 & 0xfffffff0);
    *puVar7 = in_register_00010090;
    puVar7[1] = in_register_00010094;
    puVar7[2] = in_register_00010098;
    puVar7[3] = in_vr9;
    puVar7 = (undefined4 *)((int)&fStack_130 + in_r0 & 0xfffffff0);
    *puVar7 = uVar31;
    puVar7[1] = uVar32;
    puVar7[2] = uVar33;
    puVar7[3] = uVar34;
    puVar7 = (undefined4 *)((int)&fStack_120 + in_r0 & 0xfffffff0);
    *puVar7 = uVar27;
    puVar7[1] = uVar28;
    puVar7[2] = uVar29;
    puVar7[3] = uVar30;
    ...
    *puVar7 = uVar23;
    ...
    puVar7[2] = uVar25;
    puVar7[3] = uVar26;
    fn_826310E0(puVar9,0xc0,auStack_e0,4,0x8000);
    ...
    *puVar9 = *puVar9 | 0x2000;
    fn_82837D98(*(undefined4 *)(in_r8 + 0x14),0,auStack_140);
    fn_8263CBB0(lbl_8320A898,0,auStack_140[0],0x80000000);
    puVar9 = lbl_8320A898;
    ...
    *(uint *)((int)lbl_8320A898 + 0x293c) = *(uint *)((int)lbl_8320A898 + 0x293c) & 0xfffffff7;
    ...
    puVar9 = lbl_8320A898;
    *(uint *)(lbl_8320A898 + 0x529) = uVar4 & 7 | *(uint *)(lbl_8320A898 + 0x529) & 0xfffffff8;
    puVar9[2] = puVar9[2] | 0x40;
    puVar9 = lbl_8320A898;
    *(uint *)((int)lbl_8320A898 + 0x2f04) = uVar3;
    *(uint *)((int)puVar9 + 0x28dc) =
         *(uint *)((int)puVar9 + 0x28dc) & 0xfffffff0 |
         -(uint)(*(int *)(puVar9 + 0x629) != 0) & uVar3 & 0xf;
    puVar9[2] = puVar9[2] | 0x2000000000;
    puVar9 = lbl_8320A898;
    *(uint *)((int)lbl_8320A898 + 0x2f14) = uVar5;
    *(uint *)((int)puVar9 + 0x2934) =
         (-(uint)(*(int *)(puVar9 + 0x62b) != 0) & uVar5 & 1) << 1 |
         *(uint *)((int)puVar9 + 0x2934) & 0xfffffffd;
    puVar9[2] = puVar9[2] | 0x20800;
    puVar9 = lbl_8320A898;
