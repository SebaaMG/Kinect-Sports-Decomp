...
void fn_828ACA08(undefined8 param_1,undefined8 param_2)

{
  ...
  fn_8223C478(auStack_40,0xc,0);
  fn_828E9F18(auStack_40,param_2,0xc);
  fn_828E9D40(auStack_40);
  fn_828AC768(param_1,auStack_40);
  if (iStack_28 != 0) {
    fn_8265CA20();
  }
  return;
