...
extern int fn_822732F8();
extern int fn_82273360();
...
undefined4 * fn_82272E58(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar9 + 0x61) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x61) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar2 = *(undefined1 *)(piStack00000024 + 0x18);
      *(undefined1 *)(piStack00000024 + 0x18) = *(undefined1 *)(param_3 + 0x18);
      *(undefined1 *)(param_3 + 0x18) = uVar2;
      goto LAB_82273040;
    }
  }
  else {
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x61) == '\0') {
      piVar6 = (int *)*piVar8;
      piVar7 = piVar8;
      while (piVar3 = piVar6, *(char *)((int)piVar3 + 0x61) == '\0') {
        piVar7 = piVar3;
        piVar6 = (int *)*piVar3;
      }
    }
        ...
        if (piVar8 == piVar7) {
          ...
          if (*(char *)(piVar7 + 0x18) == '\0') {
            ...
            *(undefined1 *)(piVar9 + 0x18) = 0;
            fn_822732F8(param_2,piVar9);
            piVar7 = (int *)piVar9[2];
          }
          if (*(char *)((int)piVar7 + 0x61) == '\0') {
            if ((*(char *)(*piVar7 + 0x60) != '\x01') || (*(char *)(piVar7[2] + 0x60) != '\x01')) {
              if (*(char *)(piVar7[2] + 0x60) == '\x01') {
                *(undefined1 *)(*piVar7 + 0x60) = 1;
                *(undefined1 *)(piVar7 + 0x18) = 0;
                fn_82273360(param_2,piVar7);
                piVar7 = (int *)piVar9[2];
              }
              *(undefined1 *)(piVar7 + 0x18) = *(undefined1 *)(piVar9 + 0x18);
              *(undefined1 *)(piVar9 + 0x18) = 1;
              *(undefined1 *)(piVar7[2] + 0x60) = 1;
              fn_822732F8(param_2,piVar9);
              break;
            }
LAB_8227316c:
          ...
          if (*(char *)(piVar7 + 0x18) == '\0') {
            *(undefined1 *)(piVar7 + 0x18) = 1;
            *(undefined1 *)(piVar9 + 0x18) = 0;
            fn_82273360(param_2,piVar9);
            piVar7 = (int *)*piVar9;
          }
          if (*(char *)((int)piVar7 + 0x61) == '\0') {
            if ((*(char *)(piVar7[2] + 0x60) == '\x01') && (*(char *)(*piVar7 + 0x60) == '\x01'))
            goto LAB_8227316c;
            if (*(char *)(*piVar7 + 0x60) == '\x01') {
              *(undefined1 *)(piVar7[2] + 0x60) = 1;
              *(undefined1 *)(piVar7 + 0x18) = 0;
              fn_822732F8(param_2,piVar7);
              piVar7 = (int *)*piVar9;
            }
            *(undefined1 *)(piVar7 + 0x18) = *(undefined1 *)(piVar9 + 0x18);
            *(undefined1 *)(piVar9 + 0x18) = 1;
