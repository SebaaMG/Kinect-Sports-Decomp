...
void fn_82F923D8(undefined4 param_1,int param_2)

{
  ...
  puVar2 = (undefined4 *)fn_82F953B8(param_2);
  uVar1 = *puVar2;
  puVar2 = (undefined4 *)fn_8265D5A8(uVar1);
  puVar3 = (undefined4 *)fn_82F953B8(iStack0000001c);
  *puVar3 = *puVar2;
  puVar2 = (undefined4 *)fn_8265D5A8(uVar1);
  pcVar4 = (char *)fn_82F919B8(*puVar2);
  if (*pcVar4 == '\0') {
    puVar2 = (undefined4 *)fn_8265D5A8(uVar1);
