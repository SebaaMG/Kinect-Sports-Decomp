...
void fn_8269AD70(int param_1,int param_2)

{
  ...
  *(undefined4 *)(param_1 + 0x78) = *(undefined4 *)(param_2 + 0xaf8);
  *(int *)(param_2 + 0xaf8) = param_1;
LAB_8269ade8:
  *(uint *)(param_1 + 0x8c) = *(uint *)(param_1 + 0x8c) | 0x80000;
