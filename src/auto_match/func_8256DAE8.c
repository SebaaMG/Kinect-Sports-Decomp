...
extern int fn_8256DC00();
extern int fn_82F622A8();


byte fn_8256DAE8(undefined4 *param_1,ulonglong param_2,char param_3)

{
  ...
  if ((ulonglong)(uint)param_1[5] < (param_2 & 0xffffffff)) {
    fn_8256DC00(param_1,param_2,param_1[4]);
  }
