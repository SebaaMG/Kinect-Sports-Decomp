...
ulonglong fn_82898E38(int param_1,longlong param_2,longlong param_3,longlong param_4)
  ...
  if ((uVar1 != 3) && (uVar1 != 4)) {
    ...
    if (uVar1 != 6) {
      if (uVar1 == 7) {
        ...
        if (uVar1 == *(uint *)(iVar5 + 0x18)) {
          if (4 < uVar1) {
            if (*(uint *)(iVar5 + 0x18) < 5) {
