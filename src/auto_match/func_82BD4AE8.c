...
undefined8
fn_82BD4AE8(int param_1,int param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5)

{
  ...
  if (iVar1 == 0) {
    ...
    uVar2 = fn_82BD6F78(iVar1,lbl_820E8684,param_3,param_4,param_5);
  }
