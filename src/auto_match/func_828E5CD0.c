...
undefined8 fn_828E5CD0(undefined8 param_1,int param_2)

{
  ...
  *(undefined ***)(auStack_ac + *(int *)(puStack_b0 + 4) + -4) = &lbl_82021284;
  ...
  uVar1 = fn_82240158(&puStack_b0,0xffffffff820273e8);
  fn_828E5960(uVar1,*(undefined4 *)(param_2 + 0x80));
