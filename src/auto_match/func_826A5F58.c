...
extern int fn_826A4558();
extern int fn_826A4C78();
...
undefined4 * fn_826A5F58(undefined4 *param_1,int param_2)

{
  ...
  if ((uVar3 & 0xffffffff) == 0) {
    ...
    uVar6 = fn_826A4558(uVar3,&iStack_50);
  }
  *param_1 = uVar6;
  *(undefined1 *)(param_1 + 2) = 0;
  param_1[1] = 0;
  lVar4 = fn_8267B890(*(undefined4 *)(param_2 + 0x288),0x68,0);
  if (lVar4 == 0) {
    uVar7 = 0;
  }
  else {
    uVar5 = fn_826B14D8(param_2,1);
    uVar7 = fn_826A4C78(lVar4,&iStack_50,uVar5,param_1);
  }
  if (uVar7 != 0) {
  ...
  (**(code **)(iVar2 + 0x28))(iVar1 + 0x10,&iStack_50,param_2 + 0x10,uVar5,auStack_60);
