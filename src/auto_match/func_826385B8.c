...
void fn_826385B8(int param_1,undefined4 param_2)

{
  ...
  *(undefined4 *)(param_1 + 0x2f00) = param_2;
  uVar5 = (uint)*(float *)(param_1 + 0x3218);
  uVar1 = *(uint *)(param_1 + 0x3234);
  uVar2 = *(uint *)(param_1 + 0x3238);
  uVar3 = *(uint *)(param_1 + 0x323c);
  uVar4 = *(uint *)(param_1 + 0x3240);
