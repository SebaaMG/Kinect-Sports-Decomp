...
extern int fn_823CE680();
extern int fn_823D1E30();
extern int fn_823E3D08();
extern int fn_823EAB88();
...
void fn_823CE4E0(int param_1,undefined8 param_2)

{
  ...
  fn_823E3D08(param_1,param_2,auStack_c0);
  iVar2 = lbl_832975B0;
  if (lbl_832975B0 == 0) {
    iVar2 = fn_82250A18();
  }
  ...
  if (*(char *)(iVar2 + 4) == '\0') {
    uStack_18c = 0;
    pcStack_190 = fn_823CE680;
    uStack_180 = 0x823ce68000000000;
    fn_82F68CC0(&uStack_170,auStack_c0,0x90);
    fn_82F68CC0(auStack_1f8,auStack_148,0x68);
    uVar1 = fn_823D1E30(auStack_e0,uStack_180,CONCAT44(iStack_178,uStack_174),uStack_170,
                              uStack_168,uStack_160,uStack_158,uStack_150);
    fn_8227CB30(param_1 + 0xb78,uVar1);
    fn_82359C18(uVar1);
  }
  else {
