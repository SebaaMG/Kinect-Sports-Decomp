...
longlong fn_827C2A78(int param_1,int param_2)

{
  ...
  while ((*(int *)(param_1 + 0x7c) < *(int *)(param_1 + 0x84) ||
    ...
    lVar4 = (*(code *)**(undefined4 **)(param_1 + 400))(param_1);
    if ((int)lVar4 == 0) {
      return lVar4;
    }
  }
  ...
  if (0 < *(int *)(param_1 + 0x24)) {
    ...
    do {
      if (*(char *)(iVar13 + 0x30) != '\0') {
        ...
        pcVar3 = *(code **)(*(int *)(param_1 + 0x19c) + iVar8 + 4);
        if (0 < (int)uVar9) {
  ...
  uVar9 = (ulonglong)*(uint *)(param_1 + 0x88) + 1;
  *(int *)(param_1 + 0x88) = (int)uVar9;
  return 4 - (ulonglong)(uVar9 < *(uint *)(param_1 + 0x11c));
}
