...
void fn_822CB0A0(undefined8 param_1,undefined8 param_2)

{
  ...
  uStack_20 = 0;
  uStack_2c = 4;
  fn_828E9D28(auStack_40,&uStack_50,4);
  fn_822CB608(auStack_40,param_2);
  fn_82248CC8(param_1,&uStack_50);
  if (iStack_28 != 0) {
    fn_8265CA20();
  }
  return;
