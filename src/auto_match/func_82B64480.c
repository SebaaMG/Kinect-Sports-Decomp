...
undefined8 fn_82B64480(int *param_1)
  ...
  for (; uVar4 < uVar10; uVar4 = *(int *)(iVar1 + 0x60) * 2 + uVar4) {
    ...
    if (uVar4 < uVar8) {
      ...
      do {
        ...
        puVar7 = puVar7 + 2;
        puVar5 = puVar5 + 1;
        *puVar5 = (ushort)(((ulonglong)*puVar7 & 0xf0) + ((ulonglong)*puVar9 & 0xf0) +
                           ((ulonglong)*puVar3 & 0xf0) + ((ulonglong)*puVar2 & 0xf0) + 0x20 >> 2) &
                  0xf0 | (ushort)(((ulonglong)*puVar7 & 0xf0f) + ((ulonglong)*puVar9 & 0xf0f) +
                                  ((ulonglong)*puVar3 & 0xf0f) + ((ulonglong)*puVar2 & 0xf0f) +
                                  0x202 >> 2) & 0xf0f;
        lVar6 = lVar6 + -1;
      } while (lVar6 != 0);
    }
