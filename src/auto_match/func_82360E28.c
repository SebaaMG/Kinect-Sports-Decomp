...
void fn_82360E28(int *param_1,longlong param_2)

{
  ...
  if ((0x3fffffffU - param_2 & 0xffffffff) < (ulonglong)uVar1) {
  ...
  uVar2 = 0;
  if ((ulonglong)uVar1 <= (0x3fffffff - (ulonglong)(uVar1 >> 1) & 0xffffffff)) {
    uVar2 = (ulonglong)(uVar1 >> 1) + (longlong)(int)uVar1;
  }
  if ((uVar2 & 0xffffffff) < (uVar3 & 0xffffffff)) {
    uVar2 = uVar3;
  }
  fn_82F68B78(param_1,uVar2);
  return;
}
