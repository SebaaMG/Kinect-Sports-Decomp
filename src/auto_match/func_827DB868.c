...
undefined8
fn_827DB868(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (lVar1 == 0) {
    ...
    uVar2 = fn_827E5BE8(lVar1,1,param_2,uVar2,param_3,param_4,param_5,&uStack_58);
  }
