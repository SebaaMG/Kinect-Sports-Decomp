...
undefined4 *
fn_828CE758(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)

{
  ...
  if (0x9249247 < *(uint *)(param_2 + 8)) {
    fn_828A6130(auStack_40,param_5 + 6,*(undefined4 *)param_5[7]);
    fn_8265CA20(param_5[7]);
    fn_8265CA20(param_5);
  ...
  while (cVar1 == '\0') {
    ...
    if (piVar2 == (int *)*piVar3) {
      ...
      if (*(char *)(iVar4 + 0x28) == '\0') {
        ...
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x28) = 0;
        fn_8288BA70(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar4 = *piVar3;
      if (*(char *)(iVar4 + 0x28) == '\0') {
        ...
        *(undefined1 *)(piVar5[1] + 0x28) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x28) = 0;
        fn_828A1AE8(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
