...
void fn_82CEC7E0(int param_1,undefined8 param_2,int param_3)

{
  ...
  iVar2 = param_3 + 0x20;
  lVar3 = 3;
  do {{ V16 _vt0 = vectorMergeHighWord(in_vs41,in_vs32); memcpy(auVar5, &_vt0, 16); }{ V16 _vt1 = vectorMergeHighWord(in_vs39,in_vs40); memcpy(auVar4, &_vt1, 16); }
