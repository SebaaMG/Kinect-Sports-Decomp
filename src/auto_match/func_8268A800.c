...
extern int fn_82689FF0();
extern int fn_8268A530();


void fn_8268A800(int *param_1,undefined8 param_2,undefined8 param_3,uint param_4)

{
  ...
  if (piVar8 == (int *)0x0) {
    ...
    if ((uint)(*piVar8 * 5) <= (uint)((piVar8[1] + 1) * 4)) goto LAB_8268a85c;
...
LAB_8268a85c:
  ...
  *piVar8 = *piVar8 + 1;
  ...
  if (iVar2 == -2) {
    *puVar11 = 0xffffffff;
    fn_82689FF0(iVar6 + 0x10,param_3);
  }
  else {
    do {
    ...
    if (uVar3 == param_4) {
      ...
      fn_82689F38(iVar6 + 0x10,param_3);
      *puVar11 = uVar9;
    }
    else {
