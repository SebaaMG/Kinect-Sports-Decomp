...
void fn_8284F8F8(undefined8 param_1,undefined8 param_2,int param_3,int param_4)

{
  ...
  uVar2 = (ulonglong)*(uint *)(param_3 + 0x94);
  lVar1 = uVar2 + 1;
  for (puVar3 = *(undefined4 **)(param_4 + 0x1c); lVar1 = lVar1 + -1,
