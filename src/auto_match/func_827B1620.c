...
void fn_827B1620(int *param_1,undefined8 param_2,uint param_3)

{
  ...
  if (param_3 == 0) {
    ...
    uStack_48 = CONCAT44(0x105,(((U64)(uStack_48) >> 32) & 0xFFFFFFFF));
    ...
    *apuStack_50[0] = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar3 = iVar2 + *param_1;
        if (*(int *)(iVar3 + 8) != -2) {
          fn_827B1020(apuStack_50,param_2,iVar3 + 0x10,*(undefined4 *)(iVar3 + 0x14));
