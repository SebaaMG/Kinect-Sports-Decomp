...
void fn_82639720(int param_1,int param_2,ulonglong param_3)

{
  ...
  uVar3 = (param_3 & 0x3fffffff) << 2;
  uVar4 = (ulonglong)*(byte *)(param_1 + param_2 + 0x2f92);
  iVar5 = (param_2 + 0x30) * 0x18 + param_1;
  uVar2 = uVar4 & 0xfffffffffffffffb | uVar3;
  uVar1 = (int)((uVar4 & 0xfffffffb | uVar3) >> 2) - 1;
  *(uint *)(iVar5 + 0x10) =
