...
void fn_82D3B058(undefined4 *param_1)

{
  ...
  if ((param_1[0xe] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[0xc],param_1[0xe] & 0x3fffffff,1);
  }
  param_1[0xc] = 0;
  ...
  if ((param_1[0xb] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[9],param_1[0xb] & 0x3fffffff,0x10);
  }
  param_1[9] = 0;
