...
extern int fn_828B0618();
extern int fn_828B0AF0();
...
void fn_828B10F0(int *param_1,undefined8 param_2,int param_3,undefined8 param_4)

{
  ...
  uVar1 = *(uint *)(&lbl_82024D64 + param_3 * 4);
  if ((int)param_4 == 0) {
    (**(code **)(*param_1 + 0x40))(param_1,auStack_70);
  }
  else {
    (**(code **)(*param_1 + 0x38))(param_1,auStack_70,param_4);
  }
  ...
  uStack_40 = 0;
  uStack_4c = 1;
  fn_828E9D28(auStack_60,puStack_50,1);
  if ((uVar1 & 7) != 0) {
  ...
  uVar2 = *(undefined4 *)(&lbl_82024D28 + param_3 * 4);
  fn_8223C478(auStack_60,uVar2,0);
  fn_828E9DB8(auStack_60,param_2,uVar2);
  if ((int)param_4 == 0) {
    fn_828B0AF0(param_1,auStack_70);
  }
  else {
    fn_828B0618(param_1,auStack_70,param_4);
  }
  if (iStack_48 != 0) {
    fn_8265CA20();
  }
