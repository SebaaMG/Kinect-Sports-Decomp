...
extern int fn_827DE938();
extern int fn_82811438();
extern unsigned int lbl_83156AA0;


void fn_825BF2B0(undefined8 param_1,undefined4 *param_2)

{
  ...
  iVar1 = fn_827DE938(param_2);
  if ((iVar1 != 0) && (puVar2 = (undefined4 *)fn_827DE938(param_2), puVar2 != (undefined4 *)0x0)) {
