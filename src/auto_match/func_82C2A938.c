...
undefined8 fn_82C2A938(int param_1)

{
  ...
  uVar2 = 0;
  if (*(int *)(iVar1 + 0x18) != 0) {
    apuStack_20[0] = *(undefined4 **)(*(int *)(iVar1 + 0x10) + 4);
    while ((apuStack_20[0] != (undefined4 *)0x0 &&
      ...
      if (apuStack_20[0][2] != 0) {
        *(undefined4 *)(apuStack_20[0][2] + 4) = apuStack_20[0][1];
      }
      if (apuStack_20[0][1] != 0) {
        *(undefined4 *)(apuStack_20[0][1] + 8) = apuStack_20[0][2];
      }
      ...
      *(int *)(iVar1 + 0x78) = *(int *)(iVar1 + 0x78) - *(int *)(iVar1 + 0x74);
      ...
      uVar2 = fn_82C10B28(*(undefined4 *)(iVar1 + 0x30),0x1f,apuStack_20);
      if ((int)uVar2 < 0) {
        return uVar2;
      }
      apuStack_20[0] = *(undefined4 **)(*(int *)(iVar1 + 0x10) + 4);
