...
extern int fn_82FE67E0();


undefined8 fn_8287BB10(int param_1)

{
  ...
  uVar1 = fn_82FE67E0(*(undefined4 *)(param_1 + 0x2c));
  if ((int)uVar1 == 1) {
    uVar1 = 0x20250000;
  }
  else {
    fn_828648B8(auStack_a0,param_1 + 4);
    uVar2 = fn_8223B688(auStack_60,auStack_a0);
    uVar2 = fn_8286A3D8(uVar2,0,0xffffffff82022ddc,0x2b);
    uVar2 = fn_8223DFF0(uVar2,0xffffffff82022dd4,4);
