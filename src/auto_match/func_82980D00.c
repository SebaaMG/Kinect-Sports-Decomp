...
void fn_82980D00(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  fn_828FA8D8((ulonglong)*(uint *)(param_1 + 4) + 0x18,param_2,param_3,0xffffffff821c4da8,
                    auStack_120);
