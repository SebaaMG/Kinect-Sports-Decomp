...
void fn_826DA368(int *param_1,undefined8 param_2,uint param_3)
    ...
    if (*param_1 != 0) {
      ...
      do {
        ...
        if (*(int *)(iVar3 + 8) != -2) {
          ...
          fn_826DC160(apuStack_60,param_2,iVar3 + 0x10);
          fn_827A5B60(iVar3 + 0x10,0);
