...
void fn_82526C70(undefined8 param_1,longlong param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  fn_82F668C8(param_1,param_2,param_2 + -1,param_3,&stack0x00000028);
  return;
}
