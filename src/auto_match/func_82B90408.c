...
void fn_82B90408(undefined8 param_1,ulonglong param_2,uint param_3,undefined8 param_4)

{
  ...
  if (*(int *)(iVar14 + 0x10) != 0) {
    param_4 = fn_82B8FDD0(iVar14,param_4);
  }
  ...
  if (*(int *)(iVar14 + 0x68) != 0) {
    ...
    do {
      ...
      *(uint *)lVar26 = ((iVar18 << 8 | uVar15) << 8 | uVar16) << 8 | uVar17;
