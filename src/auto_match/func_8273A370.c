...

{
  ...
  if (cVar5 == '\0') {
    ...
    if (0 < *(int *)(param_1 + 0x1c)) {
      ...
      iVar8 = (int)dVar10;
      lVar6 = 0;
      uVar4 = fn_82739680(*(undefined4 *)(iVar9 + 0x54));
      ...
      do {
        ...
        if (iVar2 < *(int *)(&lbl_82011DF0 + iVar7)) {
          ...
          *(int *)(iVar9 + 0x58) = iVar2 + iVar8;
          *(longlong *)(iVar9 + 0x48) = (longlong)iVar8 * 86400000 + *(longlong *)(iVar9 + 0x48);
          fn_827397D8(iVar9);
          return;
        }
        lVar6 = lVar6 + 1;
