...
double fn_830251D0(int *param_1)

{
  ...
  if (iVar2 != 0) {
    ...
    if (((*(byte *)(iVar2 + 0x3d) & 4) != 0) && (*(int *)(iVar2 + 0x20) != 0)) {
      iVar4 = fn_83006E68();
      if ((iVar4 != 0) && (iVar4 = fn_8302B158(), iVar4 == 1)) {
        bVar3 = true;
      }
      dVar7 = (double)*(float *)(*(int *)(iVar2 + 0x20) + 8);
    }
    if ((!bVar3) &&
       (dVar7 = (double)(float)((double)(longlong)*(short *)(iVar2 + 0x2e) * (double)lbl_82186E6C +
                               dVar7), (*(uint *)(iVar2 + 0x40) >> 1 & 1) != 0)) {
      dVar5 = (double)fn_830177C8(lbl_832642FC,iVar2,1,0);
      dVar7 = (double)(float)(dVar5 + dVar7);
    }
    if (*(int *)(iVar2 + 0x24) != 0) {
      dVar7 = (double)(float)((double)*(float *)(*(int *)(iVar2 + 0x24) + 0x2c) + dVar7);
    }
