...
undefined8 fn_82E07EC8(undefined8 param_1,undefined8 param_2,char param_3,int param_4)

{
  ...
  if (iVar4 == 0) {
    if (param_3 != '\0') {
      ...
      uVar3 = fn_82CEDB38(auStack_240,0xffffffff82149f24);
      ...
      (**(code **)(*lbl_8323B464 + 0xc))
                (lbl_8323B464,1,0xffffffffabbaab81,auStack_230,0xffffffff82149e90,0xb3);
