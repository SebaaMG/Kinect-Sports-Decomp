...
extern int fn_82A8FE60();


void fn_82A90A38(int param_1,uint *param_2,undefined8 param_3,longlong param_4,longlong param_5)

{
  ...
  for (; uVar1 != 0; uVar1 = uVar1 - 1) {
    fn_82A8FE60(param_1,param_2 + 2,param_3,param_4,param_5);
