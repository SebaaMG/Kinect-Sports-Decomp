...
undefined4 *
fn_8223F6E0(undefined4 *param_1,undefined8 param_2,undefined8 param_3,longlong param_4,
...

{
  ...
  while( true ) {
    ...
    puVar3 = (undefined8 *)fn_8223F670(auStack_50,param_2,param_3,param_4,lVar4);
    param_3 = *puVar3;
    if (param_5 - lVar4 == 0) break;
    if ((char)param_6 != '\0') {
      puVar3 = (undefined8 *)fn_8223F7A8(auStack_48,param_2,param_3,param_6,1);
      param_3 = *puVar3;
    }
