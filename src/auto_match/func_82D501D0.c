...
void fn_82D501D0(undefined4 *param_1)

{
  int *piVar1;
  int iVar2;
  
  *param_1 = &lbl_82138934;
  iVar2 = fn_82CE5410();
  piVar1 = *(int **)(iVar2 + 0x10);
  param_1[0x12] = 0;
  if ((param_1[0x13] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[0x11],param_1[0x13] & 0x3fffffff,2);
  }
  param_1[0x11] = 0;
  ...
  if ((param_1[0xd] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[0xb],param_1[0xd] & 0x3fffffff,1);
  }
  param_1[0xb] = 0;
  ...
  if ((param_1[7] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[5],param_1[7] & 0x3fffffff,2);
  }
  param_1[5] = 0;
