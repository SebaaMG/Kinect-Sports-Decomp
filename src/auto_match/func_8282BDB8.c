...
void fn_8282BDB8(int param_1,int *param_2,uint param_3)

{
  ...
  if (param_3 != 1) {
    ...
    uVar1 = uStack_6c;
    if (cStack_68 == '\0') {
      if (((param_3 == 4) && (piStack_70 = (int *)*param_2, piStack_70 != (int *)0x0)) &&
      ...
      *(uint *)(iStack_80 + 0x20) = param_3;
      *(undefined4 *)(iStack_80 + 0x10) = *(undefined4 *)(iStack_7c + 0xc);
      *(undefined4 *)(iStack_80 + 0x14) = uVar1;
      *(uint *)(iStack_80 + 0x1c) = param_3 / param_3;
      *(uint *)(iStack_80 + 0x24) = param_3;
