...
void fn_8250DFA8(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  uVar6 = fn_827F4868(param_1);
  uVar1 = *(undefined4 *)(param_1 + 0xe8);
  sVar5 = fn_827F7210(uVar2);
  if (sVar5 != 0) {
    fn_8250D028(uVar6,uVar2,uVar3,uVar4,param_4,uVar1);
  }
  fn_8250C540((double)lbl_821CA460,uVar6,uVar2,uVar3,uVar4);
