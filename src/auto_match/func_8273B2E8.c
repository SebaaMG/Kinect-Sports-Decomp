...

{
  ...
  if (cVar3 == '\0') {
    ...
    if (0 < *(int *)(param_1 + 0x1c)) {
      ...
      iVar4 = ((int)dVar6 - (*(int *)(iVar5 + 0x38) % 3600000) / 60000) * 60000;
      *(int *)(iVar5 + 0x38) = *(int *)(iVar5 + 0x38) + iVar4;
      *(longlong *)(iVar5 + 0x30) = (longlong)iVar4 + *(longlong *)(iVar5 + 0x30);
      fn_827396D0(iVar5);
    }
  }
  return;
