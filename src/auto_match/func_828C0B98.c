...
undefined4 * fn_828C0B98(undefined4 *param_1,int param_2,int param_3,char param_4)

{
  ...
  if (*(char *)((int)puVar3[1] + 0x21) == '\0') {
    ...
    do {
      puVar3 = puVar1;
      if (param_4 == '\0') {
        bVar5 = *(ulonglong *)(param_3 + 0x10) < *(ulonglong *)(puVar3 + 4);
      }
      else {
        bVar5 = *(ulonglong *)(param_3 + 0x10) <= *(ulonglong *)(puVar3 + 4);
      }
  ...
  if (*(ulonglong *)(apuStack_50[0] + 4) < *(ulonglong *)(param_3 + 0x10)) {
    ...
    *param_1 = uVar2;
    ...
    (**(code **)(*piVar4 + 0x28))(piVar4,param_3);
    *param_1 = puVar1;
