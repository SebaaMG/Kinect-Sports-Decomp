...
extern int fn_824E77C8();
extern int fn_824E7AB8();
extern int fn_824E7C00();
extern int fn_824E7DD8();
extern int fn_8260D428();


undefined4 * fn_824E7840(undefined4 *param_1,int param_2,int *param_3,int param_4)
  ...
  if (*(int *)(param_2 + 8) == 0) {
    ...
    if (param_3 != (int *)*piVar3) {
      ...
      if (iVar2 < 0) {
        ...
        piVar3 = (int *)fn_824E7DD8(apiStack_50);
        puVar6 = puVar4;
        if (0xf < *(uint *)(param_4 + 0x20)) {
        ...
        iVar2 = fn_8260D428(*piVar3 + 0xc,0,*(undefined4 *)(*piVar3 + 0x1c),puVar6,
                             *(undefined4 *)(param_4 + 0x1c));
        if (-1 < iVar2) goto LAB_824e79dc;
        cVar1 = *(char *)(apiStack_50[0][2] + 0x91);
...
LAB_824e79dc:
        ...
        if (-1 < iVar2) {
LAB_824e7a90:
          puVar4 = (undefined4 *)fn_824E7AB8(auStack_48,param_2,param_4);
          *param_1 = *puVar4;
          return param_1;
        }
        apiStack_50[0] = param_3;
        piVar3 = (int *)fn_824E77C8(apiStack_50);
  ...
  uVar5 = 1;
LAB_824e7888:
  fn_824E7C00(param_1,param_2,uVar5,param_3,param_4);
  return param_1;
}
