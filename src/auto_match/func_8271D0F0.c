...
void fn_8271D0F0(int param_1,uint param_2)

{
  ...
  if (param_2 == 0) {
    ...
    fn_826C3400(param_1 + 0x50);
    if ((*(int *)(param_1 + 0x5c) != 0) &&
       (uVar2 = (ulonglong)*(uint *)(*(int *)(param_1 + 0x5c) + 4), uVar2 != 0)) {
      iVar4 = 0;
      do {
        if (*(int *)(**(int **)(param_1 + 0x5c) + iVar4) != 0) {
          fn_826824B0();
        }
        uVar2 = uVar2 - 1;
        iVar4 = iVar4 + 4;
    ...
    fn_826C31F0(param_1 + 0x50);
    if ((*(int *)(param_1 + 0x5c) != 0) &&
       (uVar2 = (ulonglong)*(uint *)(*(int *)(param_1 + 0x5c) + 4), uVar2 != 0)) {
      iVar4 = 0;
      do {
        puVar1 = *(undefined4 **)(**(int **)(param_1 + 0x5c) + iVar4);
