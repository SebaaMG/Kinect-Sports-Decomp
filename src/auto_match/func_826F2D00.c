...
void fn_826F2D00(int *param_1,undefined8 param_2,undefined4 *param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if ((uint)(*piVar1 * 5) <= (uint)((piVar1[1] + 1) * 4)) goto LAB_826f2d5c;
...
LAB_826f2d5c:
  ...
  *piVar1 = *piVar1 + 1;
  ...
  if (uVar3 == 0xfffffffe) {
    *puVar12 = 0xffffffff;
    *(undefined4 *)(iVar11 + 0x10) = *(undefined4 *)*param_3;
    puVar4 = (undefined4 *)param_3[1];
    *(undefined4 *)(iVar11 + 0x14) = *puVar4;
    *(undefined4 *)(iVar11 + 0x18) = puVar4[1];
  }
  else {
    do {
