...

{
  ...
  cVar2 = fn_82695468(param_1,0x28);
  if (cVar2 == '\0') {
    fn_826954C0(param_1,0xffffffff8200ede0,0,0);
  }
  else {
    ...
    if (iVar3 != 0) {
      ...
      iVar1 = fn_826B32D0(*(int *)(param_1 + 0x18),*(undefined4 *)(iVar1 + 0x29c),iVar1 + 0xa8
