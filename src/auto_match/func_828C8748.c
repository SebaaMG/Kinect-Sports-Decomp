...
extern unsigned int lbl_83159FE0;


undefined8 fn_828C8748(undefined8 param_1,int param_2)

{
  ...
  *(undefined ***)(auStack_bc + *(int *)(puStack_c0 + 4) + -4) = &lbl_82021284;
  ...
  puVar3 = (&lbl_83159FE0)[*(int *)(param_2 + 0x84)];
  uVar4 = fn_82240158(&puStack_c0,0xffffffff820263d8);
  uVar4 = fn_82240158(uVar4,puVar3);
  uVar4 = fn_82240158(uVar4,0xffffffff820263c4);
  uVar4 = fn_8223FBB0(uVar4,uVar2);
  uVar4 = fn_82240158(uVar4,0xffffffff820263b4);
  uVar4 = fn_8223FBB0(uVar4,uVar1);
  fn_82240158(uVar4,0xffffffff82196fb0);
