...
void fn_82513D20(int param_1,uint param_2,undefined4 param_3)

{
  ...
  puVar1 = (undefined4 *)(*(undefined4 **)(param_1 + 0x18))[1];
  ...
  if ((puVar2 == *(undefined4 **)(param_1 + 0x18)) || (param_2 < (uint)puVar2[3])) {
    ...
    *(undefined1 *)((int)puVar1 + 0x15) = 0;
    ...
    fn_82519388(apuStack_40,param_1 + 0x14,puVar2);
