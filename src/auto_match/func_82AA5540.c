...
ulonglong fn_82AA5540(uint *param_1,uint param_2,ulonglong param_3,int param_4,undefined4 param_5)

{
  ...
  if (((param_1 != (uint *)0x0) && (3 < param_2)) && (param_4 != 0)) {
    ...
    if ((param_3 & 3) == 0) {
      ...
      if ((-1 < (int)uVar3) &&
         (uVar3 = fn_82AA5158(&iStack_50,puVar2,param_1,lVar7,param_1,0), -1 < (int)uVar3)) {
      ...
      if ((param_3 & 0x800) == 0) {
        ...
        uVar3 = fn_82AA3E10(param_1,puVar2,0,&iStack_50);
        iVar4 = (int)uVar3;
      }
      if (iVar4 < 0) {
        return uVar3;
      ...
      if ((*param_1 & 0x20) != 0) {
        ...
        uVar3 = fn_82AA5158(&iStack_50,puVar2,param_1,lVar7,param_1,1);
        if ((int)uVar3 < 0) {
          return uVar3;
        }
        uVar3 = fn_82AA3AA8(param_3,puVar2,param_1,lVar7,param_1[1] + (int)param_1,param_1[2],
        ...
        if (((param_3 & 0x800) != 0) &&
           (uVar3 = fn_82AA3E10(param_1,puVar2,1,&iStack_50), (int)uVar3 < 0)) {
          return uVar3;
        }
      }
      uVar1 = param_1[3];
