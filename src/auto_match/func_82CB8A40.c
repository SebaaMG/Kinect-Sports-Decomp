...
void fn_82CB8A40(undefined8 param_1,int *param_2,uint *param_3,int param_4,int param_5,int param_6
                  )

{
  ...
  if (param_6 == 0) {
    if (param_5 == 0) {
      ...
      do {
        ...
        do {
          ...
          *piVar14 = ((uVar1 & 0x3030303) + (*(uint *)(iVar11 + (int)puVar7) & 0x3030303) +
                      ...
                      0x2020202 >> 2 & 0x3030303) + (uVar1 >> 2 & 0x3f3f3f3f) +
          ...
          uVar2 = *(uint *)((int)puVar8 + iVar13 + param_4 * 2);
          uVar3 = *(uint *)((int)puVar7 + iVar13 + param_4);
          uVar4 = *(uint *)((int)puVar8 + iVar11 + param_4 * 2);
          *(int *)((int)piVar14 + param_4) =
               ((uVar4 & 0x3030303) + (uVar1 & 0x3030303) + (uVar2 & 0x3030303) +
                (uVar3 & 0x3030303) + 0x2020202 >> 2 & 0x3030303) + (uVar4 >> 2 & 0x3f3f3f3f) +
               (uVar1 >> 2 & 0x3f3f3f3f) + (uVar2 >> 2 & 0x3f3f3f3f) + (uVar3 >> 2 & 0x3f3f3f3f);
          uVar1 = *(uint *)((int)puVar8 + iVar11 + param_4 * 3);
          uVar2 = *(uint *)((int)puVar7 + iVar11 + param_4 * 2);
          uVar3 = *(uint *)((int)puVar7 + iVar13 + param_4 * 2);
          uVar4 = *(uint *)((int)puVar8 + iVar13 + param_4 * 3);
          puVar8 = puVar8 + param_4;
          piVar14 = (int *)((int)piVar14 + param_4 + param_4);
          *piVar14 = ((uVar1 & 0x3030303) + (uVar2 & 0x3030303) + (uVar4 & 0x3030303) +
                      (uVar3 & 0x3030303) + 0x2020202 >> 2 & 0x3030303) + (uVar1 >> 2 & 0x3f3f3f3f)
                     + (uVar2 >> 2 & 0x3f3f3f3f) + (uVar4 >> 2 & 0x3f3f3f3f) +
                     (uVar3 >> 2 & 0x3f3f3f3f);
          uVar1 = *(uint *)((int)puVar7 + iVar13 + param_4 * 3);
          uVar2 = *(uint *)((int)puVar7 + iVar11 + param_4 * 3);
          puVar7 = puVar7 + param_4;
          piVar14 = (int *)((int)piVar14 + param_4);
          *piVar14 = ((*(uint *)((int)puVar8 + iVar11) & 0x3030303) + (uVar2 & 0x3030303) +
                      (*(uint *)((int)puVar8 + iVar13) & 0x3030303) + (uVar1 & 0x3030303) +
                      0x2020202 >> 2 & 0x3030303) +
                     (*(uint *)((int)puVar8 + iVar11) >> 2 & 0x3f3f3f3f) + (uVar2 >> 2 & 0x3f3f3f3f)
      ...
      do {
        ...
        *(uint *)(iVar13 + (int)puVar10) =
             ((*puVar9 | *puVar10) & 0x1010101) + (*puVar9 >> 1 & 0x7f7f7f7f) +
             (*puVar10 >> 1 & 0x7f7f7f7f);
        puVar10 = puVar10 + 1;
        *(uint *)(iVar13 + (int)puVar9) =
             ((*puVar7 | *puVar9) & 0x1010101) + (*puVar7 >> 1 & 0x7f7f7f7f) +
             (*puVar9 >> 1 & 0x7f7f7f7f);
        puVar9 = puVar9 + 1;
        *(uint *)(iVar13 + (int)puVar7) =
             ((*puVar8 | *puVar7) & 0x1010101) + (*puVar8 >> 1 & 0x7f7f7f7f) +
             (*puVar7 >> 1 & 0x7f7f7f7f);
        puVar7 = puVar7 + 1;
        *(uint *)(iVar13 + (int)puVar8) =
             ((*puVar16 | *puVar8) & 0x1010101) + (*puVar16 >> 1 & 0x7f7f7f7f) +
             (*puVar8 >> 1 & 0x7f7f7f7f);
        puVar8 = puVar8 + 1;
    ...
    iVar13 = -1 - param_4;
    do {
      *param_2 = ((*puVar8 | *(uint *)((int)puVar8 + -1)) & 0x1010101) + (*puVar8 >> 1 & 0x7f7f7f7f)
      ...
      *(uint *)((int)piVar6 + param_4) =
      ...
      piVar6 = piVar6 + 1;
      *piVar14 = ((*(uint *)((int)puVar7 + -1) | *puVar7) & 0x1010101) +
                 (*(uint *)((int)puVar7 + -1) >> 1 & 0x7f7f7f7f) + (*puVar7 >> 1 & 0x7f7f7f7f);
      ...
      *(uint *)((int)piVar5 + param_4) =
           ((uVar1 | *puVar10) & 0x1010101) + (uVar1 >> 1 & 0x7f7f7f7f) +
           (*puVar10 >> 1 & 0x7f7f7f7f);
      piVar5 = piVar5 + 1;
      lVar17 = lVar17 + -1;
    } while (lVar17 != 0);
