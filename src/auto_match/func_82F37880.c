...
extern unsigned char bRam831b9fbb;
extern unsigned char bRam831b9fcc;
extern int fn_82F37490();
extern int fn_82F63CA0();


longlong fn_82F37880(ulonglong param_1,ulonglong param_2,undefined8 param_3)
  ...
  if ((param_1 & 0xffffffff) == 0) {
    ...
    if ((uVar18 & 0xffffffff) != 0) {
      do {
        ...
        bVar1 = (*(byte *)(iVar5 + 0x12) & bRam831b9fbb) != 0;
        if (bVar1) {
        ...
        if (uVar10 < 3) {
          ...
          do {
            *(byte *)(iVar7 + iVar12) = *(byte *)(iVar7 + iVar12) >> 1;
            if (iVar12 == 2) {
              *(byte *)(iVar5 + 0x12) = bRam831b9fcc & *(byte *)(iVar5 + 0x12);
            }
        ...
        if ((bVar2) && ((uVar17 & 7) != 0)) {
          iVar12 = (int)(uVar17 & 7);
          bVar8 = *(byte *)(-0x7ce46024 - iVar12) & *(byte *)(iVar6 + 0x10);
          *(byte *)(iVar6 + 0x10) = bVar8;
          *(byte *)(iVar6 + 0x10) = *(byte *)(iVar12 + -0x7ce46038) & bVar3 | bVar8;
        }
        if (bVar9) {
          lVar15 = fn_82F37490(param_1,lVar14,uVar13);
          if (lVar15 < 0) {
            return lVar15;
          }
          bVar9 = false;
    ...
    lVar15 = fn_82F37490(param_1,param_2,param_3);
    if ((-1 < lVar15) && (bVar9)) {
      lVar15 = fn_82F37490(param_1,lVar14,uVar13);
    }
  }
