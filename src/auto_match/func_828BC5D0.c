...
extern int fn_828A5760();
extern int fn_828BA968();
extern int fn_828BBD90();


undefined4 * fn_828BC5D0(undefined4 *param_1,int param_2,int param_3,char param_4)

{
  ...
  if (iVar4 < 0) {
    ...
    *param_1 = uVar2;
    ...
    fn_828A5760(param_2 + 0xd,puVar8);
    fn_8265CA20(param_3);
    *param_1 = puVar3;
