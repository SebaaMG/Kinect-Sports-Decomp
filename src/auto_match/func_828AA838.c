...
extern int fn_8289F418();
extern int fn_828AA2C8();
extern int fn_828B2AE0();
extern int fn_828B2BF8();
extern int fn_828C4240();


void fn_828AA838(int *param_1)

{
  ...
  if (cVar3 == '\0') {
    ...
    if (cVar3 == '\0') {
      uVar1 = fn_828B2BF8();
      fn_828B2AE0(uVar1,param_1);
    }
    iVar2 = (**(code **)(*param_1 + 4))(param_1);
    uVar1 = (**(code **)(*(int *)(iVar2 + 0x198) + 0x3c))();
    fn_828AA2C8(param_1[4],param_1,uVar1);
    fn_8289F418(*(undefined4 *)(param_1[0xd] + 0x38),param_1);
  }
  return;
}
