...
undefined8 fn_8233E6F8(int *param_1,int param_2)

{
  ...
  uVar1 = *(uint *)(&lbl_821B15DC + param_2 * 4);
  ...
  if (*(int *)(&lbl_821B15A0 + param_2 * 4) != 0) {
    uVar2 = fn_8223C610(auStack_50,*(int *)(&lbl_821B15A0 + param_2 * 4),0,0);
  }
  if (iStack_38 != 0) {
    fn_8265CA20();
  }
