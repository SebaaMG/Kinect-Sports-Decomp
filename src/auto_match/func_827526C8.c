...
void fn_827526C8(int param_1,undefined8 param_2,undefined4 param_3,undefined1 param_4,
                  undefined4 param_5)

{
  ...
  *(undefined4 *)(param_1 + 0xc) = param_5;
  ...
  uStack_14 = 0;
  uStack_13 = 0;
  fn_826A76D0(aiStack_30,&uStack_20,param_2);
  if (*(int *)(param_1 + 0x10) != 0) {
    piVar2 = (int *)fn_826F6FA8(*(int *)(param_1 + 0x10),0);
    if (piVar2 != (int *)0x0) {
      uVar1 = (**(code **)(*piVar2 + 0x5c))();
      if ((uVar1 & 0xffffffff) != 0) {
        fn_82720748(uVar1,param_1 + -0x24,aiStack_30,0,0);
      }
    }
  }
