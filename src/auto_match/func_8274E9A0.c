...
void fn_8274E9A0(int param_1,uint param_2)

{
  ...
  if (param_2 == 0) {
    ...
    if ((*(int *)(param_1 + 0x58) != 0) &&
       (uVar2 = (ulonglong)*(uint *)(*(int *)(param_1 + 0x58) + 4), uVar2 != 0)) {
      iVar4 = 0;
      do {
        if (*(int *)(**(int **)(param_1 + 0x58) + iVar4) != 0) {
          fn_826824B0();
        }
        uVar2 = uVar2 - 1;
        iVar4 = iVar4 + 4;
    ...
    if ((*(int *)(param_1 + 0x58) != 0) &&
      ...
      iVar4 = 0;
      do {
        puVar1 = *(undefined4 **)(**(int **)(param_1 + 0x58) + iVar4);
