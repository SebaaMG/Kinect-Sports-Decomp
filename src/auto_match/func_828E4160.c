...
extern int fn_828E26F0();
extern int fn_828E2868();
extern int fn_828E28E0();
extern int fn_82F622E0();
extern unsigned int stack0x00000024;


undefined4 * fn_828E4160(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  fn_828E26F0(&stack0x00000024);
  piVar8 = piStack00000024;
  piVar11 = (int *)*param_3;
  if (*(char *)((int)piVar11 + 0x25) == '\0') {
    piVar10 = piVar11;
    if ((*(char *)(param_3[2] + 0x25) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar3 = *(undefined1 *)(piStack00000024 + 9);
      *(undefined1 *)(piStack00000024 + 9) = *(undefined1 *)(param_3 + 9);
      *(undefined1 *)(param_3 + 9) = uVar3;
      goto LAB_828e435c;
    }
  }
  else {
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    piVar9 = piVar11;
    if (*(char *)((int)piVar10 + 0x25) == '\0') {
      cVar2 = *(char *)(*piVar10 + 0x25);
      piVar4 = (int *)*piVar10;
      piVar9 = piVar10;
      while (piVar7 = piVar4, cVar2 == '\0') {
        piVar4 = (int *)*piVar7;
        cVar2 = *(char *)((int)piVar4 + 0x25);
        piVar9 = piVar7;
      }
    }
  ...
  if (*(int **)(iVar5 + 8) == param_3) {
    if (*(char *)((int)piVar10 + 0x25) == '\0') {
      cVar2 = *(char *)(piVar10[2] + 0x25);
      piVar9 = (int *)piVar10[2];
      piVar4 = piVar10;
      while (piVar7 = piVar9, cVar2 == '\0') {
        piVar9 = (int *)piVar7[2];
        cVar2 = *(char *)((int)piVar9 + 0x25);
        piVar4 = piVar7;
      }
      *(int **)(iVar5 + 8) = piVar4;
    }
        ...
        if (piVar10 == piVar9) {
          ...
          if (*(char *)(piVar9 + 9) == '\0') {
            ...
            *(undefined1 *)(piVar11 + 9) = 0;
            fn_828E2868(param_2,piVar11);
            piVar9 = (int *)piVar11[2];
          }
          if (*(char *)((int)piVar9 + 0x25) == '\0') {
            if ((*(char *)(*piVar9 + 0x24) != '\x01') || (*(char *)(piVar9[2] + 0x24) != '\x01')) {
              if (*(char *)(piVar9[2] + 0x24) == '\x01') {
                *(undefined1 *)(*piVar9 + 0x24) = 1;
                *(undefined1 *)(piVar9 + 9) = 0;
                fn_828E28E0(param_2,piVar9);
                piVar9 = (int *)piVar11[2];
              }
              *(undefined1 *)(piVar9 + 9) = *(undefined1 *)(piVar11 + 9);
              *(undefined1 *)(piVar11 + 9) = 1;
              *(undefined1 *)(piVar9[2] + 0x24) = 1;
              fn_828E2868(param_2,piVar11);
              break;
            }
LAB_828e4488:
          ...
          if (*(char *)(piVar9 + 9) == '\0') {
            *(undefined1 *)(piVar9 + 9) = 1;
            *(undefined1 *)(piVar11 + 9) = 0;
            fn_828E28E0(param_2,piVar11);
            piVar9 = (int *)*piVar11;
          }
          if (*(char *)((int)piVar9 + 0x25) == '\0') {
            if ((*(char *)(piVar9[2] + 0x24) == '\x01') && (*(char *)(*piVar9 + 0x24) == '\x01'))
            goto LAB_828e4488;
            if (*(char *)(*piVar9 + 0x24) == '\x01') {
              *(undefined1 *)(piVar9[2] + 0x24) = 1;
              *(undefined1 *)(piVar9 + 9) = 0;
              fn_828E2868(param_2,piVar9);
              piVar9 = (int *)*piVar11;
            }
            *(undefined1 *)(piVar9 + 9) = *(undefined1 *)(piVar11 + 9);
            *(undefined1 *)(piVar11 + 9) = 1;
