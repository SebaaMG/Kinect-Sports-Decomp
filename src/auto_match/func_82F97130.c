...
void fn_82F97130(double param_1,int param_2,undefined4 *param_3)

{
  ...
  if (((param_3[1] & 8) == 0) || (*(char *)(param_2 + 0x34) != '\0')) {
    uVar6 = (ulonglong)*(uint *)(param_2 + 0x10);
  }
  else {
    uVar6 = (ulonglong)*(uint *)(param_2 + 0x10) - 1;
  }
    ...
    if (pfVar3 < pfVar7) {
      ...
      if (3 < (int)(((int)uVar5 >> 2) + (uint)((int)uVar5 < 0 && (uVar5 & 3) != 0))) {
        do {
          ...
          *pfVar8 = (float)((double)(float)(dVar10 + dVar14) * (double)*pfVar8);
