...
extern int fn_825BAD30();
extern int fn_825BB080();
extern int fn_8265CA20();


undefined4 * fn_825BAD90(undefined4 *param_1,int param_2,int *param_3,int *param_4)
    ...
    while (param_3 != param_4) {
      ...
      if (*(char *)((int)param_3 + 0xf) == '\0') {
        ...
        if (*(char *)((int)piVar5 + 0xf) == '\0') {
          piVar3 = (int *)*piVar5;
          while (piVar4 = piVar3, *(char *)((int)piVar4 + 0xf) == '\0') {
            piVar5 = piVar4;
            piVar3 = (int *)*piVar4;
          }
        }
          ...
          piVar4 = param_3;
          while ((piVar5 = piVar3, *(char *)((int)piVar5 + 0xf) == '\0' &&
                 (piVar4 == (int *)piVar5[2]))) {
            piVar4 = piVar5;
            piVar3 = (int *)piVar5[1];
          }
      ...
      fn_825BB080(auStack_30,param_2,param_3);
      param_3 = piVar5;
    }
    *param_1 = param_3;
  }
