...
void fn_82A95C48(longlong param_1,int param_2)

{
  ...
  lVar3 = 4;
  do {
    fn_82AA75B8(uVar1 - 0x48,((ulonglong)*(uint *)(param_2 + -0xc) & 0x3fffffff) * 4 + param_1
                      ,0x40001);
    param_2 = param_2 + 4;
    lVar3 = lVar3 + -1;{ V16 _vt0 = loadVectorLeftIndexed128(in_r0,uVar1 - 0x50); memcpy(auVar4, &_vt0, 16); }{ V16 _vt1 = vectorSplatHalfWord(auVar4,0); memcpy(auVar4, &_vt1, 16); }
