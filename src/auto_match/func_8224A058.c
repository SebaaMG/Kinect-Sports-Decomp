...
void fn_8224A058(int *param_1,undefined8 param_2,int *param_3)

{
  ...
  if (param_3 != (int *)0x0) {
    ...
    cVar4 = fn_82F64538(uVar2,0xffffffff831d72b4);
    if (cVar4 != '\0') {
      iVar5 = *param_3 + 4;
      goto LAB_8224a0c4;
    }
...
LAB_8224a0c4:
  if (iVar5 == 0) {
    (**(code **)(*param_1 + 0x14))(param_1,param_2,auStack_430);
    puVar3 = (undefined4 *)fn_8265C9E0(0x410);
