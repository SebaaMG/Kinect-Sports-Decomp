...
uint fn_82B48370(int param_1,int param_2,int param_3,int param_4)

{
  ...
  uVar3 = fn_82B841E8(param_1,*(undefined4 *)(param_1 + 0x234),0,0xd,3,4);
  ...
  *(undefined4 *)(uVar3 + 0x30) = uVar4;
  ...
  uVar4 = fn_82AD1978(uVar3,param_4);
  *(undefined4 *)(uVar3 + 0x34) = uVar4;
