...
void fn_8228E138(int param_1,int param_2)

{
  ...
  if (param_1 == 0) {
    ...
    **(undefined4 **)(param_2 + 0x174) = 0;
    ...
    fn_825138E0(&iStack_38,iVar2,1);
    if (iStack_38 != 0) {
      fn_82522588(&iStack_40,&iStack_38);
      fn_82246748(iStack_40,0);
      if (iStack_3c != 0) {
        fn_822315A0();
      }
    }
    ...
    iStack_40 = **(int **)(iVar2 + 8);
    while( true ) {
      iVar2 = lbl_83297810;
      if (lbl_83297810 == 0) {
        iVar2 = fn_82511928();
      }
      if (iStack_40 == *(int *)(iVar2 + 8)) break;
      piVar3 = (int *)fn_8228E578(auStack_30,&iStack_40);
      uVar1 = *(uint *)(*piVar3 + 4);
      ...
      if ((lVar4 - (((ulonglong)uVar1 - 2) + (ulonglong)(lVar4 == 0)) & 0xff) != 0) {
        piVar3 = (int *)fn_8228E578(auStack_28,&iStack_40);
        fn_828AE818(*(undefined4 *)(*piVar3 + 8),0);
        if (iStack_24 != 0) {
          fn_822315A0();
        }
      }
      fn_82248B90(&iStack_40);
    }
    if (iStack_34 != 0) {
      fn_822315A0();
    }
