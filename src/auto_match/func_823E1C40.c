...
undefined4 * fn_823E1C40(undefined4 *param_1,int param_2,int param_3)
...
LAB_823e1cd0:
  puVar2 = (undefined4 *)fn_823E1D38(apuStack_50,param_2,bVar3,puVar2,param_3);
