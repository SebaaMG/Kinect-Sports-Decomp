...
undefined8 fn_82A70650(int param_1,int param_2,int param_3)

{
  ...
  if (*(int *)(param_1 + 0xcc) == 0) {
    if (((*(int *)(param_1 + 0x8c) == 1) && (*(int *)(param_1 + 0x94) != 1)) &&
      ...
      if (*(int *)(param_1 + 0x78) == 1) {
        ...
        uVar8 = fn_82A705D8(param_1,param_3,iVar2,iVar2,uVar14);
      }
      if ((int)uVar8 < 0) {
        return uVar8;
      }
    ...
    if ((int)uVar9 < (int)sVar1) {
      lVar12 = uVar14 - uVar9;
      lVar13 = (uVar9 & 0x3fffffff) * 4 + uVar15;
      do {
  ...
  fVar7 = lbl_8208EE38;
  if ((*(int *)(param_1 + 0x1c0) == 1) && (uVar9 = uVar14 - 1, -1 < (int)uVar9)) {
    if (3 < sVar1) {
      uVar16 = (uVar14 & 0xffffffff) >> 2;
      lVar13 = (uVar9 & 0x1fffffff) * 8 + uVar15 + 0xc;
      lVar12 = (uVar14 & 0x3fffffff) * 4 + uVar15;
      uVar9 = uVar9 - (uVar14 & 0xfffffffc);
      do {
        iVar2 = (int)lVar12;
    ...
    if (-1 < (int)uVar9) {
      lVar10 = uVar9 + 1;
      lVar13 = (uVar9 & 0x1fffffff) * 8 + uVar15 + 0xc;
      lVar12 = (uVar9 + 1 & 0x3fffffff) * 4 + uVar15;
      do {
        lVar12 = lVar12 + -4;
        fVar5 = *(float *)lVar12 * fVar7;
