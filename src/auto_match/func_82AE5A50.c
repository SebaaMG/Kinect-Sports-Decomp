...
void fn_82AE5A50(undefined4 *param_1,ulonglong param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  uVar3 = uVar1 & 0x3c;
  lStack00000040 = (((param_2 & 0xffffffff) >> 8) + 1) * 8;
  ...
  uStack00000038 =
       ((2L << ((uVar1 & 0x3ffffffc) + 3 & 0x3f)) - 1U & -1L << uVar3 & uStack00000030) >> uVar3 &
       uStack00000048;
  if (uStack00000038 != 0) {
  ...
  *(ulonglong *)(iVar2 + (int)param_1) =
       uStack00000048 << uVar3 | *(ulonglong *)(iVar2 + (int)param_1);
  return;
}
