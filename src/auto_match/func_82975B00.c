...
undefined8
fn_82975B00(int param_1,int param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5,
...

{
  ...
  fn_828F5960(auStack_120,0x100,param_4,&stack0x00000030);
  iVar2 = 0;
  uStack_21 = 0;
  if (param_2 != 0) {
    iVar1 = *(int *)(param_2 + 4);
    if (iVar1 == 3) {
      ...
      iVar2 = *(int *)(param_2 + 0x14) + 0x10;
    }
    else if (iVar1 == 0xe) {
      iVar2 = param_2 + 0x30;
    }
  }
  fn_828FA8D8(*(undefined4 *)(param_1 + 0xc4),iVar2,param_3,0xffffffff821c4da8,auStack_120);
