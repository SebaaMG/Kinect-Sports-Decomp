...
void fn_828D8768(int *param_1,longlong param_2)

{
  ...
  if ((0x9249249U - param_2 & 0xffffffff) < (ulonglong)uVar1) {
  ...
  if (0x9249249 < (uVar5 & 0xffffffff)) {
                    /* WARNING: Subroutine does not return */
    fn_82F622A8(0xffffffff82196fd4);
  }
  if ((ulonglong)(uint)((param_1[2] - *param_1) / 0x1c) < (uVar5 & 0xffffffff)) {
    piVar8 = param_1 + 3;
    uVar4 = fn_828D4ED0(piVar8,uVar5);
    fn_828D8528(*param_1,param_1[1],uVar4,piVar8,0,uStack_40);
    iVar2 = *param_1;
    iVar3 = param_1[1];
    if (iVar2 != 0) {
      fn_828D53C0(iVar2,iVar3,piVar8,uStack_40);
      fn_8265CA20(*param_1);
    }
    iVar7 = (int)uVar4;
    *param_1 = iVar7;
    param_1[2] = (int)uVar5 * 0x1c + iVar7;
    param_1[1] = ((iVar3 - iVar2) / 0x1c) * 0x1c + iVar7;
  }
  return;
}
