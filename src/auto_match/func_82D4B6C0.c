...

{
  ...
  if ((int)uVar3 == -1) {
    ...
    uVar3 = (ulonglong)*(uint *)(param_4 + 0x1c);
  }
  uVar4 = (**(code **)(*param_7 + 0x10))(param_7,in_stack_00000054);
  if ((int)uVar4 == -1) {
    ...
    uVar4 = (ulonglong)*(uint *)(param_5 + 0x1c);
  }
  fn_82D4B3C0(param_1,param_2 + -0xc,uVar3,uVar4);
  return;
}
