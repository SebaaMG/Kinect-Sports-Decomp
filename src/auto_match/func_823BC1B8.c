...
undefined4 * fn_823BC1B8(undefined4 *param_1,int param_2)

{
  ...
  *param_1 = &lbl_821B5E94;
  param_1[1] = *(undefined4 *)(param_2 + 0x38);
  param_1[2] = *(undefined4 *)(param_2 + 0x3c);
  param_1[3] = 0;
  param_1[4] = 0;
  param_1[5] = 0;
  param_1[6] = 0;
  ...
  if (iVar1 != 0) {
    ...
    *(undefined1 *)(param_1[9] + 0x18) = 1;
    *(undefined1 *)(param_1[9] + 0x19) = 1;
    return param_1;
  }
  uStack_1c = 0;
