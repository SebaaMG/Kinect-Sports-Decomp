...
extern int fn_829B62A8();
extern int fn_829B7828();


int fn_829B6468(int *param_1,int *param_2,uint param_3,uint param_4,int param_5)
  ...
  if (uVar3 < uVar2) {
    ...
    if (param_2[8] != 0) {
      ...
      if (uVar3 < uVar2) {
        ...
        iVar5 = uVar2 - uVar3;
        do {
          fn_829B7828(*(undefined4 *)(*param_2 + iVar4),iVar1);
          iVar5 = iVar5 + -1;
          iVar4 = iVar4 + 4;
        } while (iVar5 != 0);
      }
...
LAB_829b6604:
    if (param_5 == 0) goto LAB_829b6614;
  }
  param_2[9] = 1;
LAB_829b6614:
