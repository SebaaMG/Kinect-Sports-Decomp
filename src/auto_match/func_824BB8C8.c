...
extern int fn_824BBA48();
extern int fn_82512508();
extern int fn_828EA5F8();
extern int fn_828EA610();
extern unsigned int lbl_824BC050;


void fn_824BB8C8(int param_1,int param_2,ulonglong param_3,int param_4,int param_5)
  ...
  if (((param_2 != 0) && (cVar2 = fn_828EA610(param_2), cVar2 == '\0')) &&
    ...
    if (*(int *)(param_1 + 0x30) == 0) {
      ...
      if (cVar2 != '\0') {
        ...
        iVar1 = fn_824BBA48(param_1,param_2,param_3,uVar3,uVar5);
        if (iVar1 != 0) {
          ...
          *(undefined **)(param_1 + 0x2c) = &lbl_824BC050;
          return;
        }
      }
