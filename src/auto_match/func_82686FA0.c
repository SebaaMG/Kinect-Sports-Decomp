...
void fn_82686FA0(int *param_1,undefined8 param_2,uint param_3)

{
  ...
  if (param_3 == 0) {
    ...
    apuStack_50[0] =
         (undefined4 *)fn_8267B890(lbl_831E7E64,(uVar5 + 1 & 0x1fffffff) << 3,&uStack_48);
    *apuStack_50[0] = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar3 = iVar2 + *param_1;
        if (*(int *)(iVar3 + 8) != -2) {
          fn_82686A80(apuStack_50,param_2,iVar3 + 0xc,
                        *(uint *)(iVar3 + 0xc) >> 6 ^ *(uint *)(iVar3 + 0xc));
