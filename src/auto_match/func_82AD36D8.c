...
uint fn_82AD36D8(undefined8 param_1,undefined8 param_2,uint *param_3,int param_4,int param_5,
                  int param_6)

{
  ...
  uVar2 = fn_82B841E8(param_1,param_2,0,0xd,3,4);
  ...
  *(undefined4 *)(uVar2 + 0x30) = uVar3;
  ...
  uVar3 = fn_82AD1978(uVar2,param_6);
