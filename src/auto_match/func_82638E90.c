...
void fn_82638E90(int param_1,ulonglong param_2)

{
  uint uVar1;
  ulonglong uVar2;
  
  *(int *)(param_1 + 0x2fb4) = (int)param_2;
  if (*(int *)(param_1 + 0x3150) == 0) {
    return;
  }
  uVar1 = *(uint *)(param_1 + 0x2890);
  ...
  *(ulonglong *)(param_1 + 0x10) = *(ulonglong *)(param_1 + 0x10) | 0x20000000000000;
  return;
}
