...
undefined8
fn_82A55E18(longlong param_1,ulonglong param_2,longlong param_3,ulonglong param_4,int *param_5,
             int param_6)

{
  ...
  uVar5 = fn_82A556B8(lVar22,uVar16,lVar7,uVar20,param_6);
  uVar4 = lbl_821AAD20;
  if ((int)uVar5 < 0) {
    return uVar5;
  }
