...
undefined8 fn_828B7788(undefined8 param_1,int param_2)

{
  ...
  *(undefined ***)(auStack_bc + *(int *)(puStack_c0 + 4) + -4) = &lbl_82021284;
  ...
  uVar1 = fn_82240158(&puStack_c0,0xffffffff820250e8);
  uVar1 = fn_82237920(uVar1,uVar4);
  uVar1 = fn_82240158(uVar1,0xffffffff820250b4);
  uVar1 = fn_82237920(uVar1,uVar2);
  uVar1 = fn_82240158(uVar1,0xffffffff82025084);
  uVar1 = fn_82237920(uVar1,uVar3);
  fn_82240158(uVar1,0xffffffff82025070);
