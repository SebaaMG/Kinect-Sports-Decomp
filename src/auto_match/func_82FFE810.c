...
extern int fn_8302C2A0();
extern unsigned int lbl_832642E0;


undefined8 fn_82FFE810(longlong param_1,int param_2,longlong param_3)

{
  ...
  if (piVar3 == (int *)0x0) {
    ...
    piVar3 = (int *)fn_8302C0F0(uVar1);
    if (piVar3 == (int *)0x0) {
      uVar4 = 2;
    }
    else {
      uVar4 = fn_8302C2A0(piVar3,puVar2,*(undefined4 *)(param_2 + 4),param_3,0);
      if ((int)uVar4 != 1) {
...
LAB_82ffe950:
    if ((int)uVar4 != 1) goto LAB_82ffe96c;
  }
  else if (((piVar3[0x27] & 0x3e000000U) == 0) || (((uint)piVar3[0x27] >> 0x18 & 1) == 0)) {
    RtlEnterCriticalSection(0xffffffff8326434c);
    uVar4 = fn_8302C2A0(piVar3,puVar2,*(undefined4 *)(param_2 + 4),param_3,1);
    RtlLeaveCriticalSection(0xffffffff8326434c);
    if ((int)uVar4 != 1) {
      (**(code **)(*piVar3 + 8))(piVar3);
      goto LAB_82ffe950;
