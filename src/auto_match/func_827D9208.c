...
int * fn_827D9208(int *param_1,int param_2,int *param_3,int *param_4)

{
  ...
  if ((puVar6 != puVar1) && (puVar6 = *(undefined4 **)piVar4[1], puVar6 != puVar1)) {
    do {
      ...
      if ((int)puVar6[2] <= *param_3) {
        if (*param_3 <= (int)puVar6[2]) {
  ...
  if (puVar6 != (undefined4 *)*param_4) {
    fn_827E0320(iVar3,puVar6,iVar3,param_4,(undefined4 *)*param_4,1);
  }
