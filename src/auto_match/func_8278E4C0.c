...
bool fn_8278E4C0(int param_1,char param_2)

{
  ...
  if (uVar4 < *(uint *)(param_1 + 0x10)) {
    if ((puVar1 != (uint *)0x0) && (100 < *puVar1)) goto LAB_8278e60c;
    iVar5 = 100;
  }
  else {
    if (puVar1 == (uint *)0x0) {
