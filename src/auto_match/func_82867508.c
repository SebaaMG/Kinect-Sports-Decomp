...
undefined8 fn_82867508(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((int)uVar1 == 1) {
    ...
    uVar2 = fn_8286A3D8(uVar2,0,0xffffffff82020e00,0x1f);
    uVar2 = fn_8223DFF0(uVar2,0xffffffff82020df8,4);
