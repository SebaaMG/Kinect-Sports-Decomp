...
undefined8 fn_83033110(int param_1,ulonglong param_2,byte param_3,longlong param_4)

{
  ...
  *(int *)(param_1 + 0x94) = (int)param_4;
  if ((*(int *)(param_1 + 0x24) != 0) && ((int)param_4 != 0)) {
    fn_82FF5750(lbl_832642F4,*(int *)(param_1 + 0x24),param_4 + 4);
  }
  lVar2 = 0;
  ...
  *(byte *)(param_1 + 0x28) = (param_3 & 1) << 6 | *(byte *)(param_1 + 0x28) & 0xbf;
  return 1;
}
