...
void fn_82D5C358(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4)

{
  ...
  fn_82D74E60(param_1,param_2,param_3,&ppuStack_60);
  if (cStack_5c != '\0') {
    iVar3 = KeTlsGetValue(lbl_8323B4A0);
    puVar1 = *(undefined4 **)(iVar3 + 4);
    if (puVar1 < *(undefined4 **)(iVar3 + 0xc)) {
    ...
    uStack_50 = param_4;
    fn_82D6C3E0(param_2,param_1,param_3,&ppuStack_58);
