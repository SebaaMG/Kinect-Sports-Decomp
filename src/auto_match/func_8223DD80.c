...
undefined8
fn_8223DD80(double param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,int param_5,
             undefined8 param_6)

{
  ...
  lVar2 = lVar2 - iVar3;
  uVar5 = 0;
  if ((*(uint *)(param_5 + 0x14) & 0x3000) == 0x2000) {
  ...
  uVar1 = fn_8223E810(param_3,auStack_e0,0x4c);
