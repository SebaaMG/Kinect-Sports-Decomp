...
extern unsigned int lbl_820F9C98;
extern unsigned int lbl_820F9D98;


undefined8
fn_82C2EE90(int param_1,int param_2,ulonglong param_3,int param_4,int param_5,int *param_6)
  ...
  if (1 < (int)param_3) {
    ...
    if (0 < (longlong)(param_3 - 1)) {
      ...
      do {
        ...
        iVar1 = *(int *)(&lbl_820F9C98 + iVar2);
        iVar2 = *(int *)(&lbl_820F9D98 + iVar2);
