...
void fn_82CF81D0(int param_1,ulonglong param_2,undefined8 param_3)

{
  ...
  iVar4 = param_1 + 0x18;
  RtlEnterCriticalSection(iVar4,0);
  iVar3 = (int)param_3;
  if ((param_2 & 0xffffffff) == 0) {
    ...
    *(int *)(param_1 + 0x48) = *(int *)(param_1 + 0x48) - iVar3;
    (**(code **)(**(int **)(param_1 + 0x34) + 8))(*(int **)(param_1 + 0x34),param_2,param_3);
  }
  RtlLeaveCriticalSection(iVar4);
  return;
}
