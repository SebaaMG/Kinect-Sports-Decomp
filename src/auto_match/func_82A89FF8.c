...
void fn_82A89FF8(undefined8 param_1,int param_2,undefined8 param_3,longlong param_4,
                  longlong param_5)

{
  ...
  fn_82A87148(param_3,param_4 + 0xc0,0x10,param_5 + 0x34);
  fn_82A87148(param_3,param_4 + 0xd0,0x10,param_5 + 0x36);
  return;
}
