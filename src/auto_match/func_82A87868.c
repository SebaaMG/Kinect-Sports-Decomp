...
extern int fn_82A872A8();
extern unsigned int stack0x00000000;


undefined8
fn_82A87868(uint *param_1,int *param_2,uint *param_3,longlong param_4,ulonglong param_5,
             longlong param_6)

{
  ...
  if ((int)param_5 < 1) {
    ...
    cVar6 = (**(code **)(*param_2 + 4))(param_2);
    if ((cVar6 != '\0') && (cVar6 = (**(code **)(*param_2 + 0xc))(param_2,8), cVar6 != '\0')) {
      uVar13 = 0;
      iVar11 = (int)((uint)uVar1 * (int)param_5 + 7) >> 3;
      if (0x1ff < iVar11) {
        iVar11 = 0x200;
      }
      ...
      if (cVar6 != '\0') {
        ...
        while ((int)param_5 != 0) {
          do {
            if ((int)(0x1000 - (uint)uVar1) < (int)uVar13) break;
            fn_82A872A8(uVar9,param_3 + 1,uVar4 - 0x260,uVar13,param_4);
            param_5 = param_5 - 1;
          ...
          uVar13 = uVar13 & 7;
          iVar3 = (int)((int)param_5 * (uint)uVar1 + (int)uVar13 + 7) >> 3;
