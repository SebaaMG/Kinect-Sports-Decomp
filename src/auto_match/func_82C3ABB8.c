...
extern int fn_82C3A278();
extern int fn_82C3A5E8();
extern int fn_82C3A858();
extern int fn_82F691F0();


undefined8 fn_82C3ABB8(int *param_1)

{
  ...
  do {
    ...
    if (uVar4 < 9) {
      if (uVar4 == 1) {
        aiStack_80[0] = 0;
        uVar7 = fn_82C30370(param_1 + 0x38,1,aiStack_80);
        if ((int)uVar7 < 0) {
          return uVar7;
        }
...
LAB_82c3b06c:
        ...
        uVar7 = fn_82C3A858(param_1);
        if ((int)uVar7 < 0) {
          return uVar7;
        }
        uVar7 = fn_82C3A278(param_1);
        if ((int)uVar7 < 0) {
          return uVar7;
        }
        ...
        if ((*(int *)(iVar6 + 0xc) == 0) && (param_1[0x1b] < param_1[0x19])) {
          do {
            aiStack_80[0] = 0;
            uVar7 = fn_82C30370(param_1 + 0x38,6,aiStack_80);
            if ((int)uVar7 < 0) {
              return uVar7;
            }
