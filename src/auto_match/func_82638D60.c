...
void fn_82638D60(int param_1,ulonglong param_2)

{
  uint uVar1;
  ulonglong uVar2;
  
  *(int *)(param_1 + 0x2fac) = (int)param_2;
  if (*(int *)(param_1 + 0x3148) == 0) {
    return;
  }
  uVar1 = *(uint *)(param_1 + 0x2884);
  ...
  *(ulonglong *)(param_1 + 0x10) = *(ulonglong *)(param_1 + 0x10) | 0x100000000000000;
  return;
}
