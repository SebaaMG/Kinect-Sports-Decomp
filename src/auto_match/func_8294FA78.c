...
undefined8 fn_8294FA78(int param_1)

{
  ...
  uStack_12c = 1;
  uStack_128 = 2;
  uVar4 = fn_8294AC48(param_1,*(uint **)(param_1 + 0x104),0xffffffff820369d0,auStack_120,
                        auStack_140,auStack_e0,&uStack_130,uVar8);
  bVar1 = (int)uVar4 != 1;
  if (!bVar1) {
    uVar4 = fn_8294AC48(param_1,*(undefined4 *)(param_1 + 0x104),0xffffffff82036a30,auStack_120,
                          auStack_140,auStack_e0,&uStack_130,uVar8);
  }
  if ((int)uVar4 == 0) {
    uVar6 = 0;
    ...
    if (bVar1) {
      uVar6 = uVar8 | 0x74500000;
    }
    else {
      uVar6 = uVar8 | 0x74400000;
    }
