...
void fn_827F4100(longlong param_1,int param_2)

{
  ...
  uVar3 = fn_827F7210(*(undefined4 *)(param_2 + 8));
  uVar1 = fn_827F6AB8(*(undefined4 *)(param_2 + 8));
  uVar2 = fn_827FA1E8(*(undefined4 *)(param_2 + 8));
  fn_827F6BA0(param_1,uVar3);
  fn_827F6AC0(param_1,uVar1);
  fn_827FA1F0(param_1,uVar2);
  fn_827F9AB0(param_1,0xffff);
