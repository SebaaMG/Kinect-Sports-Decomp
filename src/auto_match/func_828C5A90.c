...
extern int fn_828A2EF0();
extern int fn_828A2FC8();
...
undefined4 * fn_828C5A90(undefined4 *param_1,int *param_2,int param_3,int param_4)

{
  ...
  if ((uVar7 & 0xffffffff) < (lVar5 - (ulonglong)uStack_68 & 0xffffffff)) {
    ...
    aiStack_50[1] = 0;
    fn_828A2EF0(auStack_40,aiStack_50,&uStack_60,&uStack_70);
    uVar3 = uVar8 & 0xffffffff;
    while (uVar3 != 0) {
      if ((ulonglong)(uint)param_2[4] != 0) {
        iVar1 = param_2[3];
        param_2[3] = iVar1 + 1U;
        if ((uint)(param_2[2] << 2) <= iVar1 + 1U) {
          param_2[3] = 0;
        }
        lVar5 = (ulonglong)(uint)param_2[4] - 1;
        param_2[4] = (int)lVar5;
        if (lVar5 == 0) {
          param_2[3] = 0;
        }
    ...
    fn_828A2FC8(auStack_40,&uStack_70,aiStack_50,&uStack_60);
    uVar3 = uVar8 & 0xffffffff;
    while (uVar3 != 0) {
      if (((ulonglong)(uint)param_2[4] != 0) &&
         (lVar5 = (ulonglong)(uint)param_2[4] - 1, param_2[4] = (int)lVar5, lVar5 == 0)) {
        param_2[3] = 0;
      }
      uVar8 = uVar8 - 1;
      uVar3 = uVar8;
