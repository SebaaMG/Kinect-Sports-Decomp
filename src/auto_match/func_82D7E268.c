...

{
  ...
  *param_1 = &lbl_82139E94;
  ...
  if ((param_1[0x20] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[0x1e],param_1[0x20] & 0x3fffffff,0x10);
  }
  param_1[0x1e] = 0;
  param_1[0x20] = 0x80000000;
  fn_82CED5B8(param_1 + 0x1d);
  fn_82D3BBC8(param_1 + 4);
