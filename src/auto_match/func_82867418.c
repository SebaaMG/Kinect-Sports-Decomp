...
extern int fn_82FEB340();


undefined8 fn_82867418(undefined8 param_1,undefined8 param_2)

{
  ...
  uVar1 = fn_82FEB340(uVar1,auStack_b0);
  if ((int)uVar1 == 1) {
    uVar1 = 0x200a0000;
  }
  else {
    ...
    uVar2 = fn_8286A3D8(uVar2,0,0xffffffff82020dd4,0x22);
    uVar2 = fn_8223DFF0(uVar2,0xffffffff82020dcc,4);
