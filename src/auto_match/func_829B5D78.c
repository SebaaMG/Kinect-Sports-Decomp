...
longlong fn_829B5D78(int *param_1,undefined8 param_2,ulonglong param_3,ulonglong param_4)
  ...
  *(int *)(iVar1 + 0x50) = (int)uVar6;
  ...
  if ((param_4 & 0xffffffff) != 0) {
    do {
      ...
      lVar3 = fn_829B5C58(param_1,param_2,(longlong)(int)uVar6 * (longlong)(int)param_3);
