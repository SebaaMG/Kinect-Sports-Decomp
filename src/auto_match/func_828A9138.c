...
undefined8 fn_828A9138(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4)

{
  ...
  *(undefined ***)(auStack_ac + *(int *)(puStack_b0 + 4) + -4) = &lbl_82021284;
  ...
  uVar2 = fn_82240158(&puStack_b0,0xffffffff820243e4);
  uVar2 = fn_8223FBB0(uVar2,uVar1);
