...
undefined8 fn_828BDF20(undefined8 param_1,int *param_2,undefined8 param_3)

{
  ...
  *(undefined ***)(auStack_bc + *(int *)(puStack_c0 + 4) + -4) = &lbl_82021284;
  ...
  uVar1 = (**(code **)(*param_2 + 0x60))(auStack_e0,param_2,param_3);
  fn_8223B728(&puStack_c0,uVar1);
  if (0xf < uStack_cc) {
