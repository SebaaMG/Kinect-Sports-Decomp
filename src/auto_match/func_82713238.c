...

{
  ...
  if (((*(int **)(param_1 + 8) == (int *)0x0) ||
      (iVar6 = (**(code **)(**(int **)(param_1 + 8) + 8))(), iVar6 != 9)) ||
     (cVar7 = (**(code **)(**(int **)(param_1 + 8) + 0x40))(), cVar7 != '\0')) {
    uVar4 = lbl_82005710;
    if (*(int *)(param_1 + 0x1c) != 0) {
      uVar2 = *(undefined4 *)(param_1 + 0x18);
      uVar4 = fn_826957D0(param_1,0);
      uVar4 = fn_826972E0(uVar4,uVar2);
    }
    fn_82681898(uVar4,*(undefined4 *)(param_1 + 4));
  }
  else {
    ...
    (**(code **)(*piVar8 + 0xc))(piVar8,*(undefined4 *)(param_1 + 0x18),uVar3 - 0x60);
