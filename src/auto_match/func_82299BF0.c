...
void fn_82299BF0(undefined4 *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((param_1[0x48a] == 0) || ((bVar2 && (param_1[0x485] != 2)))) {
    ...
    fn_82672C20(*param_1,0xffffffff821aacb0,auStack_60,3);
    param_1[0x489] = 0;
    param_1[0x483] = 3;
    puVar4 = auStack_30;
    param_1[0x488] = 1;
