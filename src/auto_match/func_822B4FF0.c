...
undefined4 * fn_822B4FF0(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar8 + 0x19) == '\0') {
    piVar5 = piVar8;
    if ((*(char *)(*piVar6 + 0x19) == '\0') && (piVar5 = (int *)piVar7[2], piVar7 != param_3)) {
      piVar8[1] = (int)piVar7;
      *piVar7 = *param_3;
      piVar8 = piVar7;
      ...
      *(undefined1 *)(piVar7 + 6) = *(undefined1 *)(param_3 + 6);
