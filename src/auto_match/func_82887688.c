...
undefined4 *
fn_82887688(undefined4 *param_1,ulonglong param_2,ulonglong param_3,ulonglong param_4,
             ulonglong param_5)

{
  ...
  if ((uVar10 & 0xff) != 0) {
    if (puVar6 == (undefined4 *)**(undefined4 **)((int)param_2 + 4)) {
      puVar6 = (undefined4 *)fn_828DF458(apuStack_50,param_2,1,puVar6,param_3);
      uVar4 = *puVar6;
      *(undefined1 *)(param_1 + 1) = 1;
      *param_1 = uVar4;
      return param_1;
    }
    fn_8288A4B0(apuStack_50,uVar7,uVar8,param_4,param_5);
  }
  puVar3 = apuStack_50[0];
  if ((int)apuStack_50[0][3] < *(int *)((int)param_3 + 0xc)) {
    puVar6 = (undefined4 *)fn_828DF458(apuStack_50,param_2,uVar10,puVar6,param_3);
    uVar4 = *puVar6;
    *(undefined1 *)(param_1 + 1) = 1;
    *param_1 = uVar4;
  }
