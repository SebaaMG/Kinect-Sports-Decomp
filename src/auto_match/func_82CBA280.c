...
void fn_82CBA280(int param_1,ulonglong param_2,ulonglong param_3,int *param_4,uint *param_5)

{
  ...
  uVar1 = *param_5;
  iVar5 = *param_4;
  lVar7 = ((ulonglong)*(uint *)(param_1 + 0x88) & 0x1fffffff) * 8;
  if ((uVar1 & 4) == 0) {
    lVar2 = -8;
    lVar6 = ((ulonglong)*(uint *)(param_1 + 0x8c) & 0x1fffffff) << 3;
  }
  else {
    lVar2 = -9;
    lVar6 = ((ulonglong)*(uint *)(param_1 + 0x8c) & 0x1fffffff) * 8 + 1;
  }
  if (iVar5 == 0x4000) {
    *param_4 = 0x4000;
  }
