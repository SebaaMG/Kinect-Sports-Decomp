...
undefined4 * fn_8251E930(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar9 + 0x2d) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x2d) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar2 = *(undefined1 *)(piStack00000024 + 0xb);
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x2d) == '\0') {
      piVar6 = (int *)*piVar8;
      piVar7 = piVar8;
      while (piVar3 = piVar6, *(char *)((int)piVar3 + 0x2d) == '\0') {
        piVar7 = piVar3;
        piVar6 = (int *)*piVar3;
      }
    }
            ...
            if ((*(char *)(*piVar7 + 0x2c) != '\x01') || (*(char *)(piVar7[2] + 0x2c) != '\x01')) {
              if (*(char *)(piVar7[2] + 0x2c) == '\x01') {
                ...
                *(undefined1 *)(piVar7 + 0xb) = 0;
                fn_8251EE00(param_2,piVar7);
                piVar7 = (int *)piVar9[2];
              }
              *(undefined1 *)(piVar7 + 0xb) = *(undefined1 *)(piVar9 + 0xb);
