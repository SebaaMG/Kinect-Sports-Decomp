...
extern int fn_83030028();
extern int fn_83030BF0();


undefined8 fn_82FFEA78(longlong param_1,int param_2,longlong param_3,undefined8 param_4)

{
  ...
  if (piVar3 == (int *)0x0) {
    ...
    piVar3 = (int *)fn_83030028(uVar1);
    if (piVar3 == (int *)0x0) {
      uVar4 = 2;
    }
    else {
      uVar4 = fn_83030BF0(piVar3,puVar2,*(undefined4 *)(param_2 + 4));
      if ((int)uVar4 != 1) {
        (**(code **)(*piVar3 + 8))(piVar3);
      }
    }
    RtlLeaveCriticalSection(0xffffffff8326434c);
    if ((int)uVar4 != 1) goto LAB_82ffeb58;
  }
