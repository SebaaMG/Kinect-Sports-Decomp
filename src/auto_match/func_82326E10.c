...
undefined4 * fn_82326E10(undefined4 *param_1,int param_2,int param_3)

{
  ...
  if (uVar5 != 0) {
    ...
    if (*(char *)((int)puVar2 + 0x2d) == '\0') {
      ...
      if (*(char *)((int)puVar7 + 0x2d) == '\0') {
        puVar4 = (undefined4 *)puVar7[2];
        while (puVar1 = puVar4, *(char *)((int)puVar1 + 0x2d) == '\0') {
          puVar7 = puVar1;
...
LAB_82326eb0:
  puVar2 = (undefined4 *)fn_82550E48(auStack_50,param_2,uVar5,puVar2,param_3);
