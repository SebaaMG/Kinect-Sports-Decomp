...
undefined8
fn_830290F8(int param_1,ulonglong param_2,undefined8 param_3,undefined8 param_4,
             undefined8 *param_5,undefined2 param_6,undefined2 param_7)
    ...
    if (piVar4 != (int *)0x0) {
      ...
      *piVar4 = (int)puVar5;
      if (puVar5 == (undefined4 *)0x0) {
        ...
        fn_830086A0(puVar5,param_2,param_4,param_3,*param_5);
        *(undefined2 *)(*piVar4 + 0x28) = param_6;
        uVar2 = lbl_821AAD20;
        *(undefined2 *)(*piVar4 + 0x2a) = param_7;
