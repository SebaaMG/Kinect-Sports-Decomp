...
void fn_82A446E8(undefined4 *param_1)

{
  param_1[1] = &lbl_82089788;
  param_1[0x23] = &lbl_82089758;
  *param_1 = 0;
  fn_82A412D8(param_1 + 0x39);
  fn_82A3F6F0(param_1 + 0x2f);
  fn_82A411B8(param_1 + 0x25);
  param_1[1] = 0;
  fn_82A411B8(param_1 + 0x15);
  fn_82A411B8(param_1 + 3);
  return;
}
