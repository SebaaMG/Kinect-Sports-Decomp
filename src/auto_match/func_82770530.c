...
void fn_82770530(int *param_1,undefined8 param_2,undefined4 *param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if ((uint)(*piVar1 * 5) <= (uint)((piVar1[1] + 1) * 4)) goto LAB_8277058c;
    lVar4 = ((ulonglong)(uint)piVar1[1] + 1 & 0x7fffffff) << 1;
  }
  fn_8276FF80(param_1,param_2,lVar4);
LAB_8277058c:
  piVar1 = (int *)*param_1;
