...
void fn_824B7728(undefined8 param_1,uint param_2,uint param_3,longlong param_4,undefined4 param_5,
  ...
  if (cVar3 == '\0') {
    ...
    if ((cVar3 != '\0') && (cVar3 = fn_82512508(param_1), cVar3 != '\0')) {
      ...
      if (iVar2 != 0) {
        ...
        fn_8245B100(iVar1);
        auStack_60[0] = CONCAT11('\x01' - (param_4 == 0),(undefined1)auStack_60[0]);
        fn_8245B168(iVar1,auStack_60,1);
        auStack_60[0] = (undefined2)param_5;
