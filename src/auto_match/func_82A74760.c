...
void fn_82A74760(int *param_1,int param_2)

{
  ...
  while( true ) {
    ...
    if (uVar5 == 2 && bVar1) {
      iVar4 = fn_82A74488(&iStack_50,0,piVar6,param_1,puVar7);
      if (iVar4 < 0) {
        return;
      }
  ...
  iVar4 = fn_82A74640(&iStack_50,*(undefined2 *)(param_1 + 0x4e),piVar6);
  if (iVar4 < 0) {
    return;
  }
  ...
  *puVar7 = 0x12;
LAB_82a74904:
  iVar4 = fn_82A6D090(piVar6,1,&iStack_50);
  if (iVar4 < 0) {
    return;
  }
