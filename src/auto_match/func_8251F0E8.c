...
undefined4 *
fn_8251F0E8(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)
  ...
  *(uint *)(param_2 + 8) = *(uint *)(param_2 + 8) + 1;
  ...
  if (param_4 == *(undefined4 **)(param_2 + 4)) {
    ...
    **(undefined4 **)(param_2 + 4) = param_5;
    ...
    param_4[2] = param_5;
    iVar2 = *(int *)(param_2 + 4);
    if (param_4 != *(undefined4 **)(iVar2 + 8)) goto LAB_8251f190;
  }
  *(int **)(iVar2 + 8) = param_5;
LAB_8251f190:
...
LAB_8251f220:
      ...
      iVar2 = *piVar4;
      if (*(char *)(iVar2 + 0x2c) == '\0') goto LAB_8251f220;
