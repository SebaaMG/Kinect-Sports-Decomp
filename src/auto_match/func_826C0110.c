...
extern int fn_826BDE70();
extern int fn_826BE0E0();
extern int fn_826BEAC0();


void fn_826C0110(int *param_1,undefined8 param_2,undefined8 param_3,uint param_4)

{
  ...
  if (piVar5 == (int *)0x0) {
    ...
    if ((uint)(*piVar5 * 5) <= (uint)((piVar5[1] + 1) * 4)) goto LAB_826c016c;
...
LAB_826c016c:
  ...
  *piVar5 = *piVar5 + 1;
  ...
  if (iVar2 == -2) {
    *puVar9 = 0xffffffff;
    fn_826BDE70(iVar6 + 0x10,param_3);
  }
  else {
    do {
