...
undefined8 fn_828DCF00(undefined8 param_1,int param_2)

{
  ...
  *(undefined ***)(auStack_bc + *(int *)(puStack_c0 + 4) + -4) = &lbl_82021284;
  ...
  uVar5 = fn_82240158(&puStack_c0,0xffffffff82026f04);
  uVar5 = fn_82520AC8(uVar5,uVar4);
  uVar5 = fn_82240158(uVar5,0xffffffff82026ef4);
  uVar5 = fn_82520AC8(uVar5,uVar3);
  uVar5 = fn_82240158(uVar5,0xffffffff82026ee4);
  fn_82520AC8(uVar5,(iVar1 - iVar2) / 0x34);
