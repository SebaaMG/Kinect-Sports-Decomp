...
undefined4 *
fn_8287EFA0(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)

{
  ...
  if (0x111110f < *(uint *)(param_2 + 8)) {
    fn_8287E918(param_5 + 6);
    fn_8265CA20(param_5);
  ...
  while (cVar1 == '\0') {
    ...
    if (piVar2 == (int *)*piVar3) {
      ...
      if (*(char *)(iVar4 + 0x100) == '\0') {
        ...
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x100) = 0;
        ...
        *(undefined1 *)(piVar5[1] + 0x100) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x100) = 0;
        fn_8287CB58(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar4 = *piVar3;
      if (*(char *)(iVar4 + 0x100) == '\0') {
        ...
        *(undefined1 *)(piVar5[1] + 0x100) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x100) = 0;
        fn_8287CE60(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    cVar1 = *(char *)(piVar5[1] + 0x100);
  }
  iVar4 = *(int *)(param_2 + 4);
  *param_1 = param_5;
  *(undefined1 *)(*(int *)(iVar4 + 4) + 0x100) = 1;
  return param_1;
}
