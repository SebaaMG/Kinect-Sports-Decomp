...
void fn_828D91D8(int *param_1,int param_2,undefined8 param_3,ulonglong param_4)

{
  ...
  puStack_40 = auStack_70 + (uVar1 >> 3);
  iStack_38 = 0;
  uStack_34 = 0;
  uStack_30 = 0;
  uStack_3c = 0x19;
  fn_828E9D28(auStack_50,puStack_40,0x19);
  if ((uVar1 & 7) != 0) {
  ...
  if ((int)((param_4 & 0xffffffff) << 3) <= iVar2 - iVar3) {
    fn_828EA180(auStack_50,param_3,param_4);
  }
  if (iStack_38 != 0) {
    fn_8265CA20();
  }
