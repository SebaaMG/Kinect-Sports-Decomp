...
void fn_82D8B2D8(longlong param_1,float *param_2)

{
  ...
  puVar9 = (undefined4 *)((uint)(param_2 + 0xc) & 0xfffffff0);
  uVar15 = puVar9[1];
  uVar16 = puVar9[2];
  uVar17 = puVar9[3];
  puVar10 = (undefined4 *)((int)param_1 + 0x10U & 0xfffffff0);
  *puVar10 = *puVar9;
  puVar10[1] = uVar15;
  puVar10[2] = uVar16;
  puVar10[3] = uVar17;
  ...
  if (fVar2 + fVar1 + param_2[10] <= lbl_821AAD20) {
    ...
    uVar14 = (ulonglong)(fVar2 < fVar1);
    if (param_2[(uint)(fVar2 < fVar1) * 5] < param_2[10]) {
      uVar14 = 2;
    }
    lVar13 = uVar14 * 4;
    iVar11 = (int)uVar14;
    uVar5 = *(uint *)((int)afStack_40 + (int)lVar13);
    fVar6 = afStack_40[uVar5];
    fVar1 = param_2[uVar5 * 4 + iVar11];
    fVar2 = *(float *)((int)((lVar13 + (ulonglong)uVar5 & 0xffffffff) << 2) + (int)param_2);
    fVar3 = param_2[(int)fVar6 * 4 + iVar11];
    fVar4 = *(float *)((int)((lVar13 + (ulonglong)(uint)fVar6 & 0xffffffff) << 2) + (int)param_2);
    fVar8 = SQRT((param_2[iVar11 * 5] -
    ...
    *(float *)((int)afStack_40 + (int)lVar13) = fVar8 * lbl_82002C5C;
