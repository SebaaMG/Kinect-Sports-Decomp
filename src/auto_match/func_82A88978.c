...
void fn_82A88978(undefined8 param_1,int param_2,undefined8 param_3,longlong param_4,
                  longlong param_5)

{
  ...
  fn_82A87148(param_3,param_4 + 0x40,0x10,param_5 + 0x24);
  fn_82A87148(param_3,param_4 + 0x50,0x10,param_5 + 0x26);
  return;
}
