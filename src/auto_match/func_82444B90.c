...

{
  ...
  iVar6 = fn_82F6A544();
  iVar6 = **(int **)(iVar6 + -4);
  if (iVar6 == 0) goto LAB_82444ee8;
  *(undefined4 *)(iVar6 + 0x894) = 0;
  puVar4 = (undefined4 *)(iVar6 + 0x50U & 0xfffffff0);
  uVar19 = puVar4[1];
  uVar20 = puVar4[2];
  uVar21 = puVar4[3];
...
LAB_82444e3c:
    ...
    pfVar8 = (float *)fn_8255AA78(&fStack_60,*(undefined8 *)(iVar7 + 0x10),
                                        *(undefined8 *)(iVar7 + 0x18),*(undefined8 *)(iVar7 + 0x20),
                                        *(undefined8 *)(iVar7 + 0x28),*(undefined8 *)(iVar7 + 0x30),
                                        *(undefined8 *)(iVar7 + 0x38),*(undefined8 *)(iVar7 + 0x40))
    ;
    fVar3 = pfVar8[1];
    puVar4 = (undefined4 *)(iVar6 + 0xc0U & 0xfffffff0);
    uVar19 = puVar4[1];
    ...
    *puVar5 = *puVar4;
    ...
    if (dVar14 <= (double)lbl_82195628) {
      dVar9 = (double)fn_82809D40(-(double)((float)(dVar17 * dVar12) - (float)(dVar16 * dVar10)),
                                   (double)(lbl_821CA460 - (fVar2 + (float)(dVar11 * dVar17))),dVar9
                                  );
  ...
  fn_8253C548(iVar6,auStack_50,&fStack_70);
LAB_82444ee8:
  fn_82F6A590();
  return;
}
