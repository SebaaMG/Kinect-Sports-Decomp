...
void fn_82354368(int param_1,int param_2)

{
  ...
  if (param_1 == 0) {
    fn_8229E090(*(undefined4 *)(param_2 + 4),0,1);
    *(undefined4 *)(param_2 + 4) = 0;
    if (*(int *)(param_2 + 0x3f4) != 0) {
      uVar2 = fn_828A12E8(*(undefined4 *)(*(int *)(param_2 + 0x3f4) + 0x10));
      ...
      while (puStack_50 != puStack_2c) {
        ...
        if (cVar6 != '\0') {
          *(undefined4 *)(param_2 + 0x3b4) = 1;
          lVar3 = (**(code **)(*piVar5 + 8))(piVar5);
          fn_828AAF70(lVar3 + 0x390,1);
        }
