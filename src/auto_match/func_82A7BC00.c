...
int fn_82A7BC00(byte *param_1,ulonglong param_2,char *param_3,int param_4,ulonglong param_5)
  ...
  if (((param_2 & 0xffffffff) == 0) || (param_4 == 0)) {
    ...
    if (6 < (param_2 & 0xffffffff)) {
      do {
        ...
        *pcVar7 = (char)((uint)iVar12 >> 8) + -0x80;
        pcVar7[1] = (char)((uint)iVar10 >> 8) + -0x80;
        for (lVar9 = uVar11 - 7; pcVar7 = pcVar7 + 2, lVar9 != 0; lVar9 = lVar9 + -1) {
          bVar2 = *param_1;
