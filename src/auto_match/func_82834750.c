...
undefined4 * fn_82834750(undefined4 *param_1,int param_2,int param_3,char param_4)

{
  ...
  if (*(char *)((int)puVar3[1] + 0x11) == '\0') {
    uVar1 = *(uint *)(*(int *)(param_3 + 0xc) + 0x14);
    puVar2 = (undefined4 *)puVar3[1];
    do {
      puVar3 = puVar2;
      if (param_4 == '\0') {
        uVar4 = -(ulonglong)(uVar1 < *(uint *)(puVar3[3] + 0x14)) & 1;
      }
      else {
        uVar4 = -((ulonglong)(*(uint *)(puVar3[3] + 0x14) < uVar1) - 1);
      }
      if ((uVar4 & 0xff) == 0) {
