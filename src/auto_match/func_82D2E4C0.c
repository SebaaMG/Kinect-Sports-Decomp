...
void fn_82D2E4C0(int *param_1,ulonglong param_2)

{
  ...
  if (0 < param_1[1]) {
    puVar5 = (uint *)*param_1;
    do {
      if (((ulonglong)*puVar5 <= (param_2 & 0xffffffff)) &&
         ((param_2 & 0xffffffff) <= ((ulonglong)*puVar5 + 0x364 & 0xffffffff))) {
        uVar1 = ((uint *)*param_1)[iVar3];
        iVar4 = *(int *)(uVar1 + 900) + -1;
        *(int *)(uVar1 + 900) = iVar4;
        if (iVar4 != 0) {
          return;
        }
