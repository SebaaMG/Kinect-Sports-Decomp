...
void fn_82479690(undefined8 param_1,int param_2,undefined8 param_3,int param_4)

{
  ...
  if (((*(int *)(param_2 + 0x68) != 0) && (param_4 != 0)) &&
     (iVar1 = *(int *)(*(int *)(*(int *)(param_2 + 0x24) + 0x10) + 0x84), iVar1 != 0)) {
    if (*(int *)(*(int *)(param_2 + 0x68) + 0x100) < 0x33) {
  ...
  if ((*(int *)(param_2 + 0x3c) != 0) &&
     (iVar1 = fn_82281530(*(undefined4 *)(param_2 + 0x24)), iVar1 == 0)) {
