...
extern int fn_826A2918();
extern int fn_826A4BB0();
extern int fn_826A52D0();
...
void fn_826A4FF8(int *param_1,undefined8 param_2,uint param_3)
    ...
    if (*param_1 != 0) {
      ...
      do {
        ...
        if (*(int *)(iVar3 + 8) != -2) {
          ...
          fn_826A52D0(apuStack_60,param_2,iVar3 + 0xc);
          fn_826A2918(iVar3 + 0xc,0);
