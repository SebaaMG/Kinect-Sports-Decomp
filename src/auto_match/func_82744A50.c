...

{
  ...
  if (((*(int **)(param_1 + 8) == (int *)0x0) ||
      (iVar3 = (**(code **)(**(int **)(param_1 + 8) + 8))(), iVar3 != 0x10)) ||
    ...
    if ((uVar1 & 0xffffffff) == 0) {
      ...
      iVar3 = fn_82744378(uVar1,*(undefined4 *)(param_1 + 0x18));
    }
  }
  else {
  ...
  if (0 < *(int *)(param_1 + 0x1c)) {
    ...
    fn_82743808(iVar3,(ulonglong)*(uint *)(param_1 + 0x18) + 0x78,auStack_40);
    puVar5 = auStack_20;
    lVar6 = 1;
    do {
      puVar5 = puVar5 + -0x10;
