...
undefined4 * fn_82496880(undefined4 *param_1,int param_2,int *param_3,int *param_4)
  ...
  if ((param_3 == (int *)**(int **)(param_2 + 4)) && (param_4 == *(int **)(param_2 + 4))) {
    ...
    *(undefined4 *)(param_2 + 8) = 0;
    if (piVar3 != (int *)*piVar4) {
      do {
        piVar1 = (int *)*piVar3;
        piVar3[8] = (int)&lbl_821BEBAC;
        fn_82491E88(piVar3 + 0x14);
    ...
    while (piVar1 = param_3, piVar1 != param_4) {
      ...
      if (piVar1 != (int *)*piVar4) {
        ...
        *(int *)(*piVar1 + 4) = piVar1[1];
        piVar1[8] = (int)&lbl_821BEBAC;
        fn_82491E88(piVar1 + 0x14);
