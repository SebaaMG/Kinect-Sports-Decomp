...
void fn_82EA31D0(int param_1,undefined8 param_2,longlong param_3,undefined8 param_4,
...

{
        ...
        do {
          (**(code **)(param_1 + 0x9b8))
                    ((param_3 - (ulonglong)uVar2) + -1,*(undefined4 *)(param_1 + 0x564),
                     in_stack_0000006c,0x10,uVar18,uVar8,*(undefined4 *)(param_1 + 0x904),
                     *(undefined4 *)(param_1 + 0x618));
          iVar3 = (*pcVar1)(param_2,0x10,in_stack_0000006c,0x10,0x10);
      ...
      do {
        (**(code **)(param_1 + 0x9b8))
                  (param_3 - (ulonglong)uVar2,*(undefined4 *)(param_1 + 0x564),in_stack_0000006c,
                   0x10,uVar6,uVar8,*(undefined4 *)(param_1 + 0x904),
                   *(undefined4 *)(param_1 + 0x618));
        iVar3 = (*pcVar1)(param_2,0x10,in_stack_0000006c,0x10,0x10);
  ...
  if (iVar11 < 0) {
    ...
    do {
      (**(code **)(param_1 + 0x9b8))
                (param_3 + -1,*(undefined4 *)(param_1 + 0x564),in_stack_0000006c,0x10,uVar8,0,
  ...
  if (uVar12 != 0) {
    ...
    do {
      (**(code **)(param_1 + 0x9b8))
                (param_3,*(undefined4 *)(param_1 + 0x564),in_stack_0000006c,0x10,uVar8,0,
                 *(undefined4 *)(param_1 + 0x904),*(undefined4 *)(param_1 + 0x618));
      iVar3 = (*pcVar1)(param_2,0x10,in_stack_0000006c,0x10,0x10);
      uVar6 = (ulonglong)((int)(uVar8 + uVar17) >> 0x1f);
      uVar6 = (uVar8 + uVar17 ^ uVar6) - uVar6;
  ...
  if (uVar5 != 0) {
    do {
      if (iVar11 < 0) {
        ...
        do {
          (**(code **)(param_1 + 0x9b8))
                    (param_3 + -1,*(undefined4 *)(param_1 + 0x564),in_stack_0000006c,0x10,uVar18,
                     uVar8,*(undefined4 *)(param_1 + 0x904),*(undefined4 *)(param_1 + 0x618));
          iVar3 = (*pcVar1)(param_2,0x10,in_stack_0000006c,0x10,0x10);
          uVar7 = (ulonglong)((int)(uVar18 + uVar17) >> 0x1f);
          uVar7 = (uVar18 + uVar17 ^ uVar7) - uVar7;
          if (((int)uVar7 < 0x9f) && ((int)uVar6 < 0x9f)) {
      ...
      do {
        (**(code **)(param_1 + 0x9b8))
                  (param_3,*(undefined4 *)(param_1 + 0x564),in_stack_0000006c,0x10,uVar6,uVar8,
                   *(undefined4 *)(param_1 + 0x904),*(undefined4 *)(param_1 + 0x618));
        iVar3 = (*pcVar1)(param_2,0x10,in_stack_0000006c,0x10,0x10);
        uVar7 = (ulonglong)((int)(uVar6 + uVar17) >> 0x1f);
        uVar7 = (uVar6 + uVar17 ^ uVar7) - uVar7;
