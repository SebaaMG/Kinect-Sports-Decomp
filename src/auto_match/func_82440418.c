...
void fn_82440418(int param_1,int param_2,int param_3,int *param_4)

{
  ...
  while( true ) {
    ...
    if ((piVar2[-5] < piVar2[0x12]) || ((piVar2[0x12] == piVar2[-5] && (*piVar2 < piVar2[-0x17]))))
    {
      bVar1 = true;
    }
    else {
  ...
  while( true ) {
    ...
    if ((param_4[0x12] < piVar2[0x12]) || ((piVar2[0x12] == param_4[0x12] && (*piVar2 < *param_4))))
    {
      bVar1 = true;
    }
    else {
