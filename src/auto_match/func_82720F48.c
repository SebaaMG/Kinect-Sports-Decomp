...
void fn_82720F48(longlong param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                  int param_5)

{
  ...
  if (param_5 == 0) {
    fn_82720D48(param_1 + -0x34,param_2,param_3,0x65,0,param_4,0,0);
  }
  else {
    ...
    *(int *)(aiStack_30[0] + 8) = *(int *)(aiStack_30[0] + 8) + 1;
    fn_82720D48(param_1 + -0x34,param_2,param_3,0x65,aiStack_30,param_4,0,0);
