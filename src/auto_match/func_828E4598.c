...
extern int fn_828E2780();
extern int fn_828E3F60();


undefined4 * fn_828E4598(undefined4 *param_1,int param_2,int param_3,char param_4)

{
  ...
  uVar7 = 1;
  cVar5 = *(char *)((int)puVar4 + 0x25);
  puVar3 = *(undefined4 **)(param_2 + 4);
  while (cVar5 == '\0') {
    if (param_4 == '\0') {
      uVar7 = fn_828E0270(iVar6,puVar4 + 3);
    }
    else {
      cVar5 = fn_828E0270(puVar4 + 3,iVar6);
