...
void fn_82A67FB8(int param_1,int param_2,uint param_3)

{
  ...
  if (3 < (int)param_3) {
    ...
    do {
      fVar1 = pfVar9[-2];
      fVar2 = fVar4;
      if ((fVar4 <= fVar1) && (fVar2 = fVar1, fVar5 < fVar1)) {
        fVar2 = fVar5;
      }
      fVar1 = pfVar9[-1];
      iVar7 = (int)(fVar2 * fVar6) << 4;
  ...
  if (uVar8 < param_3) {
    ...
    do {
      ...
      pfVar9 = pfVar9 + 1;
      iVar3 = (int)(fVar2 * fVar6) << 4;
      puVar10[1] = (char)iVar3;
      puVar10[2] = (char)((uint)iVar3 >> 8);
      puVar10 = puVar10 + 3;
      *puVar10 = (char)((uint)iVar3 >> 0x10);
      iVar7 = iVar7 + -1;
    } while (iVar7 != 0);
  }
  return;
