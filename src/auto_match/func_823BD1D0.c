...
extern unsigned int lbl_821B5EF4;
extern unsigned int lbl_821C7FB8;


int * fn_823BD1D0(int *param_1,int param_2)

{
  ...
  if (puVar3 == (undefined4 *)0x0) {
    ...
    *puVar3 = &lbl_821B5EF4;
    puVar3[4] = &lbl_821C7FB8;
    puVar3[5] = *(undefined4 *)(param_2 + 4);
    puVar3[4] = &lbl_821B5EBC;
    puVar1 = (undefined4 *)(param_2 + 0x10U & 0xfffffff0);
    uVar4 = puVar1[1];
    uVar5 = puVar1[2];
    uVar6 = puVar1[3];
    puVar2 = (undefined4 *)((uint)(puVar3 + 8) & 0xfffffff0);
    *puVar2 = *puVar1;
    puVar2[1] = uVar4;
    puVar2[2] = uVar5;
    puVar2[3] = uVar6;
