...

{
  ...
  auStack_60[1] = 200;
  if ((int)(param_1[1] - *param_1) / 400 != 200) {
    uVar1 = fn_8265C9E0(80000);
    if (uVar1 == 0) {
      uStack_4c = 0;
    ...
    if ((int)uVar5 < 1) {
      uVar3 = uVar7;
      if ((int)uVar5 < 0) {
        fn_824B4188(&puStack_58,-uVar2);
        uVar3 = (ulonglong)uStack_54;
      }
    }
    else {
      if ((int)(param_1[1] - uStack_54) / 400 <= (int)uVar5) {
        uVar2 = uVar2 - (longlong)((int)(param_1[1] - *param_1) / 400);
      }
      uVar3 = uVar2 * 400 + uVar7;
    ...
    *param_1 = uVar5;
    param_1[2] = uVar5;
    param_1[1] = (uint)(uVar1 + 80000);
    param_1[4] = (int)((uint)uVar2 - uVar5) / 400;
    uVar6 = (uint)uVar2;
    if ((uVar2 & 0xffffffff) == (uVar1 + 80000 & 0xffffffff)) {
      uVar6 = uVar5;
    }
    param_1[3] = uVar6;
  }
