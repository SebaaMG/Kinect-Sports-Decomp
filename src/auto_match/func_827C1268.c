...
extern int fn_827C10A8();
extern int fn_827C1B68();


int fn_827C1268(int *param_1,int *param_2,uint param_3,uint param_4,char param_5)
  ...
  if (uVar3 < uVar2) {
    ...
    if (*(char *)(param_2 + 8) == '\0') {
      ...
      if (uVar3 < uVar2) {
        ...
        iVar5 = uVar2 - uVar3;
        do {
          fn_827C1B68(*(undefined4 *)(*param_2 + iVar4),iVar1);
          iVar5 = iVar5 + -1;
          iVar4 = iVar4 + 4;
        } while (iVar5 != 0);
      }
