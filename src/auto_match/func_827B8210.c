...
void fn_827B8210(int *param_1,undefined8 param_2,undefined4 *param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if ((uint)(*piVar1 * 5) <= (uint)((piVar1[1] + 1) * 4)) goto LAB_827b826c;
    lVar4 = ((ulonglong)(uint)piVar1[1] + 1 & 0x7fffffff) << 1;
  }
  fn_827B7738(param_1,param_2,lVar4);
LAB_827b826c:
  piVar1 = (int *)*param_1;
    ...
    *(undefined4 *)(iVar11 + 0x18) = param_3[2];
    ...
    if (uVar6 == param_4) {
      if (puVar9 != (uint *)0x0) {
        ...
        *(undefined4 *)(iVar8 + 0x1c) = *(undefined4 *)(iVar11 + 0x1c);
      }
      *(undefined4 *)(iVar11 + 0x10) = *param_3;
      *(undefined4 *)(iVar11 + 0x14) = param_3[1];
      *(undefined4 *)(iVar11 + 0x18) = param_3[2];
      ...
      *puVar12 = uVar5;
      ...
      while (puVar7 = (uint *)(uVar6 * 0x18 + iVar2 + 8), *puVar7 != param_4) {
        uVar6 = *puVar7;
      }
      if (puVar9 != (uint *)0x0) {
        *puVar9 = uVar3;
