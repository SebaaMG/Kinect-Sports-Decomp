...
undefined8 fn_82F34E58(undefined4 *param_1,ulonglong param_2,undefined4 param_3)

{
  ...
  for (puVar3 = param_1;
    ...
    if ((param_2 & 0xffffffff) < (ulonglong)(puVar3[1] + 0x14)) goto LAB_82f34efc;
    puVar2 = puVar3;
  }
...
LAB_82f34efc:
      ...
      *(byte *)((int)apuStack_30[0] + iVar1 + 0x10) =
           (&lbl_831B9F90)[(uint)param_2 & 7] | *(byte *)((int)apuStack_30[0] + iVar1 + 0x10);
