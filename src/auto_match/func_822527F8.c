...
void fn_822527F8(int param_1,undefined8 param_2,int param_3)

{
  ...
  *puVar2 = in_register_000104d0;
  ...
  (**(code **)(**(int **)(param_1 + 0x70) + 0x14))(*(int **)(param_1 + 0x70),param_2,&uStack_b0);
  (**(code **)(**(int **)(param_1 + 0x78) + 0x14))(*(int **)(param_1 + 0x78),param_2,auStack_bf);
  ...
  (**(code **)(**(int **)(param_1 + 0x90) + 0x14))(*(int **)(param_1 + 0x90),param_2,auStack_bc);
  piVar1 = *(int **)(param_3 + 0x10);
  if (piVar1 != (int *)0x0) {
    (**(code **)(*piVar1 + 4))(piVar1,&uStack_b0,auStack_bf[0],uStack_c0,auStack_70,auStack_bc[0]);
  }
  return;
}
