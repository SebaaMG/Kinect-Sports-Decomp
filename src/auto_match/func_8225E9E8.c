...
extern int fn_8225EE20();
extern int fn_823FAB00();
extern int fn_823FACD8();


undefined4 * fn_8225E9E8(undefined4 *param_1,int param_2,int *param_3,int param_4)
  ...
  if (*(int *)(param_2 + 8) == 0) {
    ...
    if (param_3 != (int *)*piVar2) {
      if (param_3 == piVar2) {
        ...
        if (*(uint *)(param_4 + 0x10) <= (uint)param_3[4]) goto LAB_8225eb34;
        uVar7 = 0;
      }
      else {
        ...
        if ((uVar3 < uVar4) &&
          ...
          if ((uVar3 <= uVar4) ||
             ((apiStack_50[0] = param_3, puVar6 = (undefined4 *)fn_822509A0(apiStack_50),
              (int *)*puVar6 != piVar2 && ((uint)apiStack_50[0][4] <= uVar3)))) goto LAB_8225eb34;
...
LAB_8225eb34:
      puVar6 = (undefined4 *)fn_8225EE20(auStack_48,param_2,param_4);
      *param_1 = *puVar6;
      return param_1;
    }
  }
