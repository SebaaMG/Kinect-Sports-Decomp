...
int fn_82B45500(undefined8 param_1,int param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((((param_2 != 0) && (*(int *)(param_2 + 4) == 0xe)) &&
      (*(int *)(param_2 + 0x1c) == (int)param_3)) &&
     (param_8 = (ulonglong)*(uint *)(param_2 + 0x14),
     *(int *)(param_2 + 0x18) * *(uint *)(param_2 + 0x14) == (int)param_4)) {
    return param_2;
  }
