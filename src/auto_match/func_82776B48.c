...
extern int fn_827753A8();


void fn_82776B48(int *param_1,undefined8 param_2,int *param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if ((uint)(*piVar1 * 5) <= (uint)((piVar1[1] + 1) * 4)) goto LAB_82776ba4;
    lVar5 = ((ulonglong)(uint)piVar1[1] + 1 & 0x7fffffff) << 1;
  }
  fn_827753A8(param_1,param_2,lVar5);
LAB_82776ba4:
  piVar1 = (int *)*param_1;
  ...
  *piVar1 = *piVar1 + 1;
  ...
  if (uVar3 == 0xfffffffe) {
    ...
    *(undefined4 *)(iVar11 + 0x18) = *(undefined4 *)param_3[1];
  }
  else {
    do {
