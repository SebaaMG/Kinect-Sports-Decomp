...
undefined8 fn_82FBC498(int param_1,undefined4 *param_2)

{
  ...
  *(undefined4 *)(param_1 + 0x10) = param_2[3];
  dVar1 = (double)fn_82F655D8(lbl_82015618,(double)((float)param_2[4] * lbl_82005718));
  *(float *)(param_1 + 0x14) = (float)dVar1;
