...
void fn_82672C20(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (iVar2 == lbl_831E7B44) {
    ...
    fn_82689CD8(*(undefined4 *)(param_1 + 0x10),param_2,param_3,param_4);
    ...
    if (lVar1 != 0) {
      ...
      uVar3 = fn_826720D8(lVar1,&uStack_50,param_2,param_3,param_4);
      if (iStack_4c != 0) {
        fn_822315A0();
      }
    }
