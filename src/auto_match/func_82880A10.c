...
undefined4 * fn_82880A10(undefined4 *param_1,uint param_2,int param_3,ulonglong param_4)

{
  ...
  if ((uVar8 & 0xff) != 0) {
    if (puVar4 == (undefined4 *)**(undefined4 **)(param_2 + 4)) {
      puVar4 = (undefined4 *)fn_828DF458(apuStack_50,param_2,1,puVar4,param_3);
      uVar2 = *puVar4;
      *(undefined1 *)(param_1 + 1) = 1;
      *param_1 = uVar2;
      return param_1;
    }
    fn_8288A4B0(apuStack_50,uVar5,param_3,param_4);
  }
  puVar1 = apuStack_50[0];
  if ((uint)apuStack_50[0][3] < *(uint *)(param_3 + 0xc)) {
    puVar4 = (undefined4 *)fn_828DF458(apuStack_50,param_2,uVar8,puVar4,param_3);
    uVar2 = *puVar4;
    *(undefined1 *)(param_1 + 1) = 1;
    *param_1 = uVar2;
  }
