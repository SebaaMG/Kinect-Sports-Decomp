...
void fn_82859E40(int param_1,int param_2,int param_3)

{
  ...
  *(int *)(param_2 + 4) = param_3;
  ...
  if (cVar1 == cVar2) {
    ...
    iVar3 = fn_828177C8(*(undefined4 *)(param_1 + 0x20),0xffffffff8201f7f0);
    iVar4 = fn_828177C8(*(undefined4 *)(param_1 + 0x24),0xffffffff8201f7f8);
