...
void fn_82D583D0(undefined8 param_1,int *param_2,undefined4 *param_3,int *param_4,int param_5)

{
  ...
  fn_82CE6820(auStack_4b0,param_3[2],param_2[2]);
  (**(code **)(*(int *)*param_2 + 0x1c))((double)(float)param_4[2],(int *)*param_2,auStack_4b0);
  ...
  for (; puVar6 != puVar5; puVar6 = puVar6 + 1) {
    pcVar4 = (char *)(**(code **)(*(int *)(param_4[3] + 0xc) + 4))
                               (auStack_4f0,param_4[3] + 0xc,param_4,param_2,param_3,piVar3,*puVar6)
    ;
    if (*pcVar4 != '\0') {
      iStack_4e0 = (**(code **)(*piVar3 + 0x14))(piVar3,*puVar6,auStack_260);
      uStack_4dc = *puVar6;
      (**(code **)((uint)*(byte *)((iVar2 + 0xd) * 0x20 + *(int *)(iStack_4e0 + 0xc) + *param_4) *
                   0x14 + *param_4 + 0x9a4))(param_2,&iStack_4e0,param_4,param_5);
