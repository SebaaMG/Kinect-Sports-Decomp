...
void fn_82512E18(uint *param_1,undefined4 *param_2)

{
  ...
  if (bVar3) {
    uVar2 = *param_1;
    if (puVar8 == puVar6) {
      uVar1 = (int)((int)puVar8 - uVar2) / 0xc;
      if (0x15555554 < uVar1) {
                    /* WARNING: Subroutine does not return */
        fn_82F622A8(0xffffffff82196fd4);
      }
      uVar5 = (longlong)(int)uVar1 + 1;
      uVar1 = (int)((int)puVar6 - uVar2) / 0xc;
      if ((ulonglong)uVar1 < (uVar5 & 0xffffffff)) {
        ...
        fn_82512FD8(param_1,uVar4);
      }
    }
    puVar8 = (undefined4 *)param_1[1];
    puVar6 = (undefined4 *)(((int)((int)param_2 - uVar2) / 0xc) * 0xc + *param_1);
    if (puVar8 == (undefined4 *)0x0) goto LAB_82512fb0;
    *puVar8 = *puVar6;
    puVar8[1] = puVar6[1];
    uVar7 = puVar6[2];
  }
    ...
    if (puVar8 == puVar6) {
      uVar2 = (int)((int)puVar8 - *param_1) / 0xc;
      if (0x15555554 < uVar2) {
                    /* WARNING: Subroutine does not return */
        fn_82F622A8(0xffffffff82196fd4);
      }
      uVar5 = (longlong)(int)uVar2 + 1;
      uVar2 = (int)((int)puVar6 - *param_1) / 0xc;
      if ((ulonglong)uVar2 < (uVar5 & 0xffffffff)) {
        uVar4 = 0;
        if ((ulonglong)uVar2 <= (0x15555555 - (ulonglong)(uVar2 >> 1) & 0xffffffff)) {
