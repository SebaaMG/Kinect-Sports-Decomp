...
void fn_824B7EB0(undefined8 param_1,uint param_2,uint param_3,uint param_4,uint param_5,
                  uint param_6)

{
  ...
  *(uint *)(iVar1 + 0x28) = param_2;
  *(uint *)(iVar1 + 0x20) = param_5;
  *(uint *)(iVar1 + 0x24) = param_6;
