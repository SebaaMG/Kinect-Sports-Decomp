...
void fn_826DC2D8(int *param_1,undefined8 param_2,int param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if ((uint)(*piVar1 * 5) <= (uint)((piVar1[1] + 1) * 4)) goto LAB_826dc334;
...
LAB_826dc334:
  ...
  *piVar1 = *piVar1 + 1;
  ...
  if (*(int *)(iVar5 + 8) == -2) {
    *puVar9 = 0xffffffff;
    fn_8268C750(iVar5 + 0x10,param_3);
    *(undefined1 *)(iVar5 + 0x14) = *(undefined1 *)(param_3 + 4);
  }
  else {
    do {
