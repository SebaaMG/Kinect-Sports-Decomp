...
undefined8 fn_82457D28(undefined8 param_1,int param_2,undefined4 *param_3)

{
  ...
  puVar1 = (undefined4 *)fn_8265C9E0(0x34);
  if (puVar1 != (undefined4 *)0x0) {
    ...
    *(undefined1 *)((int)puVar1 + 0x31) = 0;
    if (puVar1 + 3 != (undefined4 *)0x0) {
      puVar1[3] = *param_3;
      fn_82F68CC0(puVar1 + 4,param_3 + 1,0x20);
    }
    fn_82457DC8(param_1,param_2,puVar1);
    return param_1;
  }
  uStack_2c = 0;
