...
extern int fn_8287F640();


undefined4 * fn_8287F8E8(undefined4 *param_1,int param_2,int *param_3,int param_4)

{
  ...
  if (param_3 == (int *)*piVar2) {
    if (*(uint *)(param_4 + 0x10) < (uint)param_3[4]) {
      fn_8287EFA0(param_1,param_2,1,param_3,param_4);
      return param_1;
    }
  }
  else {
    if (param_3 != piVar2) {
      ...
      fn_8287EFA0(param_1,param_2,0,param_3,param_4);
      return param_1;
    }
    if (*(uint *)(piVar2[2] + 0x10) < *(uint *)(param_4 + 0x10)) {
      fn_8287EFA0(param_1,param_2,0,piVar2[2],param_4);
      return param_1;
    }
  }
LAB_8287fa6c:
