...
undefined8 fn_828D1E28(undefined8 param_1,int param_2)

{
  ...
  *(undefined ***)(auStack_dc + *(int *)(puStack_e0 + 4) + -4) = &lbl_82021284;
  ...
  uVar6 = fn_82240158(&puStack_e0,0xffffffff82026850);
  uVar6 = fn_82237920(uVar6,uVar7);
  uVar6 = fn_82240158(uVar6,0xffffffff82026834);
  uVar6 = fn_82520AC8(uVar6,uVar5);
  uVar6 = fn_82240158(uVar6,0xffffffff8202681c);
  uVar6 = fn_82520AC8(uVar6,uVar4);
  uVar6 = fn_82240158(uVar6,0xffffffff82026804);
  uVar6 = fn_82520AC8(uVar6,uVar3);
  uVar6 = fn_82240158(uVar6,0xffffffff820267ec);
  uVar6 = fn_82520AC8(uVar6,uVar2);
  uVar6 = fn_82240158(uVar6,0xffffffff820267d0);
  uVar6 = fn_828BB1F0(uVar6,uVar1);
  uVar1 = *(undefined1 *)(param_2 + 0xc5);
  uVar6 = fn_82240158(uVar6,0xffffffff820267b4);
  uVar6 = fn_828BB1F0(uVar6,uVar1);
  uVar6 = fn_82240158(uVar6,0xffffffff820267a8);
  uVar6 = fn_8223B728(uVar6,param_2 + 0xa8);
