...
void fn_82CF6738(int param_1,undefined8 param_2)

{
  ...
  auStack_100[0] = *(undefined4 *)(param_1 + 0x20);
  uStack_ec = *(undefined4 *)(param_1 + 0x24);
  uStack_d8 = *(undefined4 *)(param_1 + 0x28);
  puVar1 = (undefined4 *)((uint)(auStack_60 + in_r0) & 0xfffffff0);
  uVar3 = *puVar1;
  uVar4 = puVar1[1];
  uVar5 = puVar1[2];
  uVar6 = puVar1[3];
  puVar1 = (undefined4 *)((int)auStack_100 + in_r0 & 0xfffffff0);
  *puVar1 = uVar3;
  puVar1[1] = uVar4;
  puVar1[2] = uVar5;
  puVar1[3] = uVar6;
  ...
  *puVar1 = uVar3;
  ...
  puVar1[2] = uVar5;
  puVar1[3] = uVar6;
  fn_82CEC6E0(auStack_d0,auStack_50,auStack_100);
  ...
  *puVar1 = uVar3;
  ...
  puVar1[2] = uVar5;
  puVar1[3] = uVar6;
  fn_82CE6528(auStack_a0,param_2);
  return;
}
