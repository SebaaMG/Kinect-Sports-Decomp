...
undefined4 * fn_826749B8(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar7 + 0x2d) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x2d) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar1 = *(undefined1 *)(piStack00000024 + 0xb);
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x2d) == '\0') {
      piVar5 = (int *)*piVar8;
      piVar6 = piVar8;
      while (piVar2 = piVar5, *(char *)((int)piVar2 + 0x2d) == '\0') {
        piVar6 = piVar2;
        piVar5 = (int *)*piVar2;
      }
    }
        ...
        if (piVar8 == piVar7) {
          ...
          if (*(char *)((int)piVar7 + 0x2d) == '\0') {
            if ((*(char *)(*piVar7 + 0x2c) != '\x01') || (*(char *)(piVar7[2] + 0x2c) != '\x01')) {
              ...
              *(undefined1 *)(piVar7 + 0xb) = *(undefined1 *)(piVar6 + 0xb);
