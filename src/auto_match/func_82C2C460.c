...
extern int fn_82C40E58();


undefined8
fn_82C2C460(int param_1,undefined8 param_2,ushort *param_3,undefined4 *param_4,ulonglong param_5,
...

{
  ...
  trapWord(6,(ulonglong)*(uint *)(param_1 + 0x58),0);
  uVar15 = 0;
  uVar16 = ((param_5 & 0xffffffff) / (ulonglong)*(uint *)(param_1 + 0x58)) /
           (ulonglong)*(ushort *)(param_1 + 0x22);
  trapWord(6,(ulonglong)*(ushort *)(param_1 + 0x22),0);
  ...
  if (*(int *)(param_1 + 0xb0) == 0) {
    ...
    uVar15 = fn_82C40E58(param_1,param_4,puVar2,0);
    if ((int)uVar15 < 0) {
      return uVar15;
    }
    *param_3 = *puVar2;
