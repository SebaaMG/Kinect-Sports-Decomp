...
ulonglong fn_827908A8(uint *param_1,undefined8 param_2)
  ...
  if ((ulonglong)param_1[1] == 0) {
    ...
    if (uVar5 != 0) {
      do {
        ...
        iVar3 = fn_8272C128(uVar2 * 0xc + (ulonglong)*param_1,param_2);
        if (iVar3 == 0) {
          return uVar2;
        }
        if (iVar3 < 0) {
    ...
    if (((uVar6 != (uVar5 & 0xffffffff)) ||
        (iVar3 = fn_8272C128(uVar6 * 0xc + (ulonglong)*param_1,param_2), iVar3 != 0)) &&
       (uVar6 = uVar4, uVar4 < (uVar5 & 0xffffffff))) {
      uVar1 = *param_1;
      lVar7 = uVar4 * 0xc;
      do {
        iVar3 = fn_8272C128(lVar7 + (ulonglong)uVar1 + 0xc,param_2);
        if (-1 < iVar3) {
          return uVar6;
        }
        uVar6 = uVar6 + 1;
