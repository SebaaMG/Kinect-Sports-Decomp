...
void fn_82CBA370(int param_1,ulonglong param_2,ulonglong param_3,int *param_4,int *param_5)

{
  ...
  iVar4 = *param_4;
  iVar1 = *param_5;
  lVar6 = ((ulonglong)*(uint *)(param_1 + 0x88) & 0x1fffffff) * 8;
  lVar5 = ((ulonglong)*(uint *)(param_1 + 0x8c) & 0x1fffffff) * 8;
  if (iVar4 == 0x4000) {
    *param_4 = 0x4000;
  }
  else {
