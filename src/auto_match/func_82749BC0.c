...
extern int fn_827496F8();
extern int fn_82749748();
...
undefined4 * fn_82749BC0(undefined4 *param_1,int param_2)

{
  ...
  if ((uVar2 & 0xffffffff) == 0) {
    ...
    uVar5 = fn_827496F8(uVar2,&iStack_50);
  }
  *param_1 = uVar5;
  *(undefined1 *)(param_1 + 2) = 0;
  param_1[1] = 0;
  lVar3 = fn_8267B890(*(undefined4 *)(param_2 + 0x288),0x70,0);
  if (lVar3 == 0) {
    uVar6 = 0;
  }
  else {
    uVar4 = fn_826B14D8(param_2,1);
    uVar6 = fn_82749748(lVar3,&iStack_50,uVar4,param_1);
  }
  if (uVar6 != 0) {
  ...
  (**(code **)(iVar1 + 0x28))
            ((ulonglong)*(uint *)(param_2 + 0x28c) + 0x10,&iStack_50,param_2 + 0x48,uVar4,auStack_60
            );
