...
extern int fn_824506C8();
extern int fn_82F622A8();
extern int fn_82F68CC0();


void fn_824504E0(uint *param_1,ulonglong param_2)

{
  ...
  if (bVar4) {
    ...
    if (uVar6 == uVar2) {
      ...
      if ((ulonglong)uVar1 < (uVar6 & 0xffffffff)) {
        ...
        fn_824506C8(param_1,uVar5);
      }
    }
    uVar1 = param_1[1];
    param_2 = (longlong)((int)((int)param_2 - uVar3) / 0x18) * 0x18 + (ulonglong)*param_1;
  }
  else {
    if (uVar6 == uVar2) {
      uVar1 = (int)(uVar1 - *param_1) / 0x18;
      if (0xaaaaaa9 < uVar1) {
                    /* WARNING: Subroutine does not return */
        fn_82F622A8(0xffffffff82196fd4);
      }
      uVar6 = (longlong)(int)uVar1 + 1;
      uVar1 = (int)(uVar2 - *param_1) / 0x18;
      if ((ulonglong)uVar1 < (uVar6 & 0xffffffff)) {
        uVar5 = 0;
        if ((ulonglong)uVar1 <= (0xaaaaaaa - (ulonglong)(uVar1 >> 1) & 0xffffffff)) {
          uVar5 = (ulonglong)(uVar1 >> 1) + (longlong)(int)uVar1;
  ...
  if (uVar1 != 0) {
    fn_82F68CC0(uVar1,param_2,0x18);
  }
