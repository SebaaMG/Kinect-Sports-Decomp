...
void fn_82264148(undefined8 param_1,ulonglong param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (*pcVar2 != '\0') {
    iVar3 = fn_8225FDE0(0x58,param_2 & 0xff);
    if ((iVar3 == 0) && (cVar4 = fn_82E1CAD0(0x58), cVar4 != '\0')) {
      ...
      fn_8225FCE8(0xffffffff821a753c);
      fn_82E1CCA8();
    }
  }
  fn_82F6DCBC();
