...
void fn_8274C458(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  piVar1 = (int *)fn_82695448();
  if (piVar1 != (int *)0x0) {
    (**(code **)(*piVar1 + 4))(piVar1,0x21,param_2,&stack0x00000020);
  }
  return;
}
