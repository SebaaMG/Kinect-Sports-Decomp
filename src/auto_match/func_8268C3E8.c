...
void fn_8268C3E8(uint *param_1,uint *param_2,ulonglong param_3)

{
  ...
  if ((uVar4 & 0xffffffff) == (param_3 & 0xffffffff)) {
    do {
      puVar6 = (uint *)(uVar3 + 4);
      if (in_RESERVE != '\0') {
        uVar1 = storeWordConditionalIndexed((ulonglong)*puVar6 + 1,0,uVar3 + 4);
        *puVar6 = uVar1;
        in_cr0 = 2;
      }
    ...
    lVar5 = fn_8268B368(param_1,param_3,uVar1,*puVar2 & 0x80000000);
    fn_82F68CC0(lVar5 + 8,uVar3 + 8,uVar1);
    puVar2 = (uint *)lVar5;
  }
  *param_1 = (uint)puVar2 | 2;
  return;
}
