...
extern int fn_82E0A208();


void fn_82E0A578(longlong param_1,undefined8 param_2,undefined8 param_3,longlong param_4)

{
  ...
  if (0 < iVar8) {
    do {
      iVar8 = fn_82CEAEA8(param_2,lVar13);
...
LAB_82e0a668:
          ...
          if (*(char *)(iVar8 + 0xd) == '\x1c') {
            while (-1 < lVar3 + -1) {
              ...
              fn_82E0A208(*puVar10,puVar10[1],param_3);
              lVar6 = fn_82CEB1A8(param_2);
              lVar2 = lVar6 + lVar2;
              lVar3 = lVar3 + -1;
            }
          }
            ...
            while (-1 < lVar3 + -1) {
              ...
              fn_82E0A578(*puVar10,uVar4,param_3,uVar1);
              lVar6 = fn_82CEB1A8(param_2);
              lVar2 = lVar6 + lVar2;
              lVar3 = lVar3 + -1;
            }
          ...
          if (uVar12 == 0x19) {
            ...
            while (-1 < lVar3 + -1) {
              ...
              fn_82E0A578(uVar7,uVar5,param_3,uVar4);
              lVar6 = fn_82CEB1A8(param_2);
              lVar2 = lVar6 + lVar2;
              lVar3 = lVar3 + -1;
            }
            ...
            if (uVar12 == 0x1a) goto LAB_82e0a668;
            lVar2 = param_1;
            lVar3 = param_4;
            if (uVar12 == 0x1b) {
              while (-1 < lVar3 + -1) {
                ...
                if ((piVar11[1] != 0) && (*piVar11 != 0)) {
                  fn_82E0A578(piVar11[1],*piVar11,param_3,piVar11[2]);
                }
                lVar6 = fn_82CEB1A8(param_2);
                lVar2 = lVar6 + lVar2;
                lVar3 = lVar3 + -1;
              ...
              while (-1 < lVar3 + -1) {
                ...
                fn_82E0A208(uVar5,uVar4,param_3);
                lVar6 = fn_82CEB1A8(param_2);
                lVar2 = lVar6 + lVar2;
                lVar3 = lVar3 + -1;
              }
