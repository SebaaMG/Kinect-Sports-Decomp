...
void fn_828F7618(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  fn_828F7008(*(undefined4 *)(param_1 + 0xbd8),param_2,&stack0x00000020);
  return;
}
