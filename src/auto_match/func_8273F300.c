...
extern int fn_8273DA60();
extern int fn_8273E680();
extern int fn_8273F198();


void fn_8273F300(int *param_1,undefined8 param_2,undefined8 param_3,uint param_4)

{
  ...
  if (piVar5 == (int *)0x0) {
    ...
    if ((uint)(*piVar5 * 5) <= (uint)((piVar5[1] + 1) * 4)) goto LAB_8273f35c;
