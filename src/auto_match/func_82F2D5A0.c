...
void fn_82F2D5A0(int param_1,longlong param_2,longlong param_3)

{
  ...
  if (iVar5 < (int)param_3) {
    ...
    puVar10 = (undefined1 *)(uVar9 * 2 * iVar5 + *(int *)(param_1 + 0x84) + -2);
    do {
      uVar9 = 0;
      if (0 < iVar1) {
        ...
        do {
          ...
          uVar8 = uVar9 + uVar6;
          uVar3 = uVar8 & 0xff;
          puVar10[3] = (char)((int)((uint)*(byte *)(iVar7 + 1 + uVar12) * (0x80 - (uVar9 & 0x7f)) +
                                   (uint)*(byte *)(iVar7 + 3 + uVar12) * (uVar9 & 0x7f)) >> 7);
          uVar12 = (int)uVar8 >> 6 & 0xfffffffe;
          uVar4 = (int)uVar8 >> 6 & 0xfffffffc;
          uVar9 = uVar8 + uVar6;
          puVar10[5] = (char)((int)((uint)*(byte *)(iVar7 + 1 + uVar12) * (0x80 - (uVar8 & 0x7f)) +
                                   (uint)*(byte *)(iVar7 + 3 + uVar12) * (uVar8 & 0x7f)) >> 7);
          puVar10[2] = (char)(*(byte *)(iVar7 + 4 + uVar4) * uVar3 +
                              (uint)*(byte *)(uVar4 + iVar7) * (0x100 - uVar3) >> 8);
          puVar10[4] = (char)(*(byte *)(iVar7 + 6 + uVar4) * uVar3 +
                              (uint)*(byte *)(iVar7 + 2 + uVar4) * (0x100 - uVar3) >> 8);
          puVar10 = puVar10 + 4;
          lVar13 = lVar13 + -1;
        } while (lVar13 != 0);
      }
      if (iVar1 < (int)lVar11) {
        ...
        do {
          ...
          puVar10[3] = *(undefined1 *)((uVar12 & 0xfffffffe) + iVar7 + 1);
          puVar10[5] = *(undefined1 *)((uVar3 & 0xfffffffe) + iVar7 + 1);
          puVar10[2] = *(undefined1 *)(uVar4 + iVar7);
          puVar10 = puVar10 + 4;
          *puVar10 = *(undefined1 *)(iVar7 + 2 + uVar4);
          lVar13 = lVar13 + -1;
        } while (lVar13 != 0);
      }
      param_3 = param_3 + -1;
