...
void fn_8233D980(int *param_1,undefined4 *param_2)

{
  ...
  fn_8233EB88(auStack_60,param_2,*param_2,param_2[1]);
  lVar1 = 4;
  do {
    auStack_60[0] = fn_8223C610(auStack_40,0x20,0,0);
    fn_8233E620(param_2,auStack_60);
    lVar1 = lVar1 + -1;
  } while (lVar1 != 0);
  if (iStack_28 != 0) {
    fn_8265CA20();
