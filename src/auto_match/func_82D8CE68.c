...
void fn_82D8CE68(int param_1,int param_2,undefined8 param_3)

{
  ...
  uStack_50 = *(undefined4 *)(param_2 + 0x24);
  if ((*(char *)(param_2 + 0x20) == '\0') ||
     (iStack_4c = *(int *)(*(int *)(param_1 + 8) + 0x7c), iStack_4c == 0)) {
    iStack_4c = 0;
  }
  else {
  ...
  while (uVar5 = uVar5 - 1, -1 < (longlong)uVar5) {
    ...
    if (piVar1 != (int *)0x0) {
      ...
      *puVar3 = in_register_00010150;
      ...
      puVar3[3] = in_vr21;
      (**(code **)(*piVar1 + 0x24))(piVar1,auStack_70,*puVar6,param_3);
    }
    puVar6 = puVar6 + 1;
  }
  iVar4 = KeTlsGetValue(lbl_8323B4A0);
