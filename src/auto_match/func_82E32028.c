...
/* WARNING: Removing unreachable block (ram,0x82e31c60) */

ulonglong fn_82E32028(undefined4 *param_1)
    ...
    *param_1 = 0;
    ...
    if (piVar2 == (int *)0x0) {
      uVar3 = 0xffffffff8007000e;
            ...
            (uVar3 = (**(code **)*piVar2)(piVar2,0xffffffff8215465c,param_1), (longlong)uVar3 < 0))
    {
