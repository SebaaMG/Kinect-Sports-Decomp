...
undefined8
fn_827DB588(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
             undefined8 param_5)

{
  ...
  lVar1 = fn_827E5540(0x3c);
  if (lVar1 == 0) {
    uVar2 = 0;
  }
  else {
    fn_82517978(auStack_50,uStack_58,iStack_54,0);
    uVar2 = fn_827E57C8(lVar1,param_2,param_3,param_4,auStack_50,0,param_1);
  }
