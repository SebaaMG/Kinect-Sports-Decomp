...
void fn_827CB098(int param_1,undefined8 param_2,int *param_3,undefined8 param_4,int param_5,
...

{
  ...
  if (*(char *)(iVar1 + 0x24) == '\0') {
    ...
    fn_827C1AF8(iVar1 + 0x20,0,*param_6 * 4 + param_5,0,1,*(undefined4 *)(iVar1 + 0x28));
    uVar4 = 1;
