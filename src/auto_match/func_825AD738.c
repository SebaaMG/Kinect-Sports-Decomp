...
undefined4 * fn_825AD738(undefined4 *param_1,int param_2,ulonglong param_3,uint *param_4)

{
  ...
  if (((param_3 & 0xffffffff) == (ulonglong)*puVar2) && (param_4 == puVar2)) {
    cVar1 = *(char *)((int)puVar2[1] + 0x19);
    puVar2 = (uint *)puVar2[1];
    while (cVar1 == '\0') {
      fn_825AD990(param_2,puVar2[2]);
      puVar3 = (uint *)*puVar2;
      fn_828B55B0(puVar2 + 3);
      fn_8265CA20(puVar2);
      puVar2 = puVar3;
      cVar1 = *(char *)((int)puVar3 + 0x19);
    }
    ...
    *param_1 = **(undefined4 **)(param_2 + 4);
    ...
    while ((param_3 & 0xffffffff) != ZEXT48(param_4)) {
      ...
      fn_825ACF50(auStack_30,param_2,param_3);
