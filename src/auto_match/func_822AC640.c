...
undefined4 *
fn_822AC640(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)
  ...
  *(uint *)(param_2 + 8) = *(uint *)(param_2 + 8) + 1;
  ...
  if (param_4 == *(undefined4 **)(param_2 + 4)) {
    ...
    **(undefined4 **)(param_2 + 4) = param_5;
    ...
    param_4[2] = param_5;
    iVar2 = *(int *)(param_2 + 4);
    if (param_4 != *(undefined4 **)(iVar2 + 8)) goto LAB_822ac6e8;
  }
  *(int **)(iVar2 + 8) = param_5;
LAB_822ac6e8:
  cVar1 = *(char *)(param_5[1] + 0x14);
  piVar5 = param_5;
  do {
    if (cVar1 != '\0') {
      iVar2 = *(int *)(param_2 + 4);
      *param_1 = param_5;
      *(undefined1 *)(*(int *)(iVar2 + 4) + 0x14) = 1;
      return param_1;
    }
    piVar3 = (int *)piVar5[1];
    piVar4 = (int *)piVar3[1];
...
LAB_822ac778:
        ...
        *(undefined1 *)(piVar5[1] + 0x14) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x14) = 0;
        fn_828255F0(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar2 = *piVar4;
      if (*(char *)(iVar2 + 0x14) == '\0') goto LAB_822ac778;
      ...
      *(undefined1 *)(piVar5[1] + 0x14) = 1;
      *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x14) = 0;
      fn_8243CDF8(param_2,*(undefined4 *)(piVar5[1] + 4));
    }
