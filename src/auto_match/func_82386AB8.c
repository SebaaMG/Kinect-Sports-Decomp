...
extern int fn_824A30C8();
extern int fn_8265CA20();
extern int fn_82F622E0();
extern unsigned int stack0x00000024;


undefined4 * fn_82386AB8(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar9 + 0x31) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x31) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar2 = *(undefined1 *)(piStack00000024 + 0xc);
      *(undefined1 *)(piStack00000024 + 0xc) = *(undefined1 *)(param_3 + 0xc);
      *(undefined1 *)(param_3 + 0xc) = uVar2;
      goto LAB_82386ca0;
    }
  }
  else {
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x31) == '\0') {
      piVar6 = (int *)*piVar8;
      piVar7 = piVar8;
      while (piVar3 = piVar6, *(char *)((int)piVar3 + 0x31) == '\0') {
        piVar7 = piVar3;
        piVar6 = (int *)*piVar3;
      }
    }
...
LAB_82386ca0:
  if (*(char *)(param_3 + 0xc) == '\x01') {
    if (piVar8 != *(int **)(*(int *)(param_2 + 4) + 4)) {
      do {
        if (*(char *)(piVar8 + 0xc) != '\x01') break;
        piVar7 = (int *)*piVar9;
        if (piVar8 == piVar7) {
          piVar7 = (int *)piVar9[2];
          if (*(char *)(piVar7 + 0xc) == '\0') {
            *(undefined1 *)(piVar7 + 0xc) = 1;
            *(undefined1 *)(piVar9 + 0xc) = 0;
            fn_822CA028(param_2,piVar9);
            piVar7 = (int *)piVar9[2];
          }
          if (*(char *)((int)piVar7 + 0x31) == '\0') {
            if ((*(char *)(*piVar7 + 0x30) != '\x01') || (*(char *)(piVar7[2] + 0x30) != '\x01')) {
              if (*(char *)(piVar7[2] + 0x30) == '\x01') {
                *(undefined1 *)(*piVar7 + 0x30) = 1;
                *(undefined1 *)(piVar7 + 0xc) = 0;
                fn_822CA090(param_2,piVar7);
                piVar7 = (int *)piVar9[2];
              }
              *(undefined1 *)(piVar7 + 0xc) = *(undefined1 *)(piVar9 + 0xc);
              *(undefined1 *)(piVar9 + 0xc) = 1;
              *(undefined1 *)(piVar7[2] + 0x30) = 1;
              fn_822CA028(param_2,piVar9);
              break;
            }
LAB_82386dcc:
          ...
          if (*(char *)(piVar7 + 0xc) == '\0') {
            *(undefined1 *)(piVar7 + 0xc) = 1;
            *(undefined1 *)(piVar9 + 0xc) = 0;
            fn_822CA090(param_2,piVar9);
            piVar7 = (int *)*piVar9;
          }
          if (*(char *)((int)piVar7 + 0x31) == '\0') {
            if ((*(char *)(piVar7[2] + 0x30) == '\x01') && (*(char *)(*piVar7 + 0x30) == '\x01'))
            goto LAB_82386dcc;
            if (*(char *)(*piVar7 + 0x30) == '\x01') {
              *(undefined1 *)(piVar7[2] + 0x30) = 1;
              *(undefined1 *)(piVar7 + 0xc) = 0;
              fn_822CA028(param_2,piVar7);
              piVar7 = (int *)*piVar9;
            }
            *(undefined1 *)(piVar7 + 0xc) = *(undefined1 *)(piVar9 + 0xc);
            *(undefined1 *)(piVar9 + 0xc) = 1;
