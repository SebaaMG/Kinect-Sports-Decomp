...
void fn_830045F8(double param_1,int *param_2,int param_3,undefined8 param_4,ulonglong param_5,
...

{
  ...
  if (param_3 != 0) {
    if (*(int *)(param_3 + 0x10) != 0) {
      ...
      fn_82FF5400(lbl_832642F4,*(int *)(param_3 + 0x10),0x10000,param_5,param_7,param_6,
                        param_5);
    }
    if (*(int *)(param_3 + 0x10) == 0) {
      fStack_58 = *(float *)(param_3 + 0x28);
      ...
      if ((param_5 & 0xffffffff) == 0) {
        ...
        dVar2 = -(double)(float)((double)(longlong)*(short *)(param_2 + 0xb) * (double)lbl_82186E6C
                                - param_1);
      ...
      if ((dVar3 == dVar2) || (iStack_50 = (int)param_7, iStack_50 == 0)) {
        *(float *)(param_3 + 0x28) = (float)dVar2;
        (**(code **)(*param_2 + 0x3c))((double)(float)(dVar2 - dVar3),param_2,0);
      }
      else {
        uStack_4c = (undefined4)param_6;
        aiStack_60[0] = param_3 + 4;
        aiStack_60[1] = 0x10000;
        uStack_48 = 1;
