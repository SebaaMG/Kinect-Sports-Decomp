...
undefined8 fn_828BD150(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4)

{
  ...
  *(undefined ***)(auStack_bc + *(int *)(puStack_c0 + 4) + -4) = &lbl_82021284;
  ...
  dVar2 = (double)*(float *)(param_4 + 8);
  fn_82240158(&puStack_c0,0xffffffff82025540);
  uVar1 = fn_82237A48(dVar2);
