...
undefined4 * fn_822C7BF0(undefined4 *param_1,int param_2,int param_3)
...
LAB_822c7c98:
  puVar1 = (undefined4 *)fn_822C7D48(apuStack_50,param_2,uVar4,puVar1,param_3);
