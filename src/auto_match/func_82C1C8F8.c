...
extern int fn_82C180B8();
extern int fn_82C18288();
extern int fn_82C18678();
extern int fn_82C18CC8();


undefined8 fn_82C1C8F8(int *param_1,ushort *param_2,undefined8 param_3,undefined8 param_4)
  ...
  if ((param_1 == (int *)0x0) || (param_2 == (ushort *)0x0)) {
    ...
    if (param_1[0x58] == 1) {
      if ((param_1[0x69] == 0) || (param_1[0x6a] == 1)) {
        ...
        if ((int)uVar1 < 0) goto LAB_82c1ca78;
      }
      if ((param_1[0x69] == 1) &&
         (uVar1 = fn_82A53C10(param_1,param_3,auStack_40,param_3), uVar2 = auStack_40[0],
         (int)uVar1 < 0)) goto LAB_82c1ca78;
    }
    if ((((param_1[0x4f] == 0) ||
         ((uVar2 == 0 ||
          (uVar1 = fn_82C180B8(param_1,param_3,auStack_40,param_4), uVar2 = auStack_40[0],
          -1 < (int)uVar1)))) &&
        ((param_1[0x51] == 0 ||
         ((uVar2 == 0 ||
          (uVar1 = fn_82C18288(param_1,param_3,auStack_40,param_4), uVar2 = auStack_40[0],
