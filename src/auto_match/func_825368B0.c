...
extern int fn_822CA028();
extern int fn_822CA090();
extern int fn_8265CA20();
extern int fn_82F622E0();


undefined4 * fn_825368B0(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar7 + 0x31) == '\0') {
    piVar8 = (int *)*piVar7;
    while (piVar5 = piVar8, *(char *)((int)piVar5 + 0x31) == '\0') {
      piVar7 = piVar5;
      piVar8 = (int *)*piVar5;
    }
  }
    ...
    piVar5 = param_3;
    while ((piVar7 = piVar8, *(char *)((int)piVar7 + 0x31) == '\0' && (piVar5 == (int *)piVar7[2])))
    {
      piVar5 = piVar7;
      piVar8 = (int *)piVar7[1];
    }
  ...
  if (*(char *)((int)piVar8 + 0x31) == '\0') {
    piVar5 = piVar8;
    if ((*(char *)(*piVar6 + 0x31) == '\0') && (piVar5 = (int *)piVar7[2], piVar7 != param_3)) {
      piVar8[1] = (int)piVar7;
      *piVar7 = *param_3;
      piVar8 = piVar7;
      ...
      piVar7[1] = param_3[1];
      uVar1 = *(undefined1 *)(piVar7 + 0xc);
      *(undefined1 *)(piVar7 + 0xc) = *(undefined1 *)(param_3 + 0xc);
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar5 + 0x31) == '\0') {
      piVar4 = (int *)*piVar5;
      piVar6 = piVar5;
      while (piVar2 = piVar4, *(char *)((int)piVar2 + 0x31) == '\0') {
        piVar6 = piVar2;
        piVar4 = (int *)*piVar2;
      }
    }
        ...
        if (piVar5 == piVar8) {
          ...
          if (*(char *)(piVar8 + 0xc) == '\0') {
            ...
            *(undefined1 *)(piVar6 + 0xc) = 0;
            fn_822CA028(param_2,piVar6);
            piVar8 = (int *)piVar6[2];
          }
          if (*(char *)((int)piVar8 + 0x31) == '\0') {
            if ((*(char *)(*piVar8 + 0x30) != '\x01') || (*(char *)(piVar8[2] + 0x30) != '\x01')) {
              if (*(char *)(piVar8[2] + 0x30) == '\x01') {
                *(undefined1 *)(*piVar8 + 0x30) = 1;
                *(undefined1 *)(piVar8 + 0xc) = 0;
                fn_822CA090(param_2,piVar8);
                piVar8 = (int *)piVar6[2];
              }
              *(undefined1 *)(piVar8 + 0xc) = *(undefined1 *)(piVar6 + 0xc);
              *(undefined1 *)(piVar6 + 0xc) = 1;
              *(undefined1 *)(piVar8[2] + 0x30) = 1;
              fn_822CA028(param_2,piVar6);
              break;
            }
LAB_82536c14:
          ...
          if (*(char *)(piVar8 + 0xc) == '\0') {
            *(undefined1 *)(piVar8 + 0xc) = 1;
            *(undefined1 *)(piVar6 + 0xc) = 0;
            fn_822CA090(param_2,piVar6);
            piVar8 = (int *)*piVar6;
          }
          if (*(char *)((int)piVar8 + 0x31) == '\0') {
            if ((*(char *)(piVar8[2] + 0x30) == '\x01') && (*(char *)(*piVar8 + 0x30) == '\x01'))
            goto LAB_82536c14;
            if (*(char *)(*piVar8 + 0x30) == '\x01') {
              *(undefined1 *)(piVar8[2] + 0x30) = 1;
              *(undefined1 *)(piVar8 + 0xc) = 0;
              fn_822CA028(param_2,piVar8);
              piVar8 = (int *)*piVar6;
            }
            *(undefined1 *)(piVar8 + 0xc) = *(undefined1 *)(piVar6 + 0xc);
            *(undefined1 *)(piVar6 + 0xc) = 1;
