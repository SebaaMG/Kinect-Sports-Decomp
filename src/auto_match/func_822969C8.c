...
extern int fn_82296B18();
extern int fn_82F62680();
extern int fn_82F626D0();
extern int fn_82F62988();
extern int fn_82F64188();
extern unsigned int lbl_832975D8;
extern unsigned int uStack_30;


ulonglong fn_822969C8(undefined8 param_1)

{
  ...
  uVar1 = lbl_832975D8;
  uVar5 = (ulonglong)lbl_832975D8;
  uStack_30 = lbl_832975D8;
  uVar2 = fn_8223EEC8(0xffffffff8329eb10);
  uVar3 = fn_8223EF38(param_1,uVar2);
  uVar6 = uVar3;
  if ((uVar3 == 0) && (uVar6 = uVar5, uVar1 == 0)) {
    iVar4 = fn_82296B18(&uStack_30,param_1);
    if (iVar4 == -1) {
      fn_82F64188();
      uVar6 = uVar3;
    }
    else {
      lbl_832975D8 = uStack_30;
