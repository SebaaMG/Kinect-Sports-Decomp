...
extern unsigned int lbl_8214110C;
extern unsigned int lbl_8323B4A0;
extern unsigned int uStack_3c;
extern unsigned int uStack_40;


void fn_82D81CC8(int param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (puVar1 < *(undefined4 **)(iVar3 + 0xc)) {
    *puVar1 = "TtworldCastRayCollector";
    uVar2 = TBLr;
    puVar1[1] = (int)uVar2;
  ...
  uStack_40 = 0;
  appuStack_80[0] = &lbl_8214110C;
  uStack_3c = 0;
  fn_83088020(appuStack_80,*(undefined4 *)(param_1 + 0x58),param_2,
                    *(undefined4 *)(param_1 + 0x7c),0,param_3);
  appuStack_80[0] = &lbl_82141100;
LAB_82d81da8:
  iVar3 = KeTlsGetValue(lbl_8323B4A0);
  puVar1 = *(undefined4 **)(iVar3 + 4);
  if (puVar1 < *(undefined4 **)(iVar3 + 0xc)) {
