...
void fn_82A86D58(longlong param_1,undefined1 *param_2,ulonglong param_3)

{
  ...
  if ((param_3 & 0xffffffff) < 0x201) {
    if ((param_3 & 0xffffffff) < 0x200) {
      if (-1 < (int)-param_3 + 0x1ff) {
        lVar3 = param_3 + param_1 + -1;
        for (lVar4 = -param_3 + 0x200; lVar4 != 0; lVar4 = lVar4 + -1) {
          lVar3 = lVar3 + 1;
          *(undefined1 *)lVar3 = 0;
        }
      }
