...
extern int fn_8258E838();
extern int fn_8258ED40();
extern int fn_8265CA20();
extern unsigned int stack0x00000024;
extern unsigned int uStack00000024;


undefined4 * fn_8258E6D8(undefined4 *param_1,int param_2,ulonglong param_3,uint *param_4)

{
  ...
  if (((param_3 & 0xffffffff) == (ulonglong)*puVar2) && (param_4 == puVar2)) {
    cVar1 = *(char *)((int)puVar2[1] + 0x39);
    puVar2 = (uint *)puVar2[1];
    while (cVar1 == '\0') {
      fn_8258ED40(param_2,puVar2[2]);
      puVar3 = (uint *)*puVar2;
      fn_82230300(puVar2 + 3,1,0);
      fn_8265CA20(puVar2);
      puVar2 = puVar3;
    ...
    *param_1 = **(undefined4 **)(param_2 + 4);
    ...
    while ((param_3 & 0xffffffff) != ZEXT48(param_4)) {
      ...
      fn_8258E838(auStack_30,param_2,param_3);
