...
extern unsigned int lbl_83187D24;


undefined8 fn_82E2DC30(undefined4 *param_1,ulonglong param_2,undefined4 param_3)

{
  ...
  for (puVar3 = param_1;
    ...
    if ((param_2 & 0xffffffff) < (ulonglong)(puVar3[1] + 0x14)) goto LAB_82e2dcd4;
    puVar2 = puVar3;
  }
...
LAB_82e2dcd4:
      ...
      *(byte *)((int)apuStack_30[0] + iVar1 + 0x10) =
           (&lbl_83187D24)[(uint)param_2 & 7] | *(byte *)((int)apuStack_30[0] + iVar1 + 0x10);
