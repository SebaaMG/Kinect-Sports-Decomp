...
extern int fn_82715610();
extern int fn_82716DB8();
...
undefined4 * fn_82719D18(undefined4 *param_1,int param_2)

{
  ...
  if ((uVar3 & 0xffffffff) == 0) {
    ...
    uVar6 = fn_82715610(uVar3,&iStack_50);
  }
  *param_1 = uVar6;
  *(undefined1 *)(param_1 + 2) = 0;
  param_1[1] = 0;
  lVar4 = fn_8267B890(*(undefined4 *)(param_2 + 0x288),0x54,0);
  if (lVar4 == 0) {
    uVar7 = 0;
  }
  else {
    uVar5 = fn_826B14D8(param_2,1);
    uVar7 = fn_82716DB8(lVar4,&iStack_50,uVar5,param_1);
  }
  if (uVar7 != 0) {
  ...
  (**(code **)(iVar2 + 0x28))(iVar1 + 0x10,&iStack_50,param_2 + 0x2c,uVar5,auStack_60);
