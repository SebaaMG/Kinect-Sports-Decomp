...
ulonglong fn_82EE91C0(int param_1,undefined8 param_2)

{
  ...
  if (*(int *)(param_1 + 0x4c) == 0) {
    iVar1 = fn_8306C5D0(param_2,*(undefined4 *)(param_1 + 0x70),0,
                              *(undefined4 *)(param_1 + 0x6c));
    if ((iVar1 == 0) && (uVar2 = thunk_FUN_82a2b798(), 0 < (int)uVar2)) {
