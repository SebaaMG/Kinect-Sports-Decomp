...
extern int fn_82B63F30();
extern int fn_82F68CC0();


undefined8 fn_82B64678(int *param_1)

{
  ...
  if (((((CONCAT44(uVar10,uVar10) & 0xfffffffffffffeff) == 0) && (*(int *)(iVar7 + 0x18) == 0)) &&
    ...
    if (*(int *)(iVar9 + 0x1c) != 0) {
      ...
      if (pbVar8 != pbVar6) {
        ...
        if ((int)((ulonglong)bVar1 - (ulonglong)bVar2) != 0) goto LAB_82b647f8;
      }
    }
