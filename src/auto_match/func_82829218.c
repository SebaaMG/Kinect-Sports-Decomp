...
extern int fn_82828D18();
extern int fn_828290C8();
extern unsigned int stack0x00000024;
extern unsigned int uStack00000024;


undefined4 * fn_82829218(undefined4 *param_1,int param_2,ulonglong param_3,uint *param_4)
  ...
  if (((param_3 & 0xffffffff) == (ulonglong)**(uint **)(param_2 + 4)) &&
    ...
    *param_1 = **(undefined4 **)(param_2 + 4);
    ...
    while ((param_3 & 0xffffffff) != ZEXT48(param_4)) {
      ...
      fn_82828D18(auStack_30,param_2,param_3);
