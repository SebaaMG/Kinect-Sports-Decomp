...
extern int fn_8251E930();
extern int fn_8251ECE0();
extern int fn_825503E0();
extern unsigned int stack0x00000024;
extern unsigned int uStack00000024;


undefined4 * fn_8251E8A8(undefined4 *param_1,int param_2,ulonglong param_3,uint *param_4)
  ...
  if (((param_3 & 0xffffffff) == (ulonglong)**(uint **)(param_2 + 4)) &&
    ...
    *param_1 = **(undefined4 **)(param_2 + 4);
    ...
    while ((param_3 & 0xffffffff) != ZEXT48(param_4)) {
      ...
      fn_8251E930(auStack_30,param_2,param_3);
