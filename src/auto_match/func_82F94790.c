...
extern int fn_82F95428();
extern int fn_82F95C80();
extern int fn_82F95D18();
...
undefined4 fn_82F94790(undefined4 param_1,int param_2,undefined4 param_3)

{
  ...
  cStack_70 = '\x01';
  while (pcVar4 = (char *)fn_82F953A8(uStack_68), *pcVar4 == '\0') {
    uStack_6c = uStack_68;
    uVar1 = fn_82F919C8(uStack_68);
    uVar2 = fn_8265D5A8(uStack00000024);
    cStack_70 = fn_8225E7A0(iStack0000001c,uVar2,uVar1);
    if (cStack_70 == '\0') {
  ...
  if (cStack_70 != '\0') {
    ...
    if (cVar5 != '\0') {
      auStack_40[0] = 1;
      uVar1 = fn_82F95428(auStack_38,iStack0000001c,1,uStack_6c,uStack00000024);
      fn_82F95D48(uStack00000014,uVar1,auStack_40);
      return uStack00000014;
    }
    fn_82F95D18(auStack_60);
  }
  uVar1 = fn_8265D5A8(uStack00000024);
  fn_82F93A00(auStack_60);
  uVar2 = fn_82F919C8();
  cVar5 = fn_8225E7A0(iStack0000001c,uVar2,uVar1);
  if (cVar5 == '\0') {
    auStack_20[0] = 0;
    ...
    auStack_30[0] = 1;
    uVar1 = fn_82F95428(auStack_28,iStack0000001c,cStack_70,uStack_6c,uStack00000024);
