...
undefined8
fn_8223E2E8(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4,
             undefined8 param_5,ulonglong param_6,longlong param_7,longlong param_8)

{
  ...
  fn_8223F508(iVar3);
  piVar11 = (int *)fn_8223F468(uVar5 - 0xe8);
  if (iVar3 != 0) {
  ...
  if (*(char *)ppppcVar14 != '\x7f') {
    ...
    if ('\0' < *(char *)ppppcVar14) {
      ...
      lVar9 = fn_82F64268(uVar8,uVar5 - 0xf0);
      while( true ) {
        cVar2 = *(char *)uVar7;
  ...
  if (uVar4 != 0x40) {
    if ((uVar4 == 0x100) && (lVar15 != 0)) {
      puVar13 = (undefined8 *)fn_8223F670(uVar5 - 0xe8,param_2,param_3,param_6,1);
      param_3 = *puVar13;
      param_6 = param_6 + 1;
      uVar18 = uVar18 - 1;
    }
    puVar13 = (undefined8 *)fn_8223F7A8(uVar5 - 0xe8,param_2,param_3,param_5,lVar9);
    param_3 = *puVar13;
    lVar9 = 0;
  }
  ...
  if ((uVar7 & 0xffffffff) != 0) {
    ...
    puVar13 = (undefined8 *)
              fn_8223F6E0(uVar5 - 0xe8,param_2,param_3,param_6,uVar7 - param_6,uVar6);
    puVar13 = (undefined8 *)fn_8223F7A8(uVar5 - 0xe0,param_2,*puVar13,0x30,param_7);
    uVar16 = *puVar13;
    uVar10 = (**(code **)(*piVar11 + 4))(piVar11);
    puVar13 = (undefined8 *)fn_8223F7A8(uVar5 - 0xe0,param_2,uVar16,uVar10,1);
    puVar13 = (undefined8 *)fn_8223F7A8(uVar5 - 0xe8,param_2,*puVar13,0x30,param_8);
    param_3 = *puVar13;
  ...
  if ((uVar7 & 0xffffffff) != 0) {
    lVar15 = (uVar7 - param_6) + 1;
    puVar13 = (undefined8 *)
              fn_8223F6E0(uVar5 - 0xe0,param_2,param_3,param_6,uVar7 - param_6,uVar6);
    puVar13 = (undefined8 *)fn_8223F7A8(uVar5 - 0xe8,param_2,*puVar13,0x30,uVar17);
    uVar17 = 0;
    ...
    puVar13 = (undefined8 *)fn_8223F670(uVar5 - 0xe0,param_2,*puVar13,uVar10,1);
    param_3 = *puVar13;
    param_6 = lVar15 + param_6;
    uVar18 = uVar18 - lVar15;
  }
  puVar13 = (undefined8 *)fn_8223F6E0(uVar5 - 0xe0,param_2,param_3,param_6,uVar18,uVar6);
  puVar13 = (undefined8 *)fn_8223F7A8(uVar5 - 0xe8,param_2,*puVar13,0x30,uVar17);
  uVar6 = *puVar13;
  *(undefined8 *)(param_4 + 0x20) = 0;
  fn_8223F7A8(param_1,param_2,uVar6,param_5,lVar9);
