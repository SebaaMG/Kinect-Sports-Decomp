...

{
  ...
  if ((iVar5 < 0x14) || (0x13f < iVar5)) {
    ...
    fVar1 = *(float *)(&lbl_8321A360 + (int)((uVar4 & 0xffffffff) << 2)) *
            *(float *)(&lbl_8321A324 + iVar3 * 4);
  }
  return (double)fVar1;
}
