...
extern int fn_8271A438();
extern int fn_8271B858();
...
undefined4 * fn_8271BB30(undefined4 *param_1,int param_2)

{
  ...
  if ((uVar3 & 0xffffffff) == 0) {
    ...
    uVar6 = fn_8271A438(uVar3,&iStack_50);
  }
  *param_1 = uVar6;
  *(undefined1 *)(param_1 + 2) = 0;
  ...
  if (lVar4 == 0) {
    ...
    uVar7 = fn_8271B858(lVar4,&iStack_50,uVar5,param_1);
  }
  if (uVar7 != 0) {
  ...
  (**(code **)(iVar2 + 0x28))(iVar1 + 0x10,&iStack_50,param_2 + 0x7c,uVar5,auStack_60);
