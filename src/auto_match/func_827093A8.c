...
extern int fn_826FEC38();
extern int fn_82704368();
extern int fn_82704B60();
extern int fn_82705A70();


void fn_827093A8(int *param_1,undefined8 param_2,undefined8 param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if ((uint)(*piVar1 * 5) <= (uint)((piVar1[1] + 1) * 4)) goto LAB_82709404;
...
LAB_82709404:
  ...
  *piVar1 = *piVar1 + 1;
  ...
  uVar8 = param_4;
  if (*(int *)(iVar7 + 8) == -2) {
    fn_82704368(puVar9,param_3,0xffffffffffffffff);
  }
  else {
    do {
