...
void fn_82826BF0(int param_1,uint param_2,int param_3,int param_4)

{
  ...
  fn_82F672D8(param_3,(ulonglong)
                       *(uint *)((param_2 & 0xff) * 0x21 + *(int *)(iStack00000014 + 0x114) + -0x21)
                       + (ulonglong)*(uint *)(iStack00000014 + 200),param_4);
