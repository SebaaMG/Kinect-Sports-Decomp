...
int fn_82B1B938(undefined8 param_1,undefined8 param_2,int param_3,int param_4,undefined8 param_5,
                 int param_6)

{
  ...
  iVar2 = fn_82B841E8(param_1,*(undefined4 *)(param_3 + 0x1c),0,0xd,3,4);
