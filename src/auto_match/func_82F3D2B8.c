...
longlong fn_82F3D2B8(int *param_1,int *param_2,uint *param_3,undefined8 param_4,undefined8 param_5
                      ,undefined8 param_6)
  ...
  if (param_1[3] == 0) {
    ...
    *param_3 = 0;
    ...
    if (-1 < (int)lVar10) {
      ...
      uVar11 = (**(code **)(*param_1 + 0x38))(param_1);
      ...
      if (-1 < (int)lVar10) {
        if ((uint)param_1[0x10] < uVar11) {
          *param_3 = (uint)uVar13;
          ...
          lVar10 = (**(code **)(*param_1 + 0x34))(param_1,param_3);
