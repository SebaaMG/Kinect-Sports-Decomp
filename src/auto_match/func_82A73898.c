...
undefined8 fn_82A73898(int *param_1)
  ...
  if (*(int *)(iVar1 + 0x3c) < 3) {
    ...
    *(float *)(iVar6 + 0xc4) = (float)dVar7;
    ...
    if (*(short *)((int)param_1 + 0x96) == -1) {
      aiStack_50[0] = 0;
      uVar5 = fn_82A6D090(param_1 + 0x38,3,aiStack_50);
      if ((int)uVar5 < 0) {
        return uVar5;
      }
      *(undefined2 *)((int)param_1 + 0x96) = 0;
    ...
    if (*(short *)((int)param_1 + 0x96) < *(short *)(iVar1 + 0x244)) {
      ...
      do {
        ...
        aiStack_50[0] = 0;
        uVar5 = fn_82A6D090(piVar4,1,aiStack_50);
        if ((int)uVar5 < 0) {
          return uVar5;
        }
        if (aiStack_50[0] == 0) {
          ...
          *(undefined1 *)(iVar6 + 0xb4) = 1;
          ...
          aiStack_50[0] = 0;
          uVar5 = fn_82A6D090(piVar4,param_1[0x21],aiStack_50);
          if ((int)uVar5 < 0) {
            return uVar5;
          }
        ...
        dVar7 = (double)fn_82A6BAE0(uVar2,0);
        *(float *)(iVar6 + 0xc4) = (float)dVar7;
