...
void fn_826DB220(int *param_1,undefined8 param_2)

{
  ...
  if (uVar3 == 0) {
    ...
    apuStack_50[0] = (undefined4 *)fn_8267B890(lbl_831E7E64,uVar3 * 0xc + 8,&uStack_48);
    *apuStack_50[0] = 0;
    apuStack_50[0][1] = (int)uVar3 + -1;
    if (uVar3 != 0) {
      iVar4 = 0;
      do {
        *(undefined4 *)((int)apuStack_50[0] + iVar4 + 8) = 0xfffffffe;
        uVar3 = uVar3 - 1;
        iVar4 = iVar4 + 0xc;
      } while (uVar3 != 0);
    }
    if (*param_1 != 0) {
      ...
      do {
        iVar5 = iVar4 + *param_1;
        if (*(int *)(iVar5 + 8) != -2) {
          fn_826DACD8(apuStack_50,param_2,iVar5 + 0x10,*(undefined4 *)(*(int *)(iVar5 + 0x10) + 8)
                       );
          if (*(int *)(iVar5 + 0x10) != 0) {
            fn_8267C4F0();
          }
