...
extern unsigned int lbl_82010170;
extern unsigned int lbl_82012FA8;


undefined4 * fn_8271E4E8(undefined4 *param_1,undefined8 param_2)

{
  fn_826C35B8(param_1,param_2,0xffffffff827521e8);
  *param_1 = &lbl_82012FA8;
  param_1[4] = &lbl_82010170;
  fn_82720700(param_2,param_1 + 4);
  fn_826B1688(param_1 + 4,param_2,0xffffffff820100e0,7);
  return param_1;
}
