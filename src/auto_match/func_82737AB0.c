...
extern int fn_82757FA8();


void fn_82737AB0(int param_1)

{
  ...
  if (cVar5 == '\0') {
    ...
    if (((uVar6 & 0xffffffff) != 0) && (2 < *(int *)(param_1 + 0x1c))) {
      uVar1 = *(undefined4 *)(param_1 + 0x18);
      uVar2 = fn_826957D0(param_1,0);
      uVar3 = fn_82697700(uVar2,uVar1);
      uVar1 = *(undefined4 *)(param_1 + 0x18);
      uVar2 = fn_826957D0(param_1,1);
      uVar4 = fn_82697700(uVar2,uVar1);
      uVar1 = *(undefined4 *)(param_1 + 0x18);
      uVar2 = fn_826957D0(param_1,2);
      uVar2 = fn_82695608(uVar2,uVar1);
      if ((uVar4 & 0xffffffff) <= (uVar3 & 0xffffffff)) {
        uVar4 = uVar3 + 1;
      }
      fn_82757FA8(uVar6 + 0x30,uVar3,uVar4,uVar2);
    }
  }
  return;
}
