...
undefined4 * fn_8251B708(undefined4 *param_1,int param_2)

{
  ...
  while (*(char *)((int)puVar3 + 0x35) == '\0') {
    uVar2 = 0xffffffff8329ea40;
    if (0xf < lbl_8329EA54) {
      uVar2 = (ulonglong)lbl_8329EA40;
    }
    iVar1 = fn_8260D428(puVar3 + 3,0,puVar3[7],uVar2,lbl_8329EA50);
    if (iVar1 < 0) {
  ...
  if (puVar5 != *(undefined4 **)(param_2 + 4)) {
    ...
    iVar1 = fn_8260D428(0xffffffff8329ea40,0,lbl_8329EA50,puVar3,puVar5[7]);
    if (-1 < iVar1) {
      ppuVar4 = &puStack_40;
      goto LAB_8251b7d8;
    }
