...
void fn_822A6F38(double param_1,double param_2,int param_3,undefined8 param_4,undefined8 param_5,
...

{
  ...
  uStack_24 = 0;
  uStack_38 = param_7;
  fn_82554860(*(undefined4 *)(param_3 + 0x5c0),0,param_4,&uStack_50);
  return;
}
