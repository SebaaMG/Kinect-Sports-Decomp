...

{
  ...
  if (((*(int *)(iVar5 + 4) == *(int *)(iVar4 + 4)) &&
    ...
    if (-1 < iVar8) {
      ...
      fn_8295D318(param_1,0x58,piVar3,uVar11,auStack_60,piVar2,piVar10,uVar6);
    }
  }
  else {
    fn_8295D318(param_1,0xb,piVar3,uVar11,piVar2,piVar10,0,uVar6);
  }
  return;
}
