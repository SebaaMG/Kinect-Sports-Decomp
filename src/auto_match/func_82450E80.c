...
void fn_82450E80(int param_1,ulonglong param_2,ulonglong param_3,undefined4 *param_4)

{
  ...
  while( true ) {
    ...
    puVar3 = (undefined4 *)((int)((uVar5 & 0xffffffff) << 3) + param_1);
  ...
  while ((uVar6 = (longlong)((int)uVar7 >> 1) + (ulonglong)bVar8, (int)param_2 < iVar1 &&
         (iVar1 = (int)uVar6, puVar4 = (undefined4 *)(iVar1 * 8 + param_1),
         (int)puVar4[1] < (int)param_4[1]))) {
    uVar7 = iVar1 - 1;
