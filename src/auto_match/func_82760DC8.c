...
void fn_82760DC8(int param_1,int *param_2,int *param_3)

{
  ...
  if ((*(byte *)(param_1 + 0x34) & 0x10) != 0) {
    ...
    fn_8268D280(&uStack_94,&fStack_d0,param_1 + 0x14);
  ...
  if ((*(byte *)(param_1 + 0x34) & 0x40) != 0) {
    (**(code **)(*piVar5 + 0x30))(piVar5,&uStack_9c,&uStack_58,&uStack_98,&uStack_54);
  }
  fn_8275EC80(piVar5,&piStack_a0,*(short *)(param_3 + 0x19) != 0,param_3);
  return;
}
