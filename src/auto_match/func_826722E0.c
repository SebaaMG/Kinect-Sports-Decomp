...
void fn_826722E0(uint *param_1,longlong param_2)

{
  ...
  uVar5 = (int)(param_1[1] - *param_1) >> 6;
  if ((0x3ffffffU - param_2 & 0xffffffff) < (ulonglong)uVar5) {
  ...
  uVar5 = (int)(param_1[2] - *param_1) >> 6;
  if ((ulonglong)uVar5 < (uVar3 & 0xffffffff)) {
    uVar2 = 0;
    if ((ulonglong)uVar5 <= (0x3ffffff - (ulonglong)(uVar5 >> 1) & 0xffffffff)) {
      uVar2 = (ulonglong)(uVar5 >> 1) + (longlong)(int)uVar5;
    }
    if ((uVar2 & 0xffffffff) < (uVar3 & 0xffffffff)) {
      uVar2 = uVar3;
    }
    if ((uVar2 & 0xffffffff) < 0x4000000) {
      if ((ulonglong)(uint)((int)(param_1[2] - *param_1) >> 6) < (uVar2 & 0xffffffff)) {
        uVar1 = fn_8266FFF0(uVar2,0);
        uVar5 = param_1[1];
        uVar3 = uVar1;
        for (uVar6 = (ulonglong)*param_1; (uVar6 & 0xffffffff) != (ulonglong)uVar5;
            uVar6 = uVar6 + 0x40) {
          if ((uVar3 & 0xffffffff) != 0) {
            fn_82F68CC0(uVar3,uVar6,0x40);
          }
          uVar3 = uVar3 + 0x40;
        }
        uVar5 = *param_1;
        ...
        if (uVar5 != 0) {
          for (; uVar5 != param_1[1]; uVar5 = uVar5 + 0x40) {
          }
          fn_8265CA20();
        }
        uVar5 = (uint)uVar1;
        *param_1 = uVar5;
        param_1[2] = (int)((uVar2 & 0xffffffff) << 6) + uVar5;
        param_1[1] = (iVar4 >> 6) * 0x40 + uVar5;
      }
      return;
    }
                    /* WARNING: Subroutine does not return */
