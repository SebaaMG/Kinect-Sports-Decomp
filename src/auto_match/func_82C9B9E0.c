...
extern int fn_82C9B320();
extern unsigned int lbl_820FDD3C;
...
void fn_82C9B9E0(int param_1,int param_2)

{
  ...
  iVar11 = *(int *)(param_1 + 0xee4);
  if (*(int *)(param_1 + 0xed0) == 0) {
    iVar9 = 0;
  }
  else {
    iVar9 = *(int *)(param_1 + 0xe0) + *(int *)(param_1 + 0xed0);
  }
  if (*(int *)(param_1 + 0xed4) == 0) {
    iVar13 = 0;
  }
  else {
    iVar13 = *(int *)(param_1 + 0xe0) + *(int *)(param_1 + 0xed4);
  }
  iVar14 = *(int *)(param_1 + 0xef4);
  if (*(int *)(param_1 + 0xeec) == 0) {
    iVar15 = 0;
  }
  else {
    iVar15 = *(int *)(param_1 + 0xe0) + *(int *)(param_1 + 0xeec);
  }
  if (*(int *)(param_1 + 0xef0) == 0) {
    iVar16 = 0;
  }
  else {
    iVar16 = *(int *)(param_1 + 0xe0) + *(int *)(param_1 + 0xef0);
  }
  fn_82C9B320(param_1,param_2);
  ...
  *(undefined4 *)(param_2 + 0x184) = *(undefined4 *)(param_1 + 0x19d0);
  uVar2 = *(undefined4 *)(param_1 + 0x39e0);
  *(int *)(param_2 + 0x18c) = param_1 + 0xb7c;
  *(undefined4 *)(param_2 + 0x188) = uVar2;
  ...
  *(int *)(param_2 + 0x1e4) = iVar16;
  *(int *)(param_2 + 0x1d0) = iVar11;
  *(int *)(param_2 + 0x1d4) = iVar14;
  *(int *)(param_2 + 0x1d8) = iVar9;
  *(int *)(param_2 + 0x1dc) = iVar15;
  *(int *)(param_2 + 0x1e0) = iVar13;
  if (*(int *)(param_1 + 0x567c) == 0) {
    if (((*(int *)(param_1 + 0x3e5c) != 0) && (*(int *)(param_1 + 0x3e60) != 0)) &&
       (*(int *)(param_1 + 0x3e64) == 1)) {
      if (**(int **)(param_1 + 0x3e68) == 0) {
        iVar11 = 0;
      }
      else {
        iVar11 = *(int *)(param_1 + 0xdc) + **(int **)(param_1 + 0x3e68);
      }
      *(int *)(param_2 + 0x1d0) = iVar11;
      iVar11 = *(int *)(*(int *)(param_1 + 0x3e68) + 4);
      if (iVar11 == 0) {
        iVar11 = 0;
      }
      else {
        iVar11 = *(int *)(param_1 + 0xe0) + iVar11;
      }
      *(int *)(param_2 + 0x1d8) = iVar11;
      iVar11 = *(int *)(*(int *)(param_1 + 0x3e68) + 8);
      if (iVar11 == 0) {
        iVar11 = 0;
      }
      else {
      ...
      *(int *)(param_2 + 0x1e0) = iVar11;
    }
    if (*(int *)(param_1 + 0xec0) == 0) {
      iVar11 = 0;
    }
    else {
      iVar11 = *(int *)(param_1 + 0xdc) + *(int *)(param_1 + 0xec0);
    }
    *(int *)(param_2 + 0x230) = iVar11;
    iVar9 = iVar11 + 8;
    if (iVar11 == 0) {
      iVar9 = 0;
    }
    *(int *)(param_2 + 0x234) = iVar9;
    if (iVar11 == 0) {
      iVar9 = 0;
    }
    else {
      iVar9 = *(int *)(param_1 + 0xcc) * 8 + iVar11;
    }
    *(int *)(param_2 + 0x238) = iVar9;
    if (iVar11 == 0) {
      ...
      iVar11 = (*(int *)(param_1 + 0xcc) + 1) * 8 + iVar11;
    }
    *(int *)(param_2 + 0x23c) = iVar11;
    if (*(int *)(param_1 + 0xec4) == 0) {
      iVar11 = 0;
    }
    else {
      iVar11 = *(int *)(param_1 + 0xe0) + *(int *)(param_1 + 0xec4);
    }
    *(int *)(param_2 + 0x240) = iVar11;
    if (*(int *)(param_1 + 0xec8) != 0) {
      iVar11 = *(int *)(param_1 + 0xe0) + *(int *)(param_1 + 0xec8);
      goto LAB_82c9c378;
    }
  }
  else {
    if (iVar11 == 0) {
      ...
      iVar12 = (*(int *)(param_1 + 0xcc) >> 1) * *(int *)(param_1 + 0x50d0) + iVar11;
    }
    *(int *)(param_2 + 0x1d0) = iVar12;
    iVar10 = iVar12 + 8;
    if (iVar12 == 0) {
      iVar10 = 0;
    }
    *(int *)(param_2 + 0x1d4) = iVar10;
    if (iVar12 == 0) {
      iVar10 = 0;
    }
    else {
      iVar10 = *(int *)(param_1 + 0xcc) * 8 + iVar12;
    }
    *(int *)(param_2 + 0x1d8) = iVar10;
    if (iVar12 == 0) {
      iVar12 = 0;
    }
    else {
      iVar12 = (*(int *)(param_1 + 0xcc) + 1) * 8 + iVar12;
    }
    *(int *)(param_2 + 0x1dc) = iVar12;
    if (iVar9 == 0) {
      iVar12 = 0;
    }
    else {
      iVar12 = (*(int *)(param_1 + 0xd0) >> 1) * *(int *)(param_1 + 0x50d0) + iVar9;
    }
    *(int *)(param_2 + 0x1e0) = iVar12;
    if (iVar13 == 0) {
      iVar12 = 0;
    }
    else {
      iVar12 = (*(int *)(param_1 + 0xd0) >> 1) * *(int *)(param_1 + 0x50d0) + iVar13;
    }
    *(int *)(param_2 + 0x1e4) = iVar12;
    if (iVar14 == 0) {
      iVar12 = 0;
    }
    else {
      iVar12 = (*(int *)(param_1 + 0xcc) >> 1) * *(int *)(param_1 + 0x50d0) + iVar14;
    }
    *(int *)(param_2 + 0x200) = iVar12;
    iVar10 = iVar12 + 8;
    if (iVar12 == 0) {
      iVar10 = 0;
    }
    *(int *)(param_2 + 0x204) = iVar10;
    if (iVar12 == 0) {
      iVar10 = 0;
    }
    else {
    ...
    *(int *)(param_2 + 0x20c) = iVar12;
    if (iVar15 == 0) {
      iVar12 = 0;
    }
    else {
      iVar12 = (*(int *)(param_1 + 0xd0) >> 1) * *(int *)(param_1 + 0x50d0) + iVar15;
    }
    *(int *)(param_2 + 0x210) = iVar12;
    if (iVar16 == 0) {
      iVar12 = 0;
    }
    else {
      iVar12 = (*(int *)(param_1 + 0xd0) >> 1) * *(int *)(param_1 + 0x50d0) + iVar16;
    }
    *(int *)(param_2 + 0x214) = iVar12;
    if (*(int *)(param_1 + 0x54c8) == 0) {
      if (iVar11 == 0) {
        iVar11 = 0;
      }
      else {
        iVar11 = (*(int *)(param_1 + 0xcc) >> 1) * *(int *)(param_1 + 0x50d0) + iVar11;
      }
      *(int *)(param_2 + 0x1e8) = iVar11;
      iVar12 = iVar11 + 8;
      if (iVar11 == 0) {
        iVar12 = 0;
      }
      *(int *)(param_2 + 0x1ec) = iVar12;
      if (iVar11 == 0) {
LAB_82c9bfd4:
        iVar12 = 0;
      }
      else {
        iVar12 = *(int *)(param_1 + 0xcc) * 8 + iVar11;
      }
LAB_82c9bfd8:
      *(int *)(param_2 + 0x1f0) = iVar12;
      if (iVar11 == 0) {
        iVar11 = 0;
      }
      else {
      ...
      *(int *)(param_2 + 500) = iVar11;
      if (iVar9 == 0) {
        iVar9 = 0;
      }
      else {
        iVar9 = (*(int *)(param_1 + 0xd0) >> 1) * (*(uint *)(param_1 + 0x50d0) ^ 1) + iVar9;
      }
      *(int *)(param_2 + 0x1f8) = iVar9;
      if (iVar13 == 0) {
LAB_82c9c1a8:
        iVar13 = 0;
      }
      else {
        iVar13 = (*(int *)(param_1 + 0xd0) >> 1) * (*(uint *)(param_1 + 0x50d0) ^ 1) + iVar13;
      }
    }
    else {
      if ((*(int *)(param_1 + 0x120) == 2) && (*(int *)(param_1 + 0x50f8) != 0)) {
        if (iVar11 == 0) {
          ...
          iVar11 = (*(int *)(param_1 + 0xcc) >> 1) + iVar11;
        }
        *(int *)(param_2 + 0x1e8) = iVar11;
        iVar12 = iVar11 + 8;
        if (iVar11 == 0) {
      ...
      if (*(int *)(param_1 + 0xec0) == 0) {
        ...
        iVar11 = (*(int *)(param_1 + 0xcc) >> 1) * *(int *)(param_1 + 0x50d0) +
      ...
      *(int *)(param_2 + 500) = iVar11;
      if (*(int *)(param_1 + 0xec4) == 0) {
        ...
        iVar11 = (*(int *)(param_1 + 0xd0) >> 1) * (*(uint *)(param_1 + 0x50d0) ^ 1) +
                 *(int *)(param_1 + 0xe0) + *(int *)(param_1 + 0xec4);
      }
      *(int *)(param_2 + 0x1f8) = iVar11;
      if (*(int *)(param_1 + 0xec8) == 0) goto LAB_82c9c1a8;
      iVar13 = (*(int *)(param_1 + 0xd0) >> 1) * (*(uint *)(param_1 + 0x50d0) ^ 1) +
               *(int *)(param_1 + 0xe0) + *(int *)(param_1 + 0xec8);
    }
    *(int *)(param_2 + 0x1fc) = iVar13;
    if (iVar14 == 0) {
      iVar14 = 0;
    }
    else {
      iVar14 = (*(int *)(param_1 + 0xcc) >> 1) * *(int *)(param_1 + 0x50d0) + iVar14;
    }
    *(int *)(param_2 + 0x218) = iVar14;
    iVar11 = iVar14 + 8;
    if (iVar14 == 0) {
      iVar11 = 0;
    }
    *(int *)(param_2 + 0x21c) = iVar11;
    if (iVar14 == 0) {
      iVar11 = 0;
    }
    else {
      iVar11 = *(int *)(param_1 + 0xcc) * 8 + iVar14;
    }
    *(int *)(param_2 + 0x220) = iVar11;
    if (iVar14 == 0) {
      iVar14 = 0;
    }
    else {
      iVar14 = (*(int *)(param_1 + 0xcc) + 1) * 8 + iVar14;
    }
    *(int *)(param_2 + 0x224) = iVar14;
    if (iVar15 == 0) {
      iVar15 = 0;
    }
    else {
    ...
    *(int *)(param_2 + 0x228) = iVar15;
    if (iVar16 == 0) {
      iVar16 = 0;
    }
    else {
      iVar16 = (*(int *)(param_1 + 0xd0) >> 1) * (*(uint *)(param_1 + 0x50d0) ^ 1) + iVar16;
    }
    *(int *)(param_2 + 0x22c) = iVar16;
    if (*(int *)(param_1 + 0xec0) == 0) {
      iVar11 = 0;
    }
    else {
    ...
    *(int *)(param_2 + 0x23c) = iVar11;
    if (*(int *)(param_1 + 0xec4) == 0) {
      ...
      iVar11 = (*(int *)(param_1 + 0xd0) >> 1) * *(int *)(param_1 + 0x50d0) +
               *(int *)(param_1 + 0xe0) + *(int *)(param_1 + 0xec4);
    }
    *(int *)(param_2 + 0x240) = iVar11;
    if (*(int *)(param_1 + 0xec8) != 0) {
  ...
  iVar11 = 0;
LAB_82c9c378:
  *(int *)(param_2 + 0x244) = iVar11;
  *(undefined4 *)(param_2 + 0x57c) = *(undefined4 *)(param_1 + 0x51a4);
  *(uint *)(param_2 + 0x88c) = (uint)LZCOUNT(*(int *)(param_1 + 0xfb0) + -3) >> 5;
  *(undefined4 *)(param_2 + 0x6a0) = *(undefined4 *)(param_1 + 0x3a14);
  *(undefined4 *)(param_2 + 0x6a4) = *(undefined4 *)(param_1 + 0x39fc);
  *(undefined4 *)(param_2 + 0x6a8) = *(undefined4 *)(param_1 + 0x3a00);
  *(int *)(param_2 + 0x63c) = *(int *)(param_1 + 0x39f8) * *(int *)(param_1 + 0xd64);
  *(undefined4 *)(param_2 + 0x6ac) = *(undefined4 *)(param_1 + 0x3bec);
  *(undefined4 *)(param_2 + 0x6b0) = *(undefined4 *)(param_1 + 0x3bf0);
  *(undefined4 *)(param_2 + 0x6b4) = *(undefined4 *)(param_1 + 0x3bf4);
  *(undefined4 *)(param_2 + 0x6b8) = *(undefined4 *)(param_1 + 0x3bf8);
  ...
  *(undefined4 *)(param_2 + 0x634) = *(undefined4 *)(param_1 + 0x567c);
  if (*(int *)(param_1 + 0x567c) == 1) {
    ...
    *(undefined4 *)(param_2 + 0x5c4) = *(undefined4 *)(param_1 + 0xb2d4);
    *(int *)(param_2 + 0x5bc) = *(int *)(param_1 + 0xb2d8);
    *(uint *)(param_2 + 0x5c0) =
         ((-(uint)(*(int *)(param_1 + 0x50d0) != 0) & 0x80) + 0x80) * 2 + *(int *)(param_1 + 0xb2d8)
    ;
  }
  uVar2 = *(undefined4 *)(param_1 + 0xbc8);{ V16 _vt0 = vectorSplatImmediateSignedHalfWord(8); memcpy(auVar20, &_vt0, 16); }
  *(undefined4 *)(param_2 + 0x24c) = uVar2;
  *(undefined4 *)(param_2 + 0x248) = uVar2;
  puVar6 = (undefined2 *)(param_2 + 0x4a6);
  uVar2 = *(undefined4 *)(param_1 + 0xbd0);
  *(undefined4 *)(param_2 + 0x254) = uVar2;
  *(undefined4 *)(param_2 + 0x250) = uVar2;
  ...
  *(undefined4 *)(param_2 + 0x490) = *(undefined4 *)(param_1 + 0x3cb0);
  *(uint *)(param_2 + 0x890) =
       ((int)*(uint *)(param_1 + 0x3cb0) >> 0x1f) + (uint)(6 < *(uint *)(param_1 + 0x3cb0));
  *(undefined4 *)(param_2 + 0x494) = *(undefined4 *)(param_1 + 0x56a8);
  *(undefined4 *)(param_2 + 0x26c) = *(undefined4 *)(param_1 + 0x740);
  *(undefined4 *)(param_2 + 0x270) = *(undefined4 *)(param_1 + 0x744);
  *(undefined4 *)(param_2 + 0x278) = *(undefined4 *)(param_1 + 0x748);
  *(uint *)(param_2 + 0x470) = *(byte *)(param_2 + 0x23) + 0x1f001f;
  *(uint *)(param_2 + 0x474) = *(byte *)(param_2 + 0x23) + 0xf000f;
  *(uint *)(param_2 + 0x478) = *(byte *)(param_2 + 0x23) + 0x70007;
  *(uint *)(param_2 + 0x47c) = *(byte *)(param_2 + 0x23) + 0x30003;
  *(uint *)(param_2 + 0x480) = 0x200020 - (uint)*(byte *)(param_2 + 0x23);
  *(uint *)(param_2 + 0x484) = 0x400040 - (uint)*(byte *)(param_2 + 0x23);
  *(uint *)(param_2 + 0x488) = 0x80008 - (uint)*(byte *)(param_2 + 0x23);
  *(ushort *)(param_2 + 0x46e) = (ushort)*(byte *)(param_2 + 0x23);{ V16 _vt1 = vectorSplatHalfWord(in_vs44,7); memcpy(auVar19, &_vt1, 16); }
  ...
  puVar3 = (undefined4 *)(in_r0 + param_2 + 0x460 & 0xfffffff0);
  *puVar3 = in_register_00010000;
  puVar3[1] = in_ACC;
  puVar3[2] = in_register_00010008;
  puVar3[3] = in_vr0;
  iVar11 = 0;
  puVar3 = (undefined4 *)(param_2 + 0x450U & 0xfffffff0);
  *puVar3 = in_register_000100b0;
  puVar3[1] = in_register_000100b4;
  puVar3[2] = in_register_000100b8;
  puVar3[3] = in_vr11;
  *(undefined2 *)(param_2 + 0x498) = 2;
  uVar8 = *(int *)(param_1 + 0xcc) + 0x20;
  lVar18 = 0x10;
  *(short *)(param_2 + 0x49a) = (short)((int)(uVar8 * 4 | uVar8 >> 0x1e) >> 6);
  uVar8 = *(int *)(param_1 + 0xcc) + 0x10;
  *(short *)(param_2 + 0x49c) = (short)((int)(uVar8 * 8 | uVar8 >> 0x1d) >> 6);
  *(short *)(param_2 + 0x49e) = (short)(*(int *)(param_1 + 0xcc) * 0xc + 0x80 >> 6);
  uVar8 = *(int *)(param_1 + 0xcc) + 8;
  *(short *)(param_2 + 0x4a0) = (short)((int)(uVar8 * 0x10 | uVar8 >> 0x1c) >> 6);
  ...
  *(short *)(param_2 + 0x4a6) = (short)(*(int *)(param_1 + 0xcc) * 0x1c + 0x80 >> 6);
  do {
    iVar9 = *(int *)(param_1 + 0xd0) * iVar11;
    iVar11 = iVar11 + 1;
    puVar6 = puVar6 + 1;
    *puVar6 = (short)(iVar9 + 0x80 >> 6);
    lVar18 = lVar18 + -1;
  } while (lVar18 != 0);
  ...
  *(undefined4 *)(param_2 + 0x528) = *(undefined4 *)(param_1 + 0xf88);
  uVar5 = fn_82C69588(param_1);
  *(int *)(param_2 + 0x17c) = (int)uVar5;
  trapWord(6,uVar5,0);
  puVar7 = &lbl_820FDD3C;
  lVar18 = 4;
  uVar4 = *(ushort *)(param_2 + 0x34) >> 1;
  *(int *)(param_2 + 0x180) = (int)(uint)uVar4 / (int)uVar5;
  *(int *)(param_2 + 0x54c) = param_1 + 0x5ef0;
  *(int *)(param_2 + 0x550) = param_1 + 0x5fb0;
  trapWord(5,uVar5 & ~((ulonglong)uVar4 * 2 - 1),0xffff);
  *(undefined4 *)(param_2 + 0x268) = *(undefined4 *)(param_1 + 0x6e8);
  *(undefined4 *)(param_2 + 0x3c0) = *(undefined4 *)(param_1 + 0x3e20);
  puVar17 = (undefined1 *)(*(int *)(param_2 + 0x54c) + 1);
  iVar11 = *(int *)(param_1 + 0xcc);
  do {
    uVar8 = puVar7[-1];
    *puVar17 = 0xff;
    puVar17[-1] = (char)(uVar8 >> 8);
    *(uint *)(puVar17 + 3) = (uVar8 & 0xfe) * iVar11;
    if ((uVar8 & 1) != 0) {
      *puVar17 = (char)(uVar8 >> 0x18);
      *(uint *)(puVar17 + 7) = (uVar8 >> 0x10 & 0xfe) * iVar11;
    }
    uVar8 = *puVar7;
    puVar17[0xc] = 0xff;
    puVar17[0xb] = (char)(uVar8 >> 8);
    *(uint *)(puVar17 + 0xf) = (uVar8 & 0xfe) * iVar11;
    if ((uVar8 & 1) != 0) {
      puVar17[0xc] = (char)(uVar8 >> 0x18);
      *(uint *)(puVar17 + 0x13) = (uVar8 >> 0x10 & 0xfe) * iVar11;
    }
    uVar8 = puVar7[1];
    puVar17[0x18] = 0xff;
    puVar17[0x17] = (char)(uVar8 >> 8);
    *(uint *)(puVar17 + 0x1b) = (uVar8 & 0xfe) * iVar11;
    if ((uVar8 & 1) != 0) {
      puVar17[0x18] = (char)(uVar8 >> 0x18);
      *(uint *)(puVar17 + 0x1f) = (uVar8 >> 0x10 & 0xfe) * iVar11;
    }
    uVar8 = puVar7[2];
    puVar17[0x24] = 0xff;
    puVar17[0x23] = (char)(uVar8 >> 8);
    *(uint *)(puVar17 + 0x27) = (uVar8 & 0xfe) * iVar11;
    if ((uVar8 & 1) != 0) {
      puVar17[0x24] = (char)(uVar8 >> 0x18);
      *(uint *)(puVar17 + 0x2b) = (uVar8 >> 0x10 & 0xfe) * iVar11;
    }
    puVar7 = puVar7 + 4;
  ...
  if ((*(int *)(param_2 + 0x640) != 0) && (*(int *)(*(int *)(param_2 + 0x640) + 0xc) == 3)) {
    iVar11 = *(int *)(param_2 + 0x26c);
    iVar9 = 0;
    lVar18 = 8;
    *(int *)(param_2 + 0x644) = param_1 + 0xb1fc;
    do {
      *(byte *)(param_1 + 0xb1fc + iVar9) =
           (*(byte *)(iVar9 + iVar11) & 3) << 4 | *(byte *)(iVar9 + iVar11) >> 1 & 0x7e;
      bVar1 = *(byte *)(iVar11 + 1 + iVar9);
      *(byte *)(param_1 + 0xb1fd + iVar9) = (bVar1 & 3) << 4 | bVar1 >> 1 & 0x7e;
      bVar1 = *(byte *)(iVar11 + 2 + iVar9);
      *(byte *)(param_1 + 0xb1fe + iVar9) = (bVar1 & 3) << 4 | bVar1 >> 1 & 0x7e;
      bVar1 = *(byte *)(iVar11 + 3 + iVar9);
      *(byte *)(param_1 + 0xb1ff + iVar9) = (bVar1 & 3) << 4 | bVar1 >> 1 & 0x7e;
      iVar9 = iVar9 + 4;
      lVar18 = lVar18 + -1;
    } while (lVar18 != 0);
    iVar11 = *(int *)(param_2 + 0x270);
    iVar9 = 0;
    lVar18 = 8;
    *(int *)(param_2 + 0x648) = param_1 + 0xb21c;
    do {
      *(byte *)(param_1 + 0xb21c + iVar9) =
           (*(byte *)(iVar9 + iVar11) << 3 | *(byte *)(iVar9 + iVar11) >> 2) & 0x3e;
      bVar1 = *(byte *)(iVar11 + 1 + iVar9);
      *(byte *)(param_1 + 0xb21d + iVar9) = (bVar1 << 3 | bVar1 >> 2) & 0x3e;
      bVar1 = *(byte *)(iVar11 + 2 + iVar9);
      *(byte *)(param_1 + 0xb21e + iVar9) = (bVar1 << 3 | bVar1 >> 2) & 0x3e;
      bVar1 = *(byte *)(iVar11 + 3 + iVar9);
      *(byte *)(param_1 + 0xb21f + iVar9) = (bVar1 << 3 | bVar1 >> 2) & 0x3e;
      iVar9 = iVar9 + 4;
      lVar18 = lVar18 + -1;
    } while (lVar18 != 0);
    iVar11 = *(int *)(param_2 + 0x278);
    iVar9 = 0;
    lVar18 = 4;
    *(int *)(param_2 + 0x650) = param_1 + 0xb23c;
    do {
      *(byte *)(param_1 + 0xb23c + iVar9) =
           (*(byte *)(iVar9 + iVar11) & 3) << 3 | *(byte *)(iVar9 + iVar11) >> 1 & 0x7e;
      bVar1 = *(byte *)(iVar11 + 1 + iVar9);
      *(byte *)(param_1 + 0xb23d + iVar9) = (bVar1 & 3) << 3 | bVar1 >> 1 & 0x7e;
      bVar1 = *(byte *)(iVar11 + 2 + iVar9);
      *(byte *)(param_1 + 0xb23e + iVar9) = (bVar1 & 3) << 3 | bVar1 >> 1 & 0x7e;
      bVar1 = *(byte *)(iVar11 + 3 + iVar9);
      *(byte *)(param_1 + 0xb23f + iVar9) = (bVar1 & 3) << 3 | bVar1 >> 1 & 0x7e;
      iVar9 = iVar9 + 4;
      lVar18 = lVar18 + -1;
    } while (lVar18 != 0);
    iVar11 = *(int *)(param_2 + 0x1bc);
    iVar9 = 0;
    *(int *)(param_2 + 0x654) = param_1 + 0xb1bc;
    lVar18 = 0x10;
    do {
      *(byte *)(param_1 + 0xb1bc + iVar9) =
           *(byte *)(iVar9 + iVar11) >> 2 & 0xfe | (*(byte *)(iVar9 + iVar11) & 7) << 4;
      bVar1 = *(byte *)(iVar11 + 1 + iVar9);
      *(byte *)(param_1 + 0xb1bd + iVar9) = bVar1 >> 2 & 0xfe | (bVar1 & 7) << 4;
      bVar1 = *(byte *)(iVar11 + 2 + iVar9);
      *(byte *)(param_1 + 0xb1be + iVar9) = bVar1 >> 2 & 0xfe | (bVar1 & 7) << 4;
      bVar1 = *(byte *)(iVar11 + 3 + iVar9);
      *(byte *)(param_1 + 0xb1bf + iVar9) = bVar1 >> 2 & 0xfe | (bVar1 & 7) << 4;
      iVar9 = iVar9 + 4;
      lVar18 = lVar18 + -1;
    } while (lVar18 != 0);
  }
