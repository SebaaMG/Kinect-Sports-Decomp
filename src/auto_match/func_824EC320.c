...
void fn_824EC320(undefined8 param_1,double param_2,double param_3,double param_4,double param_5,
  ...
  if ((iVar11 != 0) && (iVar11 = *(int *)(iVar11 + 0xd54), iVar11 != 0)) {
    if (in_stack_0000006c == 0) {
      ...
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x40200;
      ...
      iVar1 = lbl_8320A898;
      *(uint *)(lbl_8320A898 + 0x2948) = *(uint *)(lbl_8320A898 + 0x2948) & 0xfffffff8 | uVar2 & 7;
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x40;
      iVar1 = lbl_8320A898;
      *(uint *)(lbl_8320A898 + 0x2f04) = uVar4;
      *(uint *)(iVar1 + 0x28dc) =
           -(uint)(*(int *)(iVar1 + 0x3148) != 0) & uVar4 & 0xf |
           *(uint *)(iVar1 + 0x28dc) & 0xfffffff0;
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x2000000000;
      iVar1 = lbl_8320A898;
      *(uint *)(lbl_8320A898 + 0x2f14) = uVar5;
      *(uint *)(iVar1 + 0x2934) =
           (-(uint)(*(int *)(iVar1 + 0x3158) != 0) & uVar5 & 1) << 1 |
           *(uint *)(iVar1 + 0x2934) & 0xfffffffd;
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x20800;
      iVar1 = lbl_8320A898;
    ...
    else if (in_stack_0000006c == 3) {
      if (*(int *)(iVar11 + 0x1714) != 0) {
        fn_824F0500(iVar11 + 0x40);
      }
      iVar1 = *(int *)(iVar11 + 0x1710);
      iVar12 = iVar1 * 0x60 + iVar11 + 0x40;
      if (iVar1 == 10) {
        uVar9 = 0;
        goto LAB_824ec8b0;
      }
      *(int *)(iVar11 + 0x1710) = iVar1 + 1;
      if ((undefined4 *)(iVar12 + 0x1310) != (undefined4 *)0x0) {
        *(undefined4 *)(iVar12 + 0x1310) = 0xb;
        *(float *)(iVar12 + 0x1314) = (float)dVar16;
        *(float *)(iVar12 + 0x1318) = (float)param_2;
        *(float *)(iVar12 + 0x131c) = (float)param_3;
        *(float *)(iVar12 + 0x1320) = (float)param_4;
        *(float *)(iVar12 + 0x1324) = (float)param_5;
        *(float *)(iVar12 + 0x1328) = (float)param_6;
        *(float *)(iVar12 + 0x132c) = (float)param_7;
        *(float *)(iVar12 + 0x1330) = (float)param_8;
        *(float *)(iVar12 + 0x1334) = (float)param_9;
        *(char *)(iVar12 + 0x1338) = in_stack_00000067;
        *(int *)(iVar12 + 0x1364) = in_stack_00000074;
        *(undefined4 *)(iVar12 + 0x1368) = in_stack_0000005c;
      }
    }
  }
  uVar9 = 1;
