...
void fn_82263B70(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (*pcVar1 != '\0') {
    iVar2 = fn_8225FDE0(0x51,0);
    if ((iVar2 == 0) && (cVar3 = fn_82E1CAD0(0x51), cVar3 != '\0')) {
      fn_82E1CB88(0xffffffff821a684c,param_1);
      fn_82E1CB88(0xffffffff821a69b8,param_2);
