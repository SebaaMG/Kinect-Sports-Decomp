...
void fn_82D8E7F8(double param_1,int param_2)

{
  ...
  *(float *)(param_2 + 0x30) = (float)(param_1 * (double)lbl_8200533C);
  dVar2 = (double)lbl_82002C5C;
  ...
  *puVar1 = in_register_000100d0;
  ...
  puVar1[3] = in_vr13;
  *(float *)(param_2 + 0x40) = (float)(param_1 * dVar2);
