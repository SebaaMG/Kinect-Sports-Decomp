...
void fn_82CF81F0(int param_1,ulonglong param_2,int param_3,int param_4)

{
  ...
  lVar4 = (longlong)param_3 * (longlong)param_4;
  iVar5 = param_1 + 0x18;
  RtlEnterCriticalSection(iVar5,1);
  iVar3 = (int)lVar4;
  if ((param_2 & 0xffffffff) == 0) {
    ...
    uVar2 = fn_82CF85A0(iVar1,param_2);
    ...
    if (iStack_3c != iVar3) {
      fn_82CF7C08(param_1,0xffffffff821336d0,param_2,&uStack_40);
      trapWord(0x1f,in_r0,0x16);
    }
    fn_82CF8600(*(undefined4 *)(param_1 + 0x44),uVar2);
    iVar3 = (**(code **)(**(int **)(param_1 + 0x34) + 0x2c))
                      (*(int **)(param_1 + 0x34),param_2,lVar4);
    *(int *)(param_1 + 0x48) = *(int *)(param_1 + 0x48) - iVar3;
    (**(code **)(**(int **)(param_1 + 0x34) + 8))(*(int **)(param_1 + 0x34),param_2,lVar4);
  }
  RtlLeaveCriticalSection(iVar5);
  return;
}
