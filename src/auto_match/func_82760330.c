...
void fn_82760330(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  cVar2 = fn_826E7448();
  if ((cVar2 != '\0') && (piVar1 = (int *)fn_826E7430(param_1), piVar1 != (int *)0x0)) {
    (**(code **)(*piVar1 + 4))(piVar1,0x31,param_2,&stack0x00000020);
  }
  return;
}
