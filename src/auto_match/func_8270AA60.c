...
void fn_8270AA60(uint *param_1,int param_2)

{
  ...
  *(uint *)(param_2 + 0x20) = *(uint *)(param_2 + 0x20) & 0xfffffffe;
  uVar2 = *(uint *)(param_2 + 0x18) >> (uVar2 & 0x3f);
  uVar12 = uVar2 - 1 >> 3 & 0x1ffffffc;
  *(uint *)(uVar12 + param_2 + 0x20) =
       *(uint *)(uVar12 + param_2 + 0x20) & ~(1 << (uVar2 - 1 & 0x1f));
