...

{
  ...
  if (cVar5 == '\0') {
    ...
    if (0 < *(int *)(param_1 + 0x1c)) {
      ...
      dVar9 = (double)fn_826972E0(uVar2,uVar1);
      uVar3 = (uint)dVar9;
      uVar7 = (ulonglong)uVar3;
      if (((int)uVar3 < 100) && (-1 < (int)uVar3)) {
        uVar7 = uVar7 + 0x76c;
      }
      iVar6 = *(int *)(iVar8 + 0x58);
      if (0x3b < iVar6) {
        uVar3 = fn_82739680(*(undefined4 *)(iVar8 + 0x54));
        uVar3 = uVar3 & 0xff;
        uVar4 = fn_82739680(uVar7);
        *(uint *)(iVar8 + 0x58) = (iVar6 - uVar3) + (uVar4 & 0xff);
      }
      iVar6 = (int)uVar7;
      ...
      *(longlong *)(iVar8 + 0x48) =
           (longlong)
           (int)(((iVar6 + -0x641) / 400 - (iVar6 + -0x76d) / 100) +
                 ((int)uVar3 >> 2) + (uint)((int)uVar3 < 0 && (uVar3 & 3) != 0) +
                 (iVar6 + -0x7b2) * 0x16d + *(int *)(iVar8 + 0x58)) * 86400000 +
           (longlong)*(int *)(iVar8 + 0x50);
      fn_827397D8(iVar8);
    }
  }
  return;
