...
extern int fn_82E0DB00();


void fn_82E0DB68(int *param_1,longlong param_2,undefined8 param_3,longlong param_4)
  ...
  if (0 < iVar8) {
    do {
      ...
      if (((*(ushort *)(iVar8 + 0x10) >> 10 & 1) == 0) &&
         (uVar12 = (uint)*(byte *)(iVar8 + 0xc), uVar12 - 0x16 < 7)) {
        if (uVar12 == 0x16) {
LAB_82e0dc5c:
          lVar2 = param_2;
          lVar3 = param_4;
          if (*(char *)(iVar8 + 0xd) == '\x1c') {
            while (-1 < lVar3 + -1) {
              ...
              fn_82E0DB00(param_1,*puVar10,puVar10[1]);
            ...
            while (-1 < lVar3 + -1) {
              ...
              fn_82E0DB68(param_1,*puVar10,uVar4,uVar1);
              lVar6 = fn_82CEB1A8(param_3);
              lVar2 = lVar6 + lVar2;
              lVar3 = lVar3 + -1;
            }
          ...
          if (uVar12 == 0x19) {
            ...
            while (-1 < lVar3 + -1) {
              ...
              uVar7 = fn_82CFFD68(auStack_60);
              fn_82E0DB68(param_1,uVar7,uVar5,uVar4);
              lVar6 = fn_82CEB1A8(param_3);
              lVar2 = lVar6 + lVar2;
              lVar3 = lVar3 + -1;
            }
            ...
            if (uVar12 == 0x1a) goto LAB_82e0dc5c;
            lVar2 = param_2;
            lVar3 = param_4;
            if (uVar12 == 0x1b) {
              while (-1 < lVar3 + -1) {
                fn_82CFFC68(auStack_68,lVar2,iVar8);
                piVar11 = (int *)fn_82CFFEC8(auStack_68,0);
                if (*piVar11 != 0) {
                  (**(code **)(*param_1 + 0x14))(param_1,*piVar11,piVar11);
                  fn_82E0DB68(param_1,piVar11[1],*piVar11,piVar11[2]);
                }
                lVar6 = fn_82CEB1A8(param_3);
                lVar2 = lVar6 + lVar2;
                lVar3 = lVar3 + -1;
              ...
              while (-1 < lVar3 + -1) {
                ...
                fn_82E0DB00(param_1,uVar5,uVar4);
                lVar6 = fn_82CEB1A8(param_3);
                lVar2 = lVar6 + lVar2;
                lVar3 = lVar3 + -1;
              }
