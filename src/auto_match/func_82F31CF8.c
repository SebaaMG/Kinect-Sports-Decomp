...
void fn_82F31CF8(double param_1,double param_2,double param_3,double param_4,int param_5)

{
  ...
  if (0 < *(int *)(param_5 + 0x5c)) {
    ...
    do {
      ...
      iVar26 = (int)dVar61;
      iRam832617f4 = iVar26 << 8;
      iVar29 = iVar26 * *(int *)(param_5 + 0x50) * 2 + *(int *)(param_5 + 100);
      iVar1 = (int)(dVar61 * dVar21 - (double)(longlong)iRam832617f4);
...
LAB_82f326ec:
                  ...
                  iRam832617f4 = iVar1 << 8;
                  iVar54 = (int)(dVar61 * dVar21 - (double)(longlong)iRam832617f4);
                  puVar35[2] = (char)((uint)*(byte *)(iVar1 * 2 + iVar29 + 2) * iVar54 +
                                      (0x100 - iVar54) * (uint)*(byte *)(iVar1 * 2 + iVar29) >> 8);
                }
                else {
                  if ((iVar1 < 1) || (*(int *)(param_5 + 0x50) <= iVar1)) goto LAB_82f326ec;
...
LAB_82f32608:
                ...
                if ((iVar54 < 1) || (*(int *)(param_5 + 0x50) <= iVar54)) goto LAB_82f32608;
                iRam832617f4 = iVar54 << 8;
          ...
          do {
            ...
            if ((iVar26 < 1) || (uVar17 = *(uint *)(param_5 + 0x50), (int)(uVar17 - 2) <= iVar26)) {
              if ((iVar26 == 0) || (iVar37 = *(int *)(param_5 + 0x50), iVar26 < iVar37 + -1)) {
                ...
                bVar3 = *pbVar32;
                iVar26 = (int)(dVar61 * dVar21 - (double)(longlong)iRam832617f4);
                puVar35[2] = (char)(((int)(((((uint)pbVar32[2] - (uint)bVar3) - (uint)bVar41) +
...
LAB_82f33848:
                  ...
                  if (iVar38 < (int)(((int)uVar17 >> 1) +
                    ...
                    iRam832617f4 = iVar38 << 8;
                    iVar29 = (uVar17 * iVar26 + iVar38 * 2) * 2;
                    uVar17 = (uint)(dVar61 * dVar60 - (double)(longlong)iRam832617f4);
...
LAB_82f336e0:
                ...
                if (iVar38 < (int)(((int)uVar17 >> 1) + (uint)((int)uVar17 < 0 && (uVar17 & 1) != 0)
                  ...
                  uVar2 = (uint)(dVar61 * dVar60 - (double)(longlong)iRam832617f4);
