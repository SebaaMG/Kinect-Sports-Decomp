...
void fn_83011EE0(int param_1,ulonglong param_2,undefined8 param_3,ulonglong param_4)
...
joined_r0x83011f10:
  do {
    ...
    if (puVar3 == (undefined4 *)0x0) {
      fn_830118C0(lbl_832642E4,param_2,param_3,param_4);
      return;
    }
    puVar1 = (undefined4 *)puVar3[2];
    if ((((param_2 & 0xffffffff) == 0) || ((ulonglong)(uint)puVar1[0xd] == (param_2 & 0xffffffff)))
       && (cVar7 = fn_83010658(param_1,puVar1[2],param_3), cVar7 == '\0')) {
      if (((param_4 & 0xff) != 0) || (puVar1[0xc] == 0)) {
