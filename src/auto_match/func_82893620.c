...
undefined4 *
fn_82893620(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)
  ...
  while (cVar1 == '\0') {
    ...
    if (piVar2 == (int *)*piVar3) {
      ...
      if (*(char *)(iVar4 + 0x4c) == '\0') {
        *(undefined1 *)(piVar2 + 0x13) = 1;
        *(undefined1 *)(iVar4 + 0x4c) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x4c) = 0;
        ...
        *(undefined1 *)(piVar5[1] + 0x4c) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x4c) = 0;
        fn_8288B9F8(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar4 = *piVar3;
      if (*(char *)(iVar4 + 0x4c) == '\0') {
        ...
        *(undefined1 *)(piVar5[1] + 0x4c) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x4c) = 0;
        fn_8288B980(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    cVar1 = *(char *)(piVar5[1] + 0x4c);
  }
  iVar4 = *(int *)(param_2 + 4);
  *param_1 = param_5;
  *(undefined1 *)(*(int *)(iVar4 + 4) + 0x4c) = 1;
  return param_1;
}
