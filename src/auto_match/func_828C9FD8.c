...
extern int fn_828C8DC8();
extern int fn_828C8F18();
extern int fn_82F622E0();
extern unsigned int stack0x00000024;


undefined4 * fn_828C9FD8(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar9 + 0x49) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x49) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar2 = *(undefined1 *)(piStack00000024 + 0x12);
  ...
  if (*(int **)(iVar4 + 8) == param_3) {
    if (*(char *)((int)piVar10 + 0x49) == '\0') {
      cVar1 = *(char *)(piVar10[2] + 0x49);
      piVar8 = (int *)piVar10[2];
      piVar3 = piVar10;
      while (piVar6 = piVar8, cVar1 == '\0') {
        piVar8 = (int *)piVar6[2];
        cVar1 = *(char *)((int)piVar8 + 0x49);
        piVar3 = piVar6;
      }
      *(int **)(iVar4 + 8) = piVar3;
    }
...
LAB_828ca1d4:
  if (*(char *)(param_3 + 0x12) == '\x01') {
    if (piVar10 != *(int **)(*(int *)(param_2 + 4) + 4)) {
      do {
        piVar8 = piVar9;
        if (*(char *)(piVar10 + 0x12) != '\x01') break;
        piVar9 = (int *)*piVar8;
        if (piVar10 == piVar9) {
          piVar9 = (int *)piVar8[2];
          if (*(char *)(piVar9 + 0x12) == '\0') {
            *(undefined1 *)(piVar9 + 0x12) = 1;
            *(undefined1 *)(piVar8 + 0x12) = 0;
            fn_828C8F18(param_2,piVar8);
            piVar9 = (int *)piVar8[2];
          }
          if (*(char *)((int)piVar9 + 0x49) == '\0') {
            if ((*(char *)(*piVar9 + 0x48) != '\x01') || (*(char *)(piVar9[2] + 0x48) != '\x01')) {
              if (*(char *)(piVar9[2] + 0x48) == '\x01') {
                *(undefined1 *)(*piVar9 + 0x48) = 1;
                *(undefined1 *)(piVar9 + 0x12) = 0;
                fn_828C8DC8(param_2,piVar9);
                piVar9 = (int *)piVar8[2];
              }
              *(undefined1 *)(piVar9 + 0x12) = *(undefined1 *)(piVar8 + 0x12);
              *(undefined1 *)(piVar8 + 0x12) = 1;
              *(undefined1 *)(piVar9[2] + 0x48) = 1;
              fn_828C8F18(param_2,piVar8);
              break;
            }
LAB_828ca300:
          ...
          if (*(char *)(piVar9 + 0x12) == '\0') {
            *(undefined1 *)(piVar9 + 0x12) = 1;
            *(undefined1 *)(piVar8 + 0x12) = 0;
            fn_828C8DC8(param_2,piVar8);
            piVar9 = (int *)*piVar8;
          }
          if (*(char *)((int)piVar9 + 0x49) == '\0') {
            if ((*(char *)(piVar9[2] + 0x48) == '\x01') && (*(char *)(*piVar9 + 0x48) == '\x01'))
            goto LAB_828ca300;
            if (*(char *)(*piVar9 + 0x48) == '\x01') {
              *(undefined1 *)(piVar9[2] + 0x48) = 1;
              *(undefined1 *)(piVar9 + 0x12) = 0;
              fn_828C8F18(param_2,piVar9);
              piVar9 = (int *)*piVar8;
            }
            *(undefined1 *)(piVar9 + 0x12) = *(undefined1 *)(piVar8 + 0x12);
            *(undefined1 *)(piVar8 + 0x12) = 1;
    ...
    *(undefined1 *)(piVar10 + 0x12) = 1;
  }
  fn_828B22F0(param_3 + 10);
  fn_8265CA20(param_3[10]);
  fn_8288E4B0(auStack_50,param_3 + 6,*(undefined4 *)param_3[7]);
