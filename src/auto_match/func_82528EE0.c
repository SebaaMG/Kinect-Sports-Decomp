...
int fn_82528EE0(int param_1,int param_2,undefined8 param_3,undefined8 param_4,undefined8 param_5,
...

{
  ...
  iVar1 = fn_82F66E68(param_1,param_2,0xffffffffffffffff,param_3,&stack0x00000028);
  if (iVar1 == -1) {
    iVar1 = param_2 + -1;
    *(undefined2 *)(param_2 * 2 + param_1 + -2) = 0;
  }
  return iVar1;
}
