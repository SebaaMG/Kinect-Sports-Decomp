...
void fn_826398E8(int param_1,int param_2,float param_3)

{
  ...
  uStack_c = (uint)(longlong)(param_3 * lbl_821954CC);
  *(uint *)(iVar1 + 0x10) = (uStack_c & 0x3ff) << 0xc | *(uint *)(iVar1 + 0x10) & 0xffc00fff;
