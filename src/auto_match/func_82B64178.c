...
undefined8 fn_82B64178(int *param_1)
  ...
  for (; uVar4 < uVar10; uVar4 = *(int *)(iVar1 + 0x60) * 2 + uVar4) {
    ...
    if (uVar4 < uVar8) {
      ...
      do {
        ...
        puVar7 = puVar7 + 2;
        puVar5 = puVar5 + 1;
        *puVar5 = (ushort)(((ulonglong)*puVar7 & 0xf81f) + ((ulonglong)*puVar9 & 0xf81f) +
                           ((ulonglong)*puVar3 & 0xf81f) + ((ulonglong)*puVar2 & 0xf81f) + 0x1002 >>
                          2) & 0xf81f |
                  (ushort)(((ulonglong)*puVar7 & 0x7e0) + ((ulonglong)*puVar9 & 0x7e0) +
                           ((ulonglong)*puVar3 & 0x7e0) + ((ulonglong)*puVar2 & 0x7e0) + 0x40 >> 2)
                  & 0x7e0;
        lVar6 = lVar6 + -1;
      } while (lVar6 != 0);
    }
