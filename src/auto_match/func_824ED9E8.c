...
void fn_824ED9E8(undefined8 param_1,double param_2,double param_3,double param_4,double param_5,
  ...
  if ((iVar12 != 0) && (iVar12 = *(int *)(iVar12 + 0xd54), iVar12 != 0)) {
    if (in_stack_0000008c == 0) {
      ...
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x80000;
      ...
      fn_82631578(lbl_8320A898,*(undefined4 *)(iVar12 + 0x68));
      iVar1 = lbl_8320A898;
      ...
      *puVar9 = uVar23;
      ...
      uVar3 = *(uint *)(lbl_8320A898 + 0x2934);
      uVar4 = *(uint *)(lbl_8320A898 + 0x2ef8);
      uVar5 = *(uint *)(lbl_8320A898 + 0x293c);
      uVar6 = *(uint *)(lbl_8320A898 + 0x2efc);
      uVar7 = *(uint *)(lbl_8320A898 + 0x2f04);
      uVar8 = *(uint *)(lbl_8320A898 + 0x2f14);
      ...
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x40;
      iVar1 = lbl_8320A898;
      *(uint *)(lbl_8320A898 + 0x2f04) = uVar7;
      *(uint *)(iVar1 + 0x28dc) =
           -(uint)(*(int *)(iVar1 + 0x3148) != 0) & uVar7 & 0xf |
           *(uint *)(iVar1 + 0x28dc) & 0xfffffff0;
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x2000000000;
      iVar1 = lbl_8320A898;
      *(uint *)(lbl_8320A898 + 0x2f14) = uVar8;
      *(uint *)(iVar1 + 0x2934) =
           (-(uint)(*(int *)(iVar1 + 0x3158) != 0) & uVar8 & 1) << 1 |
           *(uint *)(iVar1 + 0x2934) & 0xfffffffd;
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x20800;
      iVar1 = lbl_8320A898;
      *(uint *)(lbl_8320A898 + 0x2934) =
           (uVar3 >> 2 & 1) << 2 | *(uint *)(lbl_8320A898 + 0x2934) & 0xfffffffb;
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x800;
      iVar1 = lbl_8320A898;
      *(uint *)(lbl_8320A898 + 0x293c) =
           (uVar5 >> 3 & 1) << 3 | *(uint *)(lbl_8320A898 + 0x293c) & 0xfffffff7;
      *(ulonglong *)(iVar1 + 0x10) = *(ulonglong *)(iVar1 + 0x10) | 0x40200;
      fn_82637B30(lbl_8320A898,uVar6 >> 0x1f);
      fn_82637C50(lbl_8320A898,uVar4 & 0x1f);
      fn_82637CE0(lbl_8320A898,uVar4 >> 8 & 0x1f);
    }
