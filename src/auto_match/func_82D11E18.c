...
void fn_82D11E18(int *param_1,uint param_2)

{
  ...
  if (0 < param_1[1]) {
    puVar5 = (uint *)*param_1;
    do {
      if ((*puVar5 <= param_2) && (param_2 <= *puVar5 + 0x8b8)) {
        uVar1 = ((uint *)*param_1)[iVar3];
        iVar4 = *(int *)(uVar1 + 0x904) + -1;
        *(int *)(uVar1 + 0x904) = iVar4;
        if (iVar4 != 0) {
          return;
        }
        uVar2 = *(undefined4 *)(iVar3 * 4 + *param_1);
        iVar4 = fn_82CE5410();
        (**(code **)(**(int **)(iVar4 + 0x10) + 8))(*(int **)(iVar4 + 0x10),uVar2,0x908);
        iVar4 = param_1[1] + -1;
        param_1[1] = iVar4;
        if (iVar4 == iVar3) {
          return;
