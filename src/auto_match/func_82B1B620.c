...
int fn_82B1B620(undefined8 param_1,undefined8 param_2,int param_3,undefined8 param_4,int param_5)

{
  ...
  iVar2 = fn_82B841E8(param_1,*(undefined4 *)(param_3 + 0x1c),0,3,2,4);
