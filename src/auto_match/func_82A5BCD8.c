...
longlong fn_82A5BCD8(int param_1,undefined8 param_2,ulonglong param_3)

{
  ...
  if ((*(int *)(param_1 + 0x18) == 0) && ((param_3 & 0xffffffff) == 0)) {
    lVar1 = fn_82A783F8(*(undefined4 *)(param_1 + 0x94),param_2);
  }
  else {
    ...
    if (puVar2 == (uint *)0x0) {
      ...
      *puVar2 = (uint)(param_3 != 0);
      ...
      lVar1 = fn_82A5C760(*(undefined4 *)(param_1 + 0x14),puVar2);
      if (lVar1 < 0) {
        fn_82A4F4E0(puVar2);
      }
    }
