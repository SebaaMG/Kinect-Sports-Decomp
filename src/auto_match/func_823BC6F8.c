...
extern int fn_823BC870();
extern int fn_824C0C30();


undefined4 * fn_823BC6F8(undefined4 *param_1,int param_2,int *param_3,int param_4)
  ...
  if (*(int *)(param_2 + 8) == 0) {
    ...
    if (param_3 != (int *)*piVar2) {
      if (param_3 == piVar2) {
        ...
        if (*(uint *)(param_4 + 0xc) <= (uint)param_3[3]) goto LAB_823bc844;
        uVar7 = 0;
      }
      else {
        ...
        if ((uVar3 < uVar4) &&
          ...
          if ((uVar3 <= uVar4) ||
             ((apiStack_50[0] = param_3, puVar6 = (undefined4 *)fn_82248B90(apiStack_50),
              (int *)*puVar6 != piVar2 && ((uint)apiStack_50[0][3] <= uVar3)))) goto LAB_823bc844;
...
LAB_823bc844:
      puVar6 = (undefined4 *)fn_823BC870(auStack_48,param_2,param_4);
      *param_1 = *puVar6;
      return param_1;
    }
  }
  uVar7 = 1;
LAB_823bc73c:
  fn_824C0C30(param_1,param_2,uVar7,param_3,param_4);
  return param_1;
}
