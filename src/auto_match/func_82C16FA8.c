...
undefined8 fn_82C16FA8(short *param_1,uint *param_2,ushort *param_3)
...
LAB_82c1705c:
  ...
  if ((uVar7 != 0) && (uVar8 != 0)) {
    ...
    if ((((sVar1 == 0x10) || (sVar1 == 0x14)) || (sVar1 == 0x18)) || (sVar1 == 0x20)) {
      ...
      if ((((param_2[2] == *(uint *)(param_1 + 8)) || ((!bVar3 && ((param_2[1] == 2 || (!bVar5))))))
          && ((uVar2 = param_2[1], (ulonglong)uVar2 == (uVar8 & 0xffffffff) || (!bVar3)))) &&
         (((!bVar5 || ((ulonglong)uVar2 == (uVar8 & 0xffffffff))) || (uVar2 == 2)))) {
        ...
        uVar2 = *param_2;
        if (((!bVar5) ||
            ((((uVar7 & 0xffffffff) == (ulonglong)uVar2 && ((uVar9 & 8) == 0)) && ((uVar9 & 2) == 0)
             ))) && ((!bVar4 ||
                     ((((uVar9 & 8) == 0 && ((ulonglong)uVar2 <= (uVar7 & 0xffffffff))) &&
                      ((uVar7 & 0xffffffff) <= ((ulonglong)uVar2 & 0x7fffffff) << 1)))))) {
          if (!bVar3) {
            return uVar6;
          }
          if ((uVar7 & 0xffffffff) <= ((ulonglong)uVar2 & 0x3fffffff) << 2) {
            if ((uVar7 + (uVar7 & 0x7fffffff) * 2 & 0x7fffffff) << 1 < (ulonglong)uVar2) {
              return 0xffffffff80040000;
            }
            return uVar6;
          }
