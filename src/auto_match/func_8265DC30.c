...
byte fn_8265DC30(int param_1,uint param_2,char param_3)

{
  ...
  if (*(uint *)(iStack00000014 + 0x14) < uStack0000001c) {
    fn_8265DEE8(iStack00000014,uStack0000001c,*(undefined4 *)(iStack00000014 + 0x10));
  }
  else if ((cStack00000027 == '\0') || (0xf < uStack0000001c)) {
    if (uStack0000001c == 0) {
      fn_8265DAB8(iStack00000014,0);
    }
  }
  else {
    ...
    fn_8265D8A0(iStack00000014,1,uStack_10);
  }
