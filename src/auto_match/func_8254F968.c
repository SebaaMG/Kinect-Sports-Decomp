...
extern int fn_82550018();
extern int fn_82550080();
...
undefined4 * fn_8254F968(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x29) == '\0') {
      piVar6 = (int *)*piVar8;
      piVar7 = piVar8;
      while (piVar3 = piVar6, *(char *)((int)piVar3 + 0x29) == '\0') {
        piVar7 = piVar3;
        piVar6 = (int *)*piVar3;
      }
    }
        ...
        if (piVar8 == piVar7) {
          ...
          if (*(char *)(piVar7 + 10) == '\0') {
            ...
            *(undefined1 *)(piVar9 + 10) = 0;
            fn_82550018(param_2,piVar9);
            piVar7 = (int *)piVar9[2];
          }
          if (*(char *)((int)piVar7 + 0x29) == '\0') {
            if ((*(char *)(*piVar7 + 0x28) != '\x01') || (*(char *)(piVar7[2] + 0x28) != '\x01')) {
              if (*(char *)(piVar7[2] + 0x28) == '\x01') {
                *(undefined1 *)(*piVar7 + 0x28) = 1;
                *(undefined1 *)(piVar7 + 10) = 0;
                fn_82550080(param_2,piVar7);
                piVar7 = (int *)piVar9[2];
              }
              *(undefined1 *)(piVar7 + 10) = *(undefined1 *)(piVar9 + 10);
              *(undefined1 *)(piVar9 + 10) = 1;
              *(undefined1 *)(piVar7[2] + 0x28) = 1;
              fn_82550018(param_2,piVar9);
              break;
            }
LAB_8254fc7c:
          ...
          if (*(char *)(piVar7 + 10) == '\0') {
            *(undefined1 *)(piVar7 + 10) = 1;
            *(undefined1 *)(piVar9 + 10) = 0;
            fn_82550080(param_2,piVar9);
            piVar7 = (int *)*piVar9;
          }
          if (*(char *)((int)piVar7 + 0x29) == '\0') {
            if ((*(char *)(piVar7[2] + 0x28) == '\x01') && (*(char *)(*piVar7 + 0x28) == '\x01'))
            goto LAB_8254fc7c;
            if (*(char *)(*piVar7 + 0x28) == '\x01') {
              *(undefined1 *)(piVar7[2] + 0x28) = 1;
              *(undefined1 *)(piVar7 + 10) = 0;
              fn_82550018(param_2,piVar7);
              piVar7 = (int *)*piVar9;
            }
            *(undefined1 *)(piVar7 + 10) = *(undefined1 *)(piVar9 + 10);
            *(undefined1 *)(piVar9 + 10) = 1;
