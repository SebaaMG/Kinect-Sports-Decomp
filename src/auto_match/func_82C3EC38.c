...
void fn_82C3EC38(int param_1,int *param_2,longlong param_3,longlong param_4)

{
  ...
  if (param_2[8] == 0) {
    fn_82F68CC0(*param_2 * 2 + iVar2,iVar2);
  ...
  if (*(int *)(param_1 + 0x2d0) < iVar7) {
    *(short *)(param_2[8] * 2 + iVar2) = (short)*(int *)(param_1 + 0x2d0);
  }
  else if (iVar7 < *(int *)(param_1 + 0x2d4)) {
    *(short *)(param_2[8] * 2 + iVar2) = (short)*(int *)(param_1 + 0x2d4);
  }
  else {
    *(short *)(param_2[8] * 2 + iVar2) = (short)param_3;
  }
  if (iVar7 < 1) {
    if (iVar7 < 0) {
