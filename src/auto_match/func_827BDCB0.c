...
int fn_827BDCB0(int *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((uint)param_1[0x1e] < (uint)param_1[0x18]) {
    ...
    aiStack_30[0] = 0;
    (**(code **)(param_1[0x61] + 4))(param_1,param_2,aiStack_30,param_3);
    param_1[0x1e] = aiStack_30[0] + param_1[0x1e];
  }
  else {
