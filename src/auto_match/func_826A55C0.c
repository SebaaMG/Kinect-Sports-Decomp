...
extern int fn_826A28A0();
extern int fn_826A4FF8();


void fn_826A55C0(int *param_1,undefined8 param_2,undefined4 *param_3,uint param_4)

{
  ...
  if (piVar6 == (int *)0x0) {
    ...
    if ((uint)(*piVar6 * 5) <= (uint)((piVar6[1] + 1) * 4)) goto LAB_826a561c;
