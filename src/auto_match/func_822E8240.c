...
void fn_822E8240(int *param_1,undefined8 param_2,int param_3)

{
  ...
  uVar1 = *(uint *)(&lbl_821ADFDC + param_3 * 4);
  ...
  uVar2 = *(undefined4 *)(&lbl_821ADFA0 + param_3 * 4);
  fn_8223C478(auStack_60,uVar2,0);
  fn_828E9DB8(auStack_60,param_2,uVar2);
  fn_82329468(param_1,auStack_70);
  if (iStack_48 != 0) {
    fn_8265CA20();
  }
  return;
