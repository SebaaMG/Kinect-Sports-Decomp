...
undefined8 fn_82E2FA90(int param_1,ulonglong param_2,undefined4 *param_3)

{
  ...
  else if ((param_2 & 0xffffffff) < (ulonglong)*(uint *)(param_1 + 0x1d4)) {
    *param_3 = 0;
    fn_82E50CB8(param_1 + 0x54);
    iVar1 = fn_82E2F530(param_1 + 0x16c,param_2,apiStack_40);
    if (iVar1 == 0) {
