...
void fn_82264400(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (*pcVar2 != '\0') {
    iVar3 = fn_8225FDE0(0x5b,1);
    if ((iVar3 == 0) && (cVar4 = fn_82E1CAD0(0x5b), cVar4 != '\0')) {
      fn_82E1CD30();
