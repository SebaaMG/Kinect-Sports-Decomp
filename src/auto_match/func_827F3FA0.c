...
extern int fn_827FA7C0();
extern int fn_827FA940();
extern int fn_82809D40();
extern int fn_8280DF98();
extern unsigned int lbl_821AAD20;


double fn_827F3FA0(int param_1)

{
  ...
  fn_827FA940(*(undefined4 *)(param_1 + 8),auStack_20);
  uVar1 = fn_827FA7C0(*(undefined4 *)(param_1 + 8));
  if ((uVar1 & 0xf) == 0) {
