...
/* WARNING: Removing unreachable block (ram,0x828376d0) */
/* WARNING: Removing unreachable block (ram,0x82837780) */

void fn_828379F0(void)

{
  if (lbl_8320A8B4 != 0) {
    if (lbl_8320A89C == 1) {
      ...
      fn_82646390((double)lbl_82002AE0,lbl_8320A898,0x300,0,
                        *(undefined4 *)(&lbl_8320A8A8 + lbl_8320A8B8 * 4),0xffffffff8320a7f0);
    }
  }
  return;
}
