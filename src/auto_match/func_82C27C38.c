...
undefined8 fn_82C27C38(int param_1,ulonglong param_2)

{
  ...
  if (*(int *)(iVar1 + 0x18) != 0) {
    ...
    do {
      ...
      } while (apiStack_30[0][1] != 0);
      uVar3 = (**(code **)(*(int *)(iVar1 + 0x4c) + 8))(*(int *)(iVar1 + 0x4c));
      if ((int)uVar3 < 0) {
        return uVar3;
      }
      ...
      *(int *)(iVar1 + 0x18) = (int)lVar4;
      ...
      uVar3 = fn_82C10B28(*(undefined4 *)(iVar1 + 0x48),0x1d,apiStack_30);
    } while (-1 < (int)uVar3);
  }
  return uVar3;
}
