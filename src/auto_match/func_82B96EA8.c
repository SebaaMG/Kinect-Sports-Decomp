...
void fn_82B96EA8(int param_1,int param_2,int param_3,longlong param_4)

{
  ...
  if (uVar5 < uVar4) {
    puVar6 = (ushort *)(uVar5 - 8);
    lVar3 = (ulonglong)((uVar4 - uVar5) - 1 >> 3) + 1;
    do {
      pfVar2 = (float *)param_4;
      *pfVar2 = (float)(*(ulonglong *)(puVar6 + 4) & 0xffff) * fVar1;
      pfVar2[1] = (float)(*(ulonglong *)(puVar6 + 4) >> 0x10 & 0xffff) * fVar1;
      pfVar2[2] = (float)(*(ulonglong *)(puVar6 + 4) >> 0x20 & 0xffff) * fVar1;
      puVar6 = puVar6 + 4;
      pfVar2[3] = (float)*puVar6 * fVar1;
