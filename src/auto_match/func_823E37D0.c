...
void fn_823E37D0(int param_1,int *param_2,int *param_3)

{
  ...
  iVar4 = *(int *)(param_2[4] * 4 + *param_2);
  iVar2 = *(int *)(iVar4 + 0x10);
  if (*(int *)(iVar4 + 8) != 0) {
    iVar4 = iVar2 * 0x150 + param_1;
    uVar3 = 0x21;
    *(undefined1 *)(iVar4 + 0x10b4) = 0;
    *(undefined1 *)(iVar4 + 0x10b5) = 0;
    *(undefined4 *)(iVar4 + 0x10b0) = 0;
    piVar1 = *(int **)(iVar2 * 4 + *(int *)(param_1 + 0x20));
  ...
  if (*(int *)(*(int *)(param_3[4] * 4 + *param_3) + 8) != 0) {
    ...
    *(undefined1 *)(param_1 + 0x10b4) = 0;
    iVar2 = fn_822ABA88(*(undefined4 *)(param_3[4] * 4 + *param_3),0);
                    /* WARNING: Subroutine does not return */
    fn_822AF138(*(undefined4 *)(iVar2 + 0x110),0x20);
  }
  return;
}
