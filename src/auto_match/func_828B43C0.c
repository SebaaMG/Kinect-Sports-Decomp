...
extern int fn_828B4140();
extern int fn_828B4218();
...
undefined4 * fn_828B43C0(undefined4 *param_1,int *param_2,int param_3,int param_4)

{
  ...
  if ((uVar7 & 0xffffffff) < (lVar5 - (ulonglong)uStack_68 & 0xffffffff)) {
    ...
    iStack_50 = *param_2;
    uStack_4c = 0;
    fn_828B4140(auStack_40,&iStack_50,&uStack_60,&uStack_70);
    ...
    fn_828B4218(auStack_40,&uStack_70,&iStack_50,&uStack_60);
    uVar3 = uVar8 & 0xffffffff;
    while (uVar3 != 0) {
      fn_828B36D0(param_2);
      uVar8 = uVar8 - 1;
