...
extern int fn_8251BFC0();
extern int fn_8251C118();
extern int fn_8251C300();
extern int fn_8260D428();


undefined4 * fn_8251BD48(undefined4 *param_1,int param_2,int *param_3,int param_4)
  ...
  if (*(int *)(param_2 + 8) == 0) {
    ...
    if (param_3 != (int *)*piVar3) {
      ...
      if (iVar2 < 0) {
        ...
        piVar3 = (int *)fn_8251C300(apiStack_50);
        puVar6 = puVar4;
        if (0xf < *(uint *)(param_4 + 0x20)) {
...
LAB_8251bee4:
        ...
        if (-1 < iVar2) {
LAB_8251bf98:
          puVar4 = (undefined4 *)fn_8251BFC0(auStack_48,param_2,param_4);
          *param_1 = *puVar4;
          return param_1;
        }
        apiStack_50[0] = param_3;
        piVar3 = (int *)fn_82250928(apiStack_50);
  ...
  uVar5 = 1;
LAB_8251bd90:
  fn_8251C118(param_1,param_2,uVar5,param_3,param_4);
  return param_1;
}
