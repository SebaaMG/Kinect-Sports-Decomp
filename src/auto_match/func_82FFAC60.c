...
extern int fn_83009ED8();
extern int fn_8300AB88();
extern unsigned int lbl_832642E0;
extern unsigned int lbl_832645B0;


undefined8 fn_82FFAC60(int param_1,int param_2,longlong param_3)

{
  ...
  if (piVar3 == (int *)0x0) {
    ...
    if ((int)uVar4 != 1) goto LAB_82ffad78;
  }
