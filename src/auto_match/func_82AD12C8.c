...
uint fn_82AD12C8(int *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...
LAB_82ad12ec:
      ...
      bVar3 = true;
      if ((uVar2 & 0xe000000) != 0) goto LAB_82ad12ec;
    }
    param_8 = 0;
    if (bVar3) {
      param_8 = (ulonglong)uVar2 & 0x1ffe000;
      if ((uVar2 & 0x1ffe000) == 0) {
        return puVar1[3];
      }
    }
