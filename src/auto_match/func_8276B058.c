...
extern int fn_82769B98();
extern unsigned int lbl_82014C48;
extern unsigned int lbl_82014C4C;
extern unsigned int lbl_821AAD20;


float * fn_8276B058(int param_1,uint param_2,float *param_3)

{
  ...
  if ((param_2 == 0xffffffff) || (*(uint *)(param_1 + 0x34) <= param_2)) {
    ...
    *param_3 = fVar1;
    ...
    fn_82769B98(param_1 + 0x28);
  }
  fVar1 = (float)*(uint *)(param_1 + 0x54);
