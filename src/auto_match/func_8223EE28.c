...
extern unsigned int uRam83297594;
extern unsigned int uStack_30;


ulonglong fn_8223EE28(undefined8 param_1)

{
  ...
  uVar1 = uRam83297594;
  uVar5 = (ulonglong)uRam83297594;
  uStack_30 = uRam83297594;
  uVar2 = fn_8223EEC8(0xffffffff8329e9d8);
  uVar3 = fn_8223EF38(param_1,uVar2);
  uVar6 = uVar3;
  if ((uVar3 == 0) && (uVar6 = uVar5, uVar1 == 0)) {
    iVar4 = fn_8223ED78(&uStack_30,param_1);
    if (iVar4 == -1) {
      fn_82F64188();
      uVar6 = uVar3;
    }
    else {
      uRam83297594 = uStack_30;
