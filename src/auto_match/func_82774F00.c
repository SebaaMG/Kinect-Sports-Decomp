...
void fn_82774F00(int *param_1,undefined8 param_2,uint param_3)

{
  ...
  if (param_3 == 0) {
    ...
    apuStack_50[0] = (undefined4 *)fn_8267BED0(param_2,uVar5 * 0xc + 8,&uStack_48);
    *apuStack_50[0] = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar3 = iVar2 + *param_1;
        if (*(int *)(iVar3 + 8) != -2) {
          fn_82774538(apuStack_50,param_2,iVar3 + 0x10,
