...
extern int fn_82275258();
extern int fn_8265C9E0();
extern unsigned int lbl_82002B04;
extern unsigned int uStack_2c;


void fn_82275180(int param_1,undefined4 *param_2)

{
  ...
  if ((*(int *)(param_1 + 0x10) + *(int *)(param_1 + 0xc) & 3U) == 0) {
    if (*(uint *)(param_1 + 8) <= *(int *)(param_1 + 0x10) + 4U >> 2) {
      fn_82275258();
    }
  }
  uVar5 = (ulonglong)*(uint *)(param_1 + 0xc) + (ulonglong)*(uint *)(param_1 + 0x10);
  uVar3 = (uVar5 & 0xffffffff) >> 2;
  ...
  lVar4 = (ulonglong)*(uint *)(*(int *)(param_1 + 4) + iVar1) + (uVar5 & 3) * 4;
  if (lVar4 != 0) {
    *(undefined4 *)lVar4 = *param_2;
  }
