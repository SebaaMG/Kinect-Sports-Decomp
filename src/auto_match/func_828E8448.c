...
extern int fn_828E7248();
extern int fn_828E7C68();
extern unsigned int stack0x00000024;
extern unsigned int uStack00000024;


undefined4 * fn_828E8448(undefined4 *param_1,int param_2,ulonglong param_3,uint *param_4)
    ...
    *param_1 = **(undefined4 **)(param_2 + 4);
    ...
    if ((param_3 & 0xffffffff) != ZEXT48(param_4)) {
      do {
        ...
        fn_828E7248(auStack_30,param_2,param_3);
