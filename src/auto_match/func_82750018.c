...
extern int fn_8274FEE8();
extern int fn_8274FFC8();
...
undefined4 * fn_82750018(undefined4 *param_1,int param_2)

{
  ...
  *(int *)(auStack_6c[0] + 8) = *(int *)(auStack_6c[0] + 8) + 1;
  ...
  if ((uVar1 & 0xffffffff) == 0) {
    ...
    uVar5 = fn_8274FFC8(uVar1,&iStack_60);
  }
  *param_1 = uVar5;
  *(undefined1 *)(param_1 + 2) = 0;
  ...
  if (lVar2 == 0) {
    ...
    uVar6 = fn_8274FEE8(lVar2,&iStack_60,uVar3,param_1);
  }
  if (uVar6 != 0) {
  ...
  (**(code **)(iVar4 + 0x28))
            ((ulonglong)*(uint *)(param_2 + 0x29c) + 0x10,&iStack_60,param_2 + 0xa0,uVar3,auStack_70
            );
