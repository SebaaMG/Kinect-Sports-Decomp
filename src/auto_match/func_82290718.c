...
extern int fn_82290970();
extern int fn_82550380();
extern int fn_8265CA20();


undefined4 * fn_82290718(undefined4 *param_1,int param_2,int *param_3,int *param_4)
    ...
    while (param_3 != param_4) {
      ...
      if (*(char *)((int)param_3 + 0x2d) == '\0') {
        ...
        if (*(char *)((int)piVar4 + 0x2d) == '\0') {
          piVar2 = (int *)*piVar4;
          while (piVar3 = piVar2, *(char *)((int)piVar3 + 0x2d) == '\0') {
            piVar4 = piVar3;
            piVar2 = (int *)*piVar3;
          }
        }
          ...
          piVar3 = param_3;
          while ((piVar4 = piVar2, *(char *)((int)piVar4 + 0x2d) == '\0' &&
                 (piVar3 == (int *)piVar4[2]))) {
            piVar3 = piVar4;
            piVar2 = (int *)piVar4[1];
          }
      ...
      fn_82290970(auStack_30,param_2,param_3);
      param_3 = piVar4;
    }
    *param_1 = param_3;
  }
