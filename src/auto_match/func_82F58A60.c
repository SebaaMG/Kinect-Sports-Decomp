...
void fn_82F58A60(int param_1,int *param_2)

{
  ...
  fn_82F56D40(auStack_b00,iVar2,&stack0x0000001c);
  if (auStack_b00[0] != *(uint *)(iVar2 + 4)) {
    iVar2 = fn_82F58670(iVar2,&stack0x0000001c);
