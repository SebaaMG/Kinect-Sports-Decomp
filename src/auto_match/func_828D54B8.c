...
extern int fn_828D4F38();
extern unsigned int uStack00000010;
extern unsigned int uStack00000018;
extern unsigned int uStack00000020;


void fn_828D54B8(ulonglong param_1,undefined8 param_2,ulonglong param_3)

{
  ...
  if ((int)lVar3 < 0x29) {
    fn_828D4F38(param_1,param_2,param_3);
  }
  else {
    uVar4 = lVar3 + 1;
    iVar2 = (int)uVar4;
    ...
    fn_828D4F38(param_1,iVar5,iVar2);
    fn_828D4F38((((U64)(uStack00000018) >> 32) & 0xFFFFFFFF) - uVar6,param_2,(((U64)(uStack00000018) >> 32) & 0xFFFFFFFF) + uVar6);
    iVar2 = iVar1 - uVar6;
    fn_828D4F38(iVar1 + (uVar6 & 0x7fffffff) * -2,iVar2,param_3);
    fn_828D4F38(iVar5,param_2,iVar2);
  }
  return;
}
