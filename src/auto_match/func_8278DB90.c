...
void fn_8278DB90(int *param_1,undefined8 param_2,uint param_3)
    ...
    *puStack_5c = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar4 = iVar3 + *param_1;
        if (*(int *)(iVar4 + 8) != -2) {
          uVar2 = fn_8278BA98(auStack_60,*(undefined4 *)(iVar4 + 0x10));
          fn_8278C160(&puStack_5c,param_2,iVar4 + 0x10,uVar2);
          if (*(int *)(iVar4 + 0x10) != 0) {
            fn_8267C4F0();
          }
