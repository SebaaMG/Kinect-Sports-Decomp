...
undefined8 fn_82CE4F60(undefined8 param_1)

{
  ...
  pcVar2 = (char *)fn_82CE4EC0(ZEXT48(&stack0x00000000) - 0x10);
  if (*pcVar2 != '\0') {
    lVar3 = ZEXT48(&stack0x00000000) - 0xc;
    uVar1 = storeVectorElementWordIndexed(in_vs45,0,lVar3);
    *(undefined4 *)lVar3 = uVar1;
    uVar4 = 1;
    if (ABS((double)(uStack_c - lbl_82002AE0)) < extraout_f1) goto LAB_82ce4fb8;
  }
  uVar4 = 0;
LAB_82ce4fb8:
