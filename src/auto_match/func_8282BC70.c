...
void fn_8282BC70(int param_1,int *param_2,ulonglong param_3,uint param_4)

{
  ...
  if (param_4 != 1) {
    ...
    uVar1 = uStack_6c;
    if (cStack_68 == '\0') {
      if (((param_4 == 4) && (piStack_70 = (int *)*param_2, piStack_70 != (int *)0x0)) &&
      ...
      *(int **)(iStack_80 + 0x18) = param_2;
      *(uint *)(iStack_80 + 0x20) = param_4;
      *(undefined4 *)(iStack_80 + 0x10) = *(undefined4 *)(iStack_7c + 0xc);
      *(undefined4 *)(iStack_80 + 0x14) = uVar1;
      *(int *)(iStack_80 + 0x1c) = (int)((param_3 & 0xffffffff) / (ulonglong)param_4);
      *(uint *)(iStack_80 + 0x24) = param_4;
