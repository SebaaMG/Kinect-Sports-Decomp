...
void fn_8276FF80(int *param_1,undefined8 param_2,uint param_3)
    ...
    *apuStack_50[0] = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar3 = iVar2 + *param_1;
        if (*(int *)(iVar3 + 8) != -2) {
          fn_82770530(apuStack_50,param_2,iVar3 + 0x10,
                            *(uint *)(iVar3 + 0x10) >> 6 ^ *(uint *)(iVar3 + 0x18) ^
                            *(uint *)(iVar3 + 0x10));
