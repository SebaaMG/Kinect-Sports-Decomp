...
void fn_8268B920(uint *param_1,ulonglong param_2)

{
  ...
  if ((param_2 & 0xffffffff) == 0) {
    ...
    uVar3 = fn_826BD598(param_2,0xffffffffffffffff);
  }
  uVar5 = 0;
  uVar2 = *param_1 & 3;
  if ((*param_1 & 3) == 0) {
  ...
  lVar4 = fn_8268B368(param_1,uVar5,uVar3,0);
  fn_826BD620(lVar4 + 8,param_2,0xffffffffffffffff);
  lVar6 = ((ulonglong)uVar1 & 0xfffffffc) + 4;
  *param_1 = *param_1 & 3 | (uint)lVar4;
  do {
    puVar7 = (uint *)lVar6;
