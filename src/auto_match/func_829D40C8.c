...
undefined8
fn_829D40C8(double param_1,int param_2,undefined8 param_3,undefined1 param_4,undefined2 param_5,
...

{
  ...
  if ((*(ulonglong *)(param_2 + 8) & 1) == 0) {
    ...
    uVar1 = fn_831429EC(param_2,0,1,0xa2,uVar2,param_3,param_4,param_5);
  }
  return uVar1;
}
