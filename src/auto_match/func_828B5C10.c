...
void fn_828B5C10(int *param_1,longlong param_2)

{
  ...
  if ((0x3fffffffU - param_2 & 0xffffffff) < (ulonglong)uVar4) {
  ...
  if ((ulonglong)uVar4 < (uVar7 & 0xffffffff)) {
    ...
    if ((uVar6 & 0xffffffff) < 0x40000000) {
      if ((ulonglong)(uint)(param_1[2] - *param_1 >> 2) < (uVar6 & 0xffffffff)) {
        puVar5 = (undefined2 *)fn_8288BD00(param_1 + 3,uVar6);
        puVar1 = (undefined2 *)param_1[1];
        puVar8 = puVar5;
        for (puVar9 = (undefined2 *)*param_1; puVar9 != puVar1; puVar9 = puVar9 + 2) {
        ...
        *param_1 = (int)puVar5;
        param_1[2] = (int)((uVar6 & 0xffffffff) << 2) + (int)puVar5;
        param_1[1] = (int)(puVar5 + (iVar3 - iVar2 >> 2) * 2);
      }
      return;
    }
                    /* WARNING: Subroutine does not return */
