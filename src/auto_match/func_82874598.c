...
undefined8
fn_82874598(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  fn_82230110(auStack_c0,0xffffffff820223dc);
  fn_82230110(auStack_e0,0xffffffff820223e4);
  uVar1 = fn_82865100();
  ...
  uVar1 = (**(code **)(*piVar2 + 0x20))(piVar2,auStack_80,param_3,param_4,param_5,param_6);
  iVar3 = fn_82878F88(uVar1,param_7,param_8);
  if (iVar3 < 0) {
