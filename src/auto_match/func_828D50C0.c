...
void fn_828D50C0(undefined8 param_1,int param_2,int param_3,uint *param_4)

{
  ...
  while (iVar1 = iVar2, param_3 < param_2) {
    ...
    if (*param_4 <= *(uint *)(*(int *)(*(int *)(uStack_20 + 4) + uVar6 * 4) + (uVar3 & 3) * 4))
    break;
    uVar6 = uVar3 >> 2;
    if (*(uint *)(uStack_20 + 8) <= uVar6) {
      uVar6 = uVar6 - *(uint *)(uStack_20 + 8);
  ...
  *(uint *)(*(int *)(*(int *)(uStack_20 + 4) + uVar6 * 4) + (iStack00000014 + param_2 & 3U) * 4) =
       *param_4;
  return;
}
