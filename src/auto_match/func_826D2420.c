...
extern int fn_826CC1F0();
extern int fn_826D0500();


void fn_826D2420(int *param_1,undefined8 param_2,undefined4 *param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if ((uint)(*piVar1 * 5) <= (uint)((piVar1[1] + 1) * 4)) goto LAB_826d247c;
...
LAB_826d247c:
  ...
  *piVar1 = *piVar1 + 1;
  ...
  uVar8 = param_4;
  if (*(int *)(iVar5 + 8) == -2) {
    fn_826CC1F0(puVar9,param_3,0xffffffffffffffff);
  }
  else {
    do {
