...
char * fn_82F8AAE8(int param_1,uint param_2)

{
  ...
  pcVar6 = (char *)(*(int *)(param_1 + 0x38) + uVar9);
  if (*(int *)(param_1 + 0x2c) - 0x106U < uVar9) {
    uVar9 = (uVar9 - *(int *)(param_1 + 0x2c)) + 0x106;
  }
  else {
    uVar9 = 0;
  }
  ...
  if (*(char **)(param_1 + 0x8c) <= pcVar3) {
    uVar1 = uVar1 >> 2;
  }
  uVar10 = (ulonglong)uVar1;
  pcVar2 = *(char **)(param_1 + 0x74);
  pcVar11 = *(char **)(param_1 + 0x90);
  if (pcVar2 < *(char **)(param_1 + 0x90)) {
    pcVar11 = pcVar2;
  }
  do {
    ...
    param_2 = (uint)*(ushort *)
                     ((*(uint *)(param_1 + 0x34) & param_2) * 2 + *(int *)(param_1 + 0x40));
