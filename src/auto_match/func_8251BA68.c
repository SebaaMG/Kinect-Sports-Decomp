...
undefined4 * fn_8251BA68(int param_1,undefined4 *param_2,undefined4 param_3)
  ...
  if (*(char *)((int)param_2 + 0x35) == '\0') {
    ...
    *(undefined1 *)((int)puVar1 + 0x35) = 0;
    if (puVar1 + 3 != (undefined4 *)0x0) {
      ...
      puVar1[0xb] = 0;
      puVar1[10] = 0;
      fn_82517978(puVar1 + 10,param_2[10],param_2[0xb],0);
      *(undefined1 *)(puVar1 + 0xc) = *(undefined1 *)(param_2 + 0xc);
    }
    puVar1[1] = param_3;
    *(undefined1 *)(puVar1 + 0xd) = *(undefined1 *)(param_2 + 0xd);
    if (*(char *)((int)puVar3 + 0x35) != '\0') {
      puVar3 = puVar1;
    }
    uVar2 = fn_8251BA68(param_1,*param_2,puVar1);
    *puVar1 = uVar2;
    uVar2 = fn_8251BA68(param_1,param_2[2],puVar1);
    puVar1[2] = uVar2;
  }
  return puVar3;
}
