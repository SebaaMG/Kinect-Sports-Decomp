...
void fn_82806A38(int param_1,int param_2,ulonglong param_3,longlong param_4)
    ...
    do {
      ...
      if (*(short *)(param_1 + 0x1e) != 0) {
        do {
          ...
          do {
            ...
            if ((uVar7 & bVar1) != 0) {
              if ((uVar7 >> 3 & (ulonglong)bVar1) == 0) {
                ...
                *(float *)lVar17 =
                     ((float)(((puVar19[1] << 1) << (0x1fU - iVar3 & 0x3f) | *puVar19 >> iVar3) &
                             (1 << (bVar2 & 0x3f)) - 1U) + (float)(longlong)iVar15) *
          ...
          iVar15 = (int)uVar14;
          if ((iVar15 == 0) && (iVar3 = *(int *)(*(int *)(param_2 + 100) + 0x3c), iVar3 != 0)) {
            if (iVar3 == 1) {
              pfVar4 = (float *)param_4;
              if (dVar22 < (double)(float)(dVar21 - (double)(pfVar4[2] * pfVar4[2] +
                                                            *pfVar4 * *pfVar4 +
                                                            pfVar4[1] * pfVar4[1]))) {
            ...
            do {
              ...
              if ((uVar7 & uVar6) != 0) {
                if ((uVar7 >> 3 & uVar6) == 0) {
                  ...
                  *(float *)lVar17 =
                       ((float)(((puVar19[1] << 1) << (0x1fU - iVar3 & 0x3f) | *puVar19 >> iVar3) &
                               (1 << (bVar1 & 0x3f)) - 1U) + (float)(longlong)iVar15) *
                       *(float *)(*(int *)(param_1 + 4) + (int)lVar8);
                }
                else {
                  *(int *)(param_2 + 0x2c) = *(int *)(param_2 + 0x2c) + 4;
              ...
              if ((uVar7 & uVar6) != 0) {
                if ((uVar7 >> 3 & uVar6) == 0) {
                  ...
                  *(byte **)(param_2 + 0x30) = *(byte **)(param_2 + 0x30) + 1;
                  ...
                  uVar18 = ((uVar10 & 0xff) >> 3 & 0x1ffffffc) + uVar18;
                  *(float *)lVar17 =
                       ((float)(((puVar19[1] << 1) << (0x1fU - iVar5 & 0x3f) | *puVar19 >> iVar5) &
                               (1 << (bVar1 & 0x3f)) - 1U) + (float)(longlong)iVar3) *
                       *(float *)(*(int *)(param_1 + 4) + (int)lVar8);
                }
                else {
                  *(int *)(param_2 + 0x2c) = *(int *)(param_2 + 0x2c) + 4;
