...
undefined8 fn_82E54B00(int param_1,byte *param_2)
  ...
  if ((int)((ulonglong)bVar1 - (ulonglong)bVar2) != 0) {
    ...
    if ((int)((ulonglong)bVar1 - (ulonglong)bVar2) != 0) {
      ...
      do {
        ...
        pbVar4 = pbVar4 + 1;
        pbVar3 = pbVar3 + 1;
      } while (pbVar4 != (byte *)&lbl_8214C320);
      if ((int)((ulonglong)bVar1 - (ulonglong)bVar2) != 0) {
        pbVar4 = (byte *)&lbl_8214C320;
        pbVar3 = param_2;
        do {
          bVar1 = *pbVar4;
          bVar2 = *pbVar3;
          ...
          pbVar4 = pbVar4 + 1;
          pbVar3 = pbVar3 + 1;
        } while (pbVar4 != (byte *)&lbl_8214C330);
        if ((int)((ulonglong)bVar1 - (ulonglong)bVar2) != 0) {
