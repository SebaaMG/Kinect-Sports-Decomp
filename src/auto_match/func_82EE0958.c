...
undefined8
fn_82EE0958(ulonglong param_1,ulonglong param_2,undefined8 param_3,undefined8 param_4,
             undefined8 param_5)

{
  ...
  while ((iVar1 = (int)uVar5, uStack00000020 = param_3, uStack00000028 = param_4,
    ...
    if ((param_2 & 0xffffffff) < (ulonglong)(*(uint *)(iVar1 + 4) + 0x14)) goto LAB_82ee0a04;
...
LAB_82ee0a04:
      ...
      *(byte *)(iVar1 + 0x24) = (&lbl_8318A10C)[(uint)param_2 & 7] | *(byte *)(iVar1 + 0x24);
