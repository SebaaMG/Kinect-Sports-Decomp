...
void fn_82264048(undefined8 param_1,ulonglong param_2,undefined8 param_3,undefined8 param_4,
                  undefined8 param_5)

{
  ...
  if (*pcVar2 != '\0') {
    iVar3 = fn_8225FDE0(0x56,param_2 & 0xff);
    if ((iVar3 == 0) && (cVar4 = fn_82E1CAD0(0x56), cVar4 != '\0')) {
      fn_82E1CB88(0xffffffff821a684c,uVar1);
      fn_82E1CB88(0xffffffff821a69b8,param_3);
