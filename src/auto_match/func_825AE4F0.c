...
undefined4 *
fn_825AE4F0(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)
  ...
  *(uint *)(param_2 + 8) = *(uint *)(param_2 + 8) + 1;
  ...
  if (param_4 == *(undefined4 **)(param_2 + 4)) {
    ...
    **(undefined4 **)(param_2 + 4) = param_5;
    ...
    param_4[2] = param_5;
    iVar2 = *(int *)(param_2 + 4);
    if (param_4 != *(undefined4 **)(iVar2 + 8)) goto LAB_825ae5a0;
  }
  *(int **)(iVar2 + 8) = param_5;
LAB_825ae5a0:
...
LAB_825ae630:
        ...
        *(undefined1 *)(piVar5[1] + 0x18) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x18) = 0;
        fn_824C0808(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar2 = *piVar4;
      if (*(char *)(iVar2 + 0x18) == '\0') goto LAB_825ae630;
      ...
      *(undefined1 *)(piVar5[1] + 0x18) = 1;
      *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x18) = 0;
      fn_822B5400(param_2,*(undefined4 *)(piVar5[1] + 4));
    }
