...
extern int fn_830333C8();
extern unsigned int lbl_83264304;
extern unsigned int uStack_100;


undefined8 fn_83010FE0(int param_1,ulonglong param_2,int param_3)
...
joined_r0x83011014:
  do {
    ...
    if ((((param_2 & 0xffffffff) == 0) ||
      ...
      cVar6 = '\0';
      uVar3 = *(uint *)(iVar2 + 0x14) >> 8;
      if (uVar3 == 0x4011) {
        cVar6 = '\x01';
      }
      else if (uVar3 == 0x5011) {
        cVar6 = fn_830333C8(*(undefined4 *)(uVar1 + 8),param_2,*(undefined4 *)(uVar1 + 0x34),uVar1
                             );
      }
      if (cVar6 != '\0') {
        auStack_f0[0] = 0;
  ...
  do {
    while( true ) {
      ...
      if ((((param_2 & 0xffffffff) == 0) ||
          (cVar6 = fn_83010770(param_1,param_2,*(undefined4 *)(iVar2 + 0x10)), cVar6 != '\0'))
         && (((param_3 == 0 || (*(int *)(uVar1 + 0x34) == param_3)) &&
             (((*(uint *)(iVar2 + 0x14) & 0xffffff00) == 0x501100 &&
              (cVar6 = fn_830333C8(*(undefined4 *)(uVar1 + 8),param_2,
                                     *(undefined4 *)(uVar1 + 0x34),uVar1), cVar6 != '\0'))))))
      break;
      uStack_100 = CONCAT44((uint *)*puVar4,puVar4);
      puVar4 = (uint *)*puVar4;
    }
