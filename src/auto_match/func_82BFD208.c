...
ulonglong fn_82BFD208(int param_1,int param_2,int param_3,int param_4,undefined4 param_5,
...

{
  ...
  uVar5 = (((U64)(lStack_78) >> 0) & 0xFFFFFFFF);
  ...
  *(int *)((int)plVar4 + 0x5c) = iStack_64;
  if ((ulonglong)in_stack_00000054 != 0) {
    *(longlong **)((int)plVar4 + 0x4c) = plVar4 + 0xc;
  }
  if (param_1 < 0x10) {
    param_1 = 0x10;
  }
  ...
  if (param_2 < 0x7ffffff) {
    if (0 < param_2) goto LAB_82bfd344;
    param_2 = -1;
    param_4 = 0;
  }
  else {
    ...
    *puVar14 = 0;
    ...
    if (iVar9 != 0) {
      do {
        ...
        while( true ) {
          lVar12 = *plVar4;
          lStack_78 = ((((U64)(lStack_78)) & (~(((U64)0xFFFFFFFF) << 0))) | ((((U64)((undefined4)((ulonglong)lVar12 >> 0x20))) & ((U64)0xFFFFFFFF)) << 0));
          *(undefined4 *)((int)lVar16 + -8) = (((U64)(lStack_78) >> 0) & 0xFFFFFFFF);
          sync(1);
          in_RESERVE = '\x01';
