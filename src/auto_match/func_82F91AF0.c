...
extern int fn_82F92228();
extern int fn_82F923D8();
extern int fn_82F92520();
extern int fn_82F92670();
...
undefined4 fn_82F91AF0(undefined4 param_1,int param_2,char param_3,int param_4,undefined4 param_5)

{
  ...
  iVar2 = fn_82F92228(param_2);
  if (*(uint *)(iStack0000001c + 8) < iVar2 - 1U) {
    iVar2 = fn_82F92670(iStack0000001c,*(undefined4 *)(iStack0000001c + 4),iStack0000002c,
    ...
    *(int *)(iStack0000001c + 8) = *(int *)(iStack0000001c + 8) + 1;
    ...
    while( true ) {
      ...
      pcVar5 = (char *)fn_82F921F8(*puVar4);
      if (*pcVar5 != '\0') break;
      ...
      if (*piVar3 == *piVar6) {
        ...
        pcVar5 = (char *)fn_82F921F8(iStack0000002c);
        if (*pcVar5 == '\0') {
          puVar4 = (undefined4 *)fn_82F92208(iStack_44);
          puVar7 = (undefined1 *)fn_82F921F8(*puVar4);
          *puVar7 = 1;
          puVar7 = (undefined1 *)fn_82F921F8(iStack0000002c);
          *puVar7 = 1;
          puVar4 = (undefined4 *)fn_82F92208(iStack_44);
          puVar4 = (undefined4 *)fn_82F92208(*puVar4);
          puVar7 = (undefined1 *)fn_82F921F8(*puVar4);
          *puVar7 = 0;
          ...
          if (iStack_44 == *piVar3) {
            piVar3 = (int *)fn_82F92208(iStack_44);
            iStack_44 = *piVar3;
            fn_82F923D8(iStack0000001c,iStack_44);
          }
          puVar4 = (undefined4 *)fn_82F92208(iStack_44);
          puVar7 = (undefined1 *)fn_82F921F8(*puVar4);
          *puVar7 = 1;
          ...
          *puVar7 = 0;
          puVar4 = (undefined4 *)fn_82F92208(iStack_44);
          puVar4 = (undefined4 *)fn_82F92208(*puVar4);
          fn_82F92520(iStack0000001c,*puVar4);
        }
      }
      else {
        puVar4 = (undefined4 *)fn_82F92208(iStack_44);
        ...
        if (*pcVar5 == '\0') {
          ...
          *puVar7 = 0;
          ...
          if (iStack_44 == *piVar3) {
            piVar3 = (int *)fn_82F92208(iStack_44);
            iStack_44 = *piVar3;
            fn_82F92520(iStack0000001c,iStack_44);
          }
          puVar4 = (undefined4 *)fn_82F92208(iStack_44);
          puVar7 = (undefined1 *)fn_82F921F8(*puVar4);
          *puVar7 = 1;
          ...
          *puVar7 = 0;
          puVar4 = (undefined4 *)fn_82F92208(iStack_44);
          puVar4 = (undefined4 *)fn_82F92208(*puVar4);
          fn_82F923D8(iStack0000001c,*puVar4);
        }
      }
    }
