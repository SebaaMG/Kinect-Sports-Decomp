...
extern unsigned int lbl_821B5E58;


void fn_823BBE98(int *param_1,undefined8 param_2,int *param_3)

{
  ...
  if (param_3 != (int *)0x0) {
    ...
    cVar4 = fn_82F64538(uVar2,0xffffffff831de9e4);
    if (cVar4 != '\0') {
      iVar5 = *param_3 + 8;
      goto LAB_823bbf04;
    }
...
LAB_823bbf04:
  if (iVar5 == 0) {
    ...
    if (puVar3 == (undefined4 *)0x0) {
      ...
      *puVar3 = &lbl_821B5E58;
      *(undefined8 *)(puVar3 + 2) = auStack_30[0];
    }
