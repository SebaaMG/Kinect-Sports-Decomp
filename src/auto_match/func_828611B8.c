...
void fn_828611B8(float *param_1,undefined8 param_2,ulonglong param_3,ulonglong param_4)

{
  ...
  if ((param_3 & 0x40) != 0) {
    fStack_9c = -fVar2;
    fStack_a4 = param_1[3] * fVar3;
    fStack_a0 = *param_1 * fVar3;
  }
  if ((param_3 & 0x20) != 0) {
    fStack_90 = -fVar2;
    fStack_98 = param_1[2] * fVar3;
    fStack_94 = param_1[1] * fVar3;
  }
  if ((param_3 & 0x10) != 0) {
    fStack_84 = -fVar2;
    fStack_8c = param_1[3] * fVar3;
    fStack_88 = param_1[1] * fVar3;
  }
  if ((param_3 & 8) != 0) {
  ...
  if ((param_4 & 0x80) != 0) {
    ...
    fStack_60 = -(param_1[2] * fVar3);
  }
  if ((param_4 & 0x40) != 0) {
    fStack_50 = param_1[3] * fVar3;
    uStack_54 = lbl_821AAD20;
    fStack_58 = fVar2;
  }
  if ((param_4 & 0x20) != 0) {
    fStack_40 = *param_1 * fVar3;
