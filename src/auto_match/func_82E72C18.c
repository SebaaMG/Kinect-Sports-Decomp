...
undefined8 fn_82E72C18(int *param_1,uint *param_2)
...
LAB_82e72c70:
    *param_2 = (uint)uVar3;
    ...
    if ((uVar3 < 0x100000000) && (0x17 < uVar3)) {
      if ((ulonglong)(uint)param_1[0x10] < uVar3 - 0x18) goto LAB_82e72c70;
      uVar2 = fn_82EE5E28(piVar4,(uVar3 & 0xffffffff) - 0x18);
      if ((int)uVar2 < 0) {
        return uVar2;
      }
