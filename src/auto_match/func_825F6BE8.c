...
extern int fn_825D30C8();
extern int fn_825F6B28();


undefined8
fn_825F6BE8(undefined8 param_1,int param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (((lVar1 == 0) || (param_6 = *(uint *)(param_2 + 0x8ac) & param_6, param_6 == 0)) ||
    ...
    uVar2 = fn_825D30C8(param_1,lVar1,param_2 + 0xf0,param_2 + 0x130,uVar4,param_3,param_4,lVar5
                            ,param_6);
  }
  return uVar2;
}
