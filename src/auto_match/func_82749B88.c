...
void fn_82749B88(int param_1,uint param_2)

{
  ...
  if (param_2 == 0) {
    fn_826BEDE8();
    fn_826C3400(param_1 + 0x54);
    fn_826C3400(param_1 + 0x60);
    if ((*(int *)(param_1 + 0x6c) != 0) &&
       (uVar2 = (ulonglong)*(uint *)(*(int *)(param_1 + 0x6c) + 4), uVar2 != 0)) {
      iVar4 = 0;
      do {
        if (*(int *)(**(int **)(param_1 + 0x6c) + iVar4) != 0) {
          fn_826824B0();
        }
        uVar2 = uVar2 - 1;
        iVar4 = iVar4 + 4;
    ...
    fn_826BE530();
    fn_826C31F0(param_1 + 0x54);
    fn_826C31F0(param_1 + 0x60);
    if ((*(int *)(param_1 + 0x6c) != 0) &&
       (uVar2 = (ulonglong)*(uint *)(*(int *)(param_1 + 0x6c) + 4), uVar2 != 0)) {
      iVar4 = 0;
      do {
        puVar1 = *(undefined4 **)(**(int **)(param_1 + 0x6c) + iVar4);
    ...
    fn_826BEF40();
    fn_826C3448(param_1 + 0x54);
    fn_826C3448(param_1 + 0x60);
    if ((*(int *)(param_1 + 0x6c) != 0) &&
       (uVar2 = (ulonglong)*(uint *)(*(int *)(param_1 + 0x6c) + 4), uVar2 != 0)) {
      iVar4 = 0;
      do {
    ...
    fn_826BE840();
    fn_826C3290(param_1 + 0x54);
    fn_826C3290(param_1 + 0x60);
    if ((*(int *)(param_1 + 0x6c) != 0) &&
       (uVar2 = (ulonglong)*(uint *)(*(int *)(param_1 + 0x6c) + 4), uVar2 != 0)) {
      iVar4 = 0;
      do {
