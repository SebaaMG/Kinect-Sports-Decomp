...
undefined4 *
fn_82828828(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)
  ...
  *(uint *)(param_2 + 8) = *(uint *)(param_2 + 8) + 1;
  ...
  if (param_4 == *(undefined4 **)(param_2 + 4)) {
    ...
    **(undefined4 **)(param_2 + 4) = param_5;
    ...
    param_4[2] = param_5;
    iVar2 = *(int *)(param_2 + 4);
    if (param_4 != *(undefined4 **)(iVar2 + 8)) goto LAB_828288d0;
  }
  *(int **)(iVar2 + 8) = param_5;
LAB_828288d0:
  cVar1 = *(char *)(param_5[1] + 0x10);
  piVar5 = param_5;
  do {
    if (cVar1 != '\0') {
      iVar2 = *(int *)(param_2 + 4);
      *param_1 = param_5;
      *(undefined1 *)(*(int *)(iVar2 + 4) + 0x10) = 1;
      return param_1;
    }
    piVar3 = (int *)piVar5[1];
    piVar4 = (int *)piVar3[1];
...
LAB_82828960:
        ...
        *(undefined1 *)(piVar5[1] + 0x10) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x10) = 0;
        fn_82872928(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar2 = *piVar4;
      if (*(char *)(iVar2 + 0x10) == '\0') goto LAB_82828960;
      ...
      *(undefined1 *)(piVar5[1] + 0x10) = 1;
      *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x10) = 0;
      fn_82872990(param_2,*(undefined4 *)(piVar5[1] + 4));
    }
