...
void fn_82421270(undefined8 param_1,int param_2)

{
  ...
  *puVar1 = in_register_00010010;
  ...
  puVar1[3] = in_vr1;
  uStack_68 = 0;
  dVar3 = (double)fn_82539560(param_1,(double)*(float *)(iVar2 + 0x84c),
                               (double)*(float *)(iVar2 + 0x850),(double)*(float *)(iVar2 + 0x854),
