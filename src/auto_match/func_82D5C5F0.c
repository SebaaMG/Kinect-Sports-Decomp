...
void fn_82D5C5F0(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  fn_82D75FD0(param_2,param_3,param_4,&ppuStack_70,&ppuStack_70);
  if (cStack_68 != '\0') {
    iVar3 = KeTlsGetValue(lbl_8323B4A0);
    puVar1 = *(undefined4 **)(iVar3 + 4);
    if (puVar1 < *(undefined4 **)(iVar3 + 0xc)) {
    ...
    fn_82D5D320(param_2,param_3,param_4,param_5,param_6);
  }
