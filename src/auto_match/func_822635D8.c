...
void fn_822635D8(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (*pcVar1 != '\0') {
    iVar2 = fn_8225FDE0(0xd,1);
    if ((iVar2 == 0) && (cVar3 = fn_82E1CAD0(0xd), cVar3 != '\0')) {
      fn_82E1CD30();
