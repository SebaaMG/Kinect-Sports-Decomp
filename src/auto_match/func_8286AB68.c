...
extern int fn_8286A528();


undefined4 * fn_8286AB68(undefined4 *param_1,int param_2,int param_3,char param_4)
...
LAB_8286ac18:
  puVar2 = (undefined4 *)fn_8286A528(apuStack_50,param_2,uVar3,puVar2,param_3);
