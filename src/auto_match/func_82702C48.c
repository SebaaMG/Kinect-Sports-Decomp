...
void fn_82702C48(int *param_1,undefined8 param_2,undefined4 *param_3,uint param_4)

{
  ...
  if (piVar7 == (int *)0x0) {
    ...
    if ((uint)(*piVar7 * 5) <= (uint)((piVar7[1] + 1) * 4)) goto LAB_82702ca4;
...
LAB_82702ca4:
  ...
  *piVar7 = *piVar7 + 1;
  ...
  if (iVar2 == -2) {
    ...
    *(undefined4 *)(iVar8 + 0x10) = *(undefined4 *)param_3[1];
  }
  else {
    do {
