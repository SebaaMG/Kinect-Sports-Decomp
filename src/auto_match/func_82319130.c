...
extern int fn_82319540();
extern int fn_823195A8();
extern int fn_82319610();
extern int fn_8265CA20();
extern int fn_82F622E0();
extern unsigned int stack0x00000024;


undefined4 * fn_82319130(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar9 + 0x25) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x25) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar2 = *(undefined1 *)(piStack00000024 + 9);
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x25) == '\0') {
      piVar6 = (int *)*piVar8;
      piVar7 = piVar8;
      while (piVar3 = piVar6, *(char *)((int)piVar3 + 0x25) == '\0') {
        piVar7 = piVar3;
        piVar6 = (int *)*piVar3;
      }
    }
        ...
        if (piVar8 == piVar7) {
          ...
          if (*(char *)(piVar7 + 9) == '\0') {
            ...
            *(undefined1 *)(piVar9 + 9) = 0;
            fn_82319540(param_2,piVar9);
            piVar7 = (int *)piVar9[2];
          }
          if (*(char *)((int)piVar7 + 0x25) == '\0') {
            if ((*(char *)(*piVar7 + 0x24) != '\x01') || (*(char *)(piVar7[2] + 0x24) != '\x01')) {
              if (*(char *)(piVar7[2] + 0x24) == '\x01') {
                *(undefined1 *)(*piVar7 + 0x24) = 1;
                *(undefined1 *)(piVar7 + 9) = 0;
                fn_823195A8(param_2,piVar7);
                piVar7 = (int *)piVar9[2];
              }
              *(undefined1 *)(piVar7 + 9) = *(undefined1 *)(piVar9 + 9);
              *(undefined1 *)(piVar9 + 9) = 1;
              *(undefined1 *)(piVar7[2] + 0x24) = 1;
              fn_82319540(param_2,piVar9);
              break;
            }
LAB_82319444:
          ...
          if (*(char *)(piVar7 + 9) == '\0') {
            *(undefined1 *)(piVar7 + 9) = 1;
            *(undefined1 *)(piVar9 + 9) = 0;
            fn_823195A8(param_2,piVar9);
            piVar7 = (int *)*piVar9;
          }
          if (*(char *)((int)piVar7 + 0x25) == '\0') {
            if ((*(char *)(piVar7[2] + 0x24) == '\x01') && (*(char *)(*piVar7 + 0x24) == '\x01'))
            goto LAB_82319444;
            if (*(char *)(*piVar7 + 0x24) == '\x01') {
              *(undefined1 *)(piVar7[2] + 0x24) = 1;
              *(undefined1 *)(piVar7 + 9) = 0;
              fn_82319540(param_2,piVar7);
              piVar7 = (int *)*piVar9;
            }
            *(undefined1 *)(piVar7 + 9) = *(undefined1 *)(piVar9 + 9);
            *(undefined1 *)(piVar9 + 9) = 1;
