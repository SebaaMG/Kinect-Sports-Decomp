...
undefined8 fn_82F98378(int *param_1,undefined8 param_2,undefined8 param_3,ulonglong param_4)
  ...
  if ((param_4 & 0xffffffff) == 0) {
    ...
    *(undefined1 *)((int)param_1 + 0x19) = 1;
    ...
    return 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x82f983ec. Too many branches */
