...
void fn_82D6D820(undefined8 param_1,undefined8 param_2,int param_3,undefined4 param_4,int param_5)

{
  ...
  *puVar1 = uVar11;
  ...
  uStack_c0 = param_4;
  fn_82D6D088(param_2,param_1,auStack_80,&ppuStack_e0,pppuVar3);
  return;
}
