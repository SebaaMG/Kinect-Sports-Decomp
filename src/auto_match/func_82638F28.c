...
void fn_82638F28(int param_1,ulonglong param_2)

{
  uint uVar1;
  ulonglong uVar2;
  
  *(int *)(param_1 + 0x2fb8) = (int)param_2;
  if (*(int *)(param_1 + 0x3154) == 0) {
    return;
  }
  uVar1 = *(uint *)(param_1 + 0x2894);
  ...
  *(ulonglong *)(param_1 + 0x10) = *(ulonglong *)(param_1 + 0x10) | 0x10000000000000;
  return;
}
