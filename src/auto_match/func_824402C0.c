...
void fn_824402C0(int *param_1,int *param_2,int *param_3)

{
  bool bVar1;
  undefined1 auStack_80 [128];
  
  if ((param_1[0x12] < param_2[0x12]) || ((param_2[0x12] == param_1[0x12] && (*param_2 < *param_1)))
     ) {
    bVar1 = true;
  }
  else {
  ...
  if ((param_2[0x12] < param_3[0x12]) || ((param_3[0x12] == param_2[0x12] && (*param_3 < *param_2)))
     ) {
    bVar1 = true;
  }
  else {
