...
void fn_827A6060(undefined8 param_1,int *param_2,int *param_3)
    ...
    if ((iVar1 == 0) || ((iVar1 == 1 && (2 < (uint)piVar3[2])))) {
      ...
      if (iVar1 == 0) {
        ...
        if (param_2[1] != 0) {
          iVar1 = 0;
          do {
            fn_8278D2E0(*(undefined4 *)(iVar1 + *param_2),0);
            uVar5 = uVar5 + 1;
            iVar1 = iVar1 + 4;
        ...
        iVar1 = fn_82790270(uVar4,0xffffffff8201178c,uVar6);
        if ((iVar1 == 0) && (uVar5 = 0, param_2[1] != 0)) {
          iVar1 = 0;
          do {
            fn_8278D2E0(*(undefined4 *)(iVar1 + *param_2),1);
            uVar5 = uVar5 + 1;
            iVar1 = iVar1 + 4;
          } while (uVar5 < (uint)param_2[1]);
        }
