...
extern int fn_82A8F8E8();


void fn_82A908E0(int param_1,uint *param_2,undefined8 param_3,longlong param_4,longlong param_5)

{
  ...
  if ((ulonglong)*param_2 <= (ulonglong)*(uint *)(param_1 + 0x10)) {
    uVar10 = (ulonglong)*param_2;
  }
  if (uVar10 != 0) {
    param_2 = param_2 + 0x1a;
    do {
      fn_82A8F8E8(param_1,param_2 + -0x18,param_3,param_4,param_5);
      puVar2 = param_2 + 0xe;
      puVar3 = param_2 + -0xe;
      uVar10 = uVar10 - 1;
      puVar4 = param_2 + -0xd;
