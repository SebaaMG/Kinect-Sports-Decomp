...
extern int fn_82C29638();


undefined8 fn_82C29F00(int param_1,ulonglong param_2)

{
  ...
  while( true ) {
    lVar6 = 0;
    uVar5 = 0;
    piVar2 = *(int **)(*(int *)(*(int *)(param_1 + 0x2c) + 0x10) + 8);
    if (piVar2 != (int *)0x0) {
      iVar3 = *piVar2;
    ...
    uVar4 = fn_82C29638(param_1,auStack_30[0]);
