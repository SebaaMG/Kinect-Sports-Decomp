...
void fn_822491C8(int *param_1,undefined8 param_2,int *param_3)

{
  ...
  if (param_3 != (int *)0x0) {
    ...
    cVar4 = fn_82F64538(uVar2,0xffffffff831d7118);
    if (cVar4 != '\0') {
      iVar5 = *param_3 + 4;
      goto LAB_82249234;
    }
...
LAB_82249234:
  if (iVar5 == 0) {
    (**(code **)(*param_1 + 0x14))(param_1,param_2,auStack_120);
    puVar3 = (undefined4 *)fn_8265C9E0(0x104);
