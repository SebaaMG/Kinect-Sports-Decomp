...
undefined8 fn_82EE6670(int *param_1,int param_2,uint param_3,uint *param_4)
    ...
    if (auStack_30[0] < 0x100000000) {
      *param_4 = (uint)auStack_30[0];
      if (param_3 < (uint)auStack_30[0]) {
        ...
        *(ushort *)(param_2 + 0x18) =
             (ushort)(((ulonglong)(uint)param_1[0x41] & 0xffff) << 8) |
             (ushort)(((ulonglong)(uint)param_1[0x41] & 0xffff) >> 8);
        puVar4 = (ushort *)(param_2 + 0x1a);
        if (param_1[0x41] != 0) {
          uVar3 = 0;
          uStack_40 = uVar2;
          do {
            fn_82EE6350(param_1 + 0x12,uVar3,apuStack_50);
            *puVar4 = *apuStack_50[0] << 8 | *apuStack_50[0] >> 8;
            fn_82EE6350(param_1 + 0x12,uVar3,&uStack_40);
            uVar3 = uVar3 + 1 & 0xffff;
            *(uint *)(puVar4 + 1) =
                 (uint)*(byte *)((((U64)(uStack_40) >> 0) & 0xFFFFFFFF) + 7) << 0x18 |
                 (uint)*(byte *)((((U64)(uStack_40) >> 0) & 0xFFFFFFFF) + 6) << 0x10 |
                 (uint)*(byte *)((((U64)(uStack_40) >> 0) & 0xFFFFFFFF) + 5) << 8 | (uint)*(byte *)((((U64)(uStack_40) >> 0) & 0xFFFFFFFF) + 4);
            puVar4 = puVar4 + 3;
