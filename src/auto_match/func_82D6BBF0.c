...
void fn_82D6BBF0(int param_1,undefined4 *param_2,undefined8 param_3,undefined8 param_4,
                  undefined8 param_5)

{
  ...
  if (-1 < lVar6) {
    ...
    do {
      ...
      puVar5 = puVar5 + 2;
      uStack_25c = uVar1;
      (**(code **)(*(int *)*puVar5 + 0x18))((int *)*puVar5,&uStack_260,param_3,param_4,param_5);
      lVar6 = lVar6 + -1;
    } while (-1 < lVar6);
  }
  iVar3 = KeTlsGetValue(lbl_8323B4A0);
