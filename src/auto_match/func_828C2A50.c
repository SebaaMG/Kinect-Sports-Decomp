...
undefined8 fn_828C2A50(undefined8 param_1,longlong param_2,char param_3)

{
  ...
  *(undefined ***)(auStack_bc + *(int *)(puStack_c0 + 4) + -4) = &lbl_82021284;
  ...
  if (param_3 == '\0') {
    ...
    uVar2 = fn_82240158(&puStack_c0,0xffffffff82026080);
    ...
    uVar2 = fn_82240158(&puStack_c0,0xffffffff82026088);
    uVar1 = fn_8223B728(uVar2,uVar1);
