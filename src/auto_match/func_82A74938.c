...
extern unsigned int lbl_820A89B8;
extern unsigned int lbl_820A8AA8;
extern unsigned int uStack_70;


undefined8 fn_82A74938(int *param_1,int param_2,int param_3)

{
  ...
  do {
    ...
    if (param_1[0x1f] == 0) {
      piVar7 = param_1 + 0x38;
      uVar5 = fn_82A75DF8(0xffffffff820a8468,piVar7,&uStack_70,&iStack_6c,aiStack_68);
      if ((int)uVar5 < 0) {
        return uVar5;
      }
      ...
      if (iStack_6c == 0) goto LAB_82a749f4;
      if (iStack_6c == 1) {
        ...
        *(undefined2 *)(iVar3 + 0x1c) = *(undefined2 *)(&lbl_820A89B8 + (iStack_6c + -2) * 2);
        *(undefined2 *)(iVar3 + 0x1e) = *(undefined2 *)(&lbl_820A8AA8 + (iStack_6c + -2) * 2);
...
LAB_82a749f4:
      param_1[0x1f] = 3;
      uVar5 = fn_82A6D090(param_1 + 0x38,0xe,&uStack_70);
      if ((int)uVar5 < 0) {
        return uVar5;
      }
