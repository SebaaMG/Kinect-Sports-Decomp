...
undefined8 *
fn_822ED530(undefined8 *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
             undefined8 param_5,uint *param_6,float *param_7)

{
  ...
  uVar1 = fn_82F639E0(auStack_70,apuStack_78,uVar1,&iStack_7c);
  dVar3 = extraout_f1;
  if (iStack_80 != 0) {
    dVar3 = (double)fn_82F65148(uVar1,iStack_80 << 2);
    dVar3 = (double)(float)dVar3;
  }
  cVar2 = fn_822EF458(&stack0x00000020,&stack0x00000028);
  if (cVar2 != '\0') {
    *param_6 = *param_6 | 1;
  }
