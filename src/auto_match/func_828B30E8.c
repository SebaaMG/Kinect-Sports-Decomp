...
undefined4 * fn_828B30E8(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar11 + 0x19) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x19) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar3 = *(undefined1 *)(piStack00000024 + 6);
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    piVar9 = piVar11;
    if (*(char *)((int)piVar10 + 0x19) == '\0') {
      cVar2 = *(char *)(*piVar10 + 0x19);
      piVar4 = (int *)*piVar10;
      piVar9 = piVar10;
      while (piVar7 = piVar4, cVar2 == '\0') {
        piVar4 = (int *)*piVar7;
        cVar2 = *(char *)((int)piVar4 + 0x19);
        piVar9 = piVar7;
      }
    }
  ...
  if (*(int **)(iVar5 + 8) == param_3) {
    if (*(char *)((int)piVar10 + 0x19) == '\0') {
      cVar2 = *(char *)(piVar10[2] + 0x19);
      piVar9 = (int *)piVar10[2];
      piVar4 = piVar10;
      while (piVar7 = piVar9, cVar2 == '\0') {
        piVar9 = (int *)piVar7[2];
        cVar2 = *(char *)((int)piVar9 + 0x19);
        piVar4 = piVar7;
      }
      *(int **)(iVar5 + 8) = piVar4;
    }
        ...
        if (piVar10 == piVar9) {
          ...
          if (*(char *)(piVar9 + 6) == '\0') {
            ...
            *(undefined1 *)(piVar11 + 6) = 0;
            fn_828A1A70(param_2,piVar11);
            piVar9 = (int *)piVar11[2];
          }
          if (*(char *)((int)piVar9 + 0x19) == '\0') {
            if ((*(char *)(*piVar9 + 0x18) != '\x01') || (*(char *)(piVar9[2] + 0x18) != '\x01')) {
              if (*(char *)(piVar9[2] + 0x18) == '\x01') {
                *(undefined1 *)(*piVar9 + 0x18) = 1;
                *(undefined1 *)(piVar9 + 6) = 0;
                fn_828B3008(param_2,piVar9);
                piVar9 = (int *)piVar11[2];
              }
              *(undefined1 *)(piVar9 + 6) = *(undefined1 *)(piVar11 + 6);
              *(undefined1 *)(piVar11 + 6) = 1;
              *(undefined1 *)(piVar9[2] + 0x18) = 1;
              fn_828A1A70(param_2,piVar11);
              break;
            }
LAB_828b3410:
          ...
          if (*(char *)(piVar9 + 6) == '\0') {
            *(undefined1 *)(piVar9 + 6) = 1;
            *(undefined1 *)(piVar11 + 6) = 0;
            fn_828B3008(param_2,piVar11);
            piVar9 = (int *)*piVar11;
          }
          if (*(char *)((int)piVar9 + 0x19) == '\0') {
            if ((*(char *)(piVar9[2] + 0x18) == '\x01') && (*(char *)(*piVar9 + 0x18) == '\x01'))
            goto LAB_828b3410;
            if (*(char *)(*piVar9 + 0x18) == '\x01') {
              *(undefined1 *)(piVar9[2] + 0x18) = 1;
              *(undefined1 *)(piVar9 + 6) = 0;
              fn_828A1A70(param_2,piVar9);
              piVar9 = (int *)*piVar11;
            }
            *(undefined1 *)(piVar9 + 6) = *(undefined1 *)(piVar11 + 6);
            *(undefined1 *)(piVar11 + 6) = 1;
