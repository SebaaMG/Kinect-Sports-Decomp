...
undefined8 fn_826A4D98(int *param_1,ulonglong param_2,ulonglong param_3,undefined8 param_4)
    ...
    do {
      while( true ) {
        ...
        *(undefined4 *)(iVar2 + iVar6) = uVar1;
        iVar6 = (int)lVar15;
        iVar2 = (int)lVar14;
        iVar5 = fn_826A3F08(param_4,*(undefined4 *)(iVar2 + *param_1),
        ...
        iVar5 = fn_826A3F08(param_4,*(undefined4 *)(iVar7 + *param_1),
                              *(undefined4 *)(iVar6 + *param_1));
        if (iVar5 < 0) {
          iVar5 = *param_1;
        ...
        iVar6 = fn_826A3F08(param_4,*(undefined4 *)(iVar2 + *param_1),
...
LAB_826a4ff0:
          ...
          iVar6 = fn_826A3F08(param_4,*(undefined4 *)((int)lVar15 + *param_1),
                                *(undefined4 *)(iVar7 + *param_1));
        } while (iVar6 < 0);
        do {
          uVar12 = uVar12 - 1;
          lVar14 = lVar14 + -4;
          if ((longlong)uVar12 < 0) goto LAB_826a4ff0;
          iVar6 = fn_826A3F08(param_4,*(undefined4 *)(iVar7 + *param_1),
...
LAB_826a4fd0:
      ...
      if ((int)param_2 < (int)uVar3) {
        while( true ) {
          ...
          puVar9 = (undefined4 *)(*param_1 + iVar6);
          iVar7 = fn_826A3F08(param_4,puVar9[1],*puVar9);
          if (-1 < iVar7) break;
          puVar9 = (undefined4 *)(*param_1 + iVar6);
          uVar1 = puVar9[1];
          puVar9[1] = *puVar9;
