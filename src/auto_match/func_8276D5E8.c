...
void fn_8276D5E8(int *param_1,undefined8 param_2,undefined4 *param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if ((uint)(*piVar1 * 5) <= (uint)((piVar1[1] + 1) * 4)) goto LAB_8276d644;
...
LAB_8276d644:
  ...
  *piVar1 = *piVar1 + 1;
  ...
  if (uVar3 == 0xfffffffe) {
    *puVar12 = 0xffffffff;
    *(undefined2 *)(iVar5 + 0x10) = *(undefined2 *)param_3;
    *(undefined2 *)(iVar5 + 0x12) = *(undefined2 *)((int)param_3 + 2);
