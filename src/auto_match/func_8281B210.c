...
void fn_8281B210(undefined4 *param_1,undefined2 param_2,int param_3,int param_4,longlong param_5,
...

{
  ...
  if ((param_7 & 2) != 0) {
                    /* WARNING: Subroutine does not return */
    fn_82F691F0(param_5,0xee,param_6 - param_5);
  }
  fn_82819110(param_3,param_6 - param_5,param_7);
  *(undefined **)(param_3 + 0x10) = &lbl_8320A5F8;
  *(int *)(param_3 + 0x7c) = param_3 + 0x10c;
  *(undefined2 *)(param_3 + 0x82) = 0;
  *(undefined2 *)(param_3 + 0x84) = 0;
  *(undefined2 *)(param_3 + 0x80) = param_2;
  *(undefined2 *)(param_3 + 0x108) = 0xffff;
                    /* WARNING: Subroutine does not return */
  fn_82F691F0(param_3 + 0x10c,0,(param_4 - param_3) + -0x10c);
}
