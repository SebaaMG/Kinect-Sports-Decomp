...
undefined4 fn_82FB1A80(int *param_1,longlong param_2)

{
  ...
  iVar3 = fn_82FA5060(lbl_831BC768,(uVar8 + (uVar8 & 0x7fffffff) * 2 & 0x1fffffff) << 3);
  uVar2 = 0;
  if (iVar3 != 0) {
    ...
    if (*param_1 != 0) {
      if (uVar1 != 0) {
        ...
        do {
          puVar5 = (undefined4 *)(iVar7 + iVar3 + -4);
          puVar6 = (undefined4 *)(iVar7 + *param_1 + -4);
          lVar9 = 6;
          do {
            puVar6 = puVar6 + 1;
            puVar5 = puVar5 + 1;
