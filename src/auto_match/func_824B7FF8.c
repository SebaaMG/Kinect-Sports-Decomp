...
void fn_824B7FF8(undefined8 param_1,undefined1 param_2,undefined4 param_3)
  ...
  if (cVar3 == '\0') {
    ...
    if ((cVar3 != '\0') && (cVar3 = fn_82512508(param_1), cVar3 != '\0')) {
      ...
      if (iVar2 != 0) {
        ...
        fn_8245B100(iVar1);
        auStack_40[0] = (undefined2)param_3;
        fn_8245B168(iVar1,auStack_40,2);
        fn_824B70F0();
