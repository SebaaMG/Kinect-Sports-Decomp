...
void fn_8256CF38(int param_1,undefined4 *param_2)

{
  ...
  if (uVar3 != *(uint *)(param_1 + 4)) {
    ...
    for (puVar4 = *(uint **)(param_1 + 0x48); puVar4 != puVar1; puVar4 = puVar4 + 3) {
      cVar2 = fn_827D9768((ulonglong)*puVar4 + 0x1f8,uVar3 + 0x10);
      if (cVar2 != '\0') break;
    }
    if (puVar4 != *(uint **)(param_1 + 0x4c)) {
      auStack_48[0] = 0;
      auStack_48[1] = 0;
      fn_82517978(auStack_48,*puVar4,puVar4[1],0);
      fn_8256C5D0(param_1,auStack_48);
      fn_8256D710(auStack_48,param_1 + 0x48,puVar4);
    }
    puVar1 = *(uint **)(param_1 + 0x5c);
    for (puVar4 = *(uint **)(param_1 + 0x58); puVar4 != puVar1; puVar4 = puVar4 + 3) {
      cVar2 = fn_827D9768((ulonglong)*puVar4 + 0x1f8,uVar3 + 0x28);
      if (cVar2 != '\0') break;
    }
    if (puVar4 != *(uint **)(param_1 + 0x5c)) {
      auStack_48[0] = 0;
      auStack_48[1] = 0;
      fn_82517978(auStack_48,*puVar4,puVar4[1],0);
      fn_8256C5D0(param_1,auStack_48);
      fn_8256D710(auStack_48,param_1 + 0x58,puVar4);
    }
  }
  return;
}
