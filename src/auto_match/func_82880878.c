...
void fn_82880878(int param_1,ulonglong param_2)

{
  ...
  if ((param_2 & 0xffffffff) <= (0xfffffff - uVar6 & 0xffffffff)) {
    uVar5 = (ulonglong)(*(uint *)(param_1 + 8) >> 1);
    if (uVar5 < 8) {
      uVar5 = 8;
    }
    if (((param_2 & 0xffffffff) < uVar5) && (uVar6 <= (0xfffffff - uVar5 & 0xffffffff))) {
      param_2 = uVar5;
    }
