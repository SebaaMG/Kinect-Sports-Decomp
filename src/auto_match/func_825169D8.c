...
void fn_825169D8(int param_1)

{
  undefined8 uVar1;
  longlong lVar2;
  
  lVar2 = (ulonglong)*(uint *)(param_1 + 0x10) + 0x34;
  uVar1 = fn_82897B18(lVar2);
  fn_82897600(param_1,param_1 + 0x48,uVar1);
  *(undefined4 *)(param_1 + 0x70) = *(undefined4 *)(param_1 + 0xc);
  fn_82898220(param_1 + 0x48,param_1,lVar2,*(undefined4 *)(param_1 + 4));
  uVar1 = fn_8236D750(lVar2);
  fn_82243568(param_1 + 0x4c,0,uVar1,0);
  return;
}
