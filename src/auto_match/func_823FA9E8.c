...
undefined4 * fn_823FA9E8(undefined4 *param_1,int param_2,int param_3)

{
  ...
  if (*(char *)((int)puVar2[1] + 0x49) == '\0') {
    ...
    do {
      puVar2 = puVar1;
      uVar3 = ((~(ulonglong)(puVar2[4] ^ *(uint *)(param_3 + 0x10)) & 0xffffffff) >> 0x1f) +
              (ulonglong)((uint)puVar2[4] <= *(uint *)(param_3 + 0x10)) & 1;
      if (uVar3 == 0) {
  ...
  if (*(int *)(param_3 + 0x10) <= (int)apuStack_50[0][4]) {
...
LAB_823faa80:
  puVar2 = (undefined4 *)fn_823FAB00(apuStack_50,param_2,uVar3,puVar2,param_3);
