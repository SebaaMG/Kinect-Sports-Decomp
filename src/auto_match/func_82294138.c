...
void fn_82294138(int param_1,int param_2,longlong param_3)

{
  ...
  if (*(int *)(iVar3 + 0x44) != (int)param_3) {
    ...
    fn_82672C20(*puVar1,0xffffffff821ab958,auStack_50,2);
    puVar4 = auStack_30;
    lVar5 = 1;
    do {
      puVar4 = puVar4 + -0x10;
