...
extern unsigned int lbl_821B7B10;


void fn_823F80E0(int *param_1,undefined8 param_2,int *param_3)

{
  ...
  if (param_3 != (int *)0x0) {
    ...
    cVar4 = fn_82F64538(uVar2,0xffffffff831dfae8);
    if (cVar4 != '\0') {
      iVar5 = *param_3 + 0x10;
      goto LAB_823f814c;
    }
...
LAB_823f814c:
  if (iVar5 == 0) {
    ...
    (**(code **)(*param_1 + 0x14))(param_1,param_2,auStack_b0);
