...
undefined8 fn_828CDBD0(undefined8 param_1,int param_2)

{
  ...
  *(undefined ***)(auStack_bc + *(int *)(puStack_c0 + 4) + -4) = &lbl_82021284;
  ...
  uVar1 = *(undefined1 *)(param_2 + 0x8c);
  uVar3 = *(undefined4 *)(param_2 + 0x84);
  uVar4 = fn_82240158(&puStack_c0,0xffffffff82026658);
  uVar4 = fn_82520AC8(uVar4,uVar3);
  uVar4 = fn_82240158(uVar4,0xffffffff82026644);
  uVar4 = fn_828A8E18(uVar4,uVar1);
  uVar4 = fn_82240158(uVar4,0xffffffff82026638);
