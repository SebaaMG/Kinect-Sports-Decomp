...
void fn_8232AFC0(int param_1,undefined4 param_2)

{
  ...
  puVar2 = (undefined4 *)
           fn_8232B500(&stack0x00000000 + -0x40,param_1 + 0xc,&stack0x00000000 + 0x1c);
  uVar3 = 0;
  uVar4 = 0;
  ...
  *(undefined4 *)(param_1 + 0x110) = uVar3;
  ...
  puVar2 = (undefined4 *)
           fn_8232B500(&stack0x00000000 + -0x38,param_1 + 0xc,&stack0x00000000 + 0x1c);
  uVar3 = 0;
  uVar4 = 0;
  if ((undefined4 *)(&stack0x00000000 + -0x30) != puVar2) {
    uVar4 = puVar2[1];
