...
#define CONCAT12(h,l) ((U32)((((U8)(h)) << 16) | ((U16)(l))))
#define CONCAT13(h,l) ((U32)((((U8)(h)) << 24) | ((U32)(l))))


void fn_82CD5C30(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
    ...
    do {
      ...
      if (0x8000 < iVar9) {
        ...
        do {
          ...
          iVar3 = iVar6 + param_7;
          puVar10 = puVar10 + 1;
          *puVar10 = CONCAT13(*(undefined1 *)((iVar6 >> (in_stack_00000054 & 0x3f)) + iVar2),
                              CONCAT12(*(undefined1 *)
                                        ((iVar5 >> (in_stack_00000054 & 0x3f)) + iVar2),
                                       CONCAT11(*(undefined1 *)
                                                 ((iVar4 >> (in_stack_00000054 & 0x3f)) + iVar2),
                                                *(undefined1 *)(iVar1 + iVar2))));
        } while (iVar3 < iVar9);
      }
      iVar8 = iVar8 + param_8;
