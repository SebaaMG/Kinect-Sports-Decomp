...
undefined4 * fn_828C6D50(undefined4 *param_1,int param_2,undefined8 param_3)

{
  ...
  *(undefined1 *)(param_1 + 0x26) = 1;
  param_1[0x27] = 0;
  uVar1 = fn_823AA970(param_3);
  param_1[0x27] = uVar1;
  *(undefined1 *)(param_1 + 0x28) = *(undefined1 *)(param_2 + 0x5c);
  fn_8288DB98(param_2,param_3,param_1 + 0x22);
  return param_1;
}
