...

{
  ...
  uVar2 = param_1[0x1a4c] - 1;
  param_1[0x1a4c] = uVar2;
  lVar3 = (ulonglong)*param_1 + 0x40;
  lVar4 = (ulonglong)*param_1 + 0x80;
  if (param_1[0x23] != 0xffff) {
    fn_8280CD18(param_1 + uVar2 * 0x34 + 0x6c,auStack_80);
    uVar1 = param_1[0x23];
  ...
  if (param_1[0x21] != 0xffff) {
    ...
    uVar1 = param_1[0x21];
    fn_826310E0(param_1[1],(ulonglong)uVar1,auStack_80,4,
                 (ulonglong)
                 (-0x8000000000000000 >>
  ...
  if (param_1[0x22] != 0xffff) {
    fn_8280CC30(lVar3,param_1 + uVar2 * 0x34 + 0x6c,auStack_80);
    uVar1 = param_1[0x22];
    fn_826310E0(param_1[1],(ulonglong)uVar1,auStack_80,3,
                 (ulonglong)
                 (-0x8000000000000000 >>
  ...
  if (param_1[0x48] != 0xffff) {
    fn_8280CC30(lVar4,param_1 + uVar2 * 0x34 + 0x4c,(ulonglong)*param_1 + 0xc0);
    uVar2 = param_1[0x48];
    fn_826310E0(param_1[1],(ulonglong)uVar2,(ulonglong)*param_1 + 0xc0,4,
                 (ulonglong)
                 (-0x8000000000000000 >>
