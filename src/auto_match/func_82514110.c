...
extern int fn_82514288();
extern int fn_825143C8();


undefined4 * fn_82514110(undefined4 *param_1,int param_2,int *param_3,int param_4)
  ...
  if (*(int *)(param_2 + 8) == 0) {
    ...
    if (param_3 != (int *)*piVar2) {
      if (param_3 == piVar2) {
        ...
        if (*(uint *)(param_4 + 0xc) <= (uint)param_3[3]) goto LAB_8251425c;
        uVar7 = 0;
      }
      else {
        ...
        if ((uVar3 < uVar4) &&
          ...
          if ((uVar3 <= uVar4) ||
             ((apiStack_50[0] = param_3, puVar6 = (undefined4 *)fn_82248B90(apiStack_50),
              (int *)*puVar6 != piVar2 && ((uint)apiStack_50[0][3] <= uVar3)))) goto LAB_8251425c;
...
LAB_8251425c:
      puVar6 = (undefined4 *)fn_82514288(auStack_48,param_2,param_4);
      *param_1 = *puVar6;
      return param_1;
    }
  }
  uVar7 = 1;
LAB_82514154:
  fn_825143C8(param_1,param_2,uVar7,param_3,param_4);
  return param_1;
}
