...
undefined4 *
fn_828961F0(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)

{
  ...
  if (0xcccccca < *(uint *)(param_2 + 8)) {
    fn_8224ED20(auStack_40,param_5 + 4,*(undefined4 *)param_5[5]);
  ...
  while (cVar1 == '\0') {
    ...
    if (piVar2 == (int *)*piVar3) {
      ...
      if (*(char *)(iVar4 + 0x20) == '\0') {
        ...
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x20) = 0;
        fn_8288B838(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar4 = *piVar3;
      if (*(char *)(iVar4 + 0x20) == '\0') {
        ...
        *(undefined1 *)(piVar5[1] + 0x20) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x20) = 0;
        fn_828C0218(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
