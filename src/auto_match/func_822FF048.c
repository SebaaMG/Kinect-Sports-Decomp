...
void fn_822FF048(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (puVar3 == (undefined4 *)0x0) {
    ...
    *puVar3 = &lbl_821AD588;
    ...
    if (puVar3 + 3 != (undefined4 *)0x0) {
      fn_822FB670(puVar3 + 3,param_4,param_3,param_2,param_5,0);
    }
  }
  puStack_60 = puVar3 + 3;
  uVar1 = *param_7;
  puStack_5c = puVar3;
  uVar2 = fn_822C7578(puVar3 + 0x13,(ulonglong)*param_8 + 4);
  fn_82230218(uVar2,(ulonglong)uVar1 + 4,0,0xffffffffffffffff);
  iVar4 = fn_82365BD8(auStack_58,param_8);
  ...
  uVar2 = fn_822C7578((ulonglong)*param_7 + 0x40,param_4);
  fn_82230218(uVar2,param_4,0,0xffffffffffffffff);
