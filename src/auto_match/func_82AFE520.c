...
void fn_82AFE520(int param_1,uint *param_2,uint *param_3,uint param_4,char param_5,char param_6)

{
  ...
  while (puVar1 = (uint *)*puVar5, puVar1 != (uint *)0x0) {
    ...
    if (((uVar8 & 0xe000000) == 0) &&
       (((param_5 != '\0' || ((uVar8 >> 0x1e & 1) == 0)) || ((uVar8 & 0x1ffe000) != 0)))) {
  ...
  if (param_6 != '\0') {
    ...
    param_3[2] = param_3[2] | 0x1000000;
  }
  if (((param_3[2] >> 0x17 & 1) != 0) || ((param_2[2] >> 0x17 & 1) == 0)) goto LAB_82afe7b4;
  ...
  *(undefined2 *)((int)param_3 + 0x12) = uVar4;
  ...
  if ((puVar5[1] & 1) == 0) {
    ...
    iVar3 = uVar8 - 4;
    if ((iVar3 == 0) || (*(uint *)(uVar8 + 8) < *(int *)(uVar8 + 4) + 1U)) goto LAB_82afe790;
  }
  else {
LAB_82afe790:
