...
void fn_82DB4350(undefined4 *param_1)

{
  ...
  if ((param_1[0xd] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[0xb],param_1[0xd] & 0x3fffffff,0xc);
  }
  param_1[0xb] = 0;
  ...
  if ((param_1[10] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[8],param_1[10] & 0x3fffffff,0x10);
  }
  param_1[8] = 0;
