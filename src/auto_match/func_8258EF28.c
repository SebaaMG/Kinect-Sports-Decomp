...
extern int fn_8258F168();
extern int fn_8260D428();
extern int fn_8265CA20();


undefined4 * fn_8258EF28(undefined4 *param_1,int param_2,int param_3)

{
  ...
  if (uVar5 != 0) {
    ...
    if (*(char *)((int)puVar2 + 0x39) == '\0') {
      puVar7 = (undefined4 *)*puVar2;
      if (*(char *)((int)puVar7 + 0x39) == '\0') {
        puVar4 = (undefined4 *)puVar7[2];
        while (puVar1 = puVar4, *(char *)((int)puVar1 + 0x39) == '\0') {
          puVar7 = puVar1;
...
LAB_8258efc8:
  puVar2 = (undefined4 *)fn_8258F168(auStack_50,param_2,uVar5,puVar2,param_3);
