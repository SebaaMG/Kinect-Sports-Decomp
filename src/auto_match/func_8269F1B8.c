...
undefined4 * fn_8269F1B8(undefined4 *param_1,uint *param_2,ulonglong param_3,undefined4 param_4)

{
  ...
  *param_1 = 1;
  ...
  fn_8268B610(&uStack_30,*(undefined4 *)param_1[2],0xffffffffffffffff);
