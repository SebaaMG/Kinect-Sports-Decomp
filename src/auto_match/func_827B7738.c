...
void fn_827B7738(int *param_1,undefined8 param_2,uint param_3)

{
  ...
  if (param_3 == 0) {
    ...
    uStack_48 = CONCAT44(0xc3,(((U64)(uStack_48) >> 32) & 0xFFFFFFFF));
    apuStack_50[0] = (undefined4 *)0x0;
    apuStack_50[0] = (undefined4 *)fn_8267BED0(param_2,uVar5 * 0x18 + 8,&uStack_48);
    *apuStack_50[0] = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar3 = iVar2 + *param_1;
        if (*(int *)(iVar3 + 8) != -2) {
          fn_827B8210(apuStack_50,param_2,iVar3 + 0x10,
                            (uint)(byte)(*(byte *)(iVar3 + 0x1b) ^ *(byte *)(iVar3 + 0x1a) ^
                                         *(byte *)(iVar3 + 0x18) ^ *(byte *)(iVar3 + 0x17) ^
                                        *(byte *)(iVar3 + 0x16)) ^
                            (uint)*(byte *)(iVar3 + 0x19) << 1 ^ (uint)*(ushort *)(iVar3 + 0x14) ^
                            *(uint *)(iVar3 + 0x10) >> 6 ^ *(uint *)(iVar3 + 0x10));
