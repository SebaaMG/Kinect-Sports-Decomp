...
void fn_82264BB8(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (*pcVar2 != '\0') {
    iVar3 = fn_8225FDE0(0x15,param_3);
    if ((iVar3 == 0) && (cVar4 = fn_82E1CAD0(0x15), cVar4 != '\0')) {
      ...
      fn_82E1CB88(0xffffffff821a7654,param_6);
      fn_82E1CB88(0xffffffff821a7784,param_7);
      fn_82E1CCA8();
    }
  }
  return;
