...
void fn_828789A8(uint *param_1,longlong param_2)

{
  ...
  uVar1 = (int)(param_1[1] - *param_1) / 0x30;
  if ((0x5555555U - param_2 & 0xffffffff) < (ulonglong)uVar1) {
  ...
  uVar1 = (int)(param_1[2] - *param_1) / 0x30;
  ...
  if (0x5555555 < (uVar4 & 0xffffffff)) {
                    /* WARNING: Subroutine does not return */
    fn_82F622A8(0xffffffff82196fd4);
  }
  if ((ulonglong)(uint)((int)(param_1[2] - *param_1) / 0x30) < (uVar4 & 0xffffffff)) {
    uVar3 = fn_82878160(uVar4,0);
    uVar1 = param_1[1];
    uVar5 = uVar3;
    for (uVar7 = (ulonglong)*param_1; (uVar7 & 0xffffffff) != (ulonglong)uVar1; uVar7 = uVar7 + 0x30
        ) {
      if ((uVar5 & 0xffffffff) != 0) {
        fn_82878358(uVar5,uVar7);
      }
      uVar5 = uVar5 + 0x30;
    }
    uVar1 = *param_1;
    ...
    uVar6 = (uint)uVar3;
    *param_1 = uVar6;
    param_1[2] = (int)uVar4 * 0x30 + uVar6;
    param_1[1] = ((int)(uVar2 - uVar1) / 0x30) * 0x30 + uVar6;
  }
  return;
}
