...
extern int fn_824578C8();
extern int fn_82457CC8();
extern int fn_8265CA20();


undefined4 * fn_824577A0(undefined4 *param_1,int param_2,int *param_3,int *param_4)
    ...
    while (param_3 != param_4) {
      ...
      if (*(char *)((int)param_3 + 0x31) == '\0') {
        ...
        if (*(char *)((int)piVar5 + 0x31) == '\0') {
          ...
          piVar4 = param_3;
          while ((piVar5 = piVar3, *(char *)((int)piVar5 + 0x31) == '\0' &&
                 (piVar4 == (int *)piVar5[2]))) {
            piVar4 = piVar5;
            piVar3 = (int *)piVar5[1];
          }
      ...
      fn_824578C8(auStack_30,param_2,param_3);
      param_3 = piVar5;
    }
    *param_1 = param_3;
  }
