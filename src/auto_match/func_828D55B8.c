...
void fn_828D55B8(ulonglong param_1,undefined8 param_2)
  ...
  if ((((U64)(uStack00000010) >> 32) & 0xFFFFFFFF) != (((U64)(uStack00000018) >> 32) & 0xFFFFFFFF)) {
    ...
    if (uVar14 != (((U64)(uStack00000018) >> 32) & 0xFFFFFFFF)) {
      ...
      do {
        ...
        uVar1 = *(uint *)(*(int *)(uVar7 * 4 + *piVar12) + (uVar14 & 3) * 4);
        uVar9 = uVar3;
        ...
        if (uVar1 < *(uint *)(*(int *)((int)((uVar9 & 0xffffffff) << 2) + *(int *)(iVar5 + 4)) +
                             (int)((param_1 & 3) << 2))) {
          ...
          *(uint *)(*(int *)((int)((uVar9 & 0xffffffff) << 2) + *(int *)(iVar5 + 4)) +
                   (int)((param_1 & 3) << 2)) = uVar1;
        }
        else {
          uStack_68 = uStack_70;
          uVar6 = uStack_68;
          ...
          while( true ) {
            ...
            if (*(uint *)(*(int *)((int)((uVar10 & 0xffffffff) << 2) + iVar2) +
                         (int)(((ulonglong)uVar7 & 3) << 2)) <= uVar1) break;
            if (uVar8 <= uVar9) {
              uVar9 = uVar9 - uVar8;
            }
            ...
            *(undefined4 *)
             (*(int *)(*(int *)((((U64)(uStack_68) >> 0) & 0xFFFFFFFF) + 4) + uVar11 * 4) + ((((U64)(uStack_78) >> 32) & 0xFFFFFFFF) & 3) * 4) =
                 *(undefined4 *)
                  (*(int *)((int)((uVar9 & 0xffffffff) << 2) + iVar2) +
          ...
          *(uint *)(*(int *)(uVar7 * 4 + *(int *)((((U64)(uStack_68) >> 0) & 0xFFFFFFFF) + 4)) + ((((U64)(uStack_78) >> 32) & 0xFFFFFFFF) & 3) * 4)
               = uVar1;
        }
        uVar14 = uVar14 + 1;
