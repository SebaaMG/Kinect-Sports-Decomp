...
extern int fn_828B7D48();
extern int fn_828CCCC0();


void fn_828D0AF8(uint *param_1,undefined4 *param_2)

{
  ...
  if (bVar4) {
    ...
    if (puVar5 == (undefined4 *)param_1[2]) {
      fn_828B7D48(param_1,1);
    }
    puVar5 = (undefined4 *)param_1[1];
    puVar6 = (undefined4 *)(((int)((int)param_2 - uVar1) >> 3) * 8 + *param_1);
    if (puVar5 == (undefined4 *)0x0) goto LAB_828d0bc8;
    *puVar5 = 0;
    puVar5[1] = 0;
    uVar2 = puVar6[1];
    uVar3 = *puVar6;
  ...
  fn_828CCCC0(puVar5,uVar3,uVar2,0);
LAB_828d0bc8:
