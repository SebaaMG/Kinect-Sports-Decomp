...
extern int iRam831bc2b0;
extern int iRam831bc2b4;
extern int iRam831bc2c0;
extern int iRam831bc2c4;
extern unsigned int iStack_80;
extern unsigned int stack0x00000000;
extern unsigned int uRam831bc2b8;
extern unsigned int uRam831bc2bc;
extern unsigned int uStack_84;
extern unsigned int uStack_88;


undefined8 fn_82F86B68(ushort *param_1,uint *param_2)

{
  ...
  if (iVar16 == -0x3fff) {
    ...
    uVar18 = uRam831bc2b8 - 1;
    uVar8 = 1;
    iVar3 = (int)uRam831bc2b8 >> 5;
    uStack_84 = auStack_98[1];
    uVar22 = (longlong)iVar3 + (ulonglong)((int)uRam831bc2b8 < 0 && (uRam831bc2b8 & 0x1f) != 0);
    iStack_80 = auStack_98[2];
    iVar5 = (int)((uVar22 & 0x3fffffff) << 2);
    uVar19 = 0x1f - (uRam831bc2b8 +
                    (iVar3 + (uint)((int)uRam831bc2b8 < 0 && (uRam831bc2b8 & 0x1f) != 0)) * -0x20);
    iVar4 = (int)uVar18 >> 5;
    if ((1 << (uVar19 & 0x3f) & *(uint *)((int)auStack_98 + iVar5)) != 0) {
      if ((*(uint *)((int)auStack_98 + (int)((uVar22 & 0xffffffff) << 2)) & ~(-1 << (uVar19 & 0x3f))
        ...
        if ((int)uVar15 < 3) {
          ...
          do {
            if (*(int *)lVar12 != 0) goto LAB_82f86cb0;
            uVar15 = uVar15 + 1;
            lVar12 = lVar12 + 4;
          } while ((int)uVar15 < 3);
        }
...
LAB_82f86cb0:
    ...
    *(uint *)((int)auStack_98 + iVar5) = -1 << (uVar19 & 0x3f) & *(uint *)((int)auStack_98 + iVar5);
    ...
    if (iVar20 < (int)(iRam831bc2b4 - uVar10)) {
      iVar9 = 0;
      uVar8 = 2;
      auStack_98[0] = 0;
      auStack_98[1] = 0;
    ...
    lVar12 = 3;
    if (iVar20 <= iRam831bc2b4) {
      uVar17 = iRam831bc2b4 - iVar16;
      ...
      if ((1 << (uVar21 & 0x3f) & *(uint *)((int)auStack_98 + iVar9)) != 0) {
        if ((*(uint *)((int)auStack_98 + (int)((uVar22 & 0xffffffff) << 2)) &
          ...
          if ((int)uVar15 < 3) {
            lVar12 = (uVar15 & 0x3fffffff) * 4 + (uVar7 - 0x98);
            do {
              if (*(int *)lVar12 != 0) goto LAB_82f86f1c;
              uVar15 = uVar15 + 1;
              lVar12 = lVar12 + 4;
            } while ((int)uVar15 < 3);
          }
...
LAB_82f86f1c:
    ...
    if (iRam831bc2b0 <= iVar20) {
      ...
      iVar9 = iRam831bc2c4 + iVar5;
      goto LAB_82f87230;
    }
    uVar10 = iVar9 + (uint)((int)uVar6 < 0 && (uVar6 & 0x1f) != 0);
    auStack_98[0] = auStack_98[0] & 0x7fffffff;
    iVar20 = iRam831bc2c4 + iVar20;
    uVar18 = uVar6 + (iVar9 + (uint)((int)uVar6 < 0 && (uVar6 & 0x1f) != 0)) * -0x20;
    uVar21 = 0;
    lVar13 = uVar7 - 0x9c;
    do {
  ...
  uVar8 = 0;
LAB_82f87230:
  if (iRam831bc2c0 == 0x40) {
    param_2[1] = auStack_98[1];
  }
  else if (iRam831bc2c0 != 0x20) {
    return uVar8;
  }
