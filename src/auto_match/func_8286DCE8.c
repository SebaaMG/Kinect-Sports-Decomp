...
extern int fn_8286DCA0();
extern int fn_82F622E0();
extern unsigned int stack0x00000024;


undefined4 * fn_8286DCE8(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x49) == '\0') {
      piVar6 = (int *)*piVar8;
      piVar7 = piVar8;
      while (piVar3 = piVar6, *(char *)((int)piVar3 + 0x49) == '\0') {
        piVar7 = piVar3;
        piVar6 = (int *)*piVar3;
      }
    }
        ...
        if (piVar8 == piVar7) {
          ...
          if (*(char *)((int)piVar7 + 0x49) == '\0') {
            if ((*(char *)(*piVar7 + 0x48) != '\x01') || (*(char *)(piVar7[2] + 0x48) != '\x01')) {
              ...
              *(undefined1 *)(piVar7 + 0x12) = *(undefined1 *)(piVar9 + 0x12);
...
LAB_8286dffc:
  ...
  fn_8286DCA0(param_2 + 0xd,param_3 + 3);
  fn_8265CA20(param_3);
  if (*(int *)(param_2 + 8) != 0) {
