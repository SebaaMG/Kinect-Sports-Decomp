...
void fn_822440D0(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4)

{
  ...
  iVar2 = 0;
  for (pcVar3 = pcVar5; pcVar3 != pcVar5 + 0x3e; pcVar3 = pcVar3 + 1) {
    if (*pcVar3 == '\0') {
      iVar2 = iVar2 + 1;
    }
  }
  fn_8223C200(param_3,iVar2 == 0x3e,0);
  if (iVar2 != 0x3e) {
    uVar4 = 0;
    do {
      cVar1 = pcVar5[uVar4];
