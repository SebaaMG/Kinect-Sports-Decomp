...
void fn_830049F8(double param_1,int *param_2,int param_3,undefined8 param_4,ulonglong param_5,
...

{
  ...
  if (param_3 != 0) {
    if (*(int *)(param_3 + 0x1c) != 0) {
      ...
      fn_82FF5400(lbl_832642F4,*(int *)(param_3 + 0x1c),0x20000,param_5,param_7,param_6,
                        param_5);
    }
    if (*(int *)(param_3 + 0x1c) == 0) {
      fStack_58 = *(float *)(param_3 + 0x34);
      ...
      if ((param_5 & 0xffffffff) == 0) {
        ...
        fStack_54 = (float)(param_1 - (double)(longlong)*(short *)(param_2 + 0xc));
      ...
      if ((dVar3 == dVar2) || (iStack_50 = (int)param_7, iStack_50 == 0)) {
        *(float *)(param_3 + 0x34) = (float)dVar2;
        (**(code **)(*param_2 + 0x3c))((double)(float)(dVar2 - dVar3),param_2,2);
      }
      else {
        uStack_4c = (undefined4)param_6;
        aiStack_60[0] = param_3 + 4;
        aiStack_60[1] = 0x20000;
        uStack_48 = 0;
