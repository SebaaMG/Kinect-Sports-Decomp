...
void fn_823571B0(uint *param_1,undefined4 *param_2)

{
  ...
  if (bVar3) {
    uVar1 = *param_1;
    if (puVar8 == puVar6) {
      uVar2 = (int)((int)puVar8 - uVar1) >> 3;
      if (0x1ffffffe < uVar2) {
                    /* WARNING: Subroutine does not return */
        fn_82F622A8(0xffffffff82196fd4);
      }
      uVar5 = (longlong)(int)uVar2 + 1;
      uVar2 = (int)((int)puVar6 - uVar1) >> 3;
      if ((ulonglong)uVar2 < (uVar5 & 0xffffffff)) {
        ...
        fn_824BFB68(param_1,uVar4);
      }
    }
    puVar8 = (undefined4 *)param_1[1];
    puVar6 = (undefined4 *)(((int)((int)param_2 - uVar1) >> 3) * 8 + *param_1);
    if (puVar8 == (undefined4 *)0x0) goto LAB_82357330;
    *puVar8 = *puVar6;
    uVar7 = puVar6[1];
  }
  else {
    if (puVar8 == puVar6) {
      uVar1 = (int)((int)puVar8 - *param_1) >> 3;
      if (0x1ffffffe < uVar1) {
                    /* WARNING: Subroutine does not return */
        fn_82F622A8(0xffffffff82196fd4);
      }
      uVar5 = (longlong)(int)uVar1 + 1;
      uVar1 = (int)((int)puVar6 - *param_1) >> 3;
