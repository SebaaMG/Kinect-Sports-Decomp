...
void fn_829BE9E8(int param_1,int param_2,int *param_3,undefined8 param_4,longlong param_5,
...

{
  ...
  if (*(int *)(param_1 + 0x13c) <= *(int *)(iVar1 + 0x5c)) {
    iVar6 = 0;
    uVar5 = (ulonglong)*(uint *)(param_1 + 0xdc);
  ...
  uVar5 = (ulonglong)*(uint *)(param_1 + 0x13c) - (ulonglong)*(uint *)(iVar1 + 0x5c);
