...
extern int fn_825D2FA0();
extern int fn_825F6A70();


undefined8 fn_825F6E70(int param_1,undefined8 param_2,undefined8 param_3,uint param_4)

{
  ...
  if (((lVar1 == 0) || (param_4 = *(uint *)(param_1 + 0x8ac) & param_4, param_4 == 0)) ||
    ...
    uVar2 = fn_825D2FA0(lVar1,param_1 + 0xf0,param_1 + 0x130,uVar4,param_2,param_3,param_4,
                              lVar5);
  }
  return uVar2;
}
