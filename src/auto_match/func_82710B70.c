...

{
  ...
  if (cVar5 == '\0') {
    ...
    if (0 < *(int *)(param_1 + 0x1c)) {
      ...
      dVar9 = (double)fn_826972E0(uVar3,uVar2);
      uVar1 = (uint)dVar9;
    ...
    if (1 < *(int *)(param_1 + 0x1c)) {
      ...
      uVar1 = (uint)dVar9;
      lStack_38 = (longlong)(int)uVar1;
      uVar7 = (ulonglong)(uVar1 >> 0x1f) - 1 & (ulonglong)uVar1;
    }
    uVar3 = fn_82710AD8(aiStack_40,lVar6 + 0x30,uVar8,uVar7);
