...
undefined4 * fn_82519858(undefined4 *param_1,int param_2,int param_3)

{
  ...
  if (*(uint *)(param_3 + 0xc) <= (uint)apuStack_50[0][3]) {
    fn_825188C8(apuStack_50,param_3 + 0x10,**(undefined4 **)(param_3 + 0x14));
...
LAB_825198e8:
  puVar2 = (undefined4 *)fn_82519968(apuStack_50,param_2,bVar3,puVar2,param_3);
