...
void fn_82576C08(undefined8 param_1,int *param_2,undefined8 param_3,int param_4)

{
  int *piVar1;
  
  for (piVar1 = (int *)param_2[4]; piVar1 != (int *)0x0; piVar1 = (int *)piVar1[4]) {
    if ((*piVar1 != 0) && ((code *)piVar1[1] != (code *)0x0)) {
      (*(code *)piVar1[1])(param_1);
    }
  }
  ...
  for (piVar1 = (int *)param_2[6]; piVar1 != (int *)0x0; piVar1 = (int *)piVar1[1]) {
    if ((int *)*piVar1 != (int *)0x0) {
      (**(code **)(*(int *)*piVar1 + 0x1c))(param_1);
    }
  }
  if ((int *)param_2[0x20] != (int *)0x0) {
    (**(code **)(*(int *)param_2[0x20] + 0x18))(param_1);
  }
                    /* WARNING: Subroutine does not return */
