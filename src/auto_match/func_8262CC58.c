...
undefined8 fn_8262CC58(int param_1,int param_2)

{
  ...
  for (iVar1 = *(int *)(param_1 + 0x304); iVar1 != 0; iVar1 = *(int *)(iVar1 + 4)) {
    piVar3 = *(int **)(iVar1 + 8);
    if (*piVar3 == 0x6c) goto LAB_8262cc90;
  }
  piVar3 = (int *)0x0;
LAB_8262cc90:
  if (piVar3 != (int *)0x0) {
    do {
      if (piVar3[2] == *(int *)(param_2 + 0xc)) {
        if (*(float *)(param_2 + 0x10) != lbl_821CC160) {
          return 0;
        }
        if (piVar3[-2] != 0) {
      ...
      for (iVar2 = piVar3[-1]; iVar2 != 0; iVar2 = *(int *)(iVar2 + 4)) {
        piVar3 = *(int **)(iVar2 + 8);
        if (*piVar3 == iVar1) goto LAB_8262ccd4;
      }
      piVar3 = (int *)0x0;
LAB_8262ccd4:;} while (piVar3 != (int *)0x0);
  }
  return 0;
}
