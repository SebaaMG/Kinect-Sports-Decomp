...
ulonglong fn_82ABDEC0(int param_1,uint param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((param_2 == 0) || (*(int *)(param_1 + 0x2e8) == 0)) {
    return 0xffffffffffffffff;
  }
  puVar1 = *(uint **)(param_1 + 0x2f4);
  if ((puVar1 != (uint *)0x0) && (param_8 = (ulonglong)*puVar1, param_2 < param_8)) {
    return (ulonglong)puVar1[param_2];
  }
