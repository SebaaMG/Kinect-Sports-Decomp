...
void fn_826A0D90(int *param_1,undefined8 param_2)

{
  ...
  if (uVar3 == 0) {
    ...
    apuStack_60[0] = (undefined4 *)fn_8267BED0(param_2,uVar3 * 0x24 + 8,&uStack_58);
    *apuStack_60[0] = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar5 = iVar4 + *param_1;
        if (*(int *)(iVar5 + 8) != -2) {
          uVar3 = (ulonglong)*(uint *)(iVar5 + 0x14);
          if ((*(uint *)(iVar5 + 0x10) & 0x20000) != 0) {
            uVar3 = (longlong)*(short *)(iVar5 + 0x18) ^ uVar3;
          }
          fn_826A0AE8(apuStack_60,param_2,iVar5 + 0x10,uVar3);
          fn_8269F0E0(iVar5 + 0x10,0);
