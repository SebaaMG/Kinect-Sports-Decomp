...
uint fn_82B48490(int param_1,int param_2,int param_3)

{
  ...
  uVar3 = fn_82B841E8(param_1,*(undefined4 *)(param_1 + 0x234),0,0x10,2,4);
  ...
  *(uint *)(uVar3 + 8) = *(uint *)(uVar3 + 8) & 0xfffe3fff | 0x4000;
