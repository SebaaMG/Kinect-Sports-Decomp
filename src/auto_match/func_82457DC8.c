...
extern int fn_82457F28();
extern int fn_8265CA20();


undefined4 * fn_82457DC8(undefined4 *param_1,int param_2,int param_3)
  ...
  if (uVar4 != 0) {
    ...
    if (*(char *)((int)puVar3 + 0x31) == '\0') {
      ...
      if (*(char *)((int)puVar1 + 0x31) == '\0') {
        ...
        puVar1 = (undefined4 *)puVar3[1];
        while ((puVar2 = puVar1, *(char *)((int)puVar2 + 0x31) == '\0' &&
...
LAB_82457e54:
  puVar3 = (undefined4 *)fn_82457F28(auStack_30,param_2,uVar4);
