...
void fn_826942F0(int *param_1,undefined8 param_2,uint param_3)

{
  ...
  if (param_3 == 0) {
    ...
    uStack_48 = CONCAT44(0x143,(((U64)(uStack_48) >> 32) & 0xFFFFFFFF));
    apuStack_50[0] = (undefined4 *)0x0;
    apuStack_50[0] =
         (undefined4 *)fn_8267BED0(param_2,(uVar5 + 1 & 0x1fffffff) << 3,&uStack_48);
    *apuStack_50[0] = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar3 = iVar2 + *param_1;
        if (*(int *)(iVar3 + 8) != -2) {
          fn_82693FE8(apuStack_50,param_2,iVar3 + 0xc,*(undefined4 *)(*(int *)(iVar3 + 0xc) + 0xc)
                       );
