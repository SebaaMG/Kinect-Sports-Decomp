...
extern int fn_824B9370();
extern int fn_82512508();
extern int fn_828EA5F8();
extern int fn_828EA610();
extern unsigned int lbl_824B9850;


void fn_824B9228(int param_1,int param_2,ulonglong param_3,undefined8 param_4)

{
  ...
  if (((param_2 != 0) && (cVar2 = fn_828EA610(param_2), cVar2 == '\0')) &&
    ...
    if (*(int *)(*(int *)(param_2 + 0x100) + iVar4 * 4) != 1) {
      *(undefined4 *)(*(int *)(param_2 + 0x100) + iVar4 * 4) = 1;
    }
    ...
    if (*(int *)(param_1 + 0x30) == 0) {
      ...
      if ((cVar2 == '\0') ||
         (iVar1 = fn_824B9370(param_1,param_2,param_3,param_4,uVar3), iVar1 == 0)) {
        ...
        *(undefined **)(param_1 + 0x2c) = &lbl_824B9850;
      }
    }
    else {
      *(undefined4 *)(param_1 + 0x34) = 1;
