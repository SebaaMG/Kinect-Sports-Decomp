...
void fn_82D6FF00(double param_1,double param_2,int *param_3,undefined8 param_4,undefined8 param_5,
                  int *param_6)

{
  ...
  do {
    ...
    case 0xe:
      piVar5 = (int *)((uint)(byte)*piVar4 + (int)piVar4);
      pcVar1 = *(code **)((uint)*(byte *)((int)piVar4 + 1) * 0x50 + *param_6 + 0x16d4);
      if (pcVar1 != (code *)0x0) {
