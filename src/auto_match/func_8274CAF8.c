...
extern int fn_8274C300();
extern int fn_8274CA70();
...
undefined4 * fn_8274CAF8(undefined4 *param_1,int param_2)

{
  ...
  if ((uVar2 & 0xffffffff) == 0) {
    ...
    uVar5 = fn_8274C300(uVar2,&iStack_50);
  }
  *param_1 = uVar5;
  *(undefined1 *)(param_1 + 2) = 0;
  ...
  if (lVar3 == 0) {
    ...
    uVar6 = fn_8274CA70(lVar3,&iStack_50,uVar4,param_1);
  }
  if (uVar6 != 0) {
  ...
  auStack_60[0] = 0;
  iVar1 = *(int *)(*(int *)(param_2 + 0x294) + 0x10);
  uVar4 = fn_82695750(auStack_40,param_1);
  (**(code **)(iVar1 + 0x28))
            ((ulonglong)*(uint *)(param_2 + 0x294) + 0x10,&iStack_50,param_2 + 0x78,uVar4,auStack_60
            );
