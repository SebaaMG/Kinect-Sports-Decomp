...
extern int fn_826BE218();
extern int fn_826C08B8();
extern int fn_826C1018();
extern int fn_826C11C0();


void fn_826C1980(int *param_1,undefined8 param_2,undefined8 param_3,uint param_4)

{
  ...
  if (piVar1 == (int *)0x0) {
    ...
    if ((uint)(*piVar1 * 5) <= (uint)((piVar1[1] + 1) * 4)) goto LAB_826c19dc;
...
LAB_826c19dc:
  ...
  *piVar1 = *piVar1 + 1;
  ...
  uVar8 = param_4;
  if (*(int *)(iVar7 + 8) == -2) {
    fn_826C08B8(puVar9,param_3,0xffffffffffffffff);
  }
  else {
    do {
    ...
    if (uVar3 == param_4) {
      ...
      fn_826BE218(iVar7 + 0x10,param_3);
      *puVar9 = uVar8;
    }
    else {
