...
extern int fn_82888858();
extern int fn_828888D0();
extern int fn_82F622E0();
extern unsigned int stack0x00000024;


undefined4 * fn_82888E40(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)param_3 + 0x61) != '\0') {
                    /* WARNING: Subroutine does not return */
    fn_82F622E0(0xffffffff821963f4);
  }
  fn_82888720(&stack0x00000024);
  piVar8 = piStack00000024;
  piVar11 = (int *)*param_3;
  if (*(char *)((int)piVar11 + 0x61) == '\0') {
    piVar10 = piVar11;
    if ((*(char *)(param_3[2] + 0x61) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar3 = *(undefined1 *)(piStack00000024 + 0x18);
      *(undefined1 *)(piStack00000024 + 0x18) = *(undefined1 *)(param_3 + 0x18);
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    piVar9 = piVar11;
    if (*(char *)((int)piVar10 + 0x61) == '\0') {
      cVar2 = *(char *)(*piVar10 + 0x61);
      piVar4 = (int *)*piVar10;
      piVar9 = piVar10;
      while (piVar7 = piVar4, cVar2 == '\0') {
        piVar4 = (int *)*piVar7;
        cVar2 = *(char *)((int)piVar4 + 0x61);
        piVar9 = piVar7;
      }
    }
  ...
  if (*(int **)(iVar5 + 8) == param_3) {
    if (*(char *)((int)piVar10 + 0x61) == '\0') {
      cVar2 = *(char *)(piVar10[2] + 0x61);
      piVar9 = (int *)piVar10[2];
      piVar4 = piVar10;
      while (piVar7 = piVar9, cVar2 == '\0') {
        piVar9 = (int *)piVar7[2];
        cVar2 = *(char *)((int)piVar9 + 0x61);
        piVar4 = piVar7;
      }
      *(int **)(iVar5 + 8) = piVar4;
    }
...
LAB_8288903c:
  if (*(char *)(param_3 + 0x18) == '\x01') {
    if (piVar10 != *(int **)(*(int *)(param_2 + 4) + 4)) {
      do {
        if (*(char *)(piVar10 + 0x18) != '\x01') break;
        piVar9 = (int *)*piVar11;
        if (piVar10 == piVar9) {
          piVar9 = (int *)piVar11[2];
          if (*(char *)(piVar9 + 0x18) == '\0') {
            *(undefined1 *)(piVar9 + 0x18) = 1;
            *(undefined1 *)(piVar11 + 0x18) = 0;
            fn_828888D0(param_2,piVar11);
            piVar9 = (int *)piVar11[2];
          }
          if (*(char *)((int)piVar9 + 0x61) == '\0') {
            if ((*(char *)(*piVar9 + 0x60) != '\x01') || (*(char *)(piVar9[2] + 0x60) != '\x01')) {
              if (*(char *)(piVar9[2] + 0x60) == '\x01') {
                *(undefined1 *)(*piVar9 + 0x60) = 1;
                *(undefined1 *)(piVar9 + 0x18) = 0;
                fn_82888858(param_2,piVar9);
                piVar9 = (int *)piVar11[2];
              }
              *(undefined1 *)(piVar9 + 0x18) = *(undefined1 *)(piVar11 + 0x18);
              *(undefined1 *)(piVar11 + 0x18) = 1;
              *(undefined1 *)(piVar9[2] + 0x60) = 1;
              fn_828888D0(param_2,piVar11);
              break;
            }
LAB_82889168:
          ...
          if (*(char *)(piVar9 + 0x18) == '\0') {
            *(undefined1 *)(piVar9 + 0x18) = 1;
            *(undefined1 *)(piVar11 + 0x18) = 0;
            fn_82888858(param_2,piVar11);
            piVar9 = (int *)*piVar11;
          }
          if (*(char *)((int)piVar9 + 0x61) == '\0') {
            if ((*(char *)(piVar9[2] + 0x60) == '\x01') && (*(char *)(*piVar9 + 0x60) == '\x01'))
            goto LAB_82889168;
            if (*(char *)(*piVar9 + 0x60) == '\x01') {
              *(undefined1 *)(piVar9[2] + 0x60) = 1;
              *(undefined1 *)(piVar9 + 0x18) = 0;
              fn_828888D0(param_2,piVar9);
              piVar9 = (int *)*piVar11;
            }
            *(undefined1 *)(piVar9 + 0x18) = *(undefined1 *)(piVar11 + 0x18);
            *(undefined1 *)(piVar11 + 0x18) = 1;
