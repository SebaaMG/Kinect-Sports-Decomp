...
void fn_822F8FA4(int param_1,ulonglong param_2,ulonglong param_3,undefined4 *param_4,int param_5)

{
  ...
  while ((bool)(in_cr6 >> 3 & 1)) {
    ...
    puVar3 = (undefined4 *)((int)((uVar4 & 0xffffffff) << 3) + param_1);
  ...
  while (uVar4 = (longlong)((int)uVar5 >> 1) + (ulonglong)bVar6, param_5 < iVar1) {
    iVar1 = (int)uVar4;
    puVar2 = (undefined4 *)(iVar1 * 8 + param_1);
    if ((float)puVar2[1] <= (float)param_4[1]) break;
