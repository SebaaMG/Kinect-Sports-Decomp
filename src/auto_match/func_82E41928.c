...
longlong fn_82E41928(int param_1,ulonglong param_2)

{
  ...
  if ((param_2 & 0xffffffff) == 0) {
    ...
    piStack_38 = (int *)0x0;
    piStack_40 = (int *)0x0;
    lVar1 = fn_82E59440(param_2,0xffffffff820ed018,0xffffffff82154c58,&piStack_3c);
    if (((-1 < lVar1) &&
        (lVar1 = (**(code **)*piStack_3c)(piStack_3c,0xffffffff82154c18,&piStack_38), -1 < lVar1))
       && (lVar1 = (**(code **)(*piStack_38 + 0x10))(piStack_38,0xffffffff82154aa8,0,&piStack_40),
          -1 < lVar1)) {
      iStack_34 = 0;
