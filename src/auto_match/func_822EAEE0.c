...

{
  ...
  *(undefined1 *)(*(int *)(param_1 + 0x24) + 0x10) = 1;
  *(undefined1 *)(*(int *)(param_1 + 0x24) + 0x11) = 1;
  *(undefined4 *)(param_1 + 0x38) = 0;
  iVar1 = fn_8265C9E0(0x14);
  if (iVar1 != 0) {
    *(int *)(param_1 + 0x34) = iVar1;
    *(int *)iVar1 = iVar1;
    *(int *)(*(int *)(param_1 + 0x34) + 4) = *(int *)(param_1 + 0x34);
    *(int *)(*(int *)(param_1 + 0x34) + 8) = *(int *)(param_1 + 0x34);
    *(undefined1 *)(*(int *)(param_1 + 0x34) + 0x10) = 1;
    *(undefined1 *)(*(int *)(param_1 + 0x34) + 0x11) = 1;
    return param_1;
  }
  uStack_3c = 0;
