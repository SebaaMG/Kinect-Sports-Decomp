...
#define TBLr 0
extern int fn_82DAD1B0();
extern int fn_82DAE2C8();
...
void fn_82DB4198(undefined8 param_1,int param_2)

{
  ...
  if (iVar5 == 0xb) {
    ...
    iStack_2c = iVar5;
    uStack_28 = uVar3;
    fn_82DAE2C8(*(undefined4 *)(iVar5 + 8),&uStack_30);
    uStack_30 = 0;
    fn_82DAD1B0(iVar5,&uStack_30);
    uStack_30 = 1;
    fn_82DAD1B0(uVar3,&uStack_30);
  }
  iVar5 = KeTlsGetValue(lbl_8323B4A0);
  puVar1 = *(undefined4 **)(iVar5 + 4);
  if (puVar1 < *(undefined4 **)(iVar5 + 0xc)) {
