...
extern int fn_82752FC8();
extern int fn_82753BC0();
...
void fn_82753970(int *param_1,undefined8 param_2,uint param_3)

{
  ...
  if (param_3 == 0) {
    ...
    puStack_5c = (undefined4 *)fn_8267BED0(param_2,uVar6 * 0xc + 8,&uStack_58);
    *puStack_5c = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar4 = iVar3 + *param_1;
        if (*(int *)(iVar4 + 8) != -2) {
          uVar2 = fn_82752FC8(auStack_60,iVar4 + 0x10);
          fn_82753BC0(&puStack_5c,param_2,iVar4 + 0x10,uVar2);
