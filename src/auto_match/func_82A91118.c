...
undefined8
fn_82A91118(int *param_1,int *param_2,int *param_3,longlong param_4,longlong param_5,
...

{
  ...
  if (-1 < (int)uVar5) {
    do {
      ...
      fn_82A90A38(puVar6,param_3 + 1,auStack_a0,uVar7 & 7,param_4);
      uVar5 = uVar5 - 1;
