...
void fn_8250DEE8(int param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (sVar5 != 0) {
    fn_8250CE00(uVar6,uVar2,uVar3,uVar4,param_4,uVar1);
  }
