...
void fn_82CA3B20(undefined8 param_1,uint *param_2,byte *param_3,int param_4,int param_5,
...

{
  ...
  do {
    ...
    *param_2 = (uint)param_3[1] << 0x10 | (uint)*param_3 | uVar2;
    ...
    uVar2 = ((uint)pbVar3[2] << 0x10 | (uint)pbVar4[2]) << 8;
    param_2[4] = (uint)param_3[9] << 0x10 | (uint)param_3[8] | uVar2;
    param_2[param_8 + 4] = (uint)param_3[param_6 + 9] << 0x10 | (uint)param_3[param_6 + 8] | uVar2;
    uVar2 = ((uint)pbVar3[3] << 0x10 | (uint)pbVar4[3]) << 8;
    param_2[5] = (uint)param_3[0xb] << 0x10 | (uint)param_3[10] | uVar2;
    param_2[param_8 + 5] =
         (uint)param_3[param_6 + 0xb] << 0x10 | (uint)param_3[param_6 + 10] | uVar2;
    uVar2 = ((uint)pbVar3[4] << 0x10 | (uint)pbVar4[4]) << 8;
    param_2[6] = (uint)param_3[0xd] << 0x10 | (uint)param_3[0xc] | uVar2;
    param_2[param_8 + 6] =
         (uint)param_3[param_6 + 0xd] << 0x10 | (uint)param_3[param_6 + 0xc] | uVar2;
    pbVar1 = pbVar4 + 5;
    pbVar4 = pbVar4 + param_7;
    uVar2 = ((uint)pbVar3[5] << 0x10 | (uint)*pbVar1) << 8;
    pbVar3 = pbVar3 + param_7;
    param_2[7] = (uint)param_3[0xf] << 0x10 | (uint)param_3[0xe] | uVar2;
    param_2[param_8 + 7] =
         (uint)param_3[param_6 + 0xf] << 0x10 | (uint)param_3[param_6 + 0xe] | uVar2;
    lVar5 = lVar5 + -1;
