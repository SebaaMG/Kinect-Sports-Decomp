...
extern int fn_82C3B8A8();
extern unsigned int iStack_a8;
extern unsigned int lbl_820FB3A0;
extern unsigned int lbl_820FB4A0;
extern unsigned int lbl_820FB9F0;
extern unsigned int lbl_820FB9F8;
extern unsigned int lbl_820FBA00;
...
undefined8 fn_82C3BC90(int *param_1,int param_2)
...
switchD_82c3bd2c_caseD_6:
  switch(*piVar11) {
  case 1:
    param_1[0x83] = 0;
    if ((*(int *)(iVar3 + 0x250) != 0) && (param_1[0x8f] == *(int *)(param_2 + 0x1e4))) {
      *piVar11 = 0xf;
      *(code **)(iVar3 + 0x1e4) = fn_82C3B8A8;
...
LAB_82c3c13c:
    ...
    if (uStack_b0 == lbl_820FB9F0) {
      *piVar11 = 2;
      param_1[0x8f] = param_1[0x8f] + 1;
    }
    else {
      iVar8 = uStack_b0 * 2;
      param_1[0x86] = (uint)(*(ushort *)(&lbl_820FB3A0 + iVar8) >> 0xc);
      param_1[0x87] = (byte)(&lbl_820FB3A0)[iVar8] & 0xf;
      param_1[0x88] = *(ushort *)(&lbl_820FB3A0 + iVar8) >> 4 & 0xf;
      param_1[0x89] = *(ushort *)(&lbl_820FB3A0 + iVar8) & 0xf;
      *piVar11 = 5;
      param_1[0x8f] = param_1[0x8f] + 1;
    }
  ...
  case 2:
    ...
    if (uStack_b0 != lbl_820FB9F8) {
      piVar11[param_1[0x83] + 5] = (uint)((byte)(&lbl_820FB4A0)[uStack_b0] >> 4);
      piVar11[param_1[0x83] + 6] = (byte)(&lbl_820FB4A0)[uStack_b0] & 0xf;
...
LAB_82c3bed4:
    ...
    goto switchD_82c3bd2c_caseD_6;
  case 4:
    uVar4 = fn_82C3B5D0(&uStack_b0,lbl_820FBA00,piVar10,param_1,piVar11);
    if ((int)uVar4 < 0) {
      return uVar4;
    }
    piVar11[param_1[0x83] + 5] = uStack_b0;
  ...
  case 0xe:
    ...
    iVar8 = param_1[0x84];
    if ((int)uVar2 <= *(short *)(iVar3 + 0xca) + iVar8 + 1) goto LAB_82c3c13c;
    if (iVar7 == 4) {
      *piVar11 = (-(uint)(param_1[0x85] != 0) & 0xe) + 1;
    }
    goto switchD_82c3bd2c_caseD_6;
  case 0xf:
    goto switchD_82c3bd2c_caseD_f;
  }
  *piVar11 = 3;
  goto switchD_82c3bd2c_caseD_6;
switchD_82c3bd2c_caseD_f:
  *(code **)(iVar3 + 0x1e4) = fn_82C3B8A8;
  uVar4 = fn_82C3B8A8(param_1,param_2);
  return uVar4;
}
