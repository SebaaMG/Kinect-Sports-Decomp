...
void fn_826F7318(int param_1,int param_2,int param_3,undefined8 param_4)

{
  ...
  if (iVar5 != 0) {
    ...
    (**(code **)(**(int **)(param_2 + 0x70) + 4))
              (*(int **)(param_2 + 0x70),auStack_4c,*(undefined4 *)(*(int *)(param_3 + 8) + 8));
    ...
    iVar5 = *piVar1;
    uVar4 = fn_82696958(param_2 + 0x60,uVar3);
