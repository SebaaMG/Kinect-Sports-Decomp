...
extern int fn_82FF4670();


undefined4 * fn_82FF5268(undefined4 *param_1,ulonglong param_2)
...
fn_82FF4670:
    ...
    if ((ulonglong)(uint)puVar4[2] == (param_2 & 0xffffffff)) {
      if (puVar4 != (undefined4 *)0xfffffff0) {
        return puVar4 + 4;
      }
      goto fn_82FF4670;
    }
