...

{
  ...
  auStack_20 = fn_823AA970(param_2);
  fn_828CCE98(&stack_pair_18.first,param_1,&auStack_20);
  fn_828A7E40(&auStack_20,param_1,stack_pair_18.first,stack_pair_18.second);
  return;
}
