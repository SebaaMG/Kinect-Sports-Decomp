...
int * fn_82C55808(int param_1,int param_2,int param_3)

{
  ...
  if (piVar2 != (int *)0x0) {
    ...
    piVar7 = piVar2 + 1;
    iVar3 = fn_82CBBD68(piVar7,*(undefined4 *)(param_1 + 0x84));
    if (iVar3 != 0) {
      piVar8 = piVar2 + 4;
      iVar3 = fn_82CBBD68(piVar8,*(undefined4 *)(param_1 + 0x84));
      if (iVar3 != 0) {
...
LAB_82c55a08:
                ...
                iVar6 = fn_82C56398((ulonglong)(uint)piVar2[9] + 8,piVar2[8],0xffffffff82196582);
                if (iVar6 == 0) {
                  if (piVar2[6] != 0) {
                    iVar6 = piVar2[6] + -1;
                    piVar2[6] = iVar6;
