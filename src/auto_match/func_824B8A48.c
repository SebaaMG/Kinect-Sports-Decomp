...
extern int fn_824B8B78();
extern int fn_82512508();
extern int fn_828EA5F8();
extern int fn_828EA610();
extern unsigned int lbl_824B8FE0;


void fn_824B8A48(int param_1,int param_2,ulonglong param_3)

{
  ...
  if (((param_2 != 0) && (cVar2 = fn_828EA610(param_2), cVar2 == '\0')) &&
    ...
    if (*(int *)(param_1 + 0x30) == 0) {
      ...
      if ((cVar2 == '\0') || (iVar1 = fn_824B8B78(param_1,param_2,param_3,uVar3), iVar1 == 0)) {
        ...
        *(undefined **)(param_1 + 0x2c) = &lbl_824B8FE0;
      }
    }
    else {
      *(undefined4 *)(param_1 + 0x34) = 1;
