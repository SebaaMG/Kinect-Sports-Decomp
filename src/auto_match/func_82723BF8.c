...

{
  ...
  if ((*(int **)(param_1 + 8) != (int *)0x0) &&
    ...
    iVar6 = *(int *)(*(int *)(iVar6 + 0xa0) + 0x114);
    if (iVar6 != 0) {
      iVar1 = *(int *)(iVar6 + 8);
      uVar7 = (ulonglong)(*(ushort *)(iVar6 + 0x68) >> 2) & 1;
      ...
      fn_827A2850(iVar6,uVar4,uVar5,uVar7);
    }
  }
  return;
}
