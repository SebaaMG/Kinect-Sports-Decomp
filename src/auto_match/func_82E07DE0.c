...
undefined8 fn_82E07DE0(undefined8 param_1,undefined8 param_2,char param_3,int param_4)

{
  ...
  iVar4 = fn_82E07840(param_1,param_2,0xffffffff8323f34c);
  if (iVar4 == 0) {
    if (param_3 != '\0') {
      fn_82CEE578(auStack_240,auStack_230,0x200);
      uVar3 = fn_82CEDB38(auStack_240,0xffffffff82149f10);
      ...
      (**(code **)(*lbl_8323B464 + 0xc))
                (lbl_8323B464,1,0xffffffffabbaab81,auStack_230,0xffffffff82149e90,0xa2);
    ...
    uVar3 = 0;
    puVar1 = (undefined4 *)(in_r0 + *(int *)(iVar4 + 8) & 0xfffffff0);
    uVar5 = puVar1[1];
    uVar6 = puVar1[2];
    uVar7 = puVar1[3];
