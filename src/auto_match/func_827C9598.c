...
extern int fn_827C9310();
extern int fn_827C9400();


void fn_827C9598(int param_1,undefined8 param_2,uint *param_3,ulonglong param_4)

{
  ...
  *(int *)(iVar1 + 0x48) = *(int *)(param_1 + 0x118) + -1;
  if (*(int *)(iVar1 + 0x4c) == *(int *)(param_1 + 0x11c)) {
    fn_827C9400(param_1);
  }
...
LAB_827c96a0:
  ...
  if (*(uint *)(iVar1 + 0x48) <= *(uint *)(iVar1 + 0x34)) {
    ...
    *(int *)(iVar1 + 0x34) = *(int *)(param_1 + 0x118) + 1;
