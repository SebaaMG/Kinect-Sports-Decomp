...
void fn_82DE1320(int *param_1,int *param_2,byte *param_3)
...
switchD_82de136c_caseD_8:
  ...
  in_r0 = (ulonglong)*(uint *)((uint)bVar1 * 4 + -0x7d21ec90);
  switch(bVar1) {
  case 0:
    goto switchD_82de136c_caseD_0;
  case 1:
  case 2:
  case 3:
  case 4:
  ...
  case 0x21:
  case 0x22:
    param_3 = param_3 + param_3[2] + 3;
    goto LAB_82de134c;
  case 0x23:
  case 0x24:
  case 0x25:
    param_3 = param_3 + (uint)param_3[5] * 0x100 + (uint)param_3[6] + 7;
    goto LAB_82de134c;
  case 0x26:
  case 0x27:
  case 0x28:
