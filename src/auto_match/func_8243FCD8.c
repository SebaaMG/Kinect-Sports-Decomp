...
void fn_8243FCD8(int *param_1,int *param_2)

{
  ...
  if (param_1 != param_2) {
    while (piVar5 = piVar5 + 0x17, piVar5 != param_2) {
      ...
      uVar3 = uStack_5c;
      iVar2 = aiStack_a0[0];
      if (((uint)param_1[0x11] < uStack_5c) ||
         ((uStack_5c == param_1[0x11] && (aiStack_a0[0] < *param_1)))) {
        bVar1 = true;
      }
      else {
        bVar1 = false;
      ...
      if (bVar1) {
        ...
        while( true ) {
          piVar6 = piVar4 + -0x17;
          if (((uint)piVar4[-6] < uVar3) || ((uVar3 == piVar4[-6] && (iVar2 < *piVar6)))) {
            bVar1 = true;
          }
          else {
            bVar1 = false;
