...
void fn_82FFBCA8(longlong param_1,char param_2)

{
  ...
  do {
    ...
    if (in_RESERVE != '\0') {
      uVar1 = storeWordConditionalIndexed(lVar3,0,param_1 + 0x40);
      *puVar4 = uVar1;
      in_cr0 = 2;
    }
  ...
  if ((int)lVar3 < 1) {
    fn_82FF90A8(param_1);
    fn_82FFB818(lbl_832642F0,param_1);
    if ((int)((undefined4 *)param_1)[0x11] < 1) {
      fn_8302B540();
      if (param_2 == '\0') {
        fn_82FF9128(param_1);
      }
