...
void fn_82B967E0(int param_1,int param_2,int param_3,longlong param_4)

{
  ...
  uVar5 = *(int *)(param_1 + 0x60) * param_2 + *(int *)(param_1 + 100) * param_3 +
          *(int *)(param_1 + 0x20);
  uVar4 = *(int *)(param_1 + 0x68) * 2 + uVar5;
  if (uVar5 < uVar4) {
    puVar6 = (ushort *)(uVar5 - 2);
    lVar3 = (ulonglong)((uVar4 - uVar5) - 1 >> 1) + 1;
    do {
      pfVar2 = (float *)param_4;
      *pfVar2 = (float)(*(byte *)(puVar6 + 1) & 0xf) * fVar1;
      pfVar2[1] = (float)(puVar6[1] >> 4 & 0xf) * fVar1;
      pfVar2[2] = (float)(puVar6[1] & 0xf) * fVar1;
      puVar6 = puVar6 + 1;
      pfVar2[3] = (float)(*puVar6 >> 0xc) * fVar1;
