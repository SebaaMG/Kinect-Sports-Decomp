...
void fn_82507590(int param_1,undefined8 param_2)

{
  ...
  puVar2 = *(undefined4 **)(param_1 + 0xff0);
  ...
  if (lbl_821CC160 < *(float *)(param_1 + 0xffc)) {
    dVar3 = (double)fn_82A81DA8(param_2);
    fVar1 = (float)((double)*(float *)(param_1 + 0xffc) / dVar3);
