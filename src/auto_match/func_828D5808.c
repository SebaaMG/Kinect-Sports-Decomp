...
extern int fn_828D50C0();
extern unsigned int iStack_40;
extern unsigned int uStack00000010;


void fn_828D5808(ulonglong param_1,longlong param_2,longlong param_3)

{
  ...
  while (lVar3 = lVar2, iVar4 < (int)param_3) {
    ...
    uVar6 = (uVar7 - 1 & 0xffffffff) >> 2;
    if (*(uint *)(iStack_40 + 8) <= uVar6) {
      uVar6 = uVar6 - *(uint *)(iStack_40 + 8);
    }
    if (*(uint *)(*(int *)(*(int *)(iStack_40 + 4) + (int)((uVar5 & 0xffffffff) << 2)) +
                 (int)((uVar7 & 3) << 2)) <
        *(uint *)(*(int *)(*(int *)(iStack_40 + 4) + (int)((uVar6 & 0xffffffff) << 2)) +
                 (int)((uVar7 - 1 & 3) << 2))) {
      lVar3 = lVar3 + -1;
    }
    uVar5 = (uVar8 + lVar3 & 0xffffffff) >> 2;
    if (*(uint *)(iStack_40 + 8) <= uVar5) {
      uVar5 = uVar5 - *(uint *)(iStack_40 + 8);
    }
    uVar7 = (uVar8 + lVar1 & 0xffffffff) >> 2;
    if (*(uint *)(iStack_40 + 8) <= uVar7) {
      uVar7 = uVar7 - *(uint *)(iStack_40 + 8);
    }
    lVar2 = (lVar3 + 1U & 0x7fffffff) << 1;
    *(undefined4 *)
     (*(int *)(*(int *)(iStack_40 + 4) + (int)((uVar7 & 0xffffffff) << 2)) +
     (int)((uVar8 + lVar1 & 3) << 2)) =
         *(undefined4 *)
  ...
  if (iVar4 == (int)param_3) {
    uVar7 = (uVar8 + param_3) - 1;
    uVar5 = (uVar7 & 0xffffffff) >> 2;
    if (*(uint *)(iStack_40 + 8) <= uVar5) {
      uVar5 = uVar5 - *(uint *)(iStack_40 + 8);
    }
    uVar8 = uVar8 + lVar1;
    uVar6 = (uVar8 & 0xffffffff) >> 2;
    if (*(uint *)(iStack_40 + 8) <= uVar6) {
      uVar6 = uVar6 - *(uint *)(iStack_40 + 8);
    }
    lVar1 = param_3 + -1;
    *(undefined4 *)
     (*(int *)(*(int *)(iStack_40 + 4) + (int)((uVar6 & 0xffffffff) << 2)) + (int)((uVar8 & 3) << 2)
     ) = *(undefined4 *)
          (*(int *)(*(int *)(iStack_40 + 4) + (int)((uVar5 & 0xffffffff) << 2)) +
          (int)((uVar7 & 3) << 2));
  }
  uStack00000010 = param_1;
  fn_828D50C0(param_1,lVar1,param_2);
  return;
}
