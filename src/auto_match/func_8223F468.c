...

{
  ...
  uVar1 = lbl_83297598;
  uVar5 = (ulonglong)lbl_83297598;
  uStack_30 = lbl_83297598;
  uVar2 = fn_8223EEC8(0xffffffff8329e9dc);
  uVar3 = fn_8223EF38(param_1,uVar2);
  uVar6 = uVar3;
  if ((uVar3 == 0) && (uVar6 = uVar5, uVar1 == 0)) {
    iVar4 = fn_8223F3B0(&uStack_30,param_1);
    if (iVar4 == -1) {
      fn_82F64188();
      uVar6 = uVar3;
    }
    else {
      lbl_83297598 = uStack_30;
