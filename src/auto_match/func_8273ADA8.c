...

{
  ...
  if (cVar5 == '\0') {
    ...
    if (0 < *(int *)(param_1 + 0x1c)) {
      ...
      if (0x3b < iVar6) {
        uVar3 = fn_82739680(*(undefined4 *)(iVar8 + 0x3c));
        uVar3 = uVar3 & 0xff;
        uVar4 = fn_82739680(uVar7);
        *(uint *)(iVar8 + 0x40) = (iVar6 - uVar3) + (uVar4 & 0xff);
      }
      iVar6 = (int)uVar7;
      ...
      *(longlong *)(iVar8 + 0x30) =
           ...
           (int)(((iVar6 + -0x641) / 400 - (iVar6 + -0x76d) / 100) +
                 ...
                 (iVar6 + -0x7b2) * 0x16d + *(int *)(iVar8 + 0x40)) * 86400000 +
           (longlong)*(int *)(iVar8 + 0x38);
      fn_827396D0(iVar8);
    }
  }
  return;
