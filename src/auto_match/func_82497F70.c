...
extern int fn_82498128();
extern unsigned int iStack_30;


undefined4 fn_82497F70(int param_1,int param_2,int param_3)

{
  ...
  if (param_2 <= param_3) {
    do {
      iStack_30 = param_2;
      iVar4 = fn_824973B0(param_1 + 0x24,&iStack_30);
      piVar6 = (int *)(iVar4 * 8 + *(int *)(param_1 + 0x34));
      ...
      while( true ) {
        ...
        if (piVar3 == puVar7) goto LAB_82498030;
        piVar5 = piVar3;
...
LAB_82498030:
      ...
      fn_82498128(auStack_2c,param_1 + 0x24);
      param_2 = param_2 + 1;
