...
void fn_8280CFA0(int param_1,int param_2,undefined4 *param_3)

{
  ...
  *puVar1 = uVar7;
  ...
  iVar3 = fn_8280D630(auStack_70,auStack_80,uStack_c0,uStack_b8,uStack_b0,uStack_a8,uStack_a0,
                       uStack_98);
