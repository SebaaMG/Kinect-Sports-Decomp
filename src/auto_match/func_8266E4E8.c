...
void fn_8266E4E8(uint *param_1,longlong param_2)

{
  ...
  uVar1 = (int)(param_1[2] - *param_1) / 0xc;
  ...
  if (0x15555555 < (uVar4 & 0xffffffff)) {
                    /* WARNING: Subroutine does not return */
    fn_82F622A8(0xffffffff82196fd4);
  }
  if ((ulonglong)(uint)((int)(param_1[2] - *param_1) / 0xc) < (uVar4 & 0xffffffff)) {
    uVar3 = fn_8266C8F0(uVar4,0);
    uVar1 = param_1[1];
    uVar5 = uVar3;
    for (uVar7 = (ulonglong)*param_1; (uVar7 & 0xffffffff) != (ulonglong)uVar1; uVar7 = uVar7 + 0xc)
    {
      if ((uVar5 & 0xffffffff) != 0) {
        fn_8266CB08(uVar5,uVar7);
      }
      uVar5 = uVar5 + 0xc;
    }
    uVar1 = *param_1;
    ...
    uVar6 = (uint)uVar3;
    *param_1 = uVar6;
    param_1[2] = (int)uVar4 * 0xc + uVar6;
    param_1[1] = ((int)(uVar2 - uVar1) / 0xc) * 0xc + uVar6;
  }
  return;
}
