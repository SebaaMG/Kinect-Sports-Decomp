...
extern int fn_822A9F70();
extern int fn_822AA090();
extern int fn_82F622A8();


void fn_822A9BF0(uint *param_1,ulonglong param_2)

{
  ...
  if (bVar3) {
    uVar2 = *param_1;
    if (uVar6 == uVar1) {
      uVar4 = (int)(uVar4 - uVar2) >> 4;
      if (0xffffffe < uVar4) {
                    /* WARNING: Subroutine does not return */
        fn_82F622A8(0xffffffff82196fd4);
      }
      uVar6 = (longlong)(int)uVar4 + 1;
      uVar4 = (int)(uVar1 - uVar2) >> 4;
      if ((ulonglong)uVar4 < (uVar6 & 0xffffffff)) {
        ...
        fn_822A9F70(param_1,uVar5);
      }
    }
    uVar4 = param_1[1];
    if (uVar4 == 0) goto LAB_822a9d5c;
    param_2 = ((ulonglong)(uint)((int)((int)param_2 - uVar2) >> 4) & 0xfffffff) * 0x10 +
              (ulonglong)*param_1;
  }
  else {
    if (uVar6 == uVar1) {
      uVar4 = (int)(uVar4 - *param_1) >> 4;
      if (0xffffffe < uVar4) {
                    /* WARNING: Subroutine does not return */
        fn_82F622A8(0xffffffff82196fd4);
      }
      uVar6 = (longlong)(int)uVar4 + 1;
      uVar4 = (int)(uVar1 - *param_1) >> 4;
      if ((ulonglong)uVar4 < (uVar6 & 0xffffffff)) {
        uVar5 = 0;
        if ((ulonglong)uVar4 <= (0xfffffff - (ulonglong)(uVar4 >> 1) & 0xffffffff)) {
          uVar5 = (ulonglong)(uVar4 >> 1) + (longlong)(int)uVar4;
