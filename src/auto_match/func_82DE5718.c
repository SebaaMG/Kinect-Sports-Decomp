...
void fn_82DE5718(double param_1,undefined8 param_2,int param_3)

{
  ...
  loadVectorLeftIndexed128(in_r0,ZEXT48(&stack0x00000000) + 0x14);
  *(float *)(param_3 + 4) = (float)(param_1 * (double)*(float *)(param_3 + 4));
  ...
  *puVar1 = in_register_000100d0;
  ...
  puVar1[3] = in_vr13;
  fn_82CEBE20(param_3 + 0x20,ZEXT48(&stack0x00000000) - 0x20);
  return;
}
