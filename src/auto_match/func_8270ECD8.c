...
void fn_8270ECD8(int param_1,int param_2,undefined1 param_3,undefined1 param_4)

{
  ...
  *(byte *)(iVar2 + 0x658) =
       *(byte *)(iVar2 + 0x658) & ~(byte)(1 << (param_2 + (param_2 >> 3) * -8 & 0x3fU));
  iVar2 = param_1 + 0xc;
  ...
  *(undefined4 *)(*(int *)(param_1 + 0x64c) * 0x10 + iVar2 + 8) = 6;
