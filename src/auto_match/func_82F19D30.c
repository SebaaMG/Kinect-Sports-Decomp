...
void fn_82F19D30(int param_1,int param_2)

{
  ...
  iVar4 = ((int)uVar13 >> 1) * 4;
  fn_82F02410(*(undefined4 *)(param_1 + 0x1ebc),*(undefined4 *)(iVar4 + -0x7ce47108),
                    *(undefined4 *)(iVar4 + -0x7ce470ec));
  if (5 < (lVar12 - 1U & 0xffffffff)) {
    return;
  }
  if ((int)(lVar12 - 1U) == 0) {
LAB_82f19e18:
