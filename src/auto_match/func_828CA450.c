...
extern int fn_828C9D58();
extern int fn_828C9DB8();


undefined4 * fn_828CA450(undefined4 *param_1,uint param_2,int param_3,ulonglong param_4)

{
  ...
  if ((uVar9 & 0xff) != 0) {
    if (puVar4 == (undefined4 *)**(undefined4 **)(param_2 + 4)) {
      puVar4 = (undefined4 *)fn_828C9DB8(apuStack_50,param_2,1,puVar4,param_3);
      uVar2 = *puVar4;
      *(undefined1 *)(param_1 + 1) = 1;
      *param_1 = uVar2;
      return param_1;
    }
    fn_828C8D20(apuStack_50,uVar5,param_3,param_4);
  }
  puVar1 = apuStack_50[0];
  if ((uint)apuStack_50[0][4] < *puVar8) {
    puVar4 = (undefined4 *)fn_828C9DB8(apuStack_50,param_2,uVar9,puVar4,param_3);
    uVar2 = *puVar4;
    *(undefined1 *)(param_1 + 1) = 1;
    *param_1 = uVar2;
  }
  else {
    fn_828C9D58(param_2 + 0xd,puVar8);
    fn_8265CA20(param_3);
    *param_1 = puVar1;
