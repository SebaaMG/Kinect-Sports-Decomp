...
undefined8 fn_828A8F98(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4)

{
  ...
  *(undefined ***)(auStack_ac + *(int *)(puStack_b0 + 4) + -4) = &lbl_82021284;
  ...
  uVar2 = fn_82240158(&puStack_b0,0xffffffff820243d0);
  uVar2 = fn_828A8E18(uVar2,uVar1);
