...
extern unsigned int lbl_820ED378;


undefined8 fn_82C30370(int param_1,uint param_2,uint *param_3)

{
  ...
  if (param_2 < 0x19) {
    ...
    *(uint *)(param_1 + 0x28) = uVar2;
    *param_3 = *(uint *)(param_1 + 0x24) >> (uVar2 & 0x3f) & *(uint *)(&lbl_820ED378 + param_2 * 4);
  }
  else {
