...
void fn_82D54118(int param_1,undefined4 param_2,undefined4 *param_3,undefined4 param_4,
                  undefined4 param_5)

{
  ...
  *puVar1 = in_register_000100b0;
  ...
  puVar1[3] = in_vr11;
  uStack_44 = (**(code **)(*(int *)*param_3 + 0x10))();
  uStack_3c = *(undefined4 *)(param_1 + 8);
  uStack_50 = param_2;
  puStack_4c = param_3;
  uStack_40 = param_4;
  uStack_38 = param_5;
  fn_82D71478(param_1 + 0x30,&uStack_50);
  return;
}
