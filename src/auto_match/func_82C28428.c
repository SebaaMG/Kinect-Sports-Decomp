...
undefined8 fn_82C28428(int param_1,undefined8 param_2)

{
  ...
  uVar2 = 0;
  if (*(int *)(iVar1 + 0x5c) == 0) {
    uVar2 = (*(code *)**(undefined4 **)(iVar1 + 0x4c))(*(undefined4 **)(iVar1 + 0x4c),param_2);
    if (-1 < (int)uVar2) {
      *(undefined8 *)(iVar1 + 0x20) = param_2;
      *(undefined8 *)(iVar1 + 0x40) = param_2;
