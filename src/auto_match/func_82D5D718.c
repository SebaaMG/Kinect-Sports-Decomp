...
void fn_82D5D718(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4,
  ...
  *puVar1 = uVar9;
  ...
  if (param_6 != 0) {
    ...
    *puVar1 = uVar5;
    ...
    iStack_90 = param_6;
    fn_82D5C4B0(param_3,param_2,auStack_80,&ppuStack_e0,&ppuStack_b0);
    return;
  }
  fn_82D5C4B0(param_3,param_2,auStack_80,&ppuStack_e0,0);
  return;
}
