...
void fn_82421138(undefined8 param_1,int param_2)

{
  ...
  *puVar1 = in_register_00010010;
  ...
  puVar1[3] = in_vr1;
  uStack_68 = 0;
  dVar3 = (double)fn_82539560(param_1,(double)*(float *)(iVar2 + 0x85c),
                               (double)*(float *)(iVar2 + 0x860),(double)*(float *)(iVar2 + 0x864),
                               (double)*(float *)(iVar2 + 0x868));
  fn_82230110(auStack_60,0xffffffff821b8218);
  fStack_44 = (float)dVar3;
  fn_8236D0D0(&uStack_70,auStack_60);
  fn_82230300(auStack_60,1,0);
  fn_824180B0(*(uint **)(param_2 + 0xc),(ulonglong)**(uint **)(param_2 + 0xc) + 0x14b0,
  ...
  if (*(char *)(iVar2 + 4) != '\0') {
    fn_8241CE30(param_1,*(undefined4 *)(param_2 + 0xc),param_2,4);
  }
