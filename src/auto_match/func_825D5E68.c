...
void fn_825D5E68(uint *param_1,int param_2,uint param_3)

{
  ...
  if ((*param_1 == 0) && (param_1[1] == 0)) {
    ...
    *(uint *)(param_2 + 0x2934) =
         -(uint)(*(int *)(param_2 + 0x3158) != 0) & 1 | *(uint *)(param_2 + 0x2934) & 0xfffffffe;
    *(ulonglong *)(param_2 + 0x10) = *(ulonglong *)(param_2 + 0x10) | 0x20800;
  }
  uVar1 = *param_1;
  *param_1 = uVar1 | param_3;
  *(char *)(param_2 + 0x2903) = (char)(uVar1 | param_3);
