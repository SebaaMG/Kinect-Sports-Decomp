...
void fn_828B7D48(int *param_1,longlong param_2)

{
  ...
  if ((ulonglong)(uint)(param_1[2] - *param_1 >> 3) < (uVar5 & 0xffffffff)) {
    piVar8 = param_1 + 3;
    uVar4 = fn_828E62F0(piVar8,uVar5);
    fn_828B71F8(*param_1,param_1[1],uVar4,piVar8,0,uStack_40);
    iVar1 = *param_1;
    iVar2 = param_1[1];
    if (iVar1 != 0) {
      fn_82231540(iVar1,iVar2,piVar8,uStack_40);
      fn_8265CA20(*param_1);
    }
    iVar7 = (int)uVar4;
    *param_1 = iVar7;
