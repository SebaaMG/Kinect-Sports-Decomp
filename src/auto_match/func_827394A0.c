...
undefined4 * fn_827394A0(undefined4 *param_1,int param_2)

{
  ...
  if ((uVar3 & 0xffffffff) == 0) {
    ...
    uVar6 = fn_82737B90(uVar3,&iStack_50);
  }
  *param_1 = uVar6;
  *(undefined1 *)(param_1 + 2) = 0;
  param_1[1] = 0;
  lVar4 = fn_8267B890(*(undefined4 *)(param_2 + 0x288),100,0);
  if (lVar4 == 0) {
    uVar7 = 0;
  }
  else {
    uVar5 = fn_826B14D8(param_2,1);
    uVar7 = fn_82739360(lVar4,&iStack_50,uVar5,param_1);
  }
  if (uVar7 != 0) {
  ...
  (**(code **)(iVar2 + 0x28))(iVar1 + 0x10,&iStack_50,param_2 + 0xac,uVar5,auStack_60);
