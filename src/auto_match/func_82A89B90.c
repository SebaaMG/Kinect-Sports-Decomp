...
void fn_82A89B90(undefined8 param_1,int param_2,undefined8 param_3,longlong param_4,
                  longlong param_5)

{
  ...
  fn_82A87148(param_3,param_4 + 0xa0,0x10,param_5 + 0x30);
  fn_82A87148(param_3,param_4 + 0xb0,0x10,param_5 + 0x32);
  return;
}
