...
longlong fn_82A4E5A8(ulonglong param_1,uint param_2,ulonglong param_3,ulonglong param_4,
                      float *param_5)
...
LAB_82a4eab0:
    ...
    if ((param_3 & 0xffffffff) != 0) {
      ...
      if (iVar7 != iVar8) goto LAB_82a4eab0;
    }
    if ((param_4 & 0xffffffff) != 0) {
      ...
      if (param_2 != uVar12) goto LAB_82a4eab0;
    }
    ...
    if ((param_3 & 0xffffffff) == 4) {
      *param_5 = lbl_82002AE0;
      ...
      uVar20 = 0;
      uVar12 = 0;
      afStack_a0[0] = lbl_82089F1C;
      uVar15 = 1;
      afStack_a0[1] = (float)lbl_82015B38;
      afStack_a0[2] = lbl_821AAD20;
      lVar5 = (param_1 & 0x3fffffff) << 2;
      afStack_a0[3] = (float)lbl_82089F18;
      uStack_90 = lbl_82089F14;
      uStack_8c = lbl_82057B40;
      uStack_88 = lbl_82089F10;
      uStack_84 = lbl_82027070;
      uStack_80 = lbl_82022E5C;
      uStack_7c = lbl_82089F0C;
      uStack_78 = lbl_82089F08;
      if (0x3fffffff < (param_1 & 0xffffffff)) {
        lVar5 = -1;
      }
      lVar6 = fn_82A3FF60(0xffffffff83219d50,lVar5,0x2097000a,0);
      if (lVar6 == 0) {
        lVar5 = -0x7ff8fff2;
      }
      else {
        uVar13 = param_2 & 0x3fffffff;
        if (0x3fffffff < param_2) {
          uVar13 = 0xffffffff;
        }
        iVar8 = fn_82A3FF60(0xffffffff83219d50,uVar13,0x2097000a,0);
        if (iVar8 == 0) {
          lVar5 = -0x7ff8fff2;
        }
        else {
...
LAB_82a4e85c:
            if ((uVar15 & param_4) != 0) {
              if (uVar12 == param_2) goto LAB_82a4e9bc;
              uVar12 = uVar12 + 1;
              pfVar9 = pfVar9 + 1;
              *pfVar9 = *pfVar18;
            }
          ...
          lVar5 = fn_82A4E008(param_1,param_2,lVar6,iVar8,param_5);
          fVar4 = lbl_82002AE0;
          if (-1 < lVar5) {
            uVar12 = 0;
            lVar10 = 0;
...
LAB_82a4ea88:
                  ...
                  if ((uVar15 & 8) == 0) goto LAB_82a4ea88;
                  if (iVar7 == 1) {
                    if (0 < (int)param_2) {
                      pfVar18 = param_5 + -1;
                      uVar13 = param_2;
