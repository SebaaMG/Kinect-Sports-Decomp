...
void fn_82A86F50(longlong param_1,undefined1 *param_2,ulonglong param_3)

{
  ...
  if ((param_3 & 0xffffffff) < 0x25) {
    if ((param_3 & 0xffffffff) < 0x24) {
      if (-1 < (int)-param_3 + 0x23) {
        lVar3 = param_3 + param_1 + -1;
        for (lVar4 = -param_3 + 0x24; lVar4 != 0; lVar4 = lVar4 + -1) {
          lVar3 = lVar3 + 1;
          *(undefined1 *)lVar3 = 0;
        }
      }
