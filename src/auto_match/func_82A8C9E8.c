...
undefined8
fn_82A8C9E8(uint *param_1,int *param_2,uint *param_3,longlong param_4,ulonglong param_5,
             longlong param_6)

{
  ...
  uVar5 = *param_3;
  lVar11 = (ulonglong)param_3[0xe] + (ulonglong)param_3[0xd] + (ulonglong)param_3[0xc] +
           (ulonglong)param_3[0x1b] + (ulonglong)param_3[0x1a] + (ulonglong)param_3[0x19] + 8;
  iVar12 = (int)lVar11;
  uVar1 = (int)(uVar5 * iVar12 + 0x14b) >> 3;
  if ((int)param_5 < 1) {
    ...
    cVar6 = (**(code **)(*param_2 + 4))(param_2);
    if ((cVar6 != '\0') && (cVar6 = (**(code **)(*param_2 + 0xc))(param_2,0x28), cVar6 != '\0')) {
      uVar14 = 4;
      iVar2 = iVar12 * (int)param_5 + 0xb >> 3;
      lVar13 = (longlong)iVar2;
      if (0x1ff < iVar2) {
        lVar13 = 0x200;
      }
      cVar6 = (**(code **)(*param_2 + 0x10))(param_2,uVar4 - 0x460,lVar13,uVar4 - 0x480);
      if (cVar6 != '\0') {
        while (fn_82A86D58(uVar4 - 0x260,uVar4 - 0x460,lVar13), (int)param_5 != 0) {
          do {
            if (0x1000 - iVar12 < (int)uVar14) break;
            fn_82A8C620(uVar4 - 0x260,uVar14,8,param_4);
            fn_82A8FDF8(uVar9 + 4,param_3 + 2,uVar4 - 0x260,uVar14 + 8,param_4 + 0x10);
            param_5 = param_5 - 1;
          ...
          cVar6 = (**(code **)(*param_2 + 0x10))
                            (param_2,lVar13 + (uVar4 - 0x460),lVar10,uVar4 - 0x480);
          if (cVar6 == '\0') {
            return 0;
          }
