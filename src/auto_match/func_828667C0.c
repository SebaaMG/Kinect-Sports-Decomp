...
extern int fn_82FA5458();


undefined8 fn_828667C0(int param_1)

{
  ...
  auStack_70[0] = *(undefined4 *)(param_1 + 8);
  uVar1 = fn_82FA5458(auStack_70);
  if ((int)uVar1 == 1) {
    uVar1 = 0x200a0000;
    *(undefined1 *)(param_1 + 0x59) = 1;
  }
  else {
    fn_82230110(auStack_60,0xffffffff82020a98);
