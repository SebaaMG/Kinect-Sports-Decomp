...
void fn_82D3A2E0(undefined4 *param_1)

{
  ...
  if ((param_1[0x12] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[0x10],param_1[0x12] & 0x3fffffff,2);
  }
  param_1[0x10] = 0;
  ...
  if ((param_1[0xf] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[0xd],param_1[0xf] & 0x3fffffff,0x38);
  }
  param_1[0xd] = 0;
