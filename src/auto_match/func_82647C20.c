...
void fn_82647C20(int param_1,ulonglong param_2)

{
  ...
  if ((param_2 & 0xffffffff) == 0) {
    ...
    *(undefined4 *)(uVar2 + 0x10) = 0x13;
    uVar5 = *(int *)(param_1 + 0x2a94) + 4;
    *(uint *)(uVar2 + 0x14) = ((uVar5 >> 0x14) + 0x200 & 0x1000) + (uVar5 & 0x1fffffff) | 2;
  ...
  if ((iVar1 == 0) || (iVar1 == 1)) {
    ...
    uVar4 = -(ulonglong)(iVar1 == 4) & 3;
  }
  uVar2 = *(uint *)(param_1 + 0x2efc);
  uVar3 = (ulonglong)*(uint *)(param_1 + 0x30);
  if (*(uint *)(param_1 + 0x38) < uVar3) {
    uVar3 = fn_82645110(param_1);
  }
  uVar2 = fn_826453A0(param_1,uVar3,0,0xffffffff82647a70,
                        (ulonglong)(uVar2 >> 0x17) & 0x7f | uVar4 << 8 | param_2);
  *(uint *)(param_1 + 0x30) = uVar2;
  if ((param_2 & 0xffffffff) == 0) {
    ...
    *(undefined4 *)(uVar2 + 8) = 0x13;
    uVar5 = *(int *)(param_1 + 0x2a94) + 4;
    *(uint *)(uVar2 + 0xc) = ((uVar5 >> 0x14) + 0x200 & 0x1000) + (uVar5 & 0x1fffffff) | 2;
