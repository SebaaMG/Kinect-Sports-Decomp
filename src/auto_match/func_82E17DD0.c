...
void fn_82E17DD0(int param_1,int param_2,int *param_3)

{
  ...
  iVar8 = 0;
  iVar4 = *(uint *)(param_1 + 0x28) + param_2;
  if (0 < (longlong)((ulonglong)*(uint *)(param_1 + 0x2c) - (ulonglong)*(uint *)(param_1 + 0x28))) {
    do {
    ...
    } while (iVar8 < *(int *)(param_1 + 0x2c) - *(int *)(param_1 + 0x28));
  }
  return;
}
