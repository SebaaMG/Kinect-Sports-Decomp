...
void fn_8292CA08(int param_1,int param_2,int param_3,longlong param_4)

{
  ...
  if (uVar5 < uVar4) {
    puVar6 = (ulonglong *)(uVar5 - 8);
    lVar3 = (ulonglong)((uVar4 - uVar5) - 1 >> 3) + 1;
    do {
      pfVar2 = (float *)param_4;
      *pfVar2 = (float)*(ushort *)(puVar6 + 1) * fVar1;
      pfVar2[1] = (float)(puVar6[1] >> 0x20 & 0xffff) * fVar1;
      pfVar2[2] = (float)(puVar6[1] >> 0x10 & 0xffff) * fVar1;
      puVar6 = puVar6 + 1;
      pfVar2[3] = (float)(*puVar6 & 0xffff) * fVar1;
