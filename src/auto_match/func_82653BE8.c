...
void fn_82653BE8(undefined4 *param_1,char *param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  _vsnprintf(acStack_120,0x104,param_2,&stack0x00000020);
  if ((code *)*param_1 == (code *)0x0) {
    DbgPrint(acStack_120);
  }
  else {
    (*(code *)*param_1)();
  }
