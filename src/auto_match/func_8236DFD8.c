...
undefined4 * fn_8236DFD8(undefined4 *param_1,int param_2,int param_3)

{
  ...
  if (*(uint *)(param_3 + 0xc) <= (uint)puVar5[3]) {
...
LAB_8236e05c:
  puVar3 = (undefined4 *)fn_824C0C30(auStack_30,param_2,bVar4,puVar3,param_3);
