...
undefined4 * fn_824A2C00(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar7 + 0x31) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x31) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar1 = *(undefined1 *)(piStack00000024 + 0xc);
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x31) == '\0') {
      piVar5 = (int *)*piVar8;
      piVar6 = piVar8;
      while (piVar2 = piVar5, *(char *)((int)piVar2 + 0x31) == '\0') {
        piVar6 = piVar2;
        piVar5 = (int *)*piVar2;
      }
    }
        ...
        if (piVar8 == piVar7) {
          ...
          if (*(char *)((int)piVar7 + 0x31) == '\0') {
            if ((*(char *)(*piVar7 + 0x30) != '\x01') || (*(char *)(piVar7[2] + 0x30) != '\x01')) {
              ...
              *(undefined1 *)(piVar7 + 0xc) = *(undefined1 *)(piVar6 + 0xc);
