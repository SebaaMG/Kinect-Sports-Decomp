...
longlong fn_8285C228(int param_1)

{
  ...
  if (cVar1 == cVar2) {
    ...
    lVar3 = fn_828177C8(*(undefined4 *)(param_1 + 0x20),0xffffffff8201f854);
    iVar4 = fn_828177C8(*(undefined4 *)(param_1 + 0x24),0xffffffff8201f85c);
