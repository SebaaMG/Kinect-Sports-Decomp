...
void fn_82C9E1B8(int param_1,longlong param_2,int param_3,int param_4,char *param_5,int param_6,
...

{
  ...
  if (*(int *)(param_1 + 0x120) == 2) {
    ...
    do {
      ...
      if (cVar1 == '\0') {
        ...
        pcVar11[iVar2] =
             (char)*(undefined4 *)
                    ((uint)(byte)pcVar11[(int)param_8 - (int)param_5] * 4 + -0x7ce89228);
      }
      pcVar11 = pcVar11 + 1;
      lVar7 = lVar7 + -1;
    } while (lVar7 != 0);
  ...
  if ((*(int *)(param_1 + 0x120) != 2) &&
     ((param_4 != 0 || (**(short **)(param_1 + 0x6f0) != 0x4000)))) {
    if ((in_stack_00000064 == 0) &&
       (((iVar2 = (int)((uVar8 & 0x7fffffff) << 1),
         *(short *)(iVar2 + *(int *)(param_1 + 0x6f0)) != 0x4000 &&
      ...
      *pbVar3 = ((byte)*(undefined4 *)
                        ((*(char *)(param_6 + 2) * 0x10 + (uint)*(byte *)(in_stack_00000054 + 2)) *
                         4 + -0x7ce89328) |
                (byte)*(undefined4 *)((*param_5 * 0x10 + (uint)*param_8) * 4 + -0x7ce89428)) &
                *pbVar3;
    }
    if (((in_stack_0000006c == 0) &&
        (iVar2 = (int)((uVar8 & 0x7fffffff) << 1),
        *(short *)(iVar2 + *(int *)(param_1 + 0x6f0)) != 0x4000)) &&
       ((psVar4 = (short *)(iVar2 + *(int *)(param_1 + 0x6f0)), psVar4[-1] == *psVar4 &&
        (psVar4 = (short *)(*(int *)(param_1 + 0x6f4) + iVar2), psVar4[-1] == *psVar4)))) {
      *pbVar3 = ((byte)*(undefined4 *)
                        ((*(char *)(param_7 + 1) * 0x10 + (uint)*(byte *)(in_stack_0000005c + 1)) *
                         4 + -0x7ce89528) |
                (byte)*(undefined4 *)((*param_5 * 0x10 + (uint)*param_8) * 4 + -0x7ce89628)) &
                *pbVar3;
    }
    if (((in_stack_00000064 == 0) &&
        (iVar2 = (int)((uVar8 & 0x7fffffff) << 1),
        *(short *)(iVar2 + *(int *)(param_1 + 0x6f0) + 2) != 0x4000)) &&
       ((iVar5 = (int)((uVar10 & 0xffffffff) << 1),
      ...
      pbVar3[1] = ((byte)*(undefined4 *)((param_5[1] * 0x10 + (uint)param_8[1]) * 4 + -0x7ce89428) |
                  (byte)*(undefined4 *)
                         ((*(char *)(param_6 + 3) * 0x10 + (uint)*(byte *)(in_stack_00000054 + 3)) *
                          4 + -0x7ce89328)) & pbVar3[1];
    }
    iVar2 = (int)((uVar8 & 0x7fffffff) << 1);
    if (((*(short *)(iVar2 + *(int *)(param_1 + 0x6f0) + 2) != 0x4000) &&
        (psVar4 = (short *)(iVar2 + *(int *)(param_1 + 0x6f0)), *psVar4 == psVar4[1])) &&
       (psVar4 = (short *)(*(int *)(param_1 + 0x6f4) + iVar2), *psVar4 == psVar4[1])) {
      pbVar3[1] = ((byte)*(undefined4 *)((param_5[1] * 0x10 + (uint)param_8[1]) * 4 + -0x7ce89628) |
                  (byte)*(undefined4 *)((*param_5 * 0x10 + (uint)*param_8) * 4 + -0x7ce89528)) &
                  pbVar3[1];
    }
    iVar5 = (int)((uVar9 * 2 + uVar8 & 0x7fffffff) << 1);
    if (((*(short *)(iVar5 + *(int *)(param_1 + 0x6f0)) != 0x4000) &&
        (*(short *)(*(int *)(param_1 + 0x6f0) + iVar2) ==
         *(short *)(*(int *)(param_1 + 0x6f0) + iVar5))) &&
       (*(short *)(*(int *)(param_1 + 0x6f4) + iVar2) ==
        *(short *)(*(int *)(param_1 + 0x6f4) + iVar5))) {
      pbVar3[2] = ((byte)*(undefined4 *)((param_5[2] * 0x10 + (uint)param_8[2]) * 4 + -0x7ce89428) |
                  (byte)*(undefined4 *)((*param_5 * 0x10 + (uint)*param_8) * 4 + -0x7ce89328)) &
                  pbVar3[2];
    }
    if (((in_stack_0000006c == 0) && (*(short *)(iVar5 + *(int *)(param_1 + 0x6f0)) != 0x4000)) &&
       ((psVar4 = (short *)(iVar5 + *(int *)(param_1 + 0x6f0)), psVar4[-1] == *psVar4 &&
        (psVar4 = (short *)(*(int *)(param_1 + 0x6f4) + iVar5), psVar4[-1] == *psVar4)))) {
      pbVar3[2] = ((byte)*(undefined4 *)((param_5[2] * 0x10 + (uint)param_8[2]) * 4 + -0x7ce89628) |
                  (byte)*(undefined4 *)
                         ((*(char *)(param_7 + 3) * 0x10 + (uint)*(byte *)(in_stack_0000005c + 3)) *
                          4 + -0x7ce89528)) & pbVar3[2];
    }
    if (((*(short *)(iVar5 + *(int *)(param_1 + 0x6f0) + 2) != 0x4000) &&
        (*(short *)(*(int *)(param_1 + 0x6f0) + iVar2 + 2) ==
         *(short *)(*(int *)(param_1 + 0x6f0) + iVar5 + 2))) &&
       (*(short *)(*(int *)(param_1 + 0x6f4) + iVar2 + 2) ==
        *(short *)(*(int *)(param_1 + 0x6f4) + iVar5 + 2))) {
      pbVar3[3] = ((byte)*(undefined4 *)((param_5[3] * 0x10 + (uint)param_8[3]) * 4 + -0x7ce89428) |
                  (byte)*(undefined4 *)((param_5[1] * 0x10 + (uint)param_8[1]) * 4 + -0x7ce89328)) &
                  pbVar3[3];
    }
    if (((*(short *)(iVar5 + *(int *)(param_1 + 0x6f0) + 2) != 0x4000) &&
        (psVar4 = (short *)(iVar5 + *(int *)(param_1 + 0x6f0)), *psVar4 == psVar4[1])) &&
       (psVar4 = (short *)(*(int *)(param_1 + 0x6f4) + iVar5), *psVar4 == psVar4[1])) {
      pbVar3[3] = ((byte)*(undefined4 *)((param_5[3] * 0x10 + (uint)param_8[3]) * 4 + -0x7ce89628) |
                  (byte)*(undefined4 *)((param_5[1] * 0x10 + (uint)param_8[1]) * 4 + -0x7ce89528)) &
                  pbVar3[3];
    }
    ...
    if (((in_stack_00000064 == 0) &&
      ...
      pbVar3[4] = ((byte)*(undefined4 *)((param_5[4] * 0x10 + (uint)param_8[4]) * 4 + -0x7ce89428) |
                  (byte)*(undefined4 *)
                         ((*(char *)(param_6 + 4) * 0x10 + (uint)*(byte *)(in_stack_00000054 + 4)) *
                          4 + -0x7ce89328)) & pbVar3[4];
      pbVar3[5] = ((byte)*(undefined4 *)((param_5[5] * 0x10 + (uint)param_8[5]) * 4 + -0x7ce89428) |
                  (byte)*(undefined4 *)
                         ((*(char *)(param_6 + 5) * 0x10 + (uint)*(byte *)(in_stack_00000054 + 5)) *
                          4 + -0x7ce89328)) & pbVar3[5];
    }
    if (in_stack_0000006c == 0) {
      iVar2 = (int)((uVar9 & 0x7fffffff) << 1);
      if (((*(short *)(iVar2 + *(int *)(param_1 + 0x6f8)) != 0x4000) &&
        ...
        pbVar3[4] = ((byte)*(undefined4 *)((param_5[4] * 0x10 + (uint)param_8[4]) * 4 + -0x7ce89628)
                    | (byte)*(undefined4 *)
                             ((*(char *)(param_7 + 4) * 0x10 +
                              (uint)*(byte *)(in_stack_0000005c + 4)) * 4 + -0x7ce89528)) &
                    pbVar3[4];
        pbVar3[5] = ((byte)*(undefined4 *)((param_5[5] * 0x10 + (uint)param_8[5]) * 4 + -0x7ce89628)
                    | (byte)*(undefined4 *)
                             ((*(char *)(param_7 + 5) * 0x10 +
                              (uint)*(byte *)(in_stack_0000005c + 5)) * 4 + -0x7ce89528)) &
                    pbVar3[5];
      }
    }
  }
