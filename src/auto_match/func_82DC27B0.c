...
undefined4 fn_82DC27B0(int param_1,uint param_2,undefined8 param_3)

{
  ...
  *(undefined4 *)(*(int *)(iVar1 + 0x20) * 4 + *(int *)(iVar1 + 0x1c)) = 0xe;
  ...
  *(uint *)(*(int *)(iVar1 + 0x20) * 4 + *(int *)(iVar1 + 0x1c)) = param_2 & 0xff;
  *(int *)(iVar1 + 0x20) = *(int *)(iVar1 + 0x20) + 1;
  uStack_34 = uStack_38;
  uVar2 = *(undefined4 *)(*(int *)(param_1 + 4) + 0x14);
  fStack_40 = (float)(longlong)*(int *)(*(int *)(param_1 + 4) + 0x38);
  fn_82CE4040(param_3);
  iVar1 = *(int *)(param_1 + 4);
  iVar5 = fn_82CE5410();
  ...
  *(int *)(iVar1 + 0x14) = *(int *)(iVar1 + 0x14) + 1;
  ...
  if (*(uint *)(iVar1 + 0x38) == (*(uint *)(iVar1 + 0x3c) & 0x3fffffff)) {
    fn_82CE63B0(*(undefined4 *)(iVar5 + 0x10),(int *)(iVar1 + 0x34),4);
  }
  *(int *)(*(int *)(iVar1 + 0x38) * 4 + *(int *)(iVar1 + 0x34)) = (int)param_3;
  *(int *)(iVar1 + 0x38) = *(int *)(iVar1 + 0x38) + 1;
  iVar1 = *(int *)(param_1 + 4);
  *(int *)(iVar1 + 8) = *(int *)(iVar1 + 8) + 1;
  *(int *)(iVar1 + 0xc) = *(int *)(iVar1 + 0xc) + 3;
  *(int *)(iVar1 + 4) = *(int *)(iVar1 + 4) + 0x40;
  return uVar2;
}
