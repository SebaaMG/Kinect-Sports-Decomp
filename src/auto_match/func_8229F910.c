...
void fn_8229F910(undefined8 param_1,undefined8 param_2,undefined4 *param_3,undefined4 param_4)

{
  ...
  uStack_38 = param_2;
  fn_82672C20(*param_3,0xffffffff821ab84c,auStack_70,4);
  puVar2 = auStack_30;
  lVar3 = 3;
  do {
    puVar2 = puVar2 + -0x10;
