...
char * fn_82D3D350(char *param_1,int param_2,int param_3,int param_4)

{
  ...
  *(int *)(param_4 + 0x40) = *(int *)(param_4 + 0x40) + 1;
  piVar2 = *(int **)(param_2 + 0x18);{ V16 _vt0 = vectorMergeHighWord(in_vs34,in_vs32); memcpy(auVar12, &_vt0, 16); }{ V16 _vt1 = vectorMergeHighWord(in_vs63,in_vs33); memcpy(auVar11, &_vt1, 16); }{ V16 _vt2 = vectorMergeHighWord(in_vs62,in_vs32); memcpy(auVar10, &_vt2, 16); }{ V16 _vt3 = vectorMergeHighWord(in_vs60,in_vs61); memcpy(auVar9, &_vt3, 16); }
  ...
  *(int *)(param_4 + 0x40) = *(int *)(param_4 + 0x40) + -1;
  if (*param_1 != '\0') {
    ...
    *puVar4 = *puVar1;
    ...
    puVar4[2] = uVar14;
    puVar4[3] = uVar15;
    fn_82CE50D8(param_4,param_2 + 0x20,auStack_80);
