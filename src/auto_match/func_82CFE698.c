...
/* WARNING: Removing unreachable block (ram,0x82cfe088) */
...
void fn_82CFE698(int param_1,longlong param_2,int param_3)

{
  ...
  if (*(char *)(param_1 + 0xc) == '\0') {
    (**(code **)(**(int **)(param_1 + 8) + 0x10))
              (*(int **)(param_1 + 8),param_2,(longlong)param_3 * 2);
  }
  else {
    uVar5 = (longlong)param_3 * 2;
    uVar4 = 0x200;
    lVar6 = 0x100;
    ...
    trapWord(6,2,0);
    trapWord(6,2,0);
    trapWord(5,~(((uVar3 & 0xffffffff) >> 0x1f) - 1) & 2,0xffff);
