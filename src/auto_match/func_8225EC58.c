...
undefined4 *
fn_8225EC58(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)
  ...
  *(uint *)(param_2 + 8) = *(uint *)(param_2 + 8) + 1;
  ...
  if (param_4 == *(undefined4 **)(param_2 + 4)) {
    ...
    **(undefined4 **)(param_2 + 4) = param_5;
    ...
    param_4[2] = param_5;
    iVar2 = *(int *)(param_2 + 4);
    if (param_4 != *(undefined4 **)(iVar2 + 8)) goto LAB_8225ed00;
  }
  *(int **)(iVar2 + 8) = param_5;
LAB_8225ed00:
...
LAB_8225ed90:
      ...
      iVar2 = *piVar4;
      if (*(char *)(iVar2 + 0x18) == '\0') goto LAB_8225ed90;
