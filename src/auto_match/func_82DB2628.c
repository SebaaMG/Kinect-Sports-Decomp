...
void fn_82DB2628(int param_1,undefined4 *param_2,ulonglong param_3,int *param_4)

{
  ...
  if (*(int *)(param_1 + 0x48) != 0) {
    ...
    if (((param_4 == (int *)0x0) || ((param_3 & 0xffffffff) == 0)) || ((int)param_2[1] < 0x20)) {
      fn_83097440(auStack_f0,param_2,iVar8);
      uVar5 = fn_83097530(auStack_f0);
      fn_830838A8(&uStack_120);
      uStack_120 = (undefined4)uVar5;
      uStack_11b = 0;
      (**(code **)(**(int **)(iVar8 + 0x58) + 0x40))
                (*(int **)(iVar8 + 0x58),auStack_110,auStack_100);
      if (*piVar9 == 0) {
        iVar8 = fn_82CE5410();
        uVar4 = (**(code **)(**(int **)(iVar8 + 0x10) + 4))(*(int **)(iVar8 + 0x10),0x50);
        if ((uVar4 & 0xffffffff) == 0) {
          iVar8 = 0;
        }
        else {
          iVar8 = fn_83083C28(uVar4,&uStack_120);
        }
        *piVar9 = iVar8;
      }
      else {
        fn_83083B48(*piVar9,&uStack_120);
      }
      fn_830855B0(auStack_f0,0,uVar5,*(undefined4 *)(param_1 + 0x30));
      fn_83085650(param_1 + 0x30,*piVar9);
    }
    else {
      ...
      **(undefined4 **)(param_1 + 0x3c) = 4;
      ...
      uStack_c4 = *(undefined4 *)(iVar8 + 0x78);
      uStack_90 = *param_2;
      ...
      if (puVar1 < *(undefined4 **)(iVar8 + 0xc)) {
        *puVar1 = "LtbuildTreeDistributed";
        ...
        uVar3 = TBLr;
        puVar1[1] = (int)uVar3;
        *(undefined4 **)(iVar8 + 4) = puVar1 + 4;
      }
      fn_82CE8AF0(param_3,&uStack_e0,0);
      iVar8 = KeTlsGetValue(lbl_8323B4A0);
      puVar1 = *(undefined4 **)(iVar8 + 4);
      if (puVar1 < *(undefined4 **)(iVar8 + 0xc)) {
        *puVar1 = "Ststart";
      ...
      (**(code **)(*param_4 + 0xc))(param_4,param_3,3);
      fn_82CE9108(param_3);
      iVar8 = KeTlsGetValue(lbl_8323B4A0);
      puVar1 = *(undefined4 **)(iVar8 + 4);
      if (puVar1 < *(undefined4 **)(iVar8 + 0xc)) {
      ...
      fn_830853E8(*piVar9,uVar2,uStack_b0,uStack_ac);
      iVar8 = KeTlsGetValue(lbl_8323B4A0);
      puVar1 = *(undefined4 **)(iVar8 + 4);
      if (puVar1 < *(undefined4 **)(iVar8 + 0xc)) {
        *puVar1 = &lbl_8202CF7C;
      ...
      if ((uVar11 & 0x80000000) == 0) {
        (**(code **)(**(int **)(iVar8 + 0x10) + 0x10))
                  (*(int **)(iVar8 + 0x10),uVar6,uVar11 & 0x3fffffff,4);
      }
      iVar8 = fn_82CE5410();
      if ((uVar10 & 0x80000000) == 0) {
        (**(code **)(**(int **)(iVar8 + 0x10) + 0x10))
                  (*(int **)(iVar8 + 0x10),uVar5,uVar10 & 0x3fffffff,4);
      }
    }
    return;
  }
