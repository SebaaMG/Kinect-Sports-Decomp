...
undefined4 * fn_82515FD8(undefined4 *param_1,int param_2,int param_3)
...
LAB_82516068:
  puVar2 = (undefined4 *)fn_825160E0(apuStack_50,param_2,bVar3,puVar2,param_3);
