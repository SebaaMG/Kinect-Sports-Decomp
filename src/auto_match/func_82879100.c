...
extern int fn_82FE6770();


undefined8 fn_82879100(int param_1)

{
  ...
  uVar1 = fn_82FE6770(*(undefined4 *)(param_1 + 0x3c));
  if ((int)uVar1 == 1) {
    uVar1 = 0x20200000;
  }
  else {
    ...
    uVar2 = fn_8286A3D8(uVar2,0,0xffffffff820227ec,0x2e);
    uVar2 = fn_8223DFF0(uVar2,0xffffffff820227e4,4);
