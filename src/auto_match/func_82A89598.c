...
undefined8
fn_82A89598(uint *param_1,int *param_2,uint *param_3,longlong param_4,ulonglong param_5,
             longlong param_6)
      ...
      if (cVar6 != '\0') {
        while (fn_82A86D58(uVar4 - 0x260,uVar4 - 0x460,lVar13), (int)param_5 != 0) {
          do {
            ...
            fn_82A88F60(uVar9,param_3 + 1,uVar4 - 0x260,uVar14,param_4);
            param_5 = param_5 - 1;
