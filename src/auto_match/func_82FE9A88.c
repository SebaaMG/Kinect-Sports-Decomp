...
undefined8
fn_82FE9A88(undefined8 param_1,undefined4 *param_2,ulonglong param_3,undefined8 param_4,
             longlong param_5)
  ...
  if ((param_3 & 0xffffffff) == 0) {
    ...
    if (puVar2 == (undefined4 *)0x0) {
      ...
      if ((param_3 & 0xffffffff) != 0) {
        ...
        puVar5 = puVar2;
        do {
          uVar3 = fn_82FE89F8(*(undefined4 *)((int)param_2 + ((int)puVar5 - (int)puVar2)));
          *puVar5 = uVar3;
          uVar4 = uVar4 - 1;
          puVar5 = puVar5 + 1;
        } while (uVar4 != 0);
