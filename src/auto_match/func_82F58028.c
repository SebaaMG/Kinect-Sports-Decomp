...
extern int fn_82825658();
extern int fn_82829BE0();
extern int fn_82F57D98();
extern int fn_82F622E0();
extern unsigned int stack0x00000024;


undefined4 * fn_82F58028(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x21) == '\0') {
      piVar6 = (int *)*piVar8;
      piVar7 = piVar8;
      while (piVar3 = piVar6, *(char *)((int)piVar3 + 0x21) == '\0') {
        piVar7 = piVar3;
        piVar6 = (int *)*piVar3;
      }
    }
        ...
        if (piVar8 == piVar7) {
          ...
          if (*(char *)(piVar7 + 8) == '\0') {
            ...
            *(undefined1 *)(piVar9 + 8) = 0;
            fn_82829BE0(param_2,piVar9);
            piVar7 = (int *)piVar9[2];
          }
          if (*(char *)((int)piVar7 + 0x21) == '\0') {
            if ((*(char *)(*piVar7 + 0x20) != '\x01') || (*(char *)(piVar7[2] + 0x20) != '\x01')) {
              if (*(char *)(piVar7[2] + 0x20) == '\x01') {
                *(undefined1 *)(*piVar7 + 0x20) = 1;
                *(undefined1 *)(piVar7 + 8) = 0;
                fn_82825658(param_2,piVar7);
                piVar7 = (int *)piVar9[2];
              }
              *(undefined1 *)(piVar7 + 8) = *(undefined1 *)(piVar9 + 8);
              *(undefined1 *)(piVar9 + 8) = 1;
              *(undefined1 *)(piVar7[2] + 0x20) = 1;
              fn_82829BE0(param_2,piVar9);
              break;
            }
LAB_82f5833c:
          ...
          if (*(char *)(piVar7 + 8) == '\0') {
            *(undefined1 *)(piVar7 + 8) = 1;
            *(undefined1 *)(piVar9 + 8) = 0;
            fn_82825658(param_2,piVar9);
            piVar7 = (int *)*piVar9;
          }
          if (*(char *)((int)piVar7 + 0x21) == '\0') {
            if ((*(char *)(piVar7[2] + 0x20) == '\x01') && (*(char *)(*piVar7 + 0x20) == '\x01'))
            goto LAB_82f5833c;
            if (*(char *)(*piVar7 + 0x20) == '\x01') {
              *(undefined1 *)(piVar7[2] + 0x20) = 1;
              *(undefined1 *)(piVar7 + 8) = 0;
              fn_82829BE0(param_2,piVar7);
              piVar7 = (int *)*piVar9;
            }
            *(undefined1 *)(piVar7 + 8) = *(undefined1 *)(piVar9 + 8);
            *(undefined1 *)(piVar9 + 8) = 1;
