...
void fn_823BDCE0(int *param_1,undefined8 param_2,uint *param_3)

{
  ...
  if (param_3 != (uint *)0x0) {
    ...
    cVar2 = fn_82F64538(uVar1,0xffffffff831dea70);
    if (cVar2 != '\0') {
  ...
  lVar3 = 0;
LAB_823bdd4c:
  fn_823BE2A8(auStack_1c0,lVar3);
  (**(code **)(*param_1 + 0x10))(param_1,param_2,auStack_1c0);
  return;
}
