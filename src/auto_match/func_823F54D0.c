...
extern unsigned int lbl_821B7A5C;


void fn_823F54D0(int *param_1,undefined8 param_2,int *param_3)

{
  ...
  if (param_3 != (int *)0x0) {
    ...
    cVar4 = fn_82F64538(uVar2,0xffffffff831df6e4);
    if (cVar4 != '\0') {
      iVar5 = *param_3 + 4;
      goto LAB_823f5540;
    }
...
LAB_823f5540:
  if (iVar5 == 0) {
    ...
    if (puVar3 == (undefined4 *)0x0) {
      ...
      *puVar3 = &lbl_821B7A5C;
      *(undefined2 *)(puVar3 + 1) = auStack_30[0];
    }
