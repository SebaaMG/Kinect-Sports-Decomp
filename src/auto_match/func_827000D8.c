...
void fn_827000D8(int param_1,undefined8 param_2,ulonglong param_3,undefined8 param_4,
                  undefined8 param_5)

{
  ...
  if (lVar3 == 0) {
    ...
    fn_8268C510(auStack_50,param_4);
    iVar4 = fn_826FC2F0(lVar3,auStack_50,param_5,0,0);
    lVar3 = ((ulonglong)auStack_50[0] & 0xfffffffc) + 4;
    bVar2 = false;
    do {
      puVar7 = (uint *)lVar3;
  ...
  if (iVar4 != 0) {
    *(undefined4 *)(iVar4 + 4) = 0x10;
    fn_82696BC8(iVar4 + 0x60,param_2);
