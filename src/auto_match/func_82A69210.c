...
extern unsigned int lbl_8208ED4C;
extern unsigned int lbl_821AAD20;


undefined8
fn_82A69210(int param_1,int param_2,undefined4 param_3,undefined4 param_4,int param_5,
...

{
  ...
  *(uint *)(param_1 + 0x268) = uVar7 + 1;
  ...
  if (((uVar7 & 0xffff & uVar8) == 0) && ((&lbl_8208ED4C)[uVar8 & 0xf] != '\0')) {
    if ((uVar8 & 10) == 10) {
      uVar8 = 0;
    }
