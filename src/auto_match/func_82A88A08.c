...
extern int fn_82A884C0();
extern unsigned int stack0x00000000;


undefined8
fn_82A88A08(uint *param_1,int *param_2,uint *param_3,longlong param_4,ulonglong param_5,
             longlong param_6)

{
  ...
  if ((int)param_5 < 1) {
    ...
    if ((cVar6 != '\0') && (cVar6 = (**(code **)(*param_2 + 0xc))(param_2,0x36), cVar6 != '\0')) {
      ...
      cVar6 = (**(code **)(*param_2 + 0x10))(param_2,uVar4 - 0x460,lVar13,uVar4 - 0x490);
      if (cVar6 != '\0') {
        while (fn_82A86D58(uVar4 - 0x260,uVar4 - 0x460,lVar13), (int)param_5 != 0) {
          do {
            if (0x1000 - iVar12 < (int)uVar14) break;
            fn_82A884C0(uVar9,param_3 + 1,uVar4 - 0x260,uVar14,param_4);
            param_5 = param_5 - 1;
          ...
          cVar6 = (**(code **)(*param_2 + 0x10))
                            (param_2,lVar13 + (uVar4 - 0x460),lVar10,uVar4 - 0x490);
          if (cVar6 == '\0') {
            return 0;
          }
