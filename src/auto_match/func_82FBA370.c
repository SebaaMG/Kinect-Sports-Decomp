...
undefined8 fn_82FBA370(int *param_1,undefined8 param_2,undefined8 param_3,ulonglong param_4)
  ...
  if ((param_4 & 0xffffffff) == 0) {
    ...
    *(undefined1 *)((int)param_1 + 0x4a) = 1;
    return 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x82fba424. Too many branches */
