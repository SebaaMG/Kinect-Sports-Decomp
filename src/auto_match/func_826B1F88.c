...
void fn_826B1F88(int *param_1,undefined8 param_2)

{
  ...
  if (uVar3 == 0) {
    ...
    apuStack_60[0] = (undefined4 *)fn_8267BED0(param_2,uVar3 * 0x14 + 8,&uStack_58);
    *apuStack_60[0] = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        iVar5 = iVar4 + *param_1;
        if (*(int *)(iVar5 + 8) != -2) {
          fn_826AF920(apuStack_60,param_2,iVar5 + 0xc,*(undefined4 *)(*(int *)(iVar5 + 0xc) + 0xc)
                       );
