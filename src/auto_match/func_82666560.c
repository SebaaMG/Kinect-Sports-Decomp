...
void fn_82666560(uint *param_1,undefined4 param_2)

{
  ...
  if (cVar4 == '\0') {
    ...
    fn_8266ADE0(puStack00000014 + 3,puStack00000014[1],uStack0000001c);
    ...
    fn_8265D468(puStack00000014,puStack00000014[1],puStack00000014[1]);
    fn_8266ADE0(puStack00000014 + 3,puStack00000014[1],
