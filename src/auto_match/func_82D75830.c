...
extern unsigned int lbl_82139CDC;


undefined4 *
fn_82D75830(undefined8 param_1,undefined8 param_2,undefined8 param_3,ulonglong param_4)

{
  ...
  if ((param_4 & 0xffffffff) == 0) {
    ...
    *(undefined2 *)(puVar2 + 1) = 0x80;
    fn_82D74A90(puVar2,param_1,param_2,param_4);
    *puVar2 = &lbl_82139CDC;
    puVar2[0xc] = 0;
  }
  return puVar2;
