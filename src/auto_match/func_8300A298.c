...
double fn_8300A298(int param_1)

{
  ...
  if (((*(byte *)(param_1 + 0x3d) & 4) != 0) && (*(int *)(param_1 + 0x20) != 0)) {
    iVar3 = fn_83006E68();
    if ((iVar3 != 0) && (iVar3 = fn_8302B158(), iVar3 == 1)) {
      bVar2 = true;
    }
    dVar6 = (double)*(float *)(*(int *)(param_1 + 0x20) + 8);
  }
  if ((!bVar2) &&
     (dVar6 = (double)(float)((double)(longlong)*(short *)(param_1 + 0x2e) * (double)lbl_82186E6C +
                             dVar6), (*(uint *)(param_1 + 0x40) >> 1 & 1) != 0)) {
    dVar4 = (double)fn_830177C8(lbl_832642FC,param_1,1,0);
    dVar6 = (double)(float)(dVar4 + dVar6);
  }
  if (*(int *)(param_1 + 0x24) != 0) {
    dVar6 = (double)(float)((double)*(float *)(*(int *)(param_1 + 0x24) + 0x2c) + dVar6);
  }
