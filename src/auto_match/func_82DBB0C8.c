...
void fn_82DBB0C8(int *param_1,int param_2,int *param_3,int param_4)

{
  ...
  if (iVar4 != 0) {
    ...
    if (iVar5 == 0) {
      ...
      fn_82DBBF60(iVar4,param_3,puVar6);
      if (param_2 == *(int *)(iVar4 + 0x14)) {
        ...
        *puVar3 = *puVar1;
        ...
        puVar3[2] = uVar9;
        puVar3[3] = uVar10;
        *(undefined4 *)(puVar6 + 0x18) = lbl_82002AE0;
        puVar1 = (undefined4 *)((int)puVar6 + in_r0 + 0x30 & 0xfffffff0);
        ...
        *(undefined4 *)(puVar6 + 0x10) = lbl_82002AE0;
        puVar1 = (undefined4 *)((int)puVar6 + in_r0 + 0x20 & 0xfffffff0);
        *puVar1 = in_register_000100d0;
        ...
        uVar9 = puVar1[2];
        uVar10 = puVar1[3];
        puVar3 = (undefined4 *)((uint)(puVar6 + 0x18) & 0xfffffff0);
        *puVar3 = *puVar1;
        puVar3[1] = uVar8;
        puVar3[2] = uVar9;
        puVar3[3] = uVar10;
      ...
      puVar3 = (undefined4 *)(iVar5 + iVar7 & 0xfffffff0);
      *puVar3 = *puVar1;
      puVar3[1] = uVar8;
      puVar3[2] = uVar9;
      puVar3[3] = uVar10;
      uVar8 = lbl_82002AE0;
      if ((*(float *)(iVar5 + 0x2c) == lbl_821AAD20) && (*(float *)(iVar5 + 0x3c) == lbl_821AAD20))
      {
        *(undefined4 *)(iVar5 + 0x2c) = lbl_82002AE0;
        *(undefined4 *)(iVar5 + 0x3c) = uVar8;
      }
    }
