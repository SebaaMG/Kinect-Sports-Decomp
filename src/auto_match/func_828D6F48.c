...
extern int fn_828D5E50();


undefined4 * fn_828D6F48(undefined4 *param_1,int *param_2,int *param_3,int *param_4)

{
  ...
  if (param_2[2] != iVar1) {
    if (iVar1 != param_4[2]) {
      ...
      fn_828D5E50(CONCAT44(uVar7,param_2[2]),CONCAT44(uVar6,iVar1),CONCAT44(uVar5,param_4[2]),0,0)
      ;
