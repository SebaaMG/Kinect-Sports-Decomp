...
void fn_82E93F80(int param_1,int param_2,int param_3)

{
  double dVar1;
  double dVar2;
  
  if (*(int *)(param_1 + 0x77a8) == 0) {
    dVar1 = (double)fn_82F655D8((double)(longlong)*(int *)(param_1 + 0x77d8) /
                                      (double)(longlong)*(int *)(param_1 + 0x77cc),
                                      *(undefined8 *)(param_1 + 0x77e0));
    dVar1 = -(dVar1 * (double)(longlong)param_3 - (double)(longlong)param_2) /
    ...
    dVar1 = (double)fn_82F65E20(-((*(double *)(param_1 + 0x7830) - *(double *)(param_1 + 0x7838)) *
                                   *(double *)(param_1 + 0x7850) *
                                   (double)(longlong)*(int *)(param_1 + 0x77d8) -
                                  (double)(longlong)param_2) / (double)(longlong)param_3);
