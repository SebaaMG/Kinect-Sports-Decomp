...
undefined4 *
fn_8233D330(undefined4 *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  *param_1 = &lbl_821A8D8C;
  ...
  if (param_1 + 4 != (undefined4 *)0x0) {
    ...
    fn_822FB850(param_1 + 4,auStack_90,param_3,param_4,auStack_70,*param_6,param_7);
