...
void fn_82D6DA38(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4,
...

{
  ...
  *puVar1 = uVar11;
  ...
  uStack_d0 = param_5;
  fn_82D6CF80(param_1,param_3,param_2,auStack_90,&ppuStack_f0,pppuVar3);
  return;
}
