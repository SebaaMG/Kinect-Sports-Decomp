...
void fn_82928048(int param_1,uint param_2,uint param_3,int param_4)

{
  ...
  if (*(int *)(param_1 + 0x68) != 0) {
    ...
    lVar24 = ((longlong)(int)(uVar13 - 1) * (longlong)(int)(param_2 & 1) & 0x3fffffffU) * 4 +
    ...
    do {
      ...
      fVar3 = (float)((double)*(float *)(param_4 + 8 + iVar20) + dVar31) * fVar10;
      fVar4 = (float)((double)*(float *)(iVar15 + -8) + dVar25) * fVar10;
      fVar5 = (float)((double)*(float *)(iVar15 + -4) + dVar30) * fVar10;
      iVar15 = (int)(fVar3 + fVar1);
      uVar13 = (uint)(fVar4 + fVar1);
      uVar14 = (uint)(fVar5 + fVar1);
      if (*(int *)(param_1 + 0x5c) != 0) {
        iVar7 = (int)lVar17;
        iVar6 = iVar7 + *(int *)(param_1 + 0x5c);
        dVar25 = (double)((fVar4 - (float)(longlong)(int)uVar13) * fVar9);
        *(float *)(iVar6 + 0x10) = (float)(dVar25 * dVar29 + (double)*(float *)(iVar6 + 0x10));
        ...
        dVar26 = (double)((fVar3 - (float)(longlong)iVar15) * fVar9);
      ...
      *(uint *)lVar24 = (iVar15 << 8 | uVar14) << 8 | uVar13;
