...
void fn_82438150(uint *param_1,ulonglong param_2)

{
  ...
  if ((ulonglong)(uint)((int)(param_1[2] - *param_1) / 0x18) < (param_2 & 0xffffffff)) {
    lVar4 = 0;
    if (((param_2 & 0xffffffff) != 0) && (lVar4 = fn_8265C9E0(param_2 * 0x18), lVar4 == 0)) {
      uStack_3c = 0;
      ppuStack_40 = &lbl_82002B04;
                    /* WARNING: Subroutine does not return */
      fn_82230040(&ppuStack_40);
    }
    fn_824382F0(*param_1,param_1[1],lVar4);
    uVar1 = *param_1;
