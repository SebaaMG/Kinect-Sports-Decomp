...
extern int fn_82892428();
extern int fn_82892488();
extern int fn_828CCB18();


undefined4 * fn_82893850(undefined4 *param_1,uint param_2,int param_3,ulonglong param_4)

{
  ...
  if ((uint)apuStack_50[0][3] < *puVar9) {
    ...
    *param_1 = uVar2;
    ...
    fn_82892428(param_2 + 0xd,puVar9);
