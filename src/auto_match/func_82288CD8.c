...
void fn_82288CD8(undefined4 *param_1)

{
  ...
  if ((uVar2 & 0xffffffff) == 0) {
    ...
    iVar3 = fn_82266DD8(uVar2,param_1 + 0x10,*param_1,param_1[0x1a6],0);
  }
  param_1[0x183] = iVar3;
  for (puVar1 = *(undefined4 **)**(int **)(iVar3 + 0x5c0);
      puVar1 != (undefined4 *)**(int **)(iVar3 + 0x5c0); puVar1 = (undefined4 *)*puVar1) {
    iVar4 = puVar1[2];
    if (*(int *)(iVar4 + 0x40) == 0) goto LAB_82288d5c;
  }
  iVar4 = 0;
LAB_82288d5c:
  fn_82288ED8(iVar4,0);
  for (puVar1 = *(undefined4 **)**(int **)(param_1[0x183] + 0x5c0);
    ...
    iVar3 = puVar1[2];
    if (*(int *)(iVar3 + 0x40) == 1) goto LAB_82288d98;
  }
  iVar3 = 0;
LAB_82288d98:
  fn_82288ED8(iVar3,1);
  fn_8228A540(param_1,0xffffffff821a9400);
