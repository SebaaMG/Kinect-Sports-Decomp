...
undefined4 * fn_82319800(undefined4 *param_1,int param_2,int param_3)
...
LAB_82319890:
  puVar2 = (undefined4 *)fn_823198F8(apuStack_50,param_2,bVar3,puVar2,param_3);
