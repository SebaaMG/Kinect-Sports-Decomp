...
extern unsigned int lbl_8213BACC;


void fn_82D94BD8(undefined4 *param_1)

{
  int *piVar1;
  int iVar2;
  
  *param_1 = &lbl_8213BACC;
  fn_82D94360();
  fn_82CED5B8(param_1 + 0xe);
  iVar2 = fn_82CE5410();
  ...
  if ((param_1[7] & 0x80000000) == 0) {
    (**(code **)(*piVar1 + 0x10))(piVar1,param_1[5],param_1[7] & 0x3fffffff,4);
  }
  param_1[5] = 0;
