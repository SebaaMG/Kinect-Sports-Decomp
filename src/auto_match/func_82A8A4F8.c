...
undefined8
fn_82A8A4F8(uint *param_1,int *param_2,uint *param_3,longlong param_4,ulonglong param_5,
             longlong param_6)

{
  ...
  fn_82F68CC0(uVar4 - 0x490,uVar4 - 0x4c0,0x1c);
  ...
  if ((int)param_5 < 1) {
    ...
    if ((cVar6 != '\0') && (cVar6 = (**(code **)(*param_2 + 0xc))(param_2,0x36), cVar6 != '\0')) {
      ...
      cVar6 = (**(code **)(*param_2 + 0x10))(param_2,uVar4 - 0x460,lVar7,uVar4 - 0x4d0);
      if (cVar6 != '\0') {
        while (fn_82A86D58(uVar4 - 0x260,uVar4 - 0x460,lVar7), (int)param_5 != 0) {
          do {
            if (0x1000 - iVar12 < (int)uVar13) break;
            fn_82A89FF8(uVar10,param_3 + 1,uVar4 - 0x260,uVar13,param_4);
            param_5 = param_5 - 1;
          ...
          cVar6 = (**(code **)(*param_2 + 0x10))
                            (param_2,lVar7 + (uVar4 - 0x460),lVar11,uVar4 - 0x4d0);
          if (cVar6 == '\0') {
            return 0;
          }
          lVar7 = lVar7 + lVar11;
