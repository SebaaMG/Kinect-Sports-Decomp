...
void fn_825AD308(int param_1,uint param_2)

{
  ...
  iVar2 = fn_82E21DB0(uVar9 + param_2,0);
  iVar3 = uVar8 * 4;
  ...
  if (param_2 < uVar8) {
    ...
    iVar7 = ((*(int *)(param_1 + 4) - iVar4) + iVar3 >> 2) * 4;
    iVar3 = fn_82F63CA0(iVar2,iVar4,iVar7);
    if (param_2 != 0) {
      puVar5 = (undefined4 *)(iVar3 + iVar7 + -4);
      for (uVar9 = param_2; uVar9 != 0; uVar9 = uVar9 - 1) {
        puVar5 = puVar5 + 1;
        *puVar5 = 0;
      }
    }
