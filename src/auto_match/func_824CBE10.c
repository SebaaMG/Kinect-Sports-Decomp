...
undefined4 * fn_824CBE10(undefined4 *param_1,int param_2,int param_3)
...
LAB_824cbeb8:
  puVar1 = (undefined4 *)fn_824CBF68(apuStack_50,param_2,uVar4,puVar1,param_3);
