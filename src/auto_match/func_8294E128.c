...
undefined8 fn_8294E128(int param_1)

{
  ...
  uStack_12c = 1;
  uStack_128 = 2;
  uVar3 = fn_8294AC48(param_1,*(uint **)(param_1 + 0x104),0xffffffff82036610,auStack_120,
                        auStack_140,auStack_e0,&uStack_130,uVar9);
  bVar1 = (int)uVar3 != 1;
  if (!bVar1) {
    uVar3 = fn_8294AC48(param_1,*(undefined4 *)(param_1 + 0x104),0xffffffff82036690,auStack_120,
                          auStack_140,auStack_e0,&uStack_130,uVar9);
  }
  if ((int)uVar3 == 0) {
    uVar5 = 0;
