...
undefined8 fn_82867318(undefined8 param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((int)uVar1 == 1) {
    ...
    uVar2 = fn_8286A3D8(uVar2,0,0xffffffff82020db0,0x1b);
    uVar2 = fn_8223DFF0(uVar2,0xffffffff82020da8,4);
