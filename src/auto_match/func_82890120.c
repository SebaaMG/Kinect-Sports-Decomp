...
undefined1 * fn_82890120(undefined1 *param_1,int param_2)

{
  ...
  *(undefined4 *)(param_1 + 0x34) = 0;
  fn_828CCCC0(param_1 + 0x30,*(undefined4 *)(param_2 + 0x30),*(undefined4 *)(param_2 + 0x34),0
                   );
  param_1[0x38] = *(undefined1 *)(param_2 + 0x38);
  return param_1;
}
