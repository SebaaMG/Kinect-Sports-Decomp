  ...
  if ((param_3 & 0xffffffff) != 0) {
    ...
    if ((ulonglong)uVar5 < (uVar7 & 0xffffffff)) {
      ...
      if ((ulonglong)uVar5 <= (0x3fffffff - (ulonglong)(uVar5 >> 1) & 0xffffffff)) {
        uVar12 = (ulonglong)(uVar5 >> 1) + (longlong)(int)uVar5;
      }
      if ((uVar12 & 0xffffffff) < (uVar7 & 0xffffffff)) {
        uVar12 = uVar7;
      }
      lVar8 = fn_822B27D8(param_1 + 3,uVar12);
      ...
      iVar6 = (int)lVar8;
      *param_1 = iVar6;
      param_1[2] = (int)((uVar12 & 0xffffffff) << 2) + iVar6;
      param_1[1] = (int)(((longlong)(iVar3 - iVar2 >> 2) + param_3 & 0xffffffff) << 2) + iVar6;
    }
    else {
      uVar4 = *param_4;
      ...
      if ((ulonglong)uVar5 < (param_3 & 0xffffffff)) {
        ...
        uVar12 = lVar8 + (param_3 & 0x3fffffff) * -4;
        param_1[1] = (int)lVar8;
