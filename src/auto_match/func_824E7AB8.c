...
undefined4 * fn_824E7AB8(undefined4 *param_1,int param_2,int param_3)
...
LAB_824e7b60:
  puVar1 = (undefined4 *)fn_824E7C00(apuStack_50,param_2,uVar4,puVar1,param_3);
