...
extern unsigned int lbl_82139368;


undefined4 * fn_82D626B0(uint *param_1,undefined8 param_2,undefined8 param_3,undefined4 param_4)

{
  ...
  *(undefined2 *)(puVar2 + 4) = 0xffff;
  fn_82D76368((ulonglong)*param_1 + 0x20,puVar2 + 5);
  *puVar2 = &lbl_82139368;
  return puVar2;
}
