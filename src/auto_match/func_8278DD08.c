...
void fn_8278DD08(int *param_1,undefined8 param_2,uint param_3)

{
  ...
  if (param_3 == 0) {
    ...
    puStack_4c = (undefined4 *)fn_8267BED0(param_2,uVar5 * 0xc + 8,&uStack_48);
    *puStack_4c = 0;
    puStack_4c[1] = (int)uVar5 + -1;
    if (uVar5 != 0) {
      iVar2 = 0;
      do {
        *(undefined4 *)((int)puStack_4c + iVar2 + 8) = 0xfffffffe;
        uVar5 = uVar5 - 1;
        iVar2 = iVar2 + 0xc;
      } while (uVar5 != 0);
    }
    if (*param_1 != 0) {
      ...
      do {
        iVar3 = iVar2 + *param_1;
        if (*(int *)(iVar3 + 8) != -2) {
          fn_8278BDD0(auStack_50,*(undefined4 *)(iVar3 + 0x10),iVar3 + 0x10);
