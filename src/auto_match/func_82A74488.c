...
void fn_82A74488(uint *param_1,int param_2,undefined8 param_3,undefined8 param_4,int param_5)

{
  ...
  while( true ) {
    ...
    if (uVar1 == 1) break;
    if (uVar1 == 2) {
      iVar2 = fn_82A6D090(param_3,0x10,param_1);
      goto joined_r0x82a74594;
    }
    if (uVar1 == 3) {
      iVar2 = fn_82A6D090(param_3,0x18,param_1);
      goto joined_r0x82a74594;
    }
    if (uVar1 == 4) {
      iVar2 = fn_82A6D090(param_3,0x18,param_5 + 0x34);
      if (iVar2 < 0) {
        return;
      }
      *(undefined4 *)(param_5 + 4) = 5;
LAB_82a745f4:
      iVar2 = fn_82A6D090(param_3,7,param_1);
      if (iVar2 < 0) {
        return;
      }
  ...
  iVar2 = fn_82A6D090(param_3,8,param_1);
joined_r0x82a74594:
  if (iVar2 < 0) {
    return;
  }
