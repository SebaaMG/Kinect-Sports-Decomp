...
void fn_82CEBEF0(int param_1,int param_2,int param_3)

{
  ...
  *pfVar3 = *pfVar2 * *pfVar1;
  ...
  fVar8 = pfVar1[2];
  fVar9 = pfVar1[3];
  pfVar2 = (float *)(param_3 + 0x10U & 0xfffffff0);
  fVar4 = pfVar2[1];
  fVar5 = pfVar2[2];
  fVar6 = pfVar2[3];
  pfVar3 = (float *)(param_1 + 0x10U & 0xfffffff0);
  *pfVar3 = *pfVar2 * *pfVar1;
  ...
  fVar8 = pfVar1[2];
  fVar9 = pfVar1[3];
  pfVar2 = (float *)(param_3 + 0x20U & 0xfffffff0);
  fVar4 = pfVar2[1];
  fVar5 = pfVar2[2];
  fVar6 = pfVar2[3];
