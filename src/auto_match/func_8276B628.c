...
void fn_8276B628(int *param_1,undefined8 param_2,uint param_3)

{
  ...
  if (param_3 == 0) {
    ...
    apuStack_50[0] =
         (undefined4 *)fn_8267BED0(param_2,(uVar5 & 0xfffffff) * 0x10 + 8,&uStack_48);
    *apuStack_50[0] = 0;
    ...
    if (*param_1 != 0) {
      ...
      do {
        ...
        if (*(int *)(iVar3 + iVar1 + 8) != -2) {
          ...
          fn_8276D5E8(apuStack_50,param_2);
