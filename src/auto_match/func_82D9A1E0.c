...

{
  ...
  do {
    if (*(int *)(*(int *)(param_1 + 0x98) + (int)lVar1) == 0) {
      lVar3 = (ulonglong)*(uint *)(param_1 + 0x9c) - 1;
      lVar4 = (ulonglong)*(uint *)(param_1 + 0x98) + lVar1;
      *(int *)(param_1 + 0x9c) = (int)lVar3;
