...
undefined8 fn_82A88220(int *param_1,int *param_2,longlong param_3)

{
  ...
  auStack_c0[0] = lbl_8201DCB8;
  if (puVar3 == (undefined4 *)0x0) {
    puVar3 = auStack_c0;
  }
  cVar2 = (**(code **)(*param_2 + 4))(param_2);
  if ((cVar2 == '\0') ||
     (cVar2 = (**(code **)(*param_2 + 0x10))(param_2,auStack_a0,0x37,auStack_c0), cVar2 == '\0')) {
    uVar1 = 0;
  }
  else {
