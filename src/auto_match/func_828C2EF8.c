...
undefined4 *
fn_828C2EF8(undefined4 *param_1,int param_2,char param_3,undefined4 *param_4,int *param_5)

{
  ...
  if (0x5d1745b < *(uint *)(param_2 + 8)) {
    fn_828A7378(param_2 + 0xd,param_5 + 3);
    fn_8265CA20(param_5);
  ...
  while (cVar1 == '\0') {
    ...
    if (piVar2 == (int *)*piVar3) {
      ...
      if (*(char *)(iVar4 + 0x38) == '\0') {
        ...
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x38) = 0;
        fn_828A0C88(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
    else {
      iVar4 = *piVar3;
      if (*(char *)(iVar4 + 0x38) == '\0') {
        ...
        *(undefined1 *)(piVar5[1] + 0x38) = 1;
        *(undefined1 *)(*(int *)(piVar5[1] + 4) + 0x38) = 0;
        fn_828A1438(param_2,*(undefined4 *)(piVar5[1] + 4));
      }
    }
