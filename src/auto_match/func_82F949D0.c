...
extern int fn_82F95A20();
extern int fn_82F95A78();
extern int fn_82F95AD0();
extern int fn_82F95C18();
extern int fn_82F95C50();
extern int fn_82F95CE8();
...
undefined4 * fn_82F949D0(undefined4 *param_1,int param_2,undefined8 param_3)

{
  ...
  fn_82F95CE8(&stack0x00000020);
  puVar6 = (undefined4 *)fn_8265D5A8(iVar5);
  pcVar4 = (char *)fn_82F953A8(*puVar6);
  iStack_50 = iVar5;
  if (*pcVar4 == '\0') {
  ...
  if (iStack_50 == iVar5) {
    ...
    iStack_4c = *piVar7;
    pcVar4 = (char *)fn_82F953A8(iStack_54);
    if (*pcVar4 == '\0') {
    ...
    if (*piVar7 == iVar5) {
      ...
      iStack_20 = iStack_4c;
      if (*pcVar4 == '\0') {
        iStack_20 = fn_82F95A78(iStack_54);
      }
      piVar7 = (int *)fn_82F91FA0(iStack0000001c);
      *piVar7 = iStack_20;
    }
    ...
    if (*piVar7 == iVar5) {
      ...
      iStack_1c = iStack_4c;
      if (*pcVar4 == '\0') {
        iStack_1c = fn_82F95A20(iStack_54);
      }
      piVar7 = (int *)fn_82F91FD0(iStack0000001c);
      *piVar7 = iStack_1c;
    }
    ...
    *puVar8 = *puVar6;
    uVar2 = fn_82F95398(iVar5);
    uVar3 = fn_82F95398(iStack_50);
    fn_82231700(uVar3,uVar2);
  }
  pcVar4 = (char *)fn_82F95398(iVar5);
  if (*pcVar4 != '\x01') {
LAB_82f95158:
    fn_82F95C50(iStack0000001c + 1,iVar5);
    fn_82F95C18(iStack0000001c + 1,iVar5,1);
...
LAB_82f94dec:
  piVar7 = (int *)fn_82F92000(iStack0000001c);
  if ((iStack_54 == *piVar7) || (pcVar4 = (char *)fn_82F95398(iStack_54), *pcVar4 != '\x01'))
  goto LAB_82f95148;
  piVar7 = (int *)fn_8265D5A8(iStack_4c);
  if (iStack_54 == *piVar7) {
    puVar6 = (undefined4 *)fn_82F953B8(iStack_4c);
    iStack_50 = *puVar6;
    pcVar4 = (char *)fn_82F95398(iStack_50);
    if (*pcVar4 == '\0') {
      puVar9 = (undefined1 *)fn_82F95398(iStack_50);
      *puVar9 = 1;
      puVar9 = (undefined1 *)fn_82F95398(iStack_4c);
      *puVar9 = 0;
      fn_82F958D8(iStack0000001c,iStack_4c);
      puVar6 = (undefined4 *)fn_82F953B8(iStack_4c);
      iStack_50 = *puVar6;
    }
    pcVar4 = (char *)fn_82F953A8(iStack_50);
    if (*pcVar4 == '\0') {
      puVar6 = (undefined4 *)fn_8265D5A8(iStack_50);
      pcVar4 = (char *)fn_82F95398(*puVar6);
      if (*pcVar4 == '\x01') {
      ...
      if (*pcVar4 == '\x01') {
        puVar6 = (undefined4 *)fn_8265D5A8(iStack_50);
        puVar9 = (undefined1 *)fn_82F95398(*puVar6);
        *puVar9 = 1;
        puVar9 = (undefined1 *)fn_82F95398(iStack_50);
        *puVar9 = 0;
        fn_82F95AD0(iStack0000001c,iStack_50);
        puVar6 = (undefined4 *)fn_82F953B8(iStack_4c);
        iStack_50 = *puVar6;
      }
      puVar9 = (undefined1 *)fn_82F95398(iStack_4c);
      puVar10 = (undefined1 *)fn_82F95398(iStack_50);
      *puVar10 = *puVar9;
      puVar9 = (undefined1 *)fn_82F95398(iStack_4c);
      *puVar9 = 1;
      puVar6 = (undefined4 *)fn_82F953B8(iStack_50);
      ...
      *puVar9 = 1;
      fn_82F958D8(iStack0000001c,iStack_4c);
LAB_82f95148:
      puVar9 = (undefined1 *)fn_82F95398(iStack_54);
      *puVar9 = 1;
      goto LAB_82f95158;
    }
  }
    ...
    if (*pcVar4 == '\0') {
      ...
      *puVar9 = 1;
      puVar9 = (undefined1 *)fn_82F95398(iStack_4c);
      *puVar9 = 0;
      fn_82F95AD0(iStack0000001c,iStack_4c);
      puVar6 = (undefined4 *)fn_8265D5A8(iStack_4c);
      iStack_50 = *puVar6;
    }
    pcVar4 = (char *)fn_82F953A8(iStack_50);
    if (*pcVar4 == '\0') {
      ...
      if (*pcVar4 == '\x01') {
        ...
        *puVar9 = 1;
        puVar9 = (undefined1 *)fn_82F95398(iStack_50);
        *puVar9 = 0;
        fn_82F958D8(iStack0000001c,iStack_50);
        puVar6 = (undefined4 *)fn_8265D5A8(iStack_4c);
        iStack_50 = *puVar6;
      }
      puVar9 = (undefined1 *)fn_82F95398(iStack_4c);
