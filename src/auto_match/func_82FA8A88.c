...
undefined8 fn_82FA8A88(int param_1,int *param_2,undefined8 param_3)

{
  ...
  if (*(int *)(param_1 + 0x1c) == 0) {
    iStack_30 = *param_2;
    if (iStack_30 < 1) {
      (**(code **)(*(int *)(param_1 + 4) + 4))(param_1 + 4,param_3);
    }
    else {
      iStack_2c = param_2[1];
    ...
    fn_82FF5400((double)lbl_8216C698,lbl_832642F4,*(int *)(param_1 + 0x1c),0x2000000,
                      0xffffffff83260000,*param_2,param_2[1],0);
  }
  return 1;
}
