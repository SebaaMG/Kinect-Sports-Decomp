...
extern int fn_8258EDA0();
extern int fn_8258EE08();
extern int fn_8265CA20();
extern int fn_82F622E0();
extern unsigned int stack0x00000024;


undefined4 * fn_8258E838(undefined4 *param_1,int param_2,int *param_3)

{
  ...
  if (*(char *)((int)piVar7 + 0x39) == '\0') {
    ...
    if ((*(char *)(param_3[2] + 0x39) == '\0') &&
      ...
      *piStack00000024 = *param_3;
      ...
      uVar1 = *(undefined1 *)(piStack00000024 + 0xe);
      *(undefined1 *)(piStack00000024 + 0xe) = *(undefined1 *)(param_3 + 0xe);
      *(undefined1 *)(param_3 + 0xe) = uVar1;
      goto LAB_8258ea20;
    }
  }
  else {
  ...
  if ((int *)**(undefined4 **)(param_2 + 4) == param_3) {
    ...
    if (*(char *)((int)piVar8 + 0x39) == '\0') {
      piVar5 = (int *)*piVar8;
      piVar6 = piVar8;
      while (piVar2 = piVar5, *(char *)((int)piVar2 + 0x39) == '\0') {
        piVar6 = piVar2;
        piVar5 = (int *)*piVar2;
      }
    }
...
LAB_8258ea20:
  if (*(char *)(param_3 + 0xe) == '\x01') {
    if (piVar8 != *(int **)(*(int *)(param_2 + 4) + 4)) {
      do {
        piVar6 = piVar7;
        if (*(char *)(piVar8 + 0xe) != '\x01') break;
        piVar7 = (int *)*piVar6;
        if (piVar8 == piVar7) {
          piVar7 = (int *)piVar6[2];
          if (*(char *)(piVar7 + 0xe) == '\0') {
            *(undefined1 *)(piVar7 + 0xe) = 1;
            *(undefined1 *)(piVar6 + 0xe) = 0;
            fn_8258EDA0(param_2,piVar6);
            piVar7 = (int *)piVar6[2];
          }
          if (*(char *)((int)piVar7 + 0x39) == '\0') {
            if ((*(char *)(*piVar7 + 0x38) != '\x01') || (*(char *)(piVar7[2] + 0x38) != '\x01')) {
              if (*(char *)(piVar7[2] + 0x38) == '\x01') {
                *(undefined1 *)(*piVar7 + 0x38) = 1;
                *(undefined1 *)(piVar7 + 0xe) = 0;
                fn_8258EE08(param_2,piVar7);
                piVar7 = (int *)piVar6[2];
              }
              *(undefined1 *)(piVar7 + 0xe) = *(undefined1 *)(piVar6 + 0xe);
              *(undefined1 *)(piVar6 + 0xe) = 1;
              *(undefined1 *)(piVar7[2] + 0x38) = 1;
              fn_8258EDA0(param_2,piVar6);
              break;
            }
LAB_8258eb4c:
          ...
          if (*(char *)(piVar7 + 0xe) == '\0') {
            *(undefined1 *)(piVar7 + 0xe) = 1;
            *(undefined1 *)(piVar6 + 0xe) = 0;
            fn_8258EE08(param_2,piVar6);
            piVar7 = (int *)*piVar6;
          }
          if (*(char *)((int)piVar7 + 0x39) == '\0') {
            if ((*(char *)(piVar7[2] + 0x38) == '\x01') && (*(char *)(*piVar7 + 0x38) == '\x01'))
            goto LAB_8258eb4c;
            if (*(char *)(*piVar7 + 0x38) == '\x01') {
              *(undefined1 *)(piVar7[2] + 0x38) = 1;
              *(undefined1 *)(piVar7 + 0xe) = 0;
              fn_8258EDA0(param_2,piVar7);
              piVar7 = (int *)*piVar6;
            }
            *(undefined1 *)(piVar7 + 0xe) = *(undefined1 *)(piVar6 + 0xe);
            *(undefined1 *)(piVar6 + 0xe) = 1;
