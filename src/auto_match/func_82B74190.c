...
uint * fn_82B74190(int param_1,ushort *param_2,uint *param_3)

{
  ...
  if (uVar2 < 4) {
    ...
    *puVar4 = *(uint *)(param_2 + 10);
    ...
    if ((*(uint *)(param_2 + 10) & 0x800000) == 0) goto LAB_82b74328;
    uVar5 = *(uint *)(param_2 + 0x16);
  }
  else {
    if (5 < uVar2) goto LAB_82b74328;
    if (uVar2 == 4) {
      *(undefined2 *)((int)param_3 + 2) = 0x56;
    ...
    *puVar4 = *(uint *)(param_2 + 8);
    ...
    if ((*(uint *)(param_2 + 8) & 0x800000) == 0) goto LAB_82b74328;
