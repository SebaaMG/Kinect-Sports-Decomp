...
extern int fn_8243F2C0();
extern int fn_8243F748();
extern int fn_82440418();
extern int fn_82F68CC0();
extern unsigned int uStack_bc;
extern unsigned int uStack_c0;


void fn_8243E968(ulonglong param_1,ulonglong param_2,ulonglong param_3,undefined8 param_4)

{
  ...
  if (0x20 < (int)uVar1) {
    do {
      ...
      param_2 = uVar6;
      if (iVar5 < 1) break;
      fn_8243F2C0(&uStack_c0,param_1,uVar6,param_4);
      ...
      if ((int)(uStack_c0 - (int)param_1) / 0x5c < (int)((int)uVar6 - uStack_bc) / 0x5c) {
        fn_8243E968(param_1,param_2,param_3,param_4);
        param_2 = uVar6;
        param_1 = uVar7;
      }
      else {
        fn_8243E968(uVar7,uVar6,param_3,param_4);
      }
      lVar2 = param_2 - param_1;
      uVar1 = (int)lVar2 / 0x5c;
      uVar6 = param_2;
    ...
    if (0x20 < (int)uVar1) {
      ...
      if (0 < lVar4) {
        ...
        do {
          ...
          fn_82440418(param_1,lVar4,uVar1,auStack_b0,param_4);
        } while (0 < (int)lVar4);
      }
      if ((int)uVar1 < 2) {
        return;
      ...
      do {
        ...
        fn_82440418(param_1,0,((int)lVar2 + -0x5c) / 0x5c,auStack_b0,param_4);
        lVar4 = lVar4 + -0x5c;
  ...
  if (1 < (int)uVar1) {
    fn_8243F748(param_1,param_2,param_4);
  }
  return;
}
