...
undefined8 fn_822EC810(int param_1,undefined8 param_2)

{
  ...
  *(undefined8 *)((int)auStack_58 + *(int *)(aiStack_70[0] + 4)) = 9;
  piVar2 = (int *)fn_822EC998(aiStack_70,param_2);
  uVar4 = *(int *)(*piVar2 + 4) + (int)piVar2;
  if ((-(uint)((*(uint *)(uVar4 + 0xc) & 6) == 0) & uVar4) != 0) {
    iVar3 = fn_822ECAF8(aiStack_70);
    uVar5 = 1;
    if (iVar3 == -1) goto LAB_822ec8d8;
  }
  uVar5 = 0;
LAB_822ec8d8:
