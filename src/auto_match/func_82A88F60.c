...
void fn_82A88F60(undefined8 param_1,int param_2,undefined8 param_3,longlong param_4,
                  longlong param_5)

{
  ...
  fn_82A87148(param_3,param_4 + 0x60,0x10,param_5 + 0x28);
  fn_82A87148(param_3,param_4 + 0x70,0x10,param_5 + 0x2a);
  return;
}
