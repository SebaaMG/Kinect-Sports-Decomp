...
void fn_82A9A5D8(int *param_1,ulonglong param_2,undefined4 *param_3)

{
  ...
  if ((ulonglong)(uint)param_1[2] < (param_2 & 0xffffffff)) {
    ...
    lVar1 = fn_82AAC750(param_1,uVar2 * 0x114);
    if (lVar1 == 0) {
      *param_3 = 0x8007000e;
    }
    else {
      param_1[2] = (int)uVar2;
      if (*param_1 != 0) {
        fn_82F68CC0(lVar1,*param_1,(ulonglong)(uint)param_1[1] * 0x114);
