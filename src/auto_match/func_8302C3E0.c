...
undefined8 fn_8302C3E0(int *param_1,uint *param_2)

{
  ...
  if ((*(short *)(param_1 + 6) != 0) && (uVar1 = *param_2, uVar1 < 5)) {
    if (uVar1 == 1) {
      uVar2 = fn_82FF33A8(param_1,param_2[1],param_2 + 3,param_2[2]);
      return uVar2;
    }
    if (uVar1 == 2) {
      uVar2 = fn_82FF33C0(param_1,param_2[1],param_2 + 3,*(undefined1 *)((int)param_2 + 0x16),
                                param_2[2]);
      return uVar2;
    }
    if (uVar1 == 3) {
      (**(code **)(*param_1 + 0x28))(param_1,param_2[1],param_2[6],param_2[2]);
      return 1;
    }
    if (uVar1 == 0) {
