...
void fn_82D6E2C8(int *param_1,int *param_2,int *param_3,undefined8 param_4,undefined8 param_5)

{
  ...
  aiStack_90[2] = param_1[2];
  iVar4 = *param_1;
  aiStack_90[0] = *(int *)(iVar4 + 0x10);
  ...
  cStack_78 = '\0';
  piStack_84 = param_1;
  (**(code **)((uint)*(byte *)((*(int *)(aiStack_90[0] + 0xc) + 0xd) * 0x20 + *param_3 + iVar2) *
               0x14 + *param_3 + 0x9ac))(aiStack_90,param_2,param_3,&ppuStack_80,&ppuStack_80);
  if (cStack_78 != '\0') {
    ...
    aiStack_90[0] = *(int *)(iVar4 + 0x18);
    aiStack_90[1] = 0;
    (**(code **)((uint)*(byte *)((*(int *)(aiStack_90[0] + 0xc) + 0xd) * 0x20 + *param_3 + iVar2) *
                 0x14 + *param_3 + 0x9ac))(aiStack_90,param_2,param_3,param_4,param_5);
  }
  ppuStack_80 = &lbl_82138A2C;
  iVar4 = KeTlsGetValue(lbl_8323B4A0);
  puVar1 = *(undefined4 **)(iVar4 + 4);
  if (puVar1 < *(undefined4 **)(iVar4 + 0xc)) {
    *puVar1 = &lbl_8202CF7C;
