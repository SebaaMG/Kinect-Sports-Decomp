...
int * fn_82496B28(int *param_1,int param_2,int *param_3,int *param_4)
      ...
      if (*param_3 == *(int *)(iVar7 + 0x10)) {
        if (param_4 != (int *)*piVar9) {
          ...
          *(int *)(*param_4 + 4) = param_4[1];
          param_4[8] = (int)&lbl_821BEBAC;
          fn_82491E88(param_4 + 0x14);
