...
void fn_828D6860(ulonglong param_1,ulonglong param_2)

{
  ...
  if (0 < lVar4) {
    do {
      ...
      if (*(uint *)(iStack_30 + 8) <= uVar2) {
        uVar2 = uVar2 - *(uint *)(iStack_30 + 8);
      }
      _iStack_30 = CONCAT44(*(undefined4 *)
                             (*(int *)(*(int *)(iStack_30 + 4) + (int)((uVar2 & 0xffffffff) << 2)) +
                             (int)((uVar1 & 3) << 2)),(int)param_1);
      fn_828D5808(param_1,lVar4,uVar3,&iStack_30);
    } while (0 < (int)lVar4);
  }
  return;
}
