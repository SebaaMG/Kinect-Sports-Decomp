...

{
  ...
  *(int *)(iVar3 + 0xa80) = *(int *)(iVar3 + 0xa80) + 1;
  uVar1 = (uint)fVar2;
  uVar4 = *(uint *)(iVar3 + 0xa94);
  if (*(uint *)(iVar3 + 0xa90) < uVar1) {
    *(uint *)(iVar3 + 0xa90) = uVar1;
    *(undefined4 *)
     (*(int *)((*(int **)**(undefined4 **)(iVar3 + 8))[4] * 4 +
              **(int **)**(undefined4 **)(iVar3 + 8)) + 0x1c) = 1;
  }
  if ((uVar1 != 0) && ((uVar1 < uVar4 || (uVar4 == 0)))) {
    *(uint *)(iVar3 + 0xa94) = uVar1;
  }
  iStack_c = (int)(longlong)*(float *)(iVar3 + 0x208);
  *(int *)(iVar3 + 0xa88) = iStack_c + *(int *)(iVar3 + 0xa88);
  return;
}
