...
undefined8 fn_8294E2C8(int param_1)

{
  ...
  if ((**(uint **)(param_1 + 0x104) & 0xfffff) == 1) {
    uVar5 = fn_8294AC48(param_1,*(uint **)(param_1 + 0x104),0xffffffff820363d0,auStack_130,
                          auStack_150,auStack_f0,&uStack_140,1);
    if ((((int)uVar5 == 1) &&
        (uVar5 = fn_8294AC48(param_1,*(undefined4 *)(param_1 + 0x104),0xffffffff82036430,
                               auStack_130,auStack_150,auStack_f0,&uStack_140,1), (int)uVar5 == 1))
       && (uVar5 = fn_8294AC48(param_1,*(undefined4 *)(param_1 + 0x104),0xffffffff82036490,
                                 auStack_130,auStack_150,auStack_f0,&uStack_140,1), (int)uVar5 == 1)
       ) {
      uVar5 = fn_8294AC48(param_1,*(undefined4 *)(param_1 + 0x104),0xffffffff820364f0,auStack_130,
                            auStack_150,auStack_f0,&uStack_140,1);
    }
    if ((int)uVar5 == 0) {
      uVar7 = 4;
