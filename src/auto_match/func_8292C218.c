...
void fn_8292C218(int param_1,int param_2,int param_3,longlong param_4)

{
  ...
  if (uVar5 < uVar4) {
    ...
    do {
      ...
      *pfVar2 = (float)(puVar6[1] >> 10 & 0x1f) * fVar1;
      pfVar2[1] = (float)(puVar6[1] >> 5 & 0x1f) * fVar1;
      pfVar2[2] = (float)(puVar6[1] & 0x1f) * fVar1;
      puVar6 = puVar6 + 1;
      pfVar2[3] = (float)(*puVar6 >> 0xf);
