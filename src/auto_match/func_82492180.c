...
void fn_82492180(uint *param_1,ulonglong param_2,ulonglong param_3,ulonglong param_4)

{
  ...
  uVar4 = ((int)param_4 - (int)param_3) / 0x1c;
  if (uVar4 != 0) {
    uVar6 = (ulonglong)param_1[1];
    lVar2 = (longlong)((int)(param_1[1] - *param_1) / 0x1c);
    if ((0x9249249U - lVar2 & 0xffffffff) < (ulonglong)uVar4) {
                    /* WARNING: Subroutine does not return */
      fn_82F622A8(0xffffffff82196fd4);
    }
    uVar1 = lVar2 + (int)uVar4;
    uVar5 = (int)(param_1[2] - *param_1) / 0x1c;
    if ((ulonglong)uVar5 < (uVar1 & 0xffffffff)) {
      uVar6 = 0;
      if ((ulonglong)uVar5 <= (0x9249249 - (ulonglong)(uVar5 >> 1) & 0xffffffff)) {
      ...
      if (((uVar6 & 0xffffffff) != 0) &&
         ((0x9249249 < (uVar6 & 0xffffffff) || (uVar1 = fn_8265C9E0(uVar6 * 0x1c), uVar1 == 0)
          ))) {
        uStack_5c = 0;
      ...
      if ((param_3 & 0xffffffff) != (param_4 & 0xffffffff)) {
        ...
        do {
          if ((uVar8 & 0xffffffff) != 0) {
            fn_82F68CC0(uVar8,lVar2 + uVar8,0x1c);
          }
          uVar8 = uVar8 + 0x1c;
      ...
      if (uVar5 != 0) {
        for (; uVar5 != param_1[1]; uVar5 = uVar5 + 0x1c) {
        }
        fn_8265CA20();
      }
      uVar5 = (uint)uVar1;
      *param_1 = uVar5;
      uVar4 = (iVar3 / 0x1c + uVar4) * 0x1c + uVar5;
      param_1[2] = (int)uVar6 * 0x1c + uVar5;
    }
    else {
      if ((param_3 & 0xffffffff) != (param_4 & 0xffffffff)) {
        do {
          if ((uVar6 & 0xffffffff) != 0) {
            fn_82F68CC0(uVar6,param_3,0x1c);
          }
