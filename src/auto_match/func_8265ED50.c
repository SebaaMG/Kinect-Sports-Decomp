...
undefined4 fn_8265ED50(int param_1)

{
  ...
  if (iStack00000014 == 0) {
    fn_8266C340(0xffffffff820015c0,0xffffffff82001624,0x1bc,0xffffffff82001a98);
  }
  puVar2 = (undefined4 *)fn_82668D40(auStack_1c,0xffffffff831e7a4c);
  uStack_20 = *puVar2;
  while( true ) {
    uVar1 = fn_82668D80(auStack_14,0xffffffff831e7a4c);
    cVar5 = fn_82668EA0(&uStack_20,uVar1);
    iVar4 = iStack00000014;
    if (cVar5 == '\0') {
      fn_8266C438(0xffffffff82001a28,iStack00000014);
      return 0;
    }
    puVar3 = (uint *)fn_8265FA58(&uStack_20,0);
    iVar4 = fn_8265F598((ulonglong)*puVar3 + 4,iVar4);
    if (iVar4 == 0) break;
