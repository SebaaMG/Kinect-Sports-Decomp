...
uint fn_82ADD0D8(uint param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if (param_1 != 0) {
    do {
      param_8 = (ulonglong)*(uint *)(uVar1 + 0x30) & 0x80000;
      if ((*(uint *)(uVar1 + 0x30) & 0x80000) != 0) break;
