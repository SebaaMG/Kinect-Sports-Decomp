...
undefined8 fn_82F61F20(longlong param_1)

{
  ...
  if (uVar1 == 0) {
    ...
    do {
      ...
      if (in_RESERVE != '\0') {
        uVar2 = storeWordConditionalIndexed(uVar3,0,lVar5);
        *puVar6 = uVar2;
        in_cr0 = 2;
      }
    } while (!(bool)(in_cr0 >> 1 & 1));
    ...
    if (uVar1 == 0) {
      ...
      sync(1);
      do {
        if (*puVar6 != (uint)uVar3) {
          if (in_RESERVE != '\0') {
            uVar1 = storeWordConditionalIndexed((ulonglong)*puVar6,0,lVar5);
            *puVar6 = uVar1;
            in_cr0 = 2;
          }
          break;
        ...
        if (in_RESERVE != '\0') {
          uVar1 = storeWordConditionalIndexed(0,0,lVar5);
          *puVar6 = uVar1;
          in_cr0 = 2;
        }
      } while (!(bool)(in_cr0 >> 1 & 1));
