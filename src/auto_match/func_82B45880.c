...
int fn_82B45880(undefined8 param_1,int param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((((*(int *)(param_2 + 4) == 1) && (*(int *)(param_2 + 0xc) == 0)) &&
      (iVar1 = *(int *)(param_2 + 8), iVar1 != 0)) &&
     (param_8 = (ulonglong)*(uint *)(iVar1 + 4), *(uint *)(iVar1 + 4) == 3)) {
    return iVar1;
  }
