...
code_r0x828128d4:
    ...
    if ((*(int *)(iVar1 + 0xd0) == 0) &&
       ((cVar2 = fn_82813AE0(iVar1 + 8,auStack_20), cVar2 != '\0' ||
        (cVar2 = fn_82813AE0(iVar1 + 0x48,auStack_20), cVar2 != '\0')))) {
      fn_828132A8(auStack_20[0]);
      uVar3 = 1;
      goto code_r0x828128d4;
    }
    iVar1 = *(int *)(iVar1 + 200);
  } while( true );
}
