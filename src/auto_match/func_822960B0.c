...
undefined8
fn_822960B0(undefined8 param_1,undefined8 param_2,undefined8 param_3,int param_4,
...

{
  ...
  aiStack_a0[0] = iVar2;
  fn_8223F508(iVar2);
  piVar5 = (int *)fn_822969C8(aiStack_a0);
  ...
  if (uVar3 != 0x40) {
    piVar7 = aiStack_a0;
    if (uVar3 == 0x100) {
      puVar8 = (undefined8 *)fn_822964C0(piVar7,param_2,param_3,param_6,lVar10);
      piVar7 = aiStack_98;
      param_6 = lVar10 + param_6;
      param_7 = param_7 - lVar10;
      param_3 = *puVar8;
    }
    puVar8 = (undefined8 *)fn_82296328(piVar7,param_3,param_5,lVar13);
    param_3 = *puVar8;
    lVar13 = 0;
  }
  uVar4 = (**(code **)(*piVar5 + 8))(piVar5);
  puVar8 = (undefined8 *)fn_82296560(aiStack_98,param_2,param_3,param_6,param_7,uVar4);
  uVar4 = *puVar8;
  *(undefined8 *)(param_4 + 0x20) = 0;
  fn_82296328(param_1,uVar4,param_5,lVar13);
